...
public interface IGuestAgent extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationcommon.IGuestAgent
  {
    ...
    static final int TRANSACTION_startOrStopAdbd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_userRemoved = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_userLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
  }
  /** @hide */
