...
public final class KeystoreAtomPayload implements android.os.Parcelable {
  ...
  public final static int keyCreationPerUid = 10;  // android.security.metrics.KeyCreationPerUid keyCreationPerUid;
  public final static int keyOperationPerUid = 11;  // android.security.metrics.KeyOperationPerUid keyOperationPerUid;
  public final static int operationLatency = 12;  // android.security.metrics.OperationLatency operationLatency;
  public final static int keyOperationStreamingStats = 13;  // android.security.metrics.KeyOperationStreamingStats keyOperationStreamingStats;
  ...
  // android.security.metrics.KeyCreationPerUid keyCreationPerUid;

  public static KeystoreAtomPayload keyCreationPerUid(android.security.metrics.KeyCreationPerUid _value) {
    return new KeystoreAtomPayload(keyCreationPerUid, _value);
  }

  public android.security.metrics.KeyCreationPerUid getKeyCreationPerUid() {
    _assertTag(keyCreationPerUid);
    return (android.security.metrics.KeyCreationPerUid) _value;
  }

  public void setKeyCreationPerUid(android.security.metrics.KeyCreationPerUid _value) {
    _set(keyCreationPerUid, _value);
  }

  // android.security.metrics.KeyOperationPerUid keyOperationPerUid;

  public static KeystoreAtomPayload keyOperationPerUid(android.security.metrics.KeyOperationPerUid _value) {
    return new KeystoreAtomPayload(keyOperationPerUid, _value);
  }

  public android.security.metrics.KeyOperationPerUid getKeyOperationPerUid() {
    _assertTag(keyOperationPerUid);
    return (android.security.metrics.KeyOperationPerUid) _value;
  }

  public void setKeyOperationPerUid(android.security.metrics.KeyOperationPerUid _value) {
    _set(keyOperationPerUid, _value);
  }

  // android.security.metrics.OperationLatency operationLatency;

  public static KeystoreAtomPayload operationLatency(android.security.metrics.OperationLatency _value) {
    return new KeystoreAtomPayload(operationLatency, _value);
  }

  public android.security.metrics.OperationLatency getOperationLatency() {
    _assertTag(operationLatency);
    return (android.security.metrics.OperationLatency) _value;
  }

  public void setOperationLatency(android.security.metrics.OperationLatency _value) {
    _set(operationLatency, _value);
  }

  // android.security.metrics.KeyOperationStreamingStats keyOperationStreamingStats;

  public static KeystoreAtomPayload keyOperationStreamingStats(android.security.metrics.KeyOperationStreamingStats _value) {
    return new KeystoreAtomPayload(keyOperationStreamingStats, _value);
  }

  public android.security.metrics.KeyOperationStreamingStats getKeyOperationStreamingStats() {
    _assertTag(keyOperationStreamingStats);
    return (android.security.metrics.KeyOperationStreamingStats) _value;
  }

  public void setKeyOperationStreamingStats(android.security.metrics.KeyOperationStreamingStats _value) {
    _set(keyOperationStreamingStats, _value);
  }
  ...
  public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
    ...
    case keysPerUid:
      ...
      break;
    case keyCreationPerUid:
      _aidl_parcel.writeTypedObject(getKeyCreationPerUid(), _aidl_flag);
      break;
    case keyOperationPerUid:
      _aidl_parcel.writeTypedObject(getKeyOperationPerUid(), _aidl_flag);
      break;
    case operationLatency:
      _aidl_parcel.writeTypedObject(getOperationLatency(), _aidl_flag);
      break;
    case keyOperationStreamingStats:
      _aidl_parcel.writeTypedObject(getKeyOperationStreamingStats(), _aidl_flag);
      break;
    }
  }
  ...
  public void readFromParcel(android.os.Parcel _aidl_parcel) {
    ...
    case keysPerUid: {
      ...
      return; }
    case keyCreationPerUid: {
      android.security.metrics.KeyCreationPerUid _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.security.metrics.KeyCreationPerUid.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    case keyOperationPerUid: {
      android.security.metrics.KeyOperationPerUid _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.security.metrics.KeyOperationPerUid.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    case operationLatency: {
      android.security.metrics.OperationLatency _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.security.metrics.OperationLatency.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    case keyOperationStreamingStats: {
      android.security.metrics.KeyOperationStreamingStats _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.security.metrics.KeyOperationStreamingStats.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    }
  ...
  public int describeContents() {
    ...
    case keysPerUid:
      ...
      break;
    case keyCreationPerUid:
      _mask |= describeContents(getKeyCreationPerUid());
      break;
    case keyOperationPerUid:
      _mask |= describeContents(getKeyOperationPerUid());
      break;
    case operationLatency:
      _mask |= describeContents(getOperationLatency());
      break;
    case keyOperationStreamingStats:
      _mask |= describeContents(getKeyOperationStreamingStats());
      break;
    }
    return _mask;
  }
  ...
  private String _tagString(int _tag) {
    ...
    case keyCreationPerUid: return "keyCreationPerUid";
    case keyOperationPerUid: return "keyOperationPerUid";
    case operationLatency: return "operationLatency";
    case keyOperationStreamingStats: return "keyOperationStreamingStats";
    }
  ...
  public static @interface Tag {
    ...
    public static final int keyCreationPerUid = 10;
    public static final int keyOperationPerUid = 11;
    public static final int operationLatency = 12;
    public static final int keyOperationStreamingStats = 13;
  }
}
