...
public final class TelephonyStatsLog {
    ...
    /**
     * MessagingReadRestrictionReported messaging_read_restriction_reported<br>
     * Usage: StatsLog.write(StatsLog.MESSAGING_READ_RESTRICTION_REPORTED, int caller_uid, int content_provider, int read_restricted_messages_app_op_mode, int event_type, int count);<br>
     */
    public static final int MESSAGING_READ_RESTRICTION_REPORTED = 1348;
    ...
    // Values for MessagingReadRestrictionReported.content_provider
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__CONTENT_PROVIDER__CONTENT_PROVIDER_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__CONTENT_PROVIDER__CONTENT_PROVIDER_SMS_PROVIDER = 1;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__CONTENT_PROVIDER__CONTENT_PROVIDER_MMS_PROVIDER = 2;

    // Values for MessagingReadRestrictionReported.read_restricted_messages_app_op_mode
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_ALLOWED = 1;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_IGNORED = 2;

    // Values for MessagingReadRestrictionReported.event_type
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__EVENT_TYPE__MESSAGING_READ_RESTRICTION_EVENT_TYPE_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__EVENT_TYPE__RESTRICTED_MESSAGE_INSERTED = 1;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__EVENT_TYPE__UNRESTRICTED_MESSAGE_INSERTED = 2;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__EVENT_TYPE__UPDATED_MESSAGE_TO_UNRESTRICTED = 3;
    public static final int MESSAGING_READ_RESTRICTION_REPORTED__EVENT_TYPE__QUERY_RESTRICTED_MESSAGES = 4;
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (MESSAGING_READ_RESTRICTION_REPORTED == code) {
            builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
        builder.writeInt(arg3);
