...
public class EventLogTags {
  ...
  /** 31009 wm_task_restored (TaskId|1|5),(RootTaskId|1|5) */
  public static final int WM_TASK_RESTORED = 31009;
  ...
  public static void writeWmTaskRestored(int taskid, int roottaskid) {
    android.util.EventLog.writeEvent(WM_TASK_RESTORED, taskid, roottaskid);
  }
