...
public class UidPackageState implements android.os.Parcelable
{
  ...
  public static class PackageState implements android.os.Parcelable
  {
    ...
    public boolean equals(Object other) {
      ...
      if (!java.util.Objects.deepEquals(pccId, that.pccId)) return false;
      return true;
    }

    @Override
    public int hashCode() {
      return java.util.Arrays.deepHashCode(java.util.Arrays.asList(packageName, targetSdk, isPlaybackCaptureAllowed, pccId).toArray());
    }
    @Override
    public int describeContents() {
      int _mask = 0;
