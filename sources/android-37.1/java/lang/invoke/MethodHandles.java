...
return mh1;
    ...
    @android.annotation.Hide public static byte arrayElementGetter(byte[] array, int i) { return array[i]; }

    @android.annotation.Hide public static boolean arrayElementGetter(boolean[] array, int i) { return array[i]; }

    @android.annotation.Hide public static char arrayElementGetter(char[] array, int i) { return array[i]; }

    @android.annotation.Hide public static short arrayElementGetter(short[] array, int i) { return array[i]; }

    @android.annotation.Hide public static int arrayElementGetter(int[] array, int i) { return array[i]; }

    @android.annotation.Hide public static long arrayElementGetter(long[] array, int i) { return array[i]; }

    @android.annotation.Hide public static float arrayElementGetter(float[] array, int i) { return array[i]; }

    @android.annotation.Hide public static double arrayElementGetter(double[] array, int i) { return array[i]; }
...
assert((int)twice.invokeExact(21) == 42);
    ...
    @android.annotation.Hide public static byte identity(byte val) { return val; }

    @android.annotation.Hide public static boolean identity(boolean val) { return val; }

    @android.annotation.Hide public static char identity(char val) { return val; }

    @android.annotation.Hide public static short identity(short val) { return val; }

    @android.annotation.Hide public static int identity(int val) { return val; }

    @android.annotation.Hide public static long identity(long val) { return val; }

    @android.annotation.Hide public static float identity(float val) { return val; }

    @android.annotation.Hide public static double identity(double val) { return val; }
    ...
    MethodHandle insertArguments(MethodHandle target, int pos, Object... values) {
        Object[] copiedValues = Arrays.copyOf(values, values.length);
        int insCount = copiedValues.length;
        ...
        for (int i = 0; i < insCount; i++) {
            ...
            if (!ptype.isPrimitive()) {
                ptypes[pos + i].cast(copiedValues[i]);
            } else {
                // Will throw a ClassCastException if something terrible happens.
                copiedValues[i] = Wrapper.forPrimitiveType(ptype).convert(copiedValues[i], ptype);
            }
        }

        return new Transformers.InsertArguments(target, pos, copiedValues);
    }
