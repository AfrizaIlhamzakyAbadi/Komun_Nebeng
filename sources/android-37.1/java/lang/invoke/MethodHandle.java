...
public abstract class MethodHandle {
    ...
    */
    ...
    @android.annotation.Hide public static final int INVOKE_VIRTUAL = 0;

    @android.annotation.Hide public static final int INVOKE_SUPER = 1;

    @android.annotation.Hide public static final int INVOKE_DIRECT = 2;

    @android.annotation.Hide public static final int INVOKE_STATIC = 3;

    @android.annotation.Hide public static final int INVOKE_INTERFACE = 4;

    @android.annotation.Hide public static final int INVOKE_TRANSFORM = 5;

    @android.annotation.Hide public static final int INVOKE_VAR_HANDLE = 6;

    @android.annotation.Hide public static final int INVOKE_VAR_HANDLE_EXACT = 7;

    @android.annotation.Hide public static final int IGET = 8;

    @android.annotation.Hide public static final int IPUT = 9;

    @android.annotation.Hide public static final int SGET = 10;

    @android.annotation.Hide public static final int SPUT = 11;

    // The kind of this method handle (used by the runtime). This is one of the INVOKE_*
    // constants or SGET/SPUT, IGET/IPUT.

    @android.annotation.Hide protected final int handleKind;

    // The ArtMethod* or ArtField* associated with this method handle (used by the runtime).

    @android.annotation.Hide protected final long artFieldOrMethod;
