...
public abstract class BroadcastReceiver {
    ...
    public static class PendingResult {
        ...
        private ReceiverFinishController mFinishController =
                RemoteReceiverFinishController.getInstance();

        @VisibleForTesting
        @Hide
        public void setFinishController(@NonNull ReceiverFinishController controller) {
            mFinishController = controller;
        }
        ...
        public final void finish() {
            ...
            mFinishController.finishReceiver(this);
        }
