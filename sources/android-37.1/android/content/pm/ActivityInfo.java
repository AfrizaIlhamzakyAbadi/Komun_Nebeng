...
public class ActivityInfo extends ComponentInfo implements Parcelable {
    ...
    /**
     * Bit in {@link #flags}: If set, this component will only be seen
    ...
    /**
     * Includes the packages the override is applied to into the camera compatibility treatment
     * which simulates running on a portrait device, in the orientation requested by the app, or
     * orientation requested by orientation overrides, or portrait by default.
     *
     * <p>This treatment aims to mitigate camera issues on large screens, like stretched or sideways
     * previews. It simulates running on a portrait device by:
     * <ul>
     *   <li>Letterboxing the app window,
     *   <li>Cropping the camera feed to match the app's requested orientation,
     *   <li>Setting the camera sensor orientation to portrait.
     *   <li>Setting the display rotation to match the app's requested orientation, given portrait
     *       natural orientation,
     *   <li>Refreshes the activity to trigger new camera setup, with sandboxed values.
     * </ul>
     *
     * <p>By setting this override to {@code true}, it enables the camera compatibility treatment
     * which simulates app's requested orientation.
     */
    @Hide
    @ChangeId
    @Overridable
    @Disabled
    public static final long OVERRIDE_CAMERA_COMPAT_ENABLE_SIMULATE_REQUESTED_ORIENTATION =
            387235770L; // buganizer id
     ...
     * whose requested orientation is mismatched with the display orientation.
     *
    ...
    /**
     * This change id restricts treatments that force a given min aspect ratio to activities
     * whose task has a smallest screen width dp < 600.
     *
     * This treatment only takes effect if OVERRIDE_MIN_ASPECT_RATIO is also enabled.
     */
    @Hide
    ...
    @Overridable
    @Disabled
    public static final long MIN_ASPECT_RATIO_ONLY_FOR_SMALL_SCREEN = 502054812L; // buganizer id
    ...
    @Overridable
    @Disabled
    public static final long MIN_ASPECT_RATIO_ONLY_FOR_LARGE_SCREEN = 502054815L; // buganizer id
    ...
    /**
     * Small override aspect ratio, currently 4:3.
     */
    @Hide
    ...
    /**
     * Medium override aspect ratio, currently 3:2.
     */
    @TestApi
    ...
    /**
     * Large override aspect ratio, currently 16:9
     */
    @TestApi
    ...
    /**
     * This change id enables the "launch games in fullscreen" feature from a per-app override.
     * When enabled, the app will launch in fullscreen mode on desktop environments.
     */
    @Hide
    @ChangeId
    @Disabled
    @Overridable
    @FlaggedApi(Flags.FLAG_LAUNCH_GAMES_IN_FULLSCREEN_BY_ALLOWLIST)
