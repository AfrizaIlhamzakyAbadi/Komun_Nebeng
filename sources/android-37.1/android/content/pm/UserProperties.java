...
public final class UserProperties implements Parcelable {
    ...
    private static final String ATTR_SHOW_IN_USER_SWITCHER = "showInUserSwitcher";
    ...
    /**
     * Possible values for whether to show this user in the user switcher UI.
     */
    @Hide
    @IntDef(prefix = "SHOW_IN_USER_SWITCHER_", value = {
            SHOW_IN_USER_SWITCHER_NO,
            SHOW_IN_USER_SWITCHER_YES,
    })
    @Retention(RetentionPolicy.SOURCE)
    public @interface ShowInUserSwitcher {
    }

    /**
     * Suggests that the user switcher should display this full user.
     */
    @Hide
    public static final int SHOW_IN_USER_SWITCHER_NO = 0;

    /**
     * Suggests that the user switcher should hide or filter out this full user.
     */
    @Hide
    ...
    public UserProperties(UserProperties orig,
        ...
        if (hasManagePermission) {
            ...
            setShowInUserSwitcher(orig.getShowInUserSwitcher());
        }
    ...
    /**
     * Returns the internal mPropertiesPresent value. Only for testing purposes.
     */
    @Hide
    @VisibleForTesting
    ...
    /**
     * Returns whether this user should be visible in the user switcher interface.
     * <p>
     * <b>Note:</b> This is only relevant for FULL users, since profiles don't appear
     * in the user switcher anyway.
     *
     * @return {@link #SHOW_IN_USER_SWITCHER_YES} if this full user should be visible in the user
     * switcher, {@link #SHOW_IN_USER_SWITCHER_NO} otherwise.
     */
    @Hide
    @RequiresPermission(Manifest.permission.MANAGE_USERS)
    public @ShowInUserSwitcher int getShowInUserSwitcher() {
        if (isPresent(INDEX_SHOW_IN_USER_SWITCHER)) return mShowInUserSwitcher;
        if (mDefaultProperties != null) return mDefaultProperties.mShowInUserSwitcher;
        throw new SecurityException("You don't have permission to query showInUserSwitcher");
    }

    @Hide
    public void setShowInUserSwitcher(@ShowInUserSwitcher int val) {
        this.mShowInUserSwitcher = val;
        setPresent(INDEX_SHOW_IN_USER_SWITCHER);
    }
    private @ShowInUserSwitcher int mShowInUserSwitcher;
    ...
    /**
     * Returns whether a user (usually a profile) is disallowed from having items such as
     * Apps Pending Installation, Widgets, Custom App Shortcuts, etc. on Launcher home screen.
     *
    ...
    private StringBuilder listPropertiesAsStringBuilder() {
        ...
        s.append(", mShowInUserSwitcher="); s.append(getShowInUserSwitcher());
    ...
    public void println(PrintWriter pw, String prefix) {
        ...
        pw.println(prefix + "    mShowInUserSwitcher=" + getShowInUserSwitcher());
    }
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            switch(attributeName) {
                ...
                case ATTR_SHOW_IN_SHARING_SURFACES:
                    ...
                    break;
                case ATTR_SHOW_IN_USER_SWITCHER:
                    setShowInUserSwitcher(parser.getAttributeInt(i));
                    break;
    ...
    public void writeToXml(TypedXmlSerializer serializer)
        ...
        if (isPresent(INDEX_SHOW_IN_USER_SWITCHER)) {
            serializer.attributeInt(null, ATTR_SHOW_IN_USER_SWITCHER, mShowInUserSwitcher);
        }
    ...
    public void writeToParcel(@NonNull Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(mShowInUserSwitcher);
    ...
    private UserProperties(@NonNull Parcel source) {
        ...
        mShowInUserSwitcher = source.readInt();
    ...
    public static final class Builder {
        ...
        private @ShowInSharingSurfaces int mShowInSharingSurfaces =
                SHOW_IN_SHARING_SURFACES_SEPARATE;
        private @ShowInUserSwitcher int mShowInUserSwitcher = SHOW_IN_USER_SWITCHER_YES;
        ...
        @Hide
        public Builder setShowInUserSwitcher(@ShowInUserSwitcher int showInUserSwitcher) {
            mShowInUserSwitcher = showInUserSwitcher;
            return this;
        }
    ...
    private UserProperties(
            ...
            @ShowInUserSwitcher int showInUserSwitcher,
        ...
        setShowInUserSwitcher(showInUserSwitcher);
