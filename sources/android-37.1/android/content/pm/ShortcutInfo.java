...
public final class ShortcutInfo implements Parcelable {
    ...
    /**
     * When this is set, the bitmap icon is waiting to be saved.
     */
    @Hide
    ...
    public static class Builder {
        ...
        /**
         * We don't support resource strings for dynamic shortcuts for now.  (But unit tests
         * use it.)
         */
        @Hide
        @Deprecated
        ...
        /**
         * -- old signature, the internal code still uses it.
         */
        @Hide
        @Deprecated
