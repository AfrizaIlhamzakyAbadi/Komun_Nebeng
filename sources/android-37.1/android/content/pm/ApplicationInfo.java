...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
    ...
    /**
     * The memory budgets specified for this application.  The application lists zero or more
     * budgets in its manifest. This list is a faithful copy of the manifest data (so it is empty if
     * no budgets were declared in the manifest).  The MemoryLimiter consumes this list and resolves
     * overlapping budgets.
     */
    @Hide
    public final @NonNull List<MemoryBudget> memoryBudgets = new ArrayList<>();
    ...
    /**
     * if set, load 4 KB aligned LOAD segments on 16 KB device in compat
     * mode and show warning dialog.
     */
    @Hide
    public static final int PAGE_SIZE_APP_COMPAT_FLAG_LOAD_NOT_ALIGNED = 1 << 2;
    ...
    /**
     * Reserved slot. Do not reuse this bit to ensure seamless backward
     * compatibility during OTA system upgrades.
     */
    @Hide
    public static final int PAGE_SIZE_APP_COMPAT_FLAG_UNUSED = 1 << 7;

    /**
     * if set, load 4 KB aligned RELRO segments on 16 KB device in compat
     * mode and show warning dialog.
     */
    @Hide
    public static final int PAGE_SIZE_APP_COMPAT_FLAG_RELRO_NOT_ALIGNED = 1 << 8;

    /**
     * Max value for page size app compat
     */
    @Hide
    public static final int PAGE_SIZE_APP_COMPAT_FLAG_MAX = 1 << 16;
    ...
    @IntDef(
            ...
            value = {
                ...
                PAGE_SIZE_APP_COMPAT_FLAG_LOAD_NOT_ALIGNED,
                PAGE_SIZE_APP_COMPAT_FLAG_UNUSED,
                PAGE_SIZE_APP_COMPAT_FLAG_RELRO_NOT_ALIGNED,
    ...
    public ApplicationInfo(ApplicationInfo orig) {
        ...
        if (orig.memoryBudgets != null) {
            for (MemoryBudget budget : orig.memoryBudgets) {
                this.memoryBudgets.add(new MemoryBudget(budget));
            }
        }
        theme = orig.theme;
        flags = orig.flags;
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeTypedList(memoryBudgets);
    ...
    private ApplicationInfo(Parcel source) {
        ...
        source.readTypedList(this.memoryBudgets, MemoryBudget.CREATOR);
    }
