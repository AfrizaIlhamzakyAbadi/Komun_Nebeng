...
public abstract class PackageManager {
     ...
     * compatibility override that overrides the lens facing of front camera to back camera.
     *
     * <p>With this property set to {@code false}, the lens facing override will not be applied.
     *
     * <p><b>Syntax:</b>
     * <pre>
     * &lt;application&gt;
     *   &lt;property
     *     android:name="android.camera.PROPERTY_COMPAT_OVERRIDE_LENS_FACING_FRONT"
     *     android:value="true|false"/&gt;
     * &lt;/application&gt;
     * </pre>
     */
    @Hide
    public static final String PROPERTY_COMPAT_OVERRIDE_LENS_FACING_FRONT =
            "android.camera.PROPERTY_COMPAT_OVERRIDE_LENS_FACING_FRONT";
    ...
    /**
     * Flag parameter for {@link #installPackage} to allow the persistent app update for
     * this install on userdebug / eng builds.
     */
    @Hide
    public static final int INSTALL_PERSISTENT_APP = 0x00002000;
    ...
    /**
     * Indicate that no user option has been set. System default should be used.
     */
    @Hide
    public static final int VIRTUAL_GAMEPAD_USER_OPTION_UNSET = 0;

    /**
     * Indicate that user has chose to opt out from the virtual gamepad feature.
     */
    @Hide
     ...
     * {@link android.companion.virtual.VirtualDevice virtual} camera being connected to it.
     */
    @SdkConstant(SdkConstantType.FEATURE)
