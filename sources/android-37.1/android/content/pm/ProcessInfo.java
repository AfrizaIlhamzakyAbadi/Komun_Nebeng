...
public class ProcessInfo implements Parcelable {
    ...
    /**
     * If true, indicates that the process can contain only singleUser or systemUserOnly components.
     */
    ...
    public ProcessInfo(@NonNull ProcessInfo orig) {
        ...
        this.singleUser = orig.singleUser;
    }
     ...
     *   If false (default), the parent app's configuration determines behavior.
     * @param singleUser
     *   If true, indicates that the process can contain only singleUser or systemUserOnly
     *   components.
     */
    ...
    protected ProcessInfo(@NonNull Parcel in) {
        ...
        boolean _singleUser = (flg & 0x40) != 0;
