...
public final class ThemeStyle {
    ...
    /**
     * Returns the name of the given style. This method is equivalent to `toString(Integer)`.
     *
     * @param style The style value.
    ...
    /**
     * Returns the number of seed colors required for the given theme style.
     *
     * @param style The theme style.
     * @return The number of seeds required (e.g., 2 for CMF, 1 for others).
     */
    @Hide
    public static int getRequiredSeedCount(@Type int style) {
        return style == CMF ? 2 : 1;
    }
}
