...
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.COLOR_MODE;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.DENSITY_DPI;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.FONT_SCALE;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.FONT_WEIGHT_ADJUSTMENT;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.GRAMMATICAL_GENDER;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.HARD_KEYBOARD_HIDDEN;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.KEYBOARD;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.KEYBOARD_HIDDEN;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.LOCALES;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.LOCALE_LIST;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.MCC;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.MNC;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.NAVIGATION;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.NAVIGATION_HIDDEN;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.ORIENTATION;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.SCREEN_HEIGHT_DP;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.SCREEN_LAYOUT;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.SCREEN_WIDTH_DP;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.SMALLEST_SCREEN_WIDTH_DP;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.TOUCHSCREEN;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.UI_MODE;
import static com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto.WINDOW_CONFIGURATION;
import static com.android.internal.tracing.winscope.protos.Configuration.ResourcesConfigurationProto.CONFIGURATION;
import static com.android.internal.tracing.winscope.protos.Configuration.ResourcesConfigurationProto.SCREEN_HEIGHT_PX;
import static com.android.internal.tracing.winscope.protos.Configuration.ResourcesConfigurationProto.SCREEN_WIDTH_PX;
import static com.android.internal.tracing.winscope.protos.Configuration.ResourcesConfigurationProto.SDK_VERSION;
...
import com.android.internal.tracing.winscope.protos.Locale.LocaleProto;
...
public final class Configuration implements Parcelable, Comparable<Configuration> {
    ...
    /**
     * Hack to get this information from WM to app running in compat mode.
     */
    @Hide
    ...
    /**
     * Native-specific bit mask for MCC config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_MCC = 0x0001;

    /**
     * Native-specific bit mask for MNC config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_MNC = 0x0002;

    /**
     * Native-specific bit mask for LOCALE config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_LOCALE = 0x0004;

    /**
     * Native-specific bit mask for TOUCHSCREEN config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_TOUCHSCREEN = 0x0008;

    /**
     * Native-specific bit mask for KEYBOARD config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_KEYBOARD = 0x0010;

    /**
     * Native-specific bit mask for KEYBOARD_HIDDEN config; DO NOT USE UNLESS YOU
     * ARE SURE.
     */
    @Hide
    ...
    /**
     * Native-specific bit mask for NAVIGATION config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_NAVIGATION = 0x0040;

    /**
     * Native-specific bit mask for ORIENTATION config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_ORIENTATION = 0x0080;

    /**
     * Native-specific bit mask for DENSITY config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_DENSITY = 0x0100;

    /**
     * Native-specific bit mask for SCREEN_SIZE config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_SCREEN_SIZE = 0x0200;

    /**
     * Native-specific bit mask for VERSION config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_VERSION = 0x0400;

    /**
     * Native-specific bit mask for SCREEN_LAYOUT config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_SCREEN_LAYOUT = 0x0800;

    /**
     * Native-specific bit mask for UI_MODE config; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_UI_MODE = 0x1000;

    /**
     * Native-specific bit mask for SMALLEST_SCREEN_SIZE config; DO NOT USE UNLESS YOU
     * ARE SURE.
     */
    @Hide
    ...
    /**
     * Native-specific bit mask for LAYOUTDIR config ; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_LAYOUTDIR = 0x4000;

    /**
     * Native-specific bit mask for COLOR_MODE config ; DO NOT USE UNLESS YOU ARE SURE.
     */
    @Hide
    public static final int NATIVE_CONFIG_COLOR_MODE = 0x10000;

    /**
     * Native-specific bit mask for GRAMMATICAL_GENDER config; DO NOT USE UNLESS YOU
     * ARE SURE.
     */
    @Hide
     ...
     * {@link com.android.internal.tracing.winscope.protos.Configuration.ConfigurationProto}
    ...
    /**
     * Write full
     * {@link com.android.internal.tracing.winscope.protos.Configuration.ResourcesConfigurationProto}
