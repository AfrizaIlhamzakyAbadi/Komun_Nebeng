...
public class Element {
    ...
    protected static final String TAG_PROCESS = "process";
    protected static final String TAG_PROCESSES = "processes";
    ...
    private final TagCounter[] mTagCounters = new TagCounter[37];
    ...
    private void init(String tag) {
        ...
        switch (tag) {
            ...
            case TAG_APPLICATION:
                ...
                initializeCounter(TAG_PROCESSES, 1);
                break;
            case TAG_PROCESSES:
                initializeCounter(TAG_PROCESS, 20);
                break;
            case TAG_COMPATIBLE_SCREENS:
    ...
    private int getResStrMaxLen(@StyleableRes int index) {
        switch (mTag) {
            ...
            case TAG_PROCESS:
                return getProcessResStrMaxLen(index);
            case TAG_PROPERTY:
    ...
    private static int getProcessResStrMaxLen(@StyleableRes int index) {
        switch (index) {
            case R.styleable.AndroidManifestProcess_process:
            case R.styleable.AndroidManifestProcess_name:
                return MAX_ATTR_LEN_NAME;
            default:
                return DEFAULT_MAX_STRING_ATTR_LENGTH;
        }
    ...
    private boolean isComponentNameAttr(@StyleableRes int index) {
        switch (mTag) {
            ...
            case TAG_PROCESS:
                return index == R.styleable.AndroidManifestProcess_name;
            default:
                return false;
        }
    }
