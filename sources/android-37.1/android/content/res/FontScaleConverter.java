...
public interface FontScaleConverter {
     ...
     * directly and it will do the scaling conversion for you. Dimens and resources loaded from XML
     * will also be automatically converted. But for UI frameworks or other situations where you
     * need to do the conversion without an Android Context, you can use this method.
     *
