...
public class ClipboardManager extends android.text.ClipboardManager {
    ...
    /**
     * Mark this uid as having been explicitly authorized by the user to access the clip.
     *
     * @param uid The uid which the user authorized clip access to.
     */
    @Hide
    @RequiresPermission(Manifest.permission.MANAGE_CLIPBOARD_ACCESS_NOTIFICATION)
    public void notifyUserAuthorizedClipAccess(int uid) {
        try {
            mService.notifyUserAuthorizedClipAccess(uid);
        } catch (RemoteException e) {
