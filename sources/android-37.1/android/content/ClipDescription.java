...
public class ClipDescription implements Parcelable {
    ...
    /**
     * Returns true if the associated {@link ClipData} contains a {@link android.net.Uri} with the
     * {@link android.content.ContentResolver#SCHEME_CONTENT} scheme. Returns false if it does not,
     * or if there is no associated clip data.
     */
    @Hide
    public boolean containsContentUri() {
        return mContainsContentUri;
    }

    /**
     * Sets whether the associated {@link ClipData} contains a {@link android.net.Uri} with the
     * {@link android.content.ContentResolver#SCHEME_CONTENT} scheme. This should be called when
     * this description is associated with clip data or when an item is added to the associated clip
     * data.
     */
    void setContainsContentUri(boolean containsContentUri) {
        mContainsContentUri = containsContentUri;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeBoolean(mContainsContentUri);
    }
    ...
    ClipDescription(Parcel in) {
        ...
        mContainsContentUri = in.readBoolean();
    }
