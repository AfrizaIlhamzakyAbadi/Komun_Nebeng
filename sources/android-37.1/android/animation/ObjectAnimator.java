...
public final class ObjectAnimator extends ValueAnimator {
    ...
    private String mCachedTraceName;
    ...
    /**
     * This is only evaluated if tracing is enabled, so the expensive string building
     * and resource lookup only happen when necessary.
     */
    @Override
    String getNameForTrace() {
        if (mCachedTraceName == null) {
            Object target = getTarget();
            mCachedTraceName = "animator:" + (target != null ? getTargetString(target) + ":" : "")
                    + getPropertyName();
        }
        return mCachedTraceName;
    }

    private String getTargetString(Object target) {
        ...
        try {
            return name + "(id/" + view.getResources().getResourceEntryName(id) + ")";
