...
public class ValueAnimator extends Animator implements AnimationHandler.AnimationFrameCallback {
    ...
    /**
     * Optional custom name for this animator used in Perfetto trace slices.
     * When set via {@link #setTraceName}, overrides the default label returned
     * by {@link #getNameForTrace}.
     */
    ...
    /**
     * Sets a custom name for this animator used in Perfetto trace slices.
     *
     * <p>This name will be displayed in System Tracing (Perfetto) to identify the animation
     * instead of the default "animator" label.
     *
     * <p>For example, if you set the name to "CollapsePanelAnimation", the trace slice name
     * will be "CollapsePanelAnimation".
     *
     * <p>Example usage:
     * <pre>
     * ValueAnimator anim = ValueAnimator.ofFloat(0f, 1f);
     * anim.setTraceName("CollapsePanelAnimation");
     * anim.start();
     * </pre>
     *
     * @param name The custom name for this animator, or null to clear a previously set name.
     */
    @Hide
    public void setTraceName(@Nullable String name) {
        mTraceName = name;
    }
