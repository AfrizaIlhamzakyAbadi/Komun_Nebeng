...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    /**
     * This flag requests that the system only start and bind the {@link AccessibilityService}
     * when an associated shortcut is invoked.
     * <p>
     * If this flag is set, the service is expected to call
     * {@link AccessibilityService#disableSelf()} when it is done with its task (e.g. after
     * the user dismisses the UI).
     * </p>
     */
    @Hide
    public static final int FLAG_REQUIRE_SHORTCUT = 1 << 17;
    ...
    public static String flagToString(int flag) {
        switch (flag) {
            ...
            case FLAG_REQUIRE_SHORTCUT:
                return "FLAG_REQUIRE_SHORTCUT";
            default:
                return null;
        }
    }
