...
public class HealthFitnessStatsLog {
     ...
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_LATENCY_STATS, java.lang.String package_name, int session_data_type, long latency_millis);<br>
     */
     ...
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED, int[] native_data_types_active, int[] native_data_types_disabled, int number_of_writes, int uptime_seconds, int last_error_code, int steps_readers_count, int steps_writers_count, int distance_readers_count, int distance_writers_count, int calories_readers_count, int calories_writers_count);<br>
     */
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED = 1167;

    /**
     * HealthConnectBackupAgentEventReported health_connect_backup_agent_event_reported<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED, int backup_agent_operation, int status, int error, int latency_ms);<br>
     */
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED = 1203;

    /**
     * HealthConnectUdiStatsReported health_connect_udi_stats_reported<br>
     * Usage: StatsLog.write(StatsLog.HEALTH_CONNECT_UDI_STATS_REPORTED, java.lang.String package_name, int num_of_records, int num_of_records_with_udi);<br>
     */
    public static final int HEALTH_CONNECT_UDI_STATS_REPORTED = 1363;
    ...
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__ADVERTISE_DEVICE_DATA_SOURCES = 21;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__INSERT_DEVICE_RECORDS = 22;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__READ_DEVICE_RECORDS = 23;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__UPDATE_DEVICE_RECORDS = 24;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__DELETE_DEVICE_RECORDS = 25;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__GET_CURRENT_DEVICE_DATA_SOURCE = 26;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__GET_DEVICE_DATA_SOURCES = 27;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__GET_DEVICE_DATA_SOURCE_CAPABILITIES = 28;
    public static final int HEALTH_CONNECT_API_CALLED__API_METHOD__HAS_USER_ENABLED_TRACKING = 29;
    ...
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__COMBINED_ALL_DATA_PAGE = 61;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__NEW_HOME_PAGE = 64;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__PAGE__MATCHMAKING_PAGE = 65;
    ...
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__CONNECTED_APP_HOME_SCREEN_BUTTON = 328;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NOT_CONNECTED_APP_HOME_SCREEN_BUTTON = 329;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__SEE_ALL_CONNECTED_APPS_HOME_SCREEN_BUTTON = 330;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__RECENT_ACCESS_BUTTON = 331;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__HOME_SCREEN_FOOTER = 332;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__HOME_SCREEN_FOOTER_LINK = 333;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NO_APPS_AVAILABLE_HEADER = 334;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NO_APPS_AVAILABLE_LINK = 335;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MEDICAL_RECORDS_HEADER = 336;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MEDICAL_RECORDS_HEADER_LINK = 337;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__DEVICES_BUTTON = 338;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__EXPANDABLE_PREFERENCE = 339;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_HEADER = 340;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_HEADER_ICON_VIEW = 341;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_FOOTER = 342;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_SCREEN_FOOTER_LINK = 343;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__MATCHMAKING_DEVICE_PREFERENCE = 344;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_BANNER = 345;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_DISMISS_BUTTON = 346;
    public static final int HEALTH_CONNECT_UI_IMPRESSION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_BANNER_REVIEW_BUTTON = 347;
    ...
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__COMBINED_ALL_DATA_PAGE = 61;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__NEW_HOME_PAGE = 64;
    public static final int HEALTH_CONNECT_UI_INTERACTION__PAGE__MATCHMAKING_PAGE = 65;
    ...
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__CONNECTED_APP_HOME_SCREEN_BUTTON = 328;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NOT_CONNECTED_APP_HOME_SCREEN_BUTTON = 329;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__SEE_ALL_CONNECTED_APPS_HOME_SCREEN_BUTTON = 330;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__RECENT_ACCESS_BUTTON = 331;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__HOME_SCREEN_FOOTER = 332;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__HOME_SCREEN_FOOTER_LINK = 333;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NO_APPS_AVAILABLE_HEADER = 334;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NO_APPS_AVAILABLE_LINK = 335;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MEDICAL_RECORDS_HEADER = 336;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MEDICAL_RECORDS_HEADER_LINK = 337;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__DEVICES_BUTTON = 338;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__EXPANDABLE_PREFERENCE = 339;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_HEADER = 340;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_HEADER_ICON_VIEW = 341;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_FOOTER = 342;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_SCREEN_FOOTER_LINK = 343;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__MATCHMAKING_DEVICE_PREFERENCE = 344;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_BANNER = 345;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_DISMISS_BUTTON = 346;
    public static final int HEALTH_CONNECT_UI_INTERACTION__ELEMENT__NATIVE_DISTANCE_AND_CALORIES_BANNER_REVIEW_BUTTON = 347;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__ADVERTISE_DEVICE_DATA_SOURCES = 21;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__INSERT_DEVICE_RECORDS = 22;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__READ_DEVICE_RECORDS = 23;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__UPDATE_DEVICE_RECORDS = 24;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__DELETE_DEVICE_RECORDS = 25;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__GET_CURRENT_DEVICE_DATA_SOURCE = 26;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__GET_DEVICE_DATA_SOURCES = 27;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__GET_DEVICE_DATA_SOURCE_CAPABILITIES = 28;
    public static final int HEALTH_CONNECT_API_INVOKED__API_METHOD__HAS_USER_ENABLED_TRACKING = 29;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_ONE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_TWO__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_THREE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FOUR__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_FIVE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_API_INVOKED__DATA_TYPE_SIX__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__ADVERTISE_DEVICE_DATA_SOURCES = 21;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__INSERT_DEVICE_RECORDS = 22;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__READ_DEVICE_RECORDS = 23;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__UPDATE_DEVICE_RECORDS = 24;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__DELETE_DEVICE_RECORDS = 25;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__GET_CURRENT_DEVICE_DATA_SOURCE = 26;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__GET_DEVICE_DATA_SOURCES = 27;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__GET_DEVICE_DATA_SOURCE_CAPABILITIES = 28;
    public static final int HEALTH_CONNECT_PHR_API_INVOKED__API_METHOD__HAS_USER_ENABLED_TRACKING = 29;
    ...
    public static final int HEALTH_CONNECT_RESTRICTED_ECOSYSTEM_STATS__DATA_TYPE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ_OR_WRITE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__READ__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__WRITE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_ECOSYSTEM_STATS__SHARED__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_RECORDING_METHOD_STATS__DATA_TYPE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_DEVICE_INFO_STATS__DATA_TYPE__CYCLE_PHASES = 47;
    ...
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_HRV_RMSSD = 12;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_FLOORS_CLIMBED = 13;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_RESPIRATORY_RATE = 14;
    public static final int HEALTH_CONNECT_DATA_GRANULARITY_STATS__GRANULARITY_DATA_TYPE__GRANULARITY_DATA_TYPE_OXYGEN_SATURATION = 15;
    ...
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_ACTIVE__NATIVE_TRACKING_DATA_TYPE_DISTANCE = 2;
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_ACTIVE__NATIVE_TRACKING_DATA_TYPE_ACTIVE_CALORIES_BURNED = 3;
    ...
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_DISABLED__NATIVE_TRACKING_DATA_TYPE_DISTANCE = 2;
    public static final int HEALTH_CONNECT_NATIVE_TRACKING_STATS_REPORTED__NATIVE_DATA_TYPES_DISABLED__NATIVE_TRACKING_DATA_TYPE_ACTIVE_CALORIES_BURNED = 3;
    ...
    // Values for HealthConnectBackupAgentEventReported.backup_agent_operation
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__BACKUP_AGENT_OPERATION__AGENT_OPERATION_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__BACKUP_AGENT_OPERATION__AGENT_OPERATION_BACKUP = 1;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__BACKUP_AGENT_OPERATION__AGENT_OPERATION_FULL_BACKUP = 2;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__BACKUP_AGENT_OPERATION__AGENT_OPERATION_RESTORE = 3;

    // Values for HealthConnectBackupAgentEventReported.status
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__STATUS__AGENT_STATUS_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__STATUS__AGENT_STATUS_STARTED = 1;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__STATUS__AGENT_STATUS_SUCCESS = 2;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__STATUS__AGENT_STATUS_FAILURE = 3;

    // Values for HealthConnectBackupAgentEventReported.error
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__ERROR__AGENT_ERROR_UNKNOWN = 0;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__ERROR__AGENT_ERROR_STAGING_FAILED_EXCEPTION = 1;
    public static final int HEALTH_CONNECT_BACKUP_AGENT_EVENT_REPORTED__ERROR__AGENT_ERROR_TIMEOUT_EXCEPTION = 2;
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public void write(int code, int[] arg1, int[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
