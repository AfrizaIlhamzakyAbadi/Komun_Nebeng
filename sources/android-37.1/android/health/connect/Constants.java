...
public final class Constants {
    ...
    public static final String CHANNEL_GROUP_ID = "healthconnect-channel-group";
    public static final String CHANNEL_GROUP_NAME_RESOURCE = "app_label";
    public static final String CHANNEL_NAME_RESOURCE = "health_connect_notification_channel_name";
