...
public final class HealthConnectMappings {
    ...
    /**
     * @return true if {@code permissionName} is a fitness write-permission
     */
    @Hide
    ...
    /**
     * @return true if {@code permissionName} is a fitness read-permission
     */
    @Hide
    ...
    /**
     * @return A list of all fitness permissions (read and write).
     */
    @Hide
    public Set<String> getAllFitnessPermissions() {
        return Stream.concat(
                        mReadPermissionToPermissionCategoryMap.keySet().stream(),
                        mWritePermissionToDataCategoryMap.keySet().stream())
