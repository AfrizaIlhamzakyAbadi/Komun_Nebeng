 ...
 * Using: aidl --lang=java --structured --version 5 --hash 6acb69b7e1400ebd9d4e169667e93f778d3ec27c --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.data-V5-java-source/gen/android/hardware/radio/data/IRadioDataResponse.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.data-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.data/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.data/5/android/hardware/radio/data/IRadioDataResponse.aidl
 *
...
public interface IRadioDataResponse extends android.os.IInterface
{
  ...
  public static final String HASH = "6acb69b7e1400ebd9d4e169667e93f778d3ec27c";
  ...
  public static class Default implements android.hardware.radio.data.IRadioDataResponse
  {
    ...
    @Override public void dataCallListUpdated(int type, android.hardware.radio.data.SetupDataCallResult[] dcList) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.data.IRadioDataResponse
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_dataCallListUpdated:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.hardware.radio.data.SetupDataCallResult[] _arg1;
          _arg1 = data.createTypedArray(android.hardware.radio.data.SetupDataCallResult.CREATOR);
          data.enforceNoDataAvail();
          this.dataCallListUpdated(_arg0, _arg1);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.data.IRadioDataResponse
    {
      ...
      @Override public void dataCallListUpdated(int type, android.hardware.radio.data.SetupDataCallResult[] dcList) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_dataCallListUpdated, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_dataCallListUpdated = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
  ...
  public void dataCallListUpdated(int type, android.hardware.radio.data.SetupDataCallResult[] dcList) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
