 ...
 * Using: aidl --lang=java --structured --version 5 --hash 6acb69b7e1400ebd9d4e169667e93f778d3ec27c --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.data-V5-java-source/gen/android/hardware/radio/data/IRadioData.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.data-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.data/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.data/5/android/hardware/radio/data/IRadioData.aidl
 *
...
public interface IRadioData extends android.os.IInterface
{
  ...
  public static class Default implements android.hardware.radio.data.IRadioData
  {
    ...
    @Override public void notifyImsDataNetwork(int serial, android.hardware.radio.data.ImsDataNetworkInfo info) throws android.os.RemoteException
    {
    }
    @Override
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_notifyImsDataNetwork:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.hardware.radio.data.ImsDataNetworkInfo _arg1;
          _arg1 = data.readTypedObject(android.hardware.radio.data.ImsDataNetworkInfo.CREATOR);
          data.enforceNoDataAvail();
          this.notifyImsDataNetwork(_arg0, _arg1);
          break;
        }
        default:
        {
  ...
  public void notifyImsDataNetwork(int serial, android.hardware.radio.data.ImsDataNetworkInfo info) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
