 ...
 * Using: aidl --lang=java --structured --version 5 --hash b9f08521b4288bc71112cdeb47220af1ff758383 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.config-V5-java-source/gen/android/hardware/radio/config/IRadioConfigResponse.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.config-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.config/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.config/5/android/hardware/radio/config/IRadioConfigResponse.aidl
 *
...
public interface IRadioConfigResponse extends android.os.IInterface
{
  ...
  public static final String HASH = "b9f08521b4288bc71112cdeb47220af1ff758383";
  ...
  public static class Default implements android.hardware.radio.config.IRadioConfigResponse
  {
    ...
    @Override public void rebootModemResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.config.IRadioConfigResponse
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_rebootModemResponse:
        {
          android.hardware.radio.RadioResponseInfo _arg0;
          _arg0 = data.readTypedObject(android.hardware.radio.RadioResponseInfo.CREATOR);
          data.enforceNoDataAvail();
          this.rebootModemResponse(_arg0);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.config.IRadioConfigResponse
    {
      ...
      @Override public void rebootModemResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(info, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_rebootModemResponse, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_rebootModemResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
  ...
  public void rebootModemResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
