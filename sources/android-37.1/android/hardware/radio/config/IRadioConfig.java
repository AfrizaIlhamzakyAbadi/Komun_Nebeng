 ...
 * Using: aidl --lang=java --structured --version 5 --hash b9f08521b4288bc71112cdeb47220af1ff758383 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.config-V5-java-source/gen/android/hardware/radio/config/IRadioConfig.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.config-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.config/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.config/5/android/hardware/radio/config/IRadioConfig.aidl
 *
...
public interface IRadioConfig extends android.os.IInterface
{
  ...
  public static class Default implements android.hardware.radio.config.IRadioConfig
  {
    ...
    @Override public void rebootModem(int serial) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.config.IRadioConfig
  {
    ...
    private static final class Proxy implements android.hardware.radio.config.IRadioConfig
    {
      ...
      @Override public void rebootModem(int serial) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(serial);
          boolean _status = mRemote.transact(Stub.TRANSACTION_rebootModem, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_rebootModem = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
  ...
  public void rebootModem(int serial) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
