 ...
 * Using: aidl --lang=java --structured --version 5 --hash 4305c82b7f2dad0f9664f0be75e4b3e3a3b19475 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.messaging-V5-java-source/gen/android/hardware/radio/messaging/IRadioMessagingIndication.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.messaging-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.messaging/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.messaging/5/android/hardware/radio/messaging/IRadioMessagingIndication.aidl
 *
...
public interface IRadioMessagingIndication extends android.os.IInterface
{
  ...
  public static final String HASH = "4305c82b7f2dad0f9664f0be75e4b3e3a3b19475";
  ...
  public static class Default implements android.hardware.radio.messaging.IRadioMessagingIndication
  {
    ...
    @Override public void newSecureSms(int type, byte[] pdu, android.hardware.radio.network.NetworkSecurityEvent event) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.messaging.IRadioMessagingIndication
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_newSecureSms:
        {
          int _arg0;
          _arg0 = data.readInt();
          byte[] _arg1;
          _arg1 = data.createByteArray();
          android.hardware.radio.network.NetworkSecurityEvent _arg2;
          _arg2 = data.readTypedObject(android.hardware.radio.network.NetworkSecurityEvent.CREATOR);
          data.enforceNoDataAvail();
          this.newSecureSms(_arg0, _arg1, _arg2);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.messaging.IRadioMessagingIndication
    {
      ...
      @Override public void newSecureSms(int type, byte[] pdu, android.hardware.radio.network.NetworkSecurityEvent event) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_newSecureSms, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_newSecureSms = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
  ...
  public void newSecureSms(int type, byte[] pdu, android.hardware.radio.network.NetworkSecurityEvent event) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
