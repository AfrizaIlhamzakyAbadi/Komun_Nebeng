 ...
 * Using: aidl --lang=java --structured --version 5 --hash d30e321bff565b6a44f81ce4113979c4844a61a3 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen/android/hardware/radio/network/IRadioNetworkIndication.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5/android/hardware/radio/network/IRadioNetworkIndication.aidl
 *
...
public interface IRadioNetworkIndication extends android.os.IInterface
{
  ...
  public static class Default implements android.hardware.radio.network.IRadioNetworkIndication
  {
    ...
    @Override public void prioritizedScanModeChanged(int type, boolean prioritized) throws android.os.RemoteException
    {
    }
    @Override public void onNetworkSecurityEvents(int type, android.hardware.radio.network.NetworkSecurityEvent[] events) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.network.IRadioNetworkIndication
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_prioritizedScanModeChanged:
        {
          int _arg0;
          _arg0 = data.readInt();
          boolean _arg1;
          ...
          data.enforceNoDataAvail();
          this.prioritizedScanModeChanged(_arg0, _arg1);
          break;
        }
        case TRANSACTION_onNetworkSecurityEvents:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.hardware.radio.network.NetworkSecurityEvent[] _arg1;
          _arg1 = data.createTypedArray(android.hardware.radio.network.NetworkSecurityEvent.CREATOR);
          data.enforceNoDataAvail();
          this.onNetworkSecurityEvents(_arg0, _arg1);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.network.IRadioNetworkIndication
    {
      ...
      @Override public void prioritizedScanModeChanged(int type, boolean prioritized) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(type);
          _data.writeBoolean(prioritized);
          boolean _status = mRemote.transact(Stub.TRANSACTION_prioritizedScanModeChanged, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void onNetworkSecurityEvents(int type, android.hardware.radio.network.NetworkSecurityEvent[] events) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onNetworkSecurityEvents, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_prioritizedScanModeChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
    static final int TRANSACTION_onNetworkSecurityEvents = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
  ...
  public void prioritizedScanModeChanged(int type, boolean prioritized) throws android.os.RemoteException;
  public void onNetworkSecurityEvents(int type, android.hardware.radio.network.NetworkSecurityEvent[] events) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
