 ...
 * Using: aidl --lang=java --structured --version 5 --hash d30e321bff565b6a44f81ce4113979c4844a61a3 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen/android/hardware/radio/network/IRadioNetwork.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5/android/hardware/radio/network/IRadioNetwork.aidl
 *
...
public interface IRadioNetwork extends android.os.IInterface
{
  ...
  public static final String HASH = "d30e321bff565b6a44f81ce4113979c4844a61a3";
  ...
  public static class Default implements android.hardware.radio.network.IRadioNetwork
  {
    ...
    @Override public void setSatelliteNetworkInfo(int serial, android.hardware.radio.network.SatelliteNetworkInfo satelliteNetworkInfo) throws android.os.RemoteException
    {
    }
    @Override public void enablePrioritizedNetworkScan(int serial, android.hardware.radio.network.PrioritizedNetworkScanRequest scanRequest) throws android.os.RemoteException
    {
    }
    @Override public void disablePrioritizedNetworkScan(int serial) throws android.os.RemoteException
    {
    }
    @Override public void getSupportedNetworkAlertCategories(int serial) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.network.IRadioNetwork
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_setSatelliteNetworkInfo:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.hardware.radio.network.SatelliteNetworkInfo _arg1;
          _arg1 = data.readTypedObject(android.hardware.radio.network.SatelliteNetworkInfo.CREATOR);
          data.enforceNoDataAvail();
          this.setSatelliteNetworkInfo(_arg0, _arg1);
          break;
        }
        case TRANSACTION_enablePrioritizedNetworkScan:
        {
          int _arg0;
          _arg0 = data.readInt();
          android.hardware.radio.network.PrioritizedNetworkScanRequest _arg1;
          _arg1 = data.readTypedObject(android.hardware.radio.network.PrioritizedNetworkScanRequest.CREATOR);
          data.enforceNoDataAvail();
          this.enablePrioritizedNetworkScan(_arg0, _arg1);
          break;
        }
        case TRANSACTION_disablePrioritizedNetworkScan:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          this.disablePrioritizedNetworkScan(_arg0);
          break;
        }
        case TRANSACTION_getSupportedNetworkAlertCategories:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          this.getSupportedNetworkAlertCategories(_arg0);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.network.IRadioNetwork
    {
      ...
      @Override public void setSatelliteNetworkInfo(int serial, android.hardware.radio.network.SatelliteNetworkInfo satelliteNetworkInfo) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(serial);
          _data.writeTypedObject(satelliteNetworkInfo, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setSatelliteNetworkInfo, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void enablePrioritizedNetworkScan(int serial, android.hardware.radio.network.PrioritizedNetworkScanRequest scanRequest) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_enablePrioritizedNetworkScan, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void disablePrioritizedNetworkScan(int serial) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(serial);
          boolean _status = mRemote.transact(Stub.TRANSACTION_disablePrioritizedNetworkScan, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void getSupportedNetworkAlertCategories(int serial) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(serial);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getSupportedNetworkAlertCategories, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_setSatelliteNetworkInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
    static final int TRANSACTION_enablePrioritizedNetworkScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
    static final int TRANSACTION_disablePrioritizedNetworkScan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
    static final int TRANSACTION_getSupportedNetworkAlertCategories = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
  ...
  public void setSatelliteNetworkInfo(int serial, android.hardware.radio.network.SatelliteNetworkInfo satelliteNetworkInfo) throws android.os.RemoteException;
  public void enablePrioritizedNetworkScan(int serial, android.hardware.radio.network.PrioritizedNetworkScanRequest scanRequest) throws android.os.RemoteException;
  public void disablePrioritizedNetworkScan(int serial) throws android.os.RemoteException;
  public void getSupportedNetworkAlertCategories(int serial) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
