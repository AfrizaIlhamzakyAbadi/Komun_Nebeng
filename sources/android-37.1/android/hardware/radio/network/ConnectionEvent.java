 ...
 * Using: aidl --lang=java --structured --version 5 --hash d30e321bff565b6a44f81ce4113979c4844a61a3 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen/android/hardware/radio/network/ConnectionEvent.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5/android/hardware/radio/network/ConnectionEvent.aidl
 *
...
public @interface ConnectionEvent {
  ...
  public static final int AS_SIGNALLING_LTE_DRB = 16;
  public static final int AS_SIGNALLING_LTE_NON_DRB = 17;
  ...
  public static final int AS_SIGNALLING_5G_DRB = 18;
  public static final int AS_SIGNALLING_5G_NON_DRB = 19;
  ...
  interface $ {
    static String toString(int _aidl_v) {
      ...
      if (_aidl_v == AS_SIGNALLING_LTE_DRB) return "AS_SIGNALLING_LTE_DRB";
      if (_aidl_v == AS_SIGNALLING_LTE_NON_DRB) return "AS_SIGNALLING_LTE_NON_DRB";
      ...
      if (_aidl_v == AS_SIGNALLING_5G_DRB) return "AS_SIGNALLING_5G_DRB";
      if (_aidl_v == AS_SIGNALLING_5G_NON_DRB) return "AS_SIGNALLING_5G_NON_DRB";
