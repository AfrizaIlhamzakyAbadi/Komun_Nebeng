 ...
 * Using: aidl --lang=java --structured --version 5 --hash d30e321bff565b6a44f81ce4113979c4844a61a3 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen/android/hardware/radio/network/AccessTechnologySpecificInfo.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5/android/hardware/radio/network/AccessTechnologySpecificInfo.aidl
 *
...
public final class AccessTechnologySpecificInfo implements android.os.Parcelable {
  ...
  public final static int nrInfo = 5;  // android.hardware.radio.network.NrRegistrationInfo nrInfo;
  ...
  public static AccessTechnologySpecificInfo nrInfo(android.hardware.radio.network.NrRegistrationInfo _value) {
    return new AccessTechnologySpecificInfo(nrInfo, _value);
  }

  public android.hardware.radio.network.NrRegistrationInfo getNrInfo() {
    _assertTag(nrInfo);
    return (android.hardware.radio.network.NrRegistrationInfo) _value;
  }

  public void setNrInfo(android.hardware.radio.network.NrRegistrationInfo _value) {
    _set(nrInfo, _value);
  }
  ...
  public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
    ...
    case geranDtmSupported:
      ...
      break;
    case nrInfo:
      _aidl_parcel.writeTypedObject(getNrInfo(), _aidl_flag);
      break;
    }
  }
  ...
  public void readFromParcel(android.os.Parcel _aidl_parcel) {
    ...
    case geranDtmSupported: {
      ...
      return; }
    case nrInfo: {
      android.hardware.radio.network.NrRegistrationInfo _aidl_value;
      _aidl_value = _aidl_parcel.readTypedObject(android.hardware.radio.network.NrRegistrationInfo.CREATOR);
      _set(_aidl_tag, _aidl_value);
      return; }
    }
  ...
  public int describeContents() {
    ...
    case ngranNrVopsInfo:
      ...
      break;
    case nrInfo:
      _mask |= describeContents(getNrInfo());
      break;
    }
    return _mask;
  }
  ...
  public String toString() {
    ...
    case nrInfo: return "AccessTechnologySpecificInfo.nrInfo(" + (java.util.Objects.toString(getNrInfo())) + ")";
    }
