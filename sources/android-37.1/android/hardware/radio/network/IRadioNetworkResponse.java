 ...
 * Using: aidl --lang=java --structured --version 5 --hash d30e321bff565b6a44f81ce4113979c4844a61a3 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio_interface/5/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen/android/hardware/radio/network/IRadioNetworkResponse.java.d -o out/soong/.intermediates/hardware/interfaces/radio/aidl/android.hardware.radio.network-V5-java-source/gen -Nhardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5 hardware/interfaces/radio/aidl/aidl_api/android.hardware.radio.network/5/android/hardware/radio/network/IRadioNetworkResponse.aidl
 *
...
public interface IRadioNetworkResponse extends android.os.IInterface
{
  ...
  public static class Default implements android.hardware.radio.network.IRadioNetworkResponse
  {
    ...
    @Override public void setSatelliteNetworkInfoResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
    {
    }
    @Override public void enablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
    {
    }
    @Override public void disablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
    {
    }
    @Override public void getSupportedNetworkAlertCategoriesResponse(android.hardware.radio.RadioResponseInfo info, int[] alertCategories) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.radio.network.IRadioNetworkResponse
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_setSatelliteNetworkInfoResponse:
        {
          android.hardware.radio.RadioResponseInfo _arg0;
          _arg0 = data.readTypedObject(android.hardware.radio.RadioResponseInfo.CREATOR);
          data.enforceNoDataAvail();
          this.setSatelliteNetworkInfoResponse(_arg0);
          break;
        }
        case TRANSACTION_enablePrioritizedNetworkScanResponse:
        {
          android.hardware.radio.RadioResponseInfo _arg0;
          _arg0 = data.readTypedObject(android.hardware.radio.RadioResponseInfo.CREATOR);
          data.enforceNoDataAvail();
          this.enablePrioritizedNetworkScanResponse(_arg0);
          break;
        }
        case TRANSACTION_disablePrioritizedNetworkScanResponse:
        {
          android.hardware.radio.RadioResponseInfo _arg0;
          _arg0 = data.readTypedObject(android.hardware.radio.RadioResponseInfo.CREATOR);
          data.enforceNoDataAvail();
          this.disablePrioritizedNetworkScanResponse(_arg0);
          break;
        }
        case TRANSACTION_getSupportedNetworkAlertCategoriesResponse:
        {
          android.hardware.radio.RadioResponseInfo _arg0;
          _arg0 = data.readTypedObject(android.hardware.radio.RadioResponseInfo.CREATOR);
          int[] _arg1;
          _arg1 = data.createIntArray();
          data.enforceNoDataAvail();
          this.getSupportedNetworkAlertCategoriesResponse(_arg0, _arg1);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.radio.network.IRadioNetworkResponse
    {
      ...
      @Override public void setSatelliteNetworkInfoResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(info, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setSatelliteNetworkInfoResponse, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void enablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(info, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_enablePrioritizedNetworkScanResponse, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void disablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(info, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_disablePrioritizedNetworkScanResponse, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void getSupportedNetworkAlertCategoriesResponse(android.hardware.radio.RadioResponseInfo info, int[] alertCategories) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeTypedObject(info, 0);
          _data.writeIntArray(alertCategories);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getSupportedNetworkAlertCategoriesResponse, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_setSatelliteNetworkInfoResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
    static final int TRANSACTION_enablePrioritizedNetworkScanResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
    static final int TRANSACTION_disablePrioritizedNetworkScanResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
    static final int TRANSACTION_getSupportedNetworkAlertCategoriesResponse = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
  ...
  public void setSatelliteNetworkInfoResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException;
  public void enablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException;
  public void disablePrioritizedNetworkScanResponse(android.hardware.radio.RadioResponseInfo info) throws android.os.RemoteException;
  public void getSupportedNetworkAlertCategoriesResponse(android.hardware.radio.RadioResponseInfo info, int[] alertCategories) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
