...
public interface ISessionCallback extends android.os.IInterface
{
  ...
  public static final String HASH = "e6029311951274040efcf19821646c9166f30810";
  ...
  public static class Default implements android.hardware.biometrics.face.ISessionCallback
  {
    ...
    @Override public void onAuthenticationSucceededWithResult(android.hardware.biometrics.face.AuthenticateSuccess result) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.biometrics.face.ISessionCallback
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onAuthenticationSucceededWithResult:
        {
          android.hardware.biometrics.face.AuthenticateSuccess _arg0;
          _arg0 = data.readTypedObject(android.hardware.biometrics.face.AuthenticateSuccess.CREATOR);
          data.enforceNoDataAvail();
    ...
    private static final class Proxy implements android.hardware.biometrics.face.ISessionCallback
    {
    ...
    static final int TRANSACTION_onAuthenticationSucceededWithResult = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
  ...
  public void onAuthenticationSucceededWithResult(android.hardware.biometrics.face.AuthenticateSuccess result) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
