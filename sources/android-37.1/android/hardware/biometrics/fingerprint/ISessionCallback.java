 ...
 * Using: aidl --lang=java --structured --version 5 --hash 0a40e5aa0a942c5a4e577ffa6ade668ac294e269 -t --stability vintf --min_sdk_version platform_apis -pout/soong/.intermediates/hardware/interfaces/biometrics/common/aidl/android.hardware.biometrics.common_interface/4/preprocessed.aidl -pout/soong/.intermediates/hardware/interfaces/keymaster/aidl/android.hardware.keymaster_interface/4/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/biometrics/fingerprint/aidl/android.hardware.biometrics.fingerprint-V5-java-source/gen/android/hardware/biometrics/fingerprint/ISessionCallback.java.d -o out/soong/.intermediates/hardware/interfaces/biometrics/fingerprint/aidl/android.hardware.biometrics.fingerprint-V5-java-source/gen -Nhardware/interfaces/biometrics/fingerprint/aidl/aidl_api/android.hardware.biometrics.fingerprint/5 hardware/interfaces/biometrics/fingerprint/aidl/aidl_api/android.hardware.biometrics.fingerprint/5/android/hardware/biometrics/fingerprint/ISessionCallback.aidl
 *
...
public interface ISessionCallback extends android.os.IInterface
{
  ...
  public static final String HASH = "0a40e5aa0a942c5a4e577ffa6ade668ac294e269";
  ...
  public static class Default implements android.hardware.biometrics.fingerprint.ISessionCallback
  {
    ...
    @Override public void onAuthenticationSucceededWithResult(android.hardware.biometrics.fingerprint.AuthenticateSuccess result) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.biometrics.fingerprint.ISessionCallback
  {
    ...
    public static java.lang.String getDefaultTransactionName(int transactionCode)
    {
      switch (transactionCode)
      {
        ...
        case TRANSACTION_onAuthenticationSucceededWithResult:
        {
          return "onAuthenticationSucceededWithResult";
        }
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onAuthenticationSucceededWithResult:
        {
          android.hardware.biometrics.fingerprint.AuthenticateSuccess _arg0;
          _arg0 = data.readTypedObject(android.hardware.biometrics.fingerprint.AuthenticateSuccess.CREATOR);
          data.enforceNoDataAvail();
          this.onAuthenticationSucceededWithResult(_arg0);
          reply.writeNoException();
          break;
        }
        default:
    ...
    private static final class Proxy implements android.hardware.biometrics.fingerprint.ISessionCallback
    {
      ...
      @Override public void onAuthenticationSucceededWithResult(android.hardware.biometrics.fingerprint.AuthenticateSuccess result) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onAuthenticationSucceededWithResult, _data, _reply, 0);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
          _reply.readException();
    ...
    static final int TRANSACTION_onAuthenticationSucceededWithResult = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
  ...
  public void onAuthenticationSucceededWithResult(android.hardware.biometrics.fingerprint.AuthenticateSuccess result) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
