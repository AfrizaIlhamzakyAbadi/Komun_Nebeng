    ...
    public static class Builder {
        ...
        private static boolean isValidIconType(@BiometricManager.IconType int iconType) {
            return switch (iconType) {
                case BiometricManager.ICON_TYPE_PASSWORD,
                        BiometricManager.ICON_TYPE_QR_CODE,
                        BiometricManager.ICON_TYPE_ACCOUNT,
                        BiometricManager.ICON_TYPE_GENERIC,
                        BiometricManager.ICON_TYPE_SETTING,
                        BiometricManager.ICON_TYPE_RESET,
                        BiometricManager.ICON_TYPE_MESSAGE,
