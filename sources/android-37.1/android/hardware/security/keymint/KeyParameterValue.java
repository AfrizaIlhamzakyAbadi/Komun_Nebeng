 ...
 * Using: aidl --lang=java --structured --version 5 --hash 177877c3782ff5543c231b8616f1ee6a300f810d -t --stability vintf --min_sdk_version platform_apis -pout/soong/.intermediates/hardware/interfaces/security/secureclock/aidl/android.hardware.security.secureclock_interface/1/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/security/keymint/aidl/android.hardware.security.keymint-V5-java-source/gen/android/hardware/security/keymint/KeyParameterValue.java.d -o out/soong/.intermediates/hardware/interfaces/security/keymint/aidl/android.hardware.security.keymint-V5-java-source/gen -Nhardware/interfaces/security/keymint/aidl/aidl_api/android.hardware.security.keymint/5 hardware/interfaces/security/keymint/aidl/aidl_api/android.hardware.security.keymint/5/android/hardware/security/keymint/KeyParameterValue.aidl
 *
...
public final class KeyParameterValue implements android.os.Parcelable {
  ...
  public final static int mlDsaVariant = 15;  // android.hardware.security.keymint.MlDsaVariant mlDsaVariant;
  ...
  public static KeyParameterValue mlDsaVariant(int _value) {
    return new KeyParameterValue(mlDsaVariant, _value);
  }

  public int getMlDsaVariant() {
    _assertTag(mlDsaVariant);
    return (int) _value;
  }

  public void setMlDsaVariant(int _value) {
    _set(mlDsaVariant, _value);
  }
  ...
  public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
    ...
    case blob:
      ...
      break;
    case mlDsaVariant:
      _aidl_parcel.writeInt(getMlDsaVariant());
      break;
    }
  }
  ...
  private String _tagString(int _tag) {
    ...
    case mlDsaVariant: return "mlDsaVariant";
    }
