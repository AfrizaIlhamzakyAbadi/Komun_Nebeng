...
public final class InputGestureData {
    ...
    private AppLaunchData getAppLaunchData() {
        if (mInputGestureData.gestureType == KeyGestureEvent.KEY_GESTURE_TYPE_OPEN_NOTES) {
            return AppLaunchData.createLaunchDataForNotes();
        }
    ...
    public static class Builder {
        ...
        public Builder setAppLaunchData(@NonNull AppLaunchData appLaunchData) {
            mKeyGestureType = appLaunchData.getKeyGestureType();
        ...
        public InputGestureData build() throws IllegalArgumentException {
            ...
            if (mAppLaunchData != null) {
                ...
                } else if (mAppLaunchData instanceof AppLaunchData.NotesLaunchData) {
                    // Key gesture type has already been set earlier.
                    // No additional fields to set in AidlInputGestureData for NotesLaunchData.
                } else {
