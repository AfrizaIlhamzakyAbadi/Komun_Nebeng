...
import static com.android.hardware.input.Flags.enablePoemInputCustomization;
...
public final class KeyGestureEvent {
    ...
    public static final int KEY_GESTURE_TYPE_TOGGLE_PEEK = 91;
    public static final int KEY_GESTURE_TYPE_PASTE = 92;
    public static final int KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_PREVIOUS_DESK = 93;
    public static final int KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_NEXT_DESK = 94;
    public static final int KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS = 95;
    /**
     * Key gesture type indicating a launch action triggered on behalf of a POEM package.
     * Note: "POEM" (Peripheral OEM) refers to the developer of the physical peripheral
     * customization application, not the Android device manufacturer.
     */
    public static final int KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM = 96;
    /**
     * Key gesture type indicating a launch URI action triggered on behalf of a POEM package.
     */
    public static final int KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM = 97;
    public static final int KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS_REVERSE = 98;
    ...
    @IntDef(prefix = "KEY_GESTURE_TYPE_", value = {
            ...
            KEY_GESTURE_TYPE_TOGGLE_PEEK,
            KEY_GESTURE_TYPE_PASTE,
            KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_PREVIOUS_DESK,
            KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_NEXT_DESK,
            KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS,
            KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM,
            KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM,
            KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS_REVERSE
    })
    ...
    public static class Builder {
        ...
        @Nullable
        private CustomizationAction mCustomizationAction = null;
        ...
        /**
         * Sets the CustomizationAction associated with the event.
         *
         * @param action The customization action.
         * @throws IllegalStateException if customization is not enabled.
         * @throws NullPointerException if the action is null.
         * @throws IllegalArgumentException if the action type is not supported.
         */
        @NonNull
        public Builder setCustomizationAction(@NonNull CustomizationAction action) {
            if (!enablePoemInputCustomization()) {
                throw new IllegalStateException("Setting CustomizationActions is not supported.");
            }
            Objects.requireNonNull(action, "CustomizationAction cannot be null");
            if (!(action instanceof AppCustomizationAction)
                    && !(action instanceof UriCustomizationAction)) {
                throw new IllegalArgumentException("Unsupported CustomizationAction type: "
                        + action.getClass().getName());
            }
            mCustomizationAction = action;
            return this;
        }
        ...
        public KeyGestureEvent build() {
            ...
            if (enablePoemInputCustomization() && mCustomizationAction != null) {
                event.customizationAction = switch (mCustomizationAction) {
                    case AppCustomizationAction appAction -> {
                        if (mKeyGestureType != KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM) {
                            throw new IllegalStateException("AppCustomizationAction payload can "
                                    + "only be set on "
                                    + "KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM");
                        }
                        yield AidlCustomizationAction.appAction(appAction.getAidl());
                    }
                    case UriCustomizationAction uriAction -> {
                        if (mKeyGestureType != KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM) {
                            throw new IllegalStateException("UriCustomizationAction payload can "
                                    + "only be set on "
                                    + "KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM");
                        }
                        yield AidlCustomizationAction.uriAction(
                            uriAction.getAidl());
                    }
                    default -> throw new IllegalArgumentException(
                        "Unsupported CustomizationAction type: "
                            + mCustomizationAction.getClass().getName());
                };
            }
    ...
    /**
     * @return CustomizationAction associated with the event, only if key gesture type is
     * {@code KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM} or
     * {@code KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM}
     */
    @Nullable
    public CustomizationAction getCustomizationAction() {
        if (!enablePoemInputCustomization() || mKeyGestureEvent.customizationAction == null) {
            return null;
        }
        return switch (mKeyGestureEvent.customizationAction.getTag()) {
            case AidlCustomizationAction.appAction ->
                new AppCustomizationAction(mKeyGestureEvent.customizationAction.getAppAction());
            case AidlCustomizationAction.uriAction ->
                new UriCustomizationAction(mKeyGestureEvent.customizationAction.getUriAction());
            default -> null;
        };
    }
    ...
    public String toString() {
        return "KeyGestureEvent { "
                ...
                + "customizationAction = " + getCustomizationAction()
                + " }";
    }
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return mKeyGestureEvent.deviceId == that.mKeyGestureEvent.deviceId
                ...
                && Objects.equals(mKeyGestureEvent.appLaunchPackageName,
                        that.mKeyGestureEvent.appLaunchPackageName)
                && Objects.equals(mKeyGestureEvent.appLaunchClassName,
                        that.mKeyGestureEvent.appLaunchClassName)
                && Objects.equals(mKeyGestureEvent.customizationAction,
                        that.mKeyGestureEvent.customizationAction);
    }
    ...
    public int hashCode() {
        ...
        _hash = 31 * _hash + (mKeyGestureEvent.customizationAction != null
                ? mKeyGestureEvent.customizationAction.hashCode() : 0);
        return _hash;
    }
    ...
    private static String keyGestureTypeToString(@KeyGestureType int value) {
        switch (value) {
            ...
            case KEY_GESTURE_TYPE_TOGGLE_PEEK:
                return "KEY_GESTURE_TYPE_TOGGLE_PEEK";
            case KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_PREVIOUS_DESK:
                return "KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_PREVIOUS_DESK";
            case KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_NEXT_DESK:
                return "KEY_GESTURE_TYPE_MOVE_FOCUSED_TASK_TO_NEXT_DESK";
            case KEY_GESTURE_TYPE_PASTE:
                return "KEY_GESTURE_TYPE_PASTE";
            case KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS:
                return "KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS";
            case KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS_REVERSE:
                return "KEY_GESTURE_TYPE_CYCLE_GLOBAL_FOCUS_REVERSE";
            case KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM:
                return "KEY_GESTURE_TYPE_LAUNCH_APP_ON_BEHALF_OF_POEM";
            case KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM:
                return "KEY_GESTURE_TYPE_LAUNCH_URI_ON_BEHALF_OF_POEM";
