...
public final class InputManagerGlobal {
    ...
    /**
     * Gets the bitmask of all supported motion event buttons of an input device.
     */
    public int getSupportedButtons(int deviceId) {
        try {
            return mIm.getSupportedButtons(deviceId, InputDevice.SOURCE_ANY);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
