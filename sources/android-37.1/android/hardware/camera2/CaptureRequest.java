...
public final class CaptureRequest extends CameraMetadata<CaptureRequest.Key<?>>
     ...
     * weight is ignored.</p>
     * <p>If all regions have 0 weight, the camera device returns to the default
     * auto-exposure metering behavior.</p>
     ...
     * ignored.</p>
     * <p>If all regions have 0 weight, the camera device returns to the default focus metering
     * behavior. The capture result will either be a zero weight region as well, or
     ...
     * <p>If all regions have 0 weight, the camera device returns to the default white balance
     * metering behavior.</p>
     * <p>If the metering region is outside the used {@link CaptureRequest#SCALER_CROP_REGION android.scaler.cropRegion} returned in
     * capture result metadata, the camera device will ignore the sections outside the crop
     * region and output only the intersection rectangle as the metering region in the result
