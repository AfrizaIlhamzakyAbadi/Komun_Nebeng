...
public final class CameraExtensionCharacteristics {
    ...
    /**
     * Device-specific extension implementation for selfie segmentation, providing a
     * real-time selfie camera preview stream with an alpha channel to the application.
     */
    @FlaggedApi(Flags.FLAG_EXTENSION_GREEN_SCREEN)
    @SystemApi
    ...
    private static final class CameraExtensionManagerGlobal {
        ...
        private class ExtensionConnectionManager {
            ...
            public ExtensionConnectionManager() {
                ...
                if (Flags.extensionGreenScreen()) {
                    extensionList.add(EXTENSION_SELFIE_SEGMENTATION);
                }
