...
public final class StreamConfigurationMap {
     ...
     * capture request.</p>
     *
     * <p>For camera {@link CameraCharacteristics#SCALER_STREAM_CONFIGURATION_MAP stream
     * configuration map}, up until Android 11, for devices that do not support manual sensor
     * control
     * ({@link android.hardware.camera2.CameraMetadata#REQUEST_AVAILABLE_CAPABILITIES_MANUAL_SENSOR}),
     * this function may return 0. From Android 12 onwards, this function always returns a positive
     * value.</p>
     *
     * <p>For {@link CameraCharacteristics#SCALER_STREAM_CONFIGURATION_MAP_MAXIMUM_RESOLUTION
     * maximum resolution} stream configuration map, this function always returns a positive value
     * for OSes newer than Android 17.</p>
     *
