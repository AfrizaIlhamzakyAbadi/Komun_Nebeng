...
public class CameraSessionStats implements Parcelable {
    ...
    private int mExtensionNightModeIndicator;
    private int mAeMode;
    ...
    public CameraSessionStats() {
        ...
        mSharedMode = false;
        mExtensionNightModeIndicator = 0;
        mAeMode = -1;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(mExtensionNightModeIndicator);
        dest.writeInt(mAeMode);
    }
    ...
    public void readFromParcel(Parcel in) {
        ...
        mExtensionNightModeIndicator = in.readInt();
        mAeMode = in.readInt();
    }
    ...
    public int getExtensionNightModeIndicator() {
        return mExtensionNightModeIndicator;
    }
