 ...
 * Using: aidl --lang=java --structured --version 5 --hash 4a4662588b9e38b5e93c37e46353efac231f7a98 --stability vintf --min_sdk_version current -pout/soong/.intermediates/hardware/interfaces/common/aidl/android.hardware.common_interface/2/preprocessed.aidl --ninja -d out/soong/.intermediates/hardware/interfaces/contexthub/aidl/android.hardware.contexthub-V5-java-source/gen/android/hardware/contexthub/IEndpointCallback.java.d -o out/soong/.intermediates/hardware/interfaces/contexthub/aidl/android.hardware.contexthub-V5-java-source/gen -Nhardware/interfaces/contexthub/aidl/aidl_api/android.hardware.contexthub/5 hardware/interfaces/contexthub/aidl/aidl_api/android.hardware.contexthub/5/android/hardware/contexthub/IEndpointCallback.aidl
 *
...
public interface IEndpointCallback extends android.os.IInterface
{
  ...
  public static class Default implements android.hardware.contexthub.IEndpointCallback
  {
    ...
    @Override public void onDataFlowHostSinkRegistered(android.hardware.contexthub.DataFlowSinkRegistrationParams params) throws android.os.RemoteException
    {
    }
    @Override public void onDataFlowOffloadEndpointUnregistered(android.hardware.contexthub.DataFlowId dataFlowId, android.hardware.contexthub.EndpointId endpointId, android.hardware.contexthub.EndpointId[] destinationIds) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.hardware.contexthub.IEndpointCallback
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onDataFlowHostSinkRegistered:
        {
          ...
          data.enforceNoDataAvail();
          this.onDataFlowHostSinkRegistered(_arg0);
          break;
        }
        case TRANSACTION_onDataFlowOffloadEndpointUnregistered:
        {
          android.hardware.contexthub.DataFlowId _arg0;
          _arg0 = data.readTypedObject(android.hardware.contexthub.DataFlowId.CREATOR);
          android.hardware.contexthub.EndpointId _arg1;
          _arg1 = data.readTypedObject(android.hardware.contexthub.EndpointId.CREATOR);
          android.hardware.contexthub.EndpointId[] _arg2;
          _arg2 = data.createTypedArray(android.hardware.contexthub.EndpointId.CREATOR);
          data.enforceNoDataAvail();
          this.onDataFlowOffloadEndpointUnregistered(_arg0, _arg1, _arg2);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.hardware.contexthub.IEndpointCallback
    {
      ...
      @Override public void onDataFlowHostSinkRegistered(android.hardware.contexthub.DataFlowSinkRegistrationParams params) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onDataFlowHostSinkRegistered, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
      ...
      @Override public void onDataFlowOffloadEndpointUnregistered(android.hardware.contexthub.DataFlowId dataFlowId, android.hardware.contexthub.EndpointId endpointId, android.hardware.contexthub.EndpointId[] destinationIds) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeTypedObject(endpointId, 0);
          _data.writeTypedArray(destinationIds, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_onDataFlowOffloadEndpointUnregistered, _data, null, android.os.IBinder.FLAG_ONEWAY);
          if (!_status) {
            throw new android.os.RemoteException("Unimplemented");
          }
        }
    ...
    static final int TRANSACTION_onDataFlowHostSinkRegistered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_onDataFlowOffloadEndpointUnregistered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
  ...
  public void onDataFlowHostSinkRegistered(android.hardware.contexthub.DataFlowSinkRegistrationParams params) throws android.os.RemoteException;
  public void onDataFlowOffloadEndpointUnregistered(android.hardware.contexthub.DataFlowId dataFlowId, android.hardware.contexthub.EndpointId endpointId, android.hardware.contexthub.EndpointId[] destinationIds) throws android.os.RemoteException;
  public int getInterfaceVersion() throws android.os.RemoteException;
