...
public class HapticGeneratorConfig implements android.os.Parcelable
{
  /**
   ...
   * in this format.
   */
  public android.media.audio.common.AudioConfigBase audioFormat;
  ...
  public static final android.os.Parcelable.Creator<HapticGeneratorConfig> CREATOR = new android.os.Parcelable.Creator<HapticGeneratorConfig>() {
    @Override
    public HapticGeneratorConfig createFromParcel(android.os.Parcel _aidl_source) {
      HapticGeneratorConfig _aidl_out = new HapticGeneratorConfig();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public HapticGeneratorConfig[] newArray(int _aidl_size) {
      return new HapticGeneratorConfig[_aidl_size];
    }
  };
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedObject(audioFormat, _aidl_flag);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      audioFormat = _aidl_parcel.readTypedObject(android.media.audio.common.AudioConfigBase.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public int describeContents() {
    int _mask = 0;
    _mask |= describeContents(audioFormat);
