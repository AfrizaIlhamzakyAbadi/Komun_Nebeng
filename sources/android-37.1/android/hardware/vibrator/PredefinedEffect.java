 ...
 */
public class PredefinedEffect implements android.os.Parcelable
{
  ...
  public static final android.os.Parcelable.Creator<PredefinedEffect> CREATOR = new android.os.Parcelable.Creator<PredefinedEffect>() {
    @Override
    public PredefinedEffect createFromParcel(android.os.Parcel _aidl_source) {
      PredefinedEffect _aidl_out = new PredefinedEffect();
      _aidl_out.readFromParcel(_aidl_source);
      return _aidl_out;
    }
    @Override
    public PredefinedEffect[] newArray(int _aidl_size) {
      return new PredefinedEffect[_aidl_size];
    }
  };
