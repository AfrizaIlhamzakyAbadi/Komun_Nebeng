...
public final class DisplayManagerGlobal {
    ...
    /**
     * Check if the specified UID has the right permissions to access private displays.
     */
    public boolean canAccessPrivateDisplays(int uid) {
        try {
            return mDm.canAccessPrivateDisplays(uid);
        } catch (RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }
     ...
     * @param enabled true means always enabled, and false is default
     */
    @Hide
    public void setAppRequestEnabledForTesting(boolean enabled) {
        try {
            mDm.setAppRequestEnabledForTesting(enabled);
        } catch (RemoteException ex) {
            Log.e(TAG, "Error trying to set app requested resolution enabled", ex);
        }
    }
