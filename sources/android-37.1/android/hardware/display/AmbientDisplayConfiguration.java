...
public class AmbientDisplayConfiguration {
    ...
    public AmbientDisplayConfiguration(Context context) {
        ...
        mDozeEnabledByDefault = mContext.getResources().getBoolean(R.bool.config_dozeEnabled);
        mTapGestureEnabledByDefault = mContext.getResources().getBoolean(
                R.bool.config_dozeTapGestureEnabled);
        mDoubleTapGestureEnabledByDefault = mContext.getResources().getBoolean(
