...
public class GpuConfig implements android.os.Parcelable
{
  ...
  /**
   * Direct Wayland socket File Descriptor.
   * Providing this unconditionally enables the 'cross-domain' context type.
   */
  public android.os.ParcelFileDescriptor waylandSocketFd;
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedObject(waylandSocketFd, _aidl_flag);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      waylandSocketFd = _aidl_parcel.readTypedObject(android.os.ParcelFileDescriptor.CREATOR);
    } finally {
  ...
  public int describeContents() {
    int _mask = 0;
    _mask |= describeContents(waylandSocketFd);
    return _mask;
  }
