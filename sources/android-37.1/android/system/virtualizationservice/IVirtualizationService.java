...
public interface IVirtualizationService extends android.os.IInterface
{
  ...
  public static class Default implements android.system.virtualizationservice.IVirtualizationService
  {
    ...
    /**
     * Get a list of all on device VMs. This method is only intended for debug purposes,
     ...
     */
    @Override public void startOrStopAdbd(int cid, boolean start) throws android.os.RemoteException
    {
    }
    /** Notification that the virtualization service should shut down. */
    @Override public void requestShutdown() throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationservice.IVirtualizationService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_startOrStopAdbd:
        {
          ...
          data.enforceNoDataAvail();
          this.startOrStopAdbd(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
    ...
    private static final class Proxy implements android.system.virtualizationservice.IVirtualizationService
    {
      ...
      @Override public void requestShutdown() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_requestShutdown, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
    ...
    static final int TRANSACTION_startOrStopAdbd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_requestShutdown = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
  }
   ...
   * This method is protected by the DEBUG_VIRTUAL_MACHINE permission.
   */
  public void startOrStopAdbd(int cid, boolean start) throws android.os.RemoteException;
  /** Notification that the virtualization service should shut down. */
  public void requestShutdown() throws android.os.RemoteException;
}
