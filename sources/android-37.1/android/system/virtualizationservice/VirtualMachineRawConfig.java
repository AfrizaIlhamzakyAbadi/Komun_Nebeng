...
public class VirtualMachineRawConfig implements android.os.Parcelable
{
  ...
  public android.os.ParcelFileDescriptor[] pflash;
  ...
  public android.system.virtualizationservice.DeviceAssignmentConfig deviceAssignmentConfig;
   ...
   */
  public boolean allowVgicItsInPvm = false;
  ...
  /**
   * Custom client-provided DTBO, applied to the guest device tree
   * @deprecated Reserved for hypervisor-specific VMs, should NOT be used.
   */
  @Deprecated
  public android.os.ParcelFileDescriptor deviceTreeOverlay;
  ...
  public android.system.virtualizationservice.SmbiosOptions smbiosOptions;
  /**
   * Allow crash kernel for debuggable VMs.
   * 
   * This is only valid if the VM debug level is higher than NONE.
   */
  public boolean ramdump = true;
  /**
   * Name of the profile for this VM.
   * 
   * The VM profile provides a grouping of VM properties (for now only scheduling related) that
   * can be overridden by OEM/SoC. See android/virtmgr/src/vm_profiles.rs for full documentation.
   */
  public java.lang.String profileName;
  /**
   * Whether the VM should be a client of Secretkeeper. This enables keeping secrets
   * when the VM is updated, if possible.
   */
  public boolean enableSecretkeeper = true;
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedArray(pflash, _aidl_flag);
    ...
    _aidl_parcel.writeTypedObject(deviceAssignmentConfig, _aidl_flag);
    ...
    _aidl_parcel.writeBoolean(allowVgicItsInPvm);
    ...
    _aidl_parcel.writeTypedObject(deviceTreeOverlay, _aidl_flag);
    _aidl_parcel.writeTypedArray(customMemoryBackingFiles, _aidl_flag);
    _aidl_parcel.writeStringArray(hostServices);
    _aidl_parcel.writeTypedObject(smbiosOptions, _aidl_flag);
    _aidl_parcel.writeBoolean(ramdump);
    _aidl_parcel.writeString(profileName);
    _aidl_parcel.writeBoolean(enableSecretkeeper);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      pflash = _aidl_parcel.createTypedArray(android.os.ParcelFileDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      deviceAssignmentConfig = _aidl_parcel.readTypedObject(android.system.virtualizationservice.DeviceAssignmentConfig.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      allowVgicItsInPvm = _aidl_parcel.readBoolean();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      deviceTreeOverlay = _aidl_parcel.readTypedObject(android.os.ParcelFileDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      smbiosOptions = _aidl_parcel.readTypedObject(android.system.virtualizationservice.SmbiosOptions.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ramdump = _aidl_parcel.readBoolean();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      profileName = _aidl_parcel.readString();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      enableSecretkeeper = _aidl_parcel.readBoolean();
    } finally {
  ...
  public int describeContents() {
    ...
    _mask |= describeContents(deviceAssignmentConfig);
    ...
    _mask |= describeContents(deviceTreeOverlay);
    _mask |= describeContents(customMemoryBackingFiles);
    _mask |= describeContents(smbiosOptions);
    return _mask;
  }
