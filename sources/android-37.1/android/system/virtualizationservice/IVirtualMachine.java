...
public interface IVirtualMachine extends android.os.IInterface
{
  ...
  public static class Default implements android.system.virtualizationservice.IVirtualMachine
  {
    ...
    @Override public void unregisterCallback(android.system.virtualizationservice.IVirtualMachineCallback callback) throws android.os.RemoteException
    {
    }
    ...
    /** Returns guest agent port */
    @Override public int getGuestAgentPort() throws android.os.RemoteException
    {
      return 0;
    }
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationservice.IVirtualMachine
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getGuestAgentPort:
        {
          int _result = this.getGuestAgentPort();
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
    ...
    private static final class Proxy implements android.system.virtualizationservice.IVirtualMachine
    {
      ...
      @Override public int getGuestAgentPort() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getGuestAgentPort, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
    ...
    static final int TRANSACTION_isMemoryBalloonEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_getActualMemoryBalloonBytes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_setMemoryBalloon = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_connectVsock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
    static final int TRANSACTION_createAccessorBinder = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_setHostConsoleName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
    static final int TRANSACTION_suspend = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_resume = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_getDebugInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_addMemoryToGuest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_removeMemoryFromGuest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
    static final int TRANSACTION_getGuestAgentPort = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_addDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
    static final int TRANSACTION_removeDisplay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
    static final int TRANSACTION_getDisplays = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
  }
  ...
  /** Unregister a previously registered callback. */
  public void unregisterCallback(android.system.virtualizationservice.IVirtualMachineCallback callback) throws android.os.RemoteException;
  /** Starts running the VM. */
  ...
  /** Returns guest agent port */
  public int getGuestAgentPort() throws android.os.RemoteException;
  /**
   * Adds a new display to the VM.
   * 
   * @param config The configuration for the new display.
