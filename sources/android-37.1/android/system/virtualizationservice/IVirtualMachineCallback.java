...
public interface IVirtualMachineCallback extends android.os.IInterface
{
  ...
  public static class Default implements android.system.virtualizationservice.IVirtualMachineCallback
  {
    ...
    @Override public void onGuestAgentRegistered(int cid, int port) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationservice.IVirtualMachineCallback
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_onGuestAgentRegistered:
        {
          int _arg0;
          _arg0 = data.readInt();
          int _arg1;
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.onGuestAgentRegistered(_arg0, _arg1);
          break;
        }
        default:
        {
    ...
    private static final class Proxy implements android.system.virtualizationservice.IVirtualMachineCallback
    {
      ...
      @Override public void onGuestAgentRegistered(int cid, int port) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(cid);
          _data.writeInt(port);
          boolean _status = mRemote.transact(Stub.TRANSACTION_onGuestAgentRegistered, _data, null, android.os.IBinder.FLAG_ONEWAY);
        }
        finally {
          _data.recycle();
        }
    ...
    static final int TRANSACTION_onGuestAgentRegistered = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
  }
  ...
  /** Called when guest agent is registered. */
  public void onGuestAgentRegistered(int cid, int port) throws android.os.RemoteException;
}
