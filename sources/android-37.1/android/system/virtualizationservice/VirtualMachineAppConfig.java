...
public class VirtualMachineAppConfig implements android.os.Parcelable
{
   ...
   */
  public java.util.List<android.os.ParcelFileDescriptor> tenantApks;
   ...
   */
  public boolean autoStartAdbd = false;
  /**
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeTypedList(tenantApks, _aidl_flag);
    ...
    _aidl_parcel.writeBoolean(autoStartAdbd);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      tenantApks = _aidl_parcel.createTypedArrayList(android.os.ParcelFileDescriptor.CREATOR);
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      autoStartAdbd = _aidl_parcel.readBoolean();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
  ...
  public int describeContents() {
    ...
    _mask |= describeContents(tenantApks);
