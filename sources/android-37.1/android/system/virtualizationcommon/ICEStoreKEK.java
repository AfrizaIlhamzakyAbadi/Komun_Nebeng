...
public interface ICEStoreKEK extends android.os.IInterface
{
  /** Default implementation for ICEStoreKEK. */
  public static class Default implements android.system.virtualizationcommon.ICEStoreKEK
  {
    /**
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.virtualizationcommon.ICEStoreKEK
  {
    ...
    /**
     * Cast an IBinder object into an android.system.virtualizationcommon.ICEStoreKEK interface,
     * generating a proxy if needed.
     */
    public static android.system.virtualizationcommon.ICEStoreKEK asInterface(android.os.IBinder obj)
    {
      if ((obj==null)) {
        return null;
      }
      android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
      if (((iin!=null)&&(iin instanceof android.system.virtualizationcommon.ICEStoreKEK))) {
        return ((android.system.virtualizationcommon.ICEStoreKEK)iin);
      }
      return new android.system.virtualizationcommon.ICEStoreKEK.Stub.Proxy(obj);
    }
    ...
    private static final class Proxy implements android.system.virtualizationcommon.ICEStoreKEK
    {
  ...
  @android.annotation.Hide
  public static final java.lang.String DESCRIPTOR = "android.system.virtualizationcommon.ICEStoreKEK";
  /**
   * Returns a KEK used to set up the ce store, or {@code null} if ce store
   * hasn't been set up yet.
   * 
