...
public class VirtualMachineCustomImageConfig {
    ...
    public static final class UsbConfig {
        ...
        @Nullable public final String[] devices;

        public UsbConfig(boolean controller, @Nullable String[] devices) {
        ...
        android.system.virtualizationservice.UsbConfig toParceclable() {
            ...
            parcelable.devices = this.devices;
            return parcelable;
        }
        ...
        private static UsbConfig from(PersistableBundle pb) {
            ...
            String[] devices = pb.getStringArray(KEY_DEVICES);
            if (devices != null) {
        ...
        private PersistableBundle toPersistableBundle() {
            ...
            if (this.devices != null) {
                pb.putStringArray(KEY_DEVICES, this.devices);
            }
            return pb;
        }
        ...
        public static class Builder {
            ...
            @Nullable private String[] devices;
            ...
            @Hide
            public Builder setDevices(@Nullable String[] devices) {
                this.devices = devices;
                return this;
            }
            ...
            public UsbConfig build() {
                return new UsbConfig(useController, devices);
            }
        }
    }
    ...
    public static final class GpuConfig {
        ...
        @Nullable private final ParcelFileDescriptor waylandSocketFd;
        ...
        private GpuConfig(
                ...
                @Nullable ParcelFileDescriptor waylandSocketFd) {
            ...
            this.waylandSocketFd = waylandSocketFd;
        }

        @Hide
        @Nullable
        public ParcelFileDescriptor getWaylandSocketFd() {
        ...
        android.system.virtualizationservice.GpuConfig toParcelable() {
            ...
            parcelable.waylandSocketFd = this.waylandSocketFd;
            return parcelable;
        }
        ...
        public static class Builder {
            ...
            @Nullable private ParcelFileDescriptor waylandSocketFd;

            @Hide
            public Builder() {}

            @Hide
            public Builder setWaylandSocketFd(@Nullable ParcelFileDescriptor fd) {
                this.waylandSocketFd = fd;
                return this;
            }
