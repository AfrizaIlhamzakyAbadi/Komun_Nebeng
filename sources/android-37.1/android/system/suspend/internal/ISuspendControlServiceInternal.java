...
public interface ISuspendControlServiceInternal extends android.os.IInterface
{
  ...
  public static class Default implements android.system.suspend.internal.ISuspendControlServiceInternal
  {
    ...
    /** Returns aggregated stats from kernel wakelocks. */
    @Override public android.system.suspend.internal.AggregatedKernelWakelockInfo getKernelWakelockDurationStats() throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.system.suspend.internal.ISuspendControlServiceInternal
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getKernelWakelockDurationStats:
        {
          android.system.suspend.internal.AggregatedKernelWakelockInfo _result = this.getKernelWakelockDurationStats();
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
    ...
    private static final class Proxy implements android.system.suspend.internal.ISuspendControlServiceInternal
    {
      ...
      @Override public android.system.suspend.internal.AggregatedKernelWakelockInfo getKernelWakelockDurationStats() throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain();
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.system.suspend.internal.AggregatedKernelWakelockInfo _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getKernelWakelockDurationStats, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.system.suspend.internal.AggregatedKernelWakelockInfo.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
    ...
    static final int TRANSACTION_getKernelWakelockDurationStats = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
  }
  @android.annotation.Hide
  ...
  /** Returns aggregated stats from kernel wakelocks. */
  public android.system.suspend.internal.AggregatedKernelWakelockInfo getKernelWakelockDurationStats() throws android.os.RemoteException;
}
