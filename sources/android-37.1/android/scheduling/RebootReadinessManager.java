...
public final class RebootReadinessManager {
    ...
    /**
     * Helper method for the creation of {@link RebootSchedulerManager}.
     *
     * @return a new {@link RebootSchedulerManager} instance.
     */
    @Hide
    public RebootSchedulerManager createRebootSchedulerManager() {
        return new RebootSchedulerManager(mContext, mService);
    }
}
