...
public interface ModelLoadRequestCallback {
     ...
     *
     * @param request The model load request that resulted in the model being loaded
     * @param reason the reason for the unload request
     */
    @FlaggedApi(com.android.npumanager.Flags.FLAG_REQUEST_UNLOAD_REASON)
    public default void onRequestUnloadModel(
            ModelLoadRequest request, @NpuManager.NpuModelUnloadReason int reason) {}
