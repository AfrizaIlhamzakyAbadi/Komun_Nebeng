...
public abstract class WallpaperService extends Service {
    ...
    public class Engine {
        ...
        /**
         * Updates the wallpaper description for a preview engine.
         *
         * Only valid for preview engines, will throw an error for applied engines.
         *
         * @param description The new wallpaper description.
         */
        @Hide
        public void updateDescription(WallpaperDescription description) {
            if (!isPreview()) {
                throw new IllegalStateException("Only valid for preview engines.");
            }
        }
                ...
                try {
                    ...
                    if (!mCreated) {
                        ...
                        if (mSession.addToDisplay(mWindow, mLayout, View.VISIBLE,
                                ...
                                inputChannel, addRes) < WindowManagerGlobal.ADD_OKAY) {
    ...
    class IWallpaperEngineWrapper extends IWallpaperEngine.Stub
        ...
        public void updateDescription(@NonNull WallpaperDescription description) {
            if (mEngine != null) {
                mEngine.updateDescription(description);
            }
        }
