...
public abstract class ConditionProviderService extends Service {
    ...
    @Nullable
    private volatile IContextualModeManager mModesService;
    ...
    public static final void requestRebind(ComponentName componentName) {
        try {
            if (refactorModesCode()) {
                IBinder service = ServiceManager.getService(Context.CONTEXTUAL_MODE_SERVICE);
                IContextualModeManager.Stub.asInterface(service).requestBindProvider(componentName);
            } else {
    ...
    public final void requestUnbind() {
        try {
            if (refactorModesCode()) {
                getModesService().requestUnbindProvider(mProvider);
            } else {
                getNotificationInterface().requestUnbindProvider(mProvider);
            }
    ...
    public final void notifyConditions(Condition... conditions) {
        ...
        try {
            if (refactorModesCode()) {
                getModesService().notifyConditions(getPackageName(), mProvider, conditions);
            } else {
                getNotificationInterface().notifyConditions(
                        getPackageName(), mProvider, conditions);
            }
