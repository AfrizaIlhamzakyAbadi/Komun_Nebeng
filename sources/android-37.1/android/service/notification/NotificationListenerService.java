...
public abstract class NotificationListenerService extends Service {
    ...
    public final int getCurrentInterruptionFilter() {
        ...
        if (refactorModesCode()) {
            try {
                ...
                Log.v(TAG, "Unable to contact system server", e);
    ...
    public final void requestInterruptionFilter(int interruptionFilter) {
        ...
        try {
            if (refactorModesCode()) {
                ...
                getNotificationInterface().requestInterruptionFilterFromListener(
    ...
    public static class Ranking {
        ...
        // ID of the highest-priority matching rule for this notification.
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeInt(mHighestPriorityMatchingRule);
        }
        ...
        public Ranking(Parcel in) {
            ...
            mHighestPriorityMatchingRule = in.readInt();
        }
        ...
        /**
         * Returns the ID of the highest priority {@link NotificationRule} that applies to this
         * notification (or 0 if none exists).
         */
        @Hide
        public int getHighestPriorityMatchingRule() {
            return mHighestPriorityMatchingRule;
        }
        ...
        public void populate(String key, int rank, boolean matchesInterruptionFilter,
                ...
                boolean sensitiveContent, String summarization, int highestPriorityMatchingRule) {
            mKey = key;
            mRank = rank;
            ...
            mHighestPriorityMatchingRule = highestPriorityMatchingRule;
        }
        ...
        public void populate(Ranking other) {
            populate(other.mKey,
                    ...
                    other.mHighestPriorityMatchingRule);
        }
        ...
        public boolean equals(@Nullable Object o) {
            ...
            return Objects.equals(mKey, other.mKey)
                    ...
                    && mHighestPriorityMatchingRule == other.mHighestPriorityMatchingRule;
        }
    }
