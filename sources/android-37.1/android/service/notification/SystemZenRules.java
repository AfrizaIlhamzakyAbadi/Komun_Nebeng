...
public final class SystemZenRules {
    ...
    private static final String OLD_SCHEDULE_COMPONENT =
            "com.android.server.notification.ScheduleConditionProvider";
    private static final String OLD_EVENT_COMPONENT =
            "com.android.server.notification.EventConditionProvider";
    private static final String OLD_COUNTDOWN_COMPONENT =
            "com.android.server.notification.CountdownConditionProvider";
    private static final String OLD_CUSTOM_MANUAL_COMPONENT =
            "com.android.server.notification.CustomManualConditionProvider";
    ...
    public static void maybeUpgradeRules(Context context, ZenModeConfig config) {
        for (ZenRule rule : config.automaticRules.values()) {
            ...
            maybeFixSystemRulesWithIncorrectComponent(rule);
    ...
    private static void maybeFixSystemRulesWithIncorrectComponent(ZenRule rule) {
        if (isSystemOwnedRule(rule)) {
            if (rule.component != null) {
                if (OLD_SCHEDULE_COMPONENT.equals(rule.component.getClassName())) {
                    rule.component = ZenModeConfig.getScheduleConditionProvider();
                } else if (OLD_EVENT_COMPONENT.equals(rule.component.getClassName())) {
                    rule.component = ZenModeConfig.getEventConditionProvider();
                } else if (OLD_COUNTDOWN_COMPONENT.equals(rule.component.getClassName())) {
                    rule.component = ZenModeConfig.getCountdownConditionProvider();
                } else if (OLD_CUSTOM_MANUAL_COMPONENT.equals(rule.component.getClassName())) {
                    rule.component = ZenModeConfig.getCustomManualConditionProvider();
                }
            }
        }
    }
