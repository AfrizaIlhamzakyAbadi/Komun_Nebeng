...
public abstract class SelectionToolbarRenderService extends Service {
    ...
    public abstract void onShow(int uid, ShowInfo showInfo,
            SelectionToolbarRenderCallback callback);
     ...
     */
    public static class RemoteCallbackWrapper implements SelectionToolbarRenderCallback {
        ...
        public void onUpdated(WidgetInfo widgetInfo) {
            try {
                mRemoteCallback.onUpdated(widgetInfo);
            } catch (RemoteException e) {
                // no-op
            }
        }
