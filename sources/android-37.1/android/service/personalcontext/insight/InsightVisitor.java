...
public interface InsightVisitor {
    ...
    /** Visits a {@link ListInsight}. */
    default void visit(@NonNull ListInsight insight, int index) {}

    /** Visits a {@link MapInsight}. */
    default void visit(@NonNull MapInsight insight, int index) {}

    /** Visits a {@link NoResultInsight}. */
    default void visit(@NonNull NoResultInsight insight, int index) {}
