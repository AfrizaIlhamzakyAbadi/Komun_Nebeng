...
public final class PublishedContextHintWrapper implements Parcelable {
    ...
    private PublishedContextHintWrapper(Parcel source) {
        mHint = new PublishedContextHint(
                source.readParcelable(null, ContextHintWrapper.class).getContextHint());
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        dest.writeParcelable(new ContextHintWrapper(mHint.getContextHint()), flags);
    }
