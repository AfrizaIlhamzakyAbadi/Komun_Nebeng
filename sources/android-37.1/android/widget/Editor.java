...
public class Editor {
    ...
    public void setTextContextMenuItems(ContextMenu menu) {
        final TypedArray a = mTextView.getContext().obtainStyledAttributes(new int[]{
                ...
                android.R.attr.actionModeLookUpDrawable,
        });
        ...
        final int menuItemOrderLookUp = 10;
        final int menuItemOrderAutofill = 11;
        ...
        if (mTextView.canLookUpText()) {
            menu.add(CONTEXT_MENU_GROUP_MISC, TextView.ID_LOOK_UP, menuItemOrderLookUp,
                            com.android.internal.R.string.look_up)
                    .setIcon(a.getDrawable(7))
                    .setOnMenuItemClickListener(mOnContextMenuItemClickListener);
        }
    ...
    private class TextActionModeCallback extends ActionMode.Callback2 {
        ...
        private void populateMenuWithItems(Menu menu) {
            ...
            if (mTextView.canLookUpText()) {
                menu.add(Menu.NONE, TextView.ID_LOOK_UP, ACTION_MODE_MENU_ITEM_ORDER_LOOK_UP,
                        com.android.internal.R.string.look_up)
                        .setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
            }
