    ...
    public interface RemoteViewsFactory {
        ...
        default RemoteViews.RemoteCollectionItems getRemoteCollectionItems(int capSize,
            ...
            try {
                ...
                RemoteViews.ImageCache testImageCache = null;
                ...
                for (int i = 0; i < numOfEntries; i++) {
                    ...
                    if (testImageCache == null) {
                        testImageCache = new RemoteViews.ImageCache(currentView.getImageCache());
                    } else {
                        testImageCache.mergeWithCache(currentView.getImageCache());
                    }
                    if (testImageCache.getBitmapMemory() >= capBitmapSize) {
                        break;
                    }
