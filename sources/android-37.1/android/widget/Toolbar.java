...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mCollapseIconResId = a.getResourceId(R.styleable.Toolbar_collapseIcon, 0);
    ...
    public Drawable getCollapseIcon() {
        return mCollapseButtonView != null
                ? mCollapseButtonView.getDrawable() : getDefaultCollapseIcon();
    }
    ...
    public void setCollapseIcon(@Nullable Drawable icon) {
        if (icon != null) {
            ensureCollapseButtonView(icon);
            mCollapseButtonView.setImageDrawable(icon);
        } else if (mCollapseButtonView != null) {
            mCollapseButtonView.setImageDrawable(getDefaultCollapseIcon());
        }
    }
    ...
    private Drawable getDefaultCollapseIcon() {
        if (mCollapseIcon == null && mCollapseIconResId != 0) {
            mCollapseIcon = getContext().getDrawable(mCollapseIconResId);
        }
        return mCollapseIcon;
    }

    private void ensureCollapseButtonView() {
        ensureCollapseButtonView(getDefaultCollapseIcon());
    }

    private void ensureCollapseButtonView(Drawable icon) {
        if (mCollapseButtonView == null) {
