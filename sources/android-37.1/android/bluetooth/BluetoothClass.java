...
public final class BluetoothClass implements Parcelable {
    ...
    public static class Device {
         ...
         *
         * <p>This constant indicates that the Bluetooth device is a hearing aid within the {@link
         * Major#AUDIO_VIDEO} major device class. It can be compared against the result of {@link
         * BluetoothClass#getDeviceClass()} to identify hearing aid devices.
         */
        @FlaggedApi(Flags.FLAG_ADD_HEARING_AID_CLASS_OF_DEVICE)
        public static final int AUDIO_VIDEO_HEARING_AID = 0x044C;
        ...
        if (profile == PROFILE_A2DP) {
            ...
            return switch (getDeviceClass()) {
                case Device.AUDIO_VIDEO_HIFI_AUDIO,
                        ...
                        true;
                case Device.AUDIO_VIDEO_HEARING_AID -> Flags.addHearingAidClassOfDevice();
                default -> false;
            };
