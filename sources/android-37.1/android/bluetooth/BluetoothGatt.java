...
public final class BluetoothGatt implements BluetoothProfile {
    ...
    private class GattCallback extends IBluetoothGattCallback.Stub {
        ...
        public void onClientRegistered(int status) {
            ...
            try {
                ...
                boolean isAutoMtuEnabled = mGattConnectionSettings.isAutomaticMtuEnabled();

                mService.clientConnect(
                        mBluetoothGattCallback,
                        mDevice,
                        new BluetoothGattConnectionSettings.InnerParcel(
                                !mAutoConnect, mTransport, mOpportunistic, isAutoMtuEnabled),
                        mAttributionSource);
    ...
    public boolean connect() {
        if (!mClientRegistered) {
            synchronized (mStateLock) {
                if (mConnState != CONN_STATE_IDLE) {
                    Log.v(TAG, "connect(): called but connState was not idle");
                    return false;
                }
            ...
            try {
                ...
                Log.e(TAG, "connect(): Failed to register callback");
                return false;
            }
        ...
        try {
            Log.d(TAG, "connect(): Device=" + mDevice + ", auto=" + mAutoConnect);
    ...
    public void setPreferredPhy(
        ...
        try {
            mService.setPreferredPhy(
                    mLeConnectionCallback, mDevice, txPhy, rxPhy, phyOptions, mAttributionSource);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
        }
    }
    ...
    public void readPhy() {
        ...
        try {
            mService.readPhy(mLeConnectionCallback, mDevice, mAttributionSource);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
        }
    }
    ...
    public boolean readRemoteRssi() {
        ...
        try {
            return mService.readRemoteRssi(mLeConnectionCallback, mDevice, mAttributionSource);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
            return false;
        }
    ...
    public boolean requestConnectionPriority(int connectionPriority) {
        ...
        try {
            mService.connectionParameterUpdate(
                    mLeConnectionCallback, mDevice, connectionPriority, mAttributionSource);
        } catch (RemoteException e) {
            Log.e(TAG, "", e);
            return false;
        }
    ...
    public @SubrateRequestReturnValues int requestSubrateMode(@SubrateMode int subrateMode) {
        ...
        try {
            return mService.subrateModeRequest(
                    mLeConnectionCallback, mDevice, subrateMode, mAttributionSource);
        } catch (RemoteException e) {
