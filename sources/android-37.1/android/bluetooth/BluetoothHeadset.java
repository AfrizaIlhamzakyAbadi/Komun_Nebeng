...
public final class BluetoothHeadset implements BluetoothProfile {
     ...
     * HFP codec type CVSD.
     *
     * <p>Continuous Variable Slope Delta modulation (CVSD) as defined by the Bluetooth SIG in the
     * HFP Specification.
     */
    @FlaggedApi(Flags.FLAG_HFP_GET_CODEC_API)
     ...
     * HFP codec type mSBC.
     *
     * <p>Modified Sub-Band Codec (mSBC) as defined by the Bluetooth SIG in the HFP Specification.
     */
    @FlaggedApi(Flags.FLAG_HFP_GET_CODEC_API)
     ...
     *
     * <p>Low Complexity Communication Codec (LC3) for Super Wideband (SWB) as defined by the
     * Bluetooth SIG in the HFP Specification.
     */
    @FlaggedApi(Flags.FLAG_HFP_GET_CODEC_API)
     ...
     * state of the profile from this intent. For applications targeting above {@link
     * android.os.Build.VERSION_CODES#CINAMON_BUN} this API will always enforce
    ...
    @RequiresBluetoothConnectPermission
    @FlaggedApi(Flags.FLAG_ENFORCE_BLUETOOTH_PRIVILEGED_FOR_HEADSET)
    @RequiresPermission(
            allOf = {
                BLUETOOTH_CONNECT,
                MODIFY_PHONE_STATE,
     ...
     * #STATE_DISCONNECTING} can be used to distinguish between the two scenarios. For applications
     * targeting above {@link android.os.Build.VERSION_CODES#CINAMON_BUN} this API will always
     * enforce BLUETOOTH_PRIVILEGED.
     *
     * @param device Remote Bluetooth Device
     * @return false on immediate error, true otherwise
     */
