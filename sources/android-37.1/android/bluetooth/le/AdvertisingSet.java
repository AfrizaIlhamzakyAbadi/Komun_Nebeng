...
public final class AdvertisingSet {
    ...
    public void enableAdvertising(boolean enable, int duration, int maxExtendedAdvertisingEvents) {
        try {
            mAdvertise.enableAdvertisingSet(
                    mAdvertiserId, enable, duration, maxExtendedAdvertisingEvents, mSource);
    ...
    public void setAdvertisingData(AdvertiseData advertiseData) {
        try {
            mAdvertise.setAdvertisingData(mAdvertiserId, advertiseData, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void setScanResponseData(AdvertiseData scanResponse) {
        try {
            mAdvertise.setScanResponseData(mAdvertiserId, scanResponse, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void setAdvertisingParameters(AdvertisingSetParameters parameters) {
        try {
            mAdvertise.setAdvertisingParameters(mAdvertiserId, parameters, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void setPeriodicAdvertisingParameters(PeriodicAdvertisingParameters parameters) {
        try {
            mAdvertise.setPeriodicAdvertisingParameters(mAdvertiserId, parameters, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void setPeriodicAdvertisingData(AdvertiseData periodicData) {
        try {
            mAdvertise.setPeriodicAdvertisingData(mAdvertiserId, periodicData, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void setPeriodicAdvertisingEnabled(boolean enable) {
        try {
            mAdvertise.setPeriodicAdvertisingEnable(mAdvertiserId, enable, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
    ...
    public void getOwnAddress() {
        try {
            mAdvertise.getOwnAddress(mAdvertiserId, mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }
