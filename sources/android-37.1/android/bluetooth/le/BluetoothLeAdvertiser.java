...
public final class BluetoothLeAdvertiser {
    ...
    public void startAdvertising(
        ...
        synchronized (mLegacyAdvertisers) {
            ...
            if (!BluetoothLeUtils.checkAdapterStateOn(mAdapter)) {
                ...
                postStartFailure(callback, ADVERTISE_FAILED_INTERNAL_ERROR);
                return;
            }
    ...
    public void startAdvertisingSet(
        ...
        if (!BluetoothLeUtils.checkAdapterStateOn(mAdapter)) {
            ...
            postStartSetFailure(handler, callback, ADVERTISE_FAILED_INTERNAL_ERROR);
            return;
        }
    ...
    public void stopAdvertisingSet(AdvertisingSetCallback callback) {
        ...
        try {
            advertise.stopAdvertisingSet(wrapped, mSource);
        } catch (RemoteException e) {
                ...
                executeFromBinder(
                        ...
                        () -> {
                            ...
                            AdvertisingSet advertisingSet =
                                    new AdvertisingSet(advertise, advertiserId, mSource);
