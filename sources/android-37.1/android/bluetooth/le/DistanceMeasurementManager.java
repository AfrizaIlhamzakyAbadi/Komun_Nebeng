...
public final class DistanceMeasurementManager {
    ...
    public @NonNull List<DistanceMeasurementMethod> getSupportedMethods() {
        ...
        try {
            ...
            return distanceMeasurement.getSupportedDistanceMeasurementMethods(mSource);
        ...
        try {
            ...
            DistanceMeasurementSession session =
                    new DistanceMeasurementSession(
                            distanceMeasurement, mUuid, params, executor, mSource, callback);
            ...
            distanceMeasurement.startDistanceMeasurement(mUuid, params, mCallbackWrapper, mSource);
    ...
    public @CsSecurityLevel int getLocalChannelSoundingMaxSupportedSecurityLevel() {
        ...
        try {
            ...
            return distanceMeasurement.getLocalChannelSoundingMaxSupportedSecurityLevel(mSource);
        } catch (RemoteException e) {
            Log.e(TAG, "Failed to get supported security Level - ", e);
        }
        return defaultValue;
    ...
    public @NonNull Set<@CsSecurityLevel Integer> getChannelSoundingSupportedSecurityLevels() {
        try {
            ...
            return Arrays.stream(
                            distanceMeasurement.getChannelSoundingSupportedSecurityLevels(mSource))
                    .boxed()
