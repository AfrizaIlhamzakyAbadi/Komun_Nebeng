...
public final class BluetoothStatusCodes {
    ...
    /** Indicates that joining a broadcast source failed because no broadcast code was provided. */
    @FlaggedApi(Flags.FLAG_LEAUDIO_BROADCAST_SINK_FEATURE)
    @SystemApi
    public static final int ERROR_LE_BROADCAST_CODE_REQUIRED = 1212;

    /**
     * Indicates that a broadcast sink device is already executing Broadcast Isochronous Group (BIG)
     * synchronization to the given broadcast source.
     */
    @FlaggedApi(Flags.FLAG_LEAUDIO_BROADCAST_SINK_FEATURE)
    @SystemApi
    public static final int ERROR_LE_BROADCAST_DUPLICATE_SYNC_STREAM_REQUEST = 1213;
