...
public final class LocationDeviceConfig {
    ...
    /**
     * Sampling rate for location auditing when MLS is on.
     */
    public static final String MLS_ON_SAMPLING_RATE =
            "location_auditing_mls_on_sampling_rate";

    /**
     * Sampling rate for location auditing when MLS is off and under emergency.
     */
    public static final String MLS_OFF_EMERGENCY_ON_SAMPLING_RATE =
            "location_auditing_mls_off_emergency_on_sampling_rate";

    /**
     * Sampling rate for location auditing when MLS is off and not in emergency.
     */
    public static final String MLS_OFF_EMERGENCY_OFF_SAMPLING_RATE =
            "location_auditing_mls_off_emergency_off_sampling_rate";
