...
public final class WifiRttSpecificData implements Parcelable {
    ...
    /**
     * Gets the minimum time between measurements for IEEE 802.11az non-trigger
     * based ranging.
     *
     * @return the minimum time between measurements
     */
    @NonNull
    @FlaggedApi(Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    public Duration getNtbMinMeasurementTime() {
        return Duration.ofNanos(mNtbMinMeasurementTime * 1000);
    }

    /**
     * Gets the maximum time between measurements for IEEE 802.11az non-trigger
     * based ranging.
     *
     * @return the maximum time between measurements
     */
    @NonNull
    @FlaggedApi(Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    public Duration getNtbMaxMeasurementTime() {
        return Duration.ofNanos(mNtbMaxMeasurementTime * 1000);
    }
    ...
    /**
     * Gets the number of transmit spatial streams that the initiator station used for the ranging
     * result for IEEE 802.11az.
     *
    ...
    /**
     * Gets the number of receive spatial streams that the initiator station used for the ranging
     * result for IEEE 802.11az.
     *
