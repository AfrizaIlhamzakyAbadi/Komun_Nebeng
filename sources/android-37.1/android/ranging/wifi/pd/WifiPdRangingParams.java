...
public final class WifiPdRangingParams implements Parcelable {
    ...
    public static final class Builder {
         ...
         * @throws NullPointerException if required parameters are not set.
         * @throws IllegalArgumentException if Device IK length is not 16 or password is empty.
         */
        @NonNull
        public WifiPdRangingParams build() {
            if (mPasnMode == AUTHENTICATED_PASN_MODE) {
                ...
                if (mDeviceIk.length != 16 || mPassword.isEmpty()) {
                    throw new IllegalArgumentException("Device IK or password is invalid for "
