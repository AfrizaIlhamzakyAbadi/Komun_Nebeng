...
public final class UwbRangingCapabilities implements Parcelable, TechnologyCapabilities {
    ...
    private final boolean mSupportsDlTdoaRangingIndexesUpdate;
    ...
    private UwbRangingCapabilities(Builder builder) {
        ...
        mSupportsDlTdoaRangingIndexesUpdate = builder.mSupportsDlTdoaRangingIndexesUpdate;
    }
    ...
    private UwbRangingCapabilities(Parcel in) {
        ...
        mSupportsDlTdoaRangingIndexesUpdate = in.readBoolean();
    }
    ...
    /**
     * Whether Downlink time difference of arrival (DL-TDOA) dynamic ranging round indexes update
     * is supported. If true, apps can use
     * {@link android.ranging.RangingSession#updateDlTdoaRangingRoundsFiraPacket(List)} to
     * update the ranging round indexes for an ongoing DL-TDoA session.
     *
     * @return true if dynamic update is supported.
     */
    @FlaggedApi(Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    public boolean isDlTdoaRangingIndexesUpdateSupported() {
        return mSupportsDlTdoaRangingIndexesUpdate;
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeBoolean(mSupportsDlTdoaRangingIndexesUpdate);
    }
    ...
    public static class Builder {
        ...
        private boolean mSupportsDlTdoaRangingIndexesUpdate = false;
        ...
        /**
         * @param supportsDlTdoaRangingIndexesUpdate whether DL-TDOA dynamic ranging round indexes
         * update is supported by. If true, apps can use
         * {@link android.ranging.RangingSession#updateDlTdoaRangingRoundsFiraPacket(List)} to
         *  update ranging round indexes dynamically for an ongoing DL-TDoA session.
         *
         * @return this builder instance for method chaining.
         */
        @NonNull
        @FlaggedApi(Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
        public Builder setDlTdoaRangingIndexesUpdateSupported(
                boolean supportsDlTdoaRangingIndexesUpdate) {
            this.mSupportsDlTdoaRangingIndexesUpdate = supportsDlTdoaRangingIndexesUpdate;
            return this;
        }
    ...
    public String toString() {
        return "UwbRangingCapabilities{ "
                ...
                + mSupportedAntennaModes
                + ", mSupportsDlTdoaRangingIndexesUpdate="
                + mSupportsDlTdoaRangingIndexesUpdate
                + " }";
    }
}
