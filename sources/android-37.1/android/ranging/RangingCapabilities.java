...
public final class RangingCapabilities implements Parcelable {
    ...
    /**
     * Checks if a given ranging technology is enabled and available for use.
     */
    @Hide
    public boolean isTechnologyEnabled(@RangingManager.RangingTechnology int technology) {
        return mAvailabilities.getOrDefault(technology, NOT_SUPPORTED) == ENABLED;
    }
