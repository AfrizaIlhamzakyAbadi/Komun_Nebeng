...
public final class BleSpecificData implements Parcelable {
    ...
    /**
     * Gets whether the raw confidence level is available.
     *
     * @return true if the raw confidence level is available, false otherwise.
     */
    ...
    /**
     * Gets the raw confidence level.
     *
     * @return the raw confidence level in [0.0, 1.0], or Double.NaN if not available.
     */
    @FlaggedApi(Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.mDelaySpreadMeters, mDelaySpreadMeters) == 0
                ...
                && Double.compare(that.mRawConfidence, mRawConfidence) == 0;
    }

    @Override
    public int hashCode() {
        return Objects.hash(mDelaySpreadMeters, mRemoteTxPowerDbm, mRawConfidence);
    }
    ...
    public static final class Builder {
         ...
         * Sets raw confidence.
         *
         * @param rawConfidence the raw confidence in [0.0, 1.0]
         * @return the Builder instance
         */
        @NonNull
        public Builder setRawConfidence(@FloatRange(from = 0.0, to = 1.0) double rawConfidence) {
            mRawConfidence = rawConfidence;
            return this;
        }
