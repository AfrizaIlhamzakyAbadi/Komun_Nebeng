...
public final class RangingManager {
    ...
    /**
     * Fused Location Provider (FLP) location-based ranging technology.
     *
     * <p>Requires {@code android.Manifest.permission.ACCESS_FINE_LOCATION} permission. If location
     * ranging is initiated or active while the calling application is in the background, {@code
     * android.Manifest.permission.ACCESS_BACKGROUND_LOCATION} is also required; otherwise, location
     * updates will be dynamically paused in the background.
     */
