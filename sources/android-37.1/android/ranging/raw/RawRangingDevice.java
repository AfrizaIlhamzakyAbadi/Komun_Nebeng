...
import android.ranging.location.LocationRangingParams;
...
public final class RawRangingDevice implements Parcelable {
     ...
     *     <li> WiFi PD - 256 milliseconds. </li>
     * </ul>
     */
     ...
     *     <li> WiFi PD - 512 milliseconds. </li>
     * </ul>
     */
     ...
     *     milliseconds otherwise. </li>
     *     <li> WiFi PD - 128 milliseconds. </li>
     * </ul>
     */
    ...
    private final LocationRangingParams mLocationRangingParams;
    ...
    private RawRangingDevice(Builder builder) {
        ...
        mLocationRangingParams = builder.mLocationRangingParams;
    }
    ...
    private RawRangingDevice(Parcel in) {
        ...
        mLocationRangingParams = in.readParcelable(LocationRangingParams.class.getClassLoader(),
                LocationRangingParams.class);
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeParcelable(mLocationRangingParams, flags);
    }
    ...
    /**
     * Returns the location ranging parameters, if applicable.
     *
     * @return the {@link LocationRangingParams}, or {@code null} if not set.
     */
    @Nullable
    @FlaggedApi(Flags.FLAG_RANGING_LOCATION_ENABLED)
    public LocationRangingParams getLocationRangingParams() {
        return mLocationRangingParams;
    }
    ...
    public Map<@RangingManager.RangingTechnology Integer, Duration> getRangingIntervalValues() {
        ...
        if (mLocationRangingParams != null) {
            Duration locationUpdateInterval = mLocationRangingParams.getUpdateInterval();
            map.put(RangingManager.LOCATION, locationUpdateInterval);
        }
        return map;
    }
    ...
    public static final class Builder {
        ...
        private LocationRangingParams mLocationRangingParams;
         ...
         *
         * <p>Requires {@code android.Manifest.permission.ACCESS_FINE_LOCATION} permission. If
         * ranging is initiated or active while the calling application is in the background, {@code
         * android.Manifest.permission.ACCESS_BACKGROUND_LOCATION} is also required. See <a
         * href="https://developer.android.com/develop/sensors-and-location/location/permissions">
         * Request location permissions</a> for details on requesting location permission.
         *
        ...
        /**
         * Sets the location ranging parameters.
         *
         * @param params the {@link LocationRangingParams} to be set.
         * @return this {@link Builder} instance for chaining calls.
         */
        @FlaggedApi(Flags.FLAG_RANGING_LOCATION_ENABLED)
        @NonNull
        public Builder setLocationRangingParams(@NonNull LocationRangingParams params) {
            Objects.requireNonNull(params);
            mLocationRangingParams = params;
            return this;
        }
        ...
        public RawRangingDevice build() {
            ...
            if (Stream.of(mUwbRangingParams, mBleCsRangingParams, mBleRssiRangingParams,
                            ...
                            mWifiPdRangingParams, mDlTdoaRangingParams,
                            mLocationRangingParams)
