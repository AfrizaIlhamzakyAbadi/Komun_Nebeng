...
/**
 * A network Domain, represented as a lower-case string for the hostname, and a boolean to define
 * whether the subdomains are considered part of the same domain.
 */
...
public final class Domain {
     ...
     */
    @Hide public final String hostname;

    /**
     * Whether this domain includes subdomains.
     */
    @Hide public final boolean subdomainsIncluded;

    /**
     * Constructor for a Domain object.
     *
     * @param hostname the hostname of the domain.
     * @param subdomainsIncluded whether subdomains are considered part of this domain.
     */
    public Domain(@NonNull String hostname, boolean subdomainsIncluded) {
        if (hostname == null) {
    ...
    /**
     * @return true if the domain is considered a localhost domain.
     */
