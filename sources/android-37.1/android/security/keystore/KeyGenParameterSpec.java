 ...
 *
 * <p><b>Note:</b> ML-DSA support is only available on devices with a Trusted Execution Environment
 * running KeyMint version >= 5. Support can be determined by checking that
 * {@link android.content.pm.PackageManager#FEATURE_HARDWARE_KEYSTORE} has a value {@code >= 500}.
 *
