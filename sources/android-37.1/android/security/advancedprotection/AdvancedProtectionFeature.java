...
public final class AdvancedProtectionFeature implements Parcelable {
    ...
    public boolean isProvisioned() {
        return isFeatureProvisioned(mProvisioningMode);
    }
    ...
    /** Helper method to determine if a feature's provisioning mode is in the provisioned range. */
    @Hide
    public static boolean isFeatureProvisioned(@ProvisioningMode int featureProvisioningMode) {
        return featureProvisioningMode < PROVISIONING_MODE_DEPROVISIONED_BY_DEFAULT;
    }
