...
public final class AdvancedProtectionManager {
    ...
    /**
     * Feature identifier for disabling debugging features when Advanced Protection Mode (AAPM) is
     * enabled.
     *
     * <p>When this protection is active, debugging features such as {@code adb} are disabled.
     */
    @SystemApi
    @FlaggedApi(Flags.FLAG_AAPM_FEATURE_DISABLE_DEBUGGING_FEATURES)
    public static final int FEATURE_ID_DISALLOW_DEBUGGING_FEATURES = 7;

    /**
     * Feature identifier for disabling ADB's capability to change AAPM.
     *
     * <p>When this feature is provisioned, commands changing AAPM state, such as {@code adb shell
     * cmd advanced_protection set-protection-enabled}, will be disabled.
     */
    @SystemApi
    @FlaggedApi(Flags.FLAG_AAPM_ENTERPRISE_INTEGRATION)
    ...
    @IntDef(
            ...
            value = {
                ...
                FEATURE_ID_DISALLOW_DEBUGGING_FEATURES,
                FEATURE_ID_DISALLOW_STATE_CHANGE_VIA_ADB,
            })
    ...
    private static ArrayMap<Integer, String> buildFeatureIdToNameMap() {
        ...
        map.put(FEATURE_ID_DISALLOW_DEBUGGING_FEATURES, "DISALLOW_DEBUGGING_FEATURES");
        map.put(FEATURE_ID_DISALLOW_STATE_CHANGE_VIA_ADB, "DISALLOW_STATE_CHANGE_VIA_ADB");
        return map;
    }
        ...
        if (DISALLOW_INSTALL_UNKNOWN_SOURCES_GLOBALLY.equals(identifier)) {
            ...
            dialogType =
                    (dialogType == SUPPORT_DIALOG_TYPE_UNKNOWN)
                            ? SUPPORT_DIALOG_TYPE_DISABLED_SETTING
                            : dialogType;
        } else if (DISALLOW_DEBUGGING_FEATURES.equals(identifier)) {
            featureId = FEATURE_ID_DISALLOW_DEBUGGING_FEATURES;
            dialogType =
                    (dialogType == SUPPORT_DIALOG_TYPE_UNKNOWN)
                            ? SUPPORT_DIALOG_TYPE_DISABLED_SETTING
                            : dialogType;
