...
public class AndroidKeyStoreProvider extends Provider {
    ...
    static AndroidKeyStorePublicKey makeAndroidKeyStorePublicKeyFromKeyEntryResponse(
        ...
        } else if (KeyProperties.ED25519_OID.equalsIgnoreCase(jcaKeyAlgorithm)) {
            final byte[] publicKeyEncoded = publicKey.getEncoded();
            return new AndroidKeyStoreEdECPublicKey(descriptor, metadata, KeyProperties.ED25519_OID,
