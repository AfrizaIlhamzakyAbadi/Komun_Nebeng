...
public abstract class AndroidKeyStoreKeyPairGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    public static class MLDSA extends AndroidKeyStoreKeyPairGeneratorSpi {
        public MLDSA() {
            super(
                    /* keymasterAlgorithm= */ KeymasterDefs.KM_ALGORITHM_ML_DSA,
    ...
    protected AndroidKeyStoreKeyPairGeneratorSpi(
        ...
        mMlDsaVariantTag = switch (mlDsaAlgorithmName) {
            case KeyProperties.KEY_ALGORITHM_ML_DSA_65 -> KeymasterDefs.KM_ML_DSA_VARIANT_65;
            case KeyProperties.KEY_ALGORITHM_ML_DSA_87 -> KeymasterDefs.KM_ML_DSA_VARIANT_87;
            // JEP 497 requires that KeyPairGenerator instances initialized with the family
            // name "ML-DSA" generate ML-DSA-65 keys.
            case KeyProperties.KEY_ALGORITHM_ML_DSA -> KeymasterDefs.KM_ML_DSA_VARIANT_65;
    ...
    public void initialize(AlgorithmParameterSpec params, SecureRandom random)
        ...
        try {
            ...
            try {
                ...
                } else if (mKeymasterAlgorithm == KeymasterDefs.KM_ALGORITHM_ML_DSA) {
                    mKeymasterDigests =
    ...
    private KeyGenParameterSpec buildKeyGenParameterSpecFromLegacy(KeyPairGeneratorSpec legacySpec,
        ...
        switch (keymasterAlgorithm) {
                ...
                if (mOriginalKeymasterAlgorithm == ALGORITHM_XDH) {
                    specBuilder =
                            new KeyGenParameterSpec.Builder(
                                    legacySpec.getKeystoreAlias(), KeyProperties.PURPOSE_AGREE_KEY);
                } else {
                    specBuilder =
                            new KeyGenParameterSpec.Builder(
            ...
            case KeymasterDefs.KM_ALGORITHM_RSA:
                ...
                break;
            case KeymasterDefs.KM_ALGORITHM_ML_DSA:
                specBuilder =
                        new KeyGenParameterSpec.Builder(
                                legacySpec.getKeystoreAlias(),
                                KeyProperties.PURPOSE_SIGN | KeyProperties.PURPOSE_VERIFY);
    ...
    private Collection<KeyParameter> constructKeyGenerationArguments()
        ...
        // non-sentinel value.
        if (mKeymasterAlgorithm != KeymasterDefs.KM_ALGORITHM_ML_DSA) {
            params.add(
            ...
            case KeymasterDefs.KM_ALGORITHM_ML_DSA:
                params.add(
                        KeyStore2ParameterUtils.makeEnum(
                                KeymasterDefs.KM_TAG_ML_DSA_VARIANT, mMlDsaVariantTag));
                break;
            default:
                throw new ProviderException("Unsupported algorithm: " + mKeymasterAlgorithm);
        }
