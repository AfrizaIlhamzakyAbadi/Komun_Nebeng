...
abstract class AndroidKeyStoreMlDsaSignatureSpi extends AndroidKeyStoreSignatureSpiBase {
    ...
    protected void addAlgorithmSpecificParametersToBegin(
        ...
        if (algorithm.equalsIgnoreCase(KeyProperties.KEY_ALGORITHM_ML_DSA_65)) {
            variantTag = KeymasterDefs.KM_ML_DSA_VARIANT_65;
        } else if (algorithm.equalsIgnoreCase(KeyProperties.KEY_ALGORITHM_ML_DSA_87)) {
            variantTag = KeymasterDefs.KM_ML_DSA_VARIANT_87;
        } else {
        ...
        parameters.add(
                KeyStore2ParameterUtils.makeEnum(
                        KeymasterDefs.KM_TAG_ALGORITHM, KeymasterDefs.KM_ALGORITHM_ML_DSA));
        parameters.add(
                KeyStore2ParameterUtils.makeEnum(KeymasterDefs.KM_TAG_ML_DSA_VARIANT, variantTag));
        parameters.add(
                KeyStore2ParameterUtils.makeEnum(
