...
public final class SafetyCenterManager {
    ...
    /**
     * Used as a {@code boolean} extra field in {@link Intent#ACTION_SAFETY_CENTER} intents to
     * specify whether to lead to a Safety Center page with all active issues. If true, this will
     * redirect to the appropriate Safety Center page.
     */
    @FlaggedApi(Flags.FLAG_SAFETY_CENTER_SHOW_ISSUES_API)
    public static final String EXTRA_SHOW_ISSUES = "android.safetycenter.extra.SHOW_ISSUES";
