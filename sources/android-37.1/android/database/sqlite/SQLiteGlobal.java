...
public final class SQLiteGlobal {
    ...
    public static int getDefaultPageSize() {
        synchronized (sLock) {
            if (sDefaultPageSize == 0) {
                ...
                sDefaultPageSize = new StatFs(getDataPathForBlockSizeCheck()).getBlockSize();
            }
    ...
    @RavenwoodReplace
    private static String getDataPathForBlockSizeCheck() {
        return "/data";
    }

    private static String getDataPathForBlockSizeCheck$ravenwood() {
        return "/tmp";
    }
