...
public final class ProxyOptions {
    ...
    static void apply(
        ...
        builder.setProxyOptions(
                org.chromium.net.ProxyOptions.fromProxyList(
                        proxies,
                        switch (options.getFallbackBehavior()) {
                            case ALL_PROXIES_FAILED_BEHAVIOR_DISALLOW_DIRECT -> org.chromium.net.ProxyOptions.ALL_PROXIES_FAILED_BEHAVIOR_DISALLOW_DIRECT;
                            case ALL_PROXIES_FAILED_BEHAVIOR_ALLOW_DIRECT -> org.chromium.net.ProxyOptions.ALL_PROXIES_FAILED_BEHAVIOR_ALLOW_DIRECT;
