...
public abstract class UrlRequest {
     ...
     * UrlRequest.Callback#onSucceeded}, {@link UrlRequest.Callback#onFailed} or {@link
     * UrlRequest.Callback#onCanceled}. It's also allowed to call this method in the terminal
     * callback itself.
     *
     * @throws IllegalStateException If called before the terminal callback is called.
     */
    // This method should have been final, but that would require a complete refactor of UrlRequest
    // to move the logic upward.
    @NonNull
