...
public abstract class BidirectionalStream {
    ...
    /**
     * Returns the detailed timing metrics for the request.
     *
     * <p>This method can be only called when the request has reached a terminal callback. This is
     * defined by the execution of one of the following callbacks: {@link
     * BidirectionalStream.Callback#onSucceeded}, {@link BidirectionalStream.Callback#onFailed} or
     * {@link BidirectionalStream.Callback#onCanceled}. It's also allowed to call this method in the
     * terminal callback itself.
     *
     * @throws IllegalStateException If called before the terminal callback is called.
     */
    // This method should have been final, but that would require a complete refactor of
    // BidirectionalStream to move the logic upward.
    @NonNull
    @FlaggedApi(Flags.FLAG_REQUEST_FINISHED_TIMINGS)
    public FinishedRequestTimings getFinishedRequestTimings() {
        throw new UnsupportedOperationException(
                "This should never happen as the impl is supposed to override this method.");
    }
}
