...
class UrlRequestWrapper extends android.net.http.UrlRequest {
    ...
    private final org.chromium.net.impl.CronetUrlRequest backend;
    ...
    public UrlRequestWrapper(
        ...
        // Downcast to CronetUrlRequest to access impl only methods (e.g. getRequestFinishedTimings)
        this.backend = (CronetUrlRequest) backend;
    ...
    public FinishedRequestTimings getFinishedRequestTimings() {
        return new FinishedRequestTimings(backend.getFinishedRequestTimings());
    }
}
