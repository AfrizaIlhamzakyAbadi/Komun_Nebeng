...
public class NetworkIdentity {
    ...
    public int hashCode() {
        ...
        result = 31 * result + mRatType;
        result = 31 * result + Objects.hashCode(mSubscriberId);
        result = 31 * result + Objects.hashCode(mWifiNetworkKey);
        result = 31 * result + Boolean.hashCode(mRoaming);
        result = 31 * result + Boolean.hashCode(mMetered);
        result = 31 * result + Boolean.hashCode(mDefaultNetwork);
        result = 31 * result + mOemManaged;
        result = 31 * result + mSubId;
        result = 31 * result + Long.hashCode(mTransportTypesBits);
        return result;
    }
