...
public class WifiConfiguration implements Parcelable {
    ...
    */
    ...
    /**
     * Uid of the Device Owner or Profile Owner managing this configuration.
     */
    @Hide
    public int managedUid = -1;
    ...
    /**
     * True if this configuration is a managed configuration.
     */
    private boolean mIsManaged = false;

    /**
     * Indicate whether the network is locked down by the administrator.
     * This field is only applicable for managed networks.
     */
    private boolean mIsLockedDown = false;
    ...
    public String toString() {
        ...
        sbuf.append(" mIsManaged=").append(mIsManaged).append("\n");
        sbuf.append(" mIsLockedDown=").append(mIsLockedDown).append("\n");
        sbuf.append(" managedUid=").append(managedUid).append("\n");
    ...
    public WifiConfiguration(@NonNull WifiConfiguration source) {
        if (source != null) {
            ...
            mIsLockedDown = source.mIsLockedDown;
            managedUid = source.managedUid;
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeBoolean(mIsManaged);
        dest.writeBoolean(mIsLockedDown);
        dest.writeInt(managedUid);
    }
    ...
    public static final @android.annotation.NonNull Creator<WifiConfiguration> CREATOR =
            new Creator<WifiConfiguration>() {
                public WifiConfiguration createFromParcel(Parcel in) {
                    ...
                    config.mIsManaged = in.readBoolean();
                    config.mIsLockedDown = in.readBoolean();
                    config.managedUid = in.readInt();
                    return config;
                }
    ...
    /**
     * Sets whether this configuration is a managed configuration.
     *
     * @param isManaged {@code true} if managed, {@code false} otherwise.
     */
    @Hide
    ...
    /**
     * Returns whether this configuration is a managed configuration.
     *
     * True if this configuration is a managed configuration.
     *
     * @return {@code true} if managed, {@code false} otherwise.
     */
    @FlaggedApi(Flags.FLAG_MANAGED_WIFI_FOR_MUM)
    public boolean isManaged() {
        return mIsManaged;
    }

    /**
     * Sets whether this configuration is a locked down configuration.
     *
     * @param isLockedDown {@code true} if locked down, {@code false} otherwise.
     */
    @FlaggedApi(Flags.FLAG_MANAGED_WIFI_FOR_MUM)
    public void setLockedDown(boolean isLockedDown) {
        mIsLockedDown = isLockedDown;
    }

    /**
     * Returns whether this configuration is a locked down configuration.
     *
     * This field is only applicable for managed networks. When a managed network is locked down,
     * modification is only allowed by the administrator who locked it down.
     *
     * @return {@code true} if locked down, {@code false} otherwise.
     */
    @FlaggedApi(Flags.FLAG_MANAGED_WIFI_FOR_MUM)
    public boolean isLockedDown() {
        return mIsLockedDown;
    }
}
