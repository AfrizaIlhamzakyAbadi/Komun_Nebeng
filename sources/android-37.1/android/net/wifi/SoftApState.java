...
public final class SoftApState implements Parcelable {
    ...
    final int mState;
    @WifiManager.SapStateReason
    final int mStateChangedReason;
    @Nullable
     ...
     * @param reason Failure or disable reason.
    ...
    public SoftApState(@WifiManager.WifiApState int state,
            @WifiManager.SapStateReason int reason,
            @Nullable TetheringManager.TetheringRequest tetheringRequest,
            @Nullable String iface) {
        mState = state;
        mStateChangedReason = reason;
    ...
    private SoftApState(@NonNull Parcel in) {
        mState = in.readInt();
        mStateChangedReason = in.readInt();
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeInt(mStateChangedReason);
        if (SdkLevel.isAtLeastV()) {
            // TetheringRequest is parcelable starting in V.
    ...
    /**
     * Get the state reason.
     *
     * @return One of {@link WifiManager.SapStateReason}.
     */
    @SystemApi
    @FlaggedApi(Flags.FLAG_SOFTAP_TRAFFIC_MONITOR)
    @WifiManager.SapStateReason
    public int getReason() {
        return mStateChangedReason;
    }
    ...
    public String toString() {
        return "SoftApState{"
                + "mState=" + mState
                + ", mStateChangedReason=" + mStateChangedReason
    ...
    public boolean equals(Object o) {
        ...
        return mState == stateInfo.mState && mStateChangedReason == stateInfo.mStateChangedReason
    ...
    @Override
    public int hashCode() {
        return Objects.hash(mState, mStateChangedReason, mTetheringRequest, mIface);
    }
}
