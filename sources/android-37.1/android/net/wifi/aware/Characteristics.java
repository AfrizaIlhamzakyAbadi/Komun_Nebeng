...
public final class Characteristics implements Parcelable {
    ...
    public static final String KEY_SUPPORTED_OFFLOAD_BOOTSTRAPPING_METHODS =
            "key_supported_offload_bootstrapping_methods";

    private final Bundle mCharacteristics;

    /**
     * : should not be created by apps
     */
    @Hide
    ...
    /**
     * Returns the supported bootstrapping methods for framework offloaded auto-pairing. Returns a
     * combination of the {@code PAIRING_BOOTSTRAPPING_*} bitmask constants from {@link
     * AwarePairingConfig}.
     */
    @FlaggedApi(Flags.FLAG_AWARE_AUTO_PAIRING)
    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    @AwarePairingConfig.OffloadedBootstrappingMethod
    public int getSupportedOffloadBootstrappingMethods() {
        if (!SdkLevel.isAtLeastU()) {
            throw new UnsupportedOperationException();
        }
        return mCharacteristics.getInt(KEY_SUPPORTED_OFFLOAD_BOOTSTRAPPING_METHODS);
    }
