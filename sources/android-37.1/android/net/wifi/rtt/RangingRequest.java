...
public final class RangingRequest implements Parcelable {
    ...
    public static final class Builder {
         ...
         *
         * Note: RTT burst size is primarily applicable to IEEE 802.11mc, but it can also
         * be used with IEEE 802.11az to generate multiple NTB ranging requests per
         * measurement. This is used when multiple very rapid range measurements are
         * needed to improve accuracy during motion, without the overhead of a new
         * application level ranging request.
         *
         * @param rttBurstSize The number of FTM packets, or NTB repetitions, used to estimate
         * a range.
