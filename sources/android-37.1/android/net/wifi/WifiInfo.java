...
public class WifiInfo implements TransportInfo, Parcelable {
    ...
    public WifiInfo() {
        ...
        mMaxSupportedRxLinkSpeed = LINK_SPEED_UNKNOWN;
        mMaxSupportedTxLinkSpeed = LINK_SPEED_UNKNOWN;
    }
    ...
    public static int convertSecurityTypeToDpmWifiSecurity(
            @WifiAnnotations.SecurityType int securityType, boolean isWepExcludedFromPersonal) {
        switch (securityType) {
            ...
            case SECURITY_TYPE_WAPI_PSK:
                return isWepExcludedFromPersonal ? DevicePolicyManager.WIFI_SECURITY_PERSONAL_WPA
    ...
    /**
     * Returns the rank of the security level. Higher rank means more secure.
     */
    @Hide
    public static int getSecurityLevelRank(int level) {
        return switch (level) {
            case DevicePolicyManager.WIFI_SECURITY_OPEN -> 0;
            case DevicePolicyManager.WIFI_SECURITY_PERSONAL -> 1;
            case DevicePolicyManager.WIFI_SECURITY_PERSONAL_WPA -> 2;
            case DevicePolicyManager.WIFI_SECURITY_ENTERPRISE_EAP -> 3;
            case DevicePolicyManager.WIFI_SECURITY_ENTERPRISE_192 -> 4;
            default -> -1;
        };
    }
