...
public final class NsdManager {
    ...
    public void discoverServices(@NonNull DiscoveryRequest discoveryRequest,
        ...
        try {
            mService.discoverServices(key, discoveryRequest, getDisplayId());
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
    ...
    public void registerServiceInfoCallback(@NonNull DiscoveryRequest discoveryRequest,
        ...
        int key = putListener(listener, executor, discoveryRequest);
        try {
            mService.registerServiceInfoCallbackWithRequest(key, discoveryRequest, getDisplayId());
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
    ...
    private int getDisplayId() {
        try {
            ...
            // Expected if the context does not have an associated display as per the API definition
            // Fall through with DEFAULT_DISPLAY
