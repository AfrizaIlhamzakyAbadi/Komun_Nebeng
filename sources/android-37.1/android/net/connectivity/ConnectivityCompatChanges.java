...
public final class ConnectivityCompatChanges {
    ...
    /**
     * Enforce cross-app communication restrictions over the loopback interface.
     *
     * <p>Apps targeting a release after C will require
     * {@link android.Manifest.permission#USE_LOOPBACK_INTERFACE} to use the loopback interface
     * to communicate with other apps. Loopback usage to communicate within the same app is not
     * restricted.
     *
     * <p>Apps targeting C or earlier will be allowed to continue using the loopback interface
     * if they request {@link android.Manifest.permission#INTERNET}.
     */
    @ChangeId
    @EnabledAfter(targetSdkVersion = Build.VERSION_CODES.CINNAMON_BUN)
    public static final long ENFORCE_LOOPBACK_RESTRICTIONS = 514327662L;
