...
public abstract class IkeIdentification {
    ...
    /**
     * Subject Alternative Name Type for RFC822 Email Address defined in RFC 5280
     */
    @Hide
    protected static final int SAN_TYPE_RFC822_NAME = 1;

    /**
     * Subject Alternative Name Type for DNS Name defined in RFC 5280
     */
    @Hide
    protected static final int SAN_TYPE_DNS = 2;

    /**
     * Subject Alternative Name Type for IP Address defined in RFC 5280
     */
    @Hide
