...
public final class IkeSessionParams {
    ...
    @IntDef({
        ...
        IKE_OPTION_MOBIKE_RETRANSMIT_SUSPENSION
    })
    ...
    /**
     * If set, the IKE library will suspend retransmissions when the underlying network is lost
     * during a MOBIKE-enabled session.
     *
     * <p>Retransmissions will remain suspended until a new network is set or the session is
     * terminated.
     */
    @Hide
    public static final int IKE_OPTION_MOBIKE_RETRANSMIT_SUSPENSION = 10;

    private static final int MIN_IKE_OPTION = IKE_OPTION_ACCEPT_ANY_REMOTE_ID;
    private static final int MAX_IKE_OPTION = IKE_OPTION_MOBIKE_RETRANSMIT_SUSPENSION;
