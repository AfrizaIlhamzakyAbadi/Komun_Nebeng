...
public final class LinkProperties implements Parcelable {
    ...
    /**
     * Returns true if this link has a global IPv6 address, regardless of whether it's preferred or
     * not.
     *
     * @return {@code true} if there is a global IPv6 address, {@code false} otherwise.
     */
    @Hide
    public boolean hasAnyGlobalIpv6Address() {
        for (LinkAddress address : mLinkAddresses) {
            if (address.getAddress() instanceof Inet6Address && address.isGlobalValid()) {
                return true;
            }
        }
        return false;
