...
public final class SatelliteManager {
    ...
    /**
     * The requested prioritized network scan failed.
     */
    @SystemApi
    @FlaggedApi(Flags.FLAG_SATELLITE_UPSELL_26Q4)
    public static final int SATELLITE_RESULT_PRIORITIZED_SCAN_FAILED = 31;
    ...
    @IntDef(prefix = {"SATELLITE_RESULT_"}, value = {
            ...
            SATELLITE_RESULT_PRIORITIZED_SCAN_FAILED
    })
