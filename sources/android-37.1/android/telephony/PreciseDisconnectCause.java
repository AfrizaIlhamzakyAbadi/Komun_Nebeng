...
public final class PreciseDisconnectCause {
    ...
    @IntDef(prefix = { "NOT_VALID", "NO_DISCONNECT_CAUSE_AVAILABLE", "UNOBTAINABLE_NUMBER",
            "NO_ROUTE_TO_DESTINATION", "CHANNEL_UNACCEPTABLE", "OPERATOR_DETERMINED_BARRING",
            "NORMAL", "BUSY", "NO_USER_RESPONDING", "NO_ANSWER_FROM_USER", "CALL_REJECTED",
            "NUMBER_CHANGED", "PREEMPTION", "DESTINATION_OUT_OF_ORDER", "INVALID_NUMBER_FORMAT",
            "FACILITY_REJECTED", "STATUS_ENQUIRY", "NORMAL_UNSPECIFIED", "NO_CIRCUIT_AVAIL",
            "NETWORK_OUT_OF_ORDER", "TEMPORARY_FAILURE", "SWITCHING_CONGESTION",
            "ACCESS_INFORMATION_DISCARDED", "CHANNEL_NOT_AVAIL",
            "RESOURCES_UNAVAILABLE_OR_UNSPECIFIED", "QOS_NOT_AVAIL",
            "REQUESTED_FACILITY_NOT_SUBSCRIBED", "INCOMING_CALLS_BARRED_WITHIN_CUG",
            "BEARER_CAPABILITY_NOT_AUTHORIZED", "BEARER_NOT_AVAIL",
            "SERVICE_OPTION_NOT_AVAILABLE", "BEARER_SERVICE_NOT_IMPLEMENTED", "ACM_LIMIT_EXCEEDED",
            "REQUESTED_FACILITY_NOT_IMPLEMENTED", "ONLY_DIGITAL_INFORMATION_BEARER_AVAILABLE",
            "SERVICE_OR_OPTION_NOT_IMPLEMENTED", "INVALID_TRANSACTION_IDENTIFIER",
            "USER_NOT_MEMBER_OF_CUG", "INCOMPATIBLE_DESTINATION", "SEMANTICALLY_INCORRECT_MESSAGE",
            "INVALID_MANDATORY_INFORMATION", "MESSAGE_TYPE_NON_IMPLEMENTED",
            "MESSAGE_TYPE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE", "INFORMATION_ELEMENT_NON_EXISTENT",
            "CONDITIONAL_IE_ERROR", "MESSAGE_NOT_COMPATIBLE_WITH_PROTOCOL_STATE",
            "RECOVERY_ON_TIMER_EXPIRED", "PROTOCOL_ERROR_UNSPECIFIED", "INTERWORKING_UNSPECIFIED",
            "CALL_BARRED", "FDN_BLOCKED", "IMSI_UNKNOWN_IN_VLR", "IMEI_NOT_ACCEPTED", "RADIO_OFF",
            "OUT_OF_SRV", "NO_VALID_SIM", "RADIO_INTERNAL_ERROR", "NETWORK_RESP_TIMEOUT",
            "NETWORK_REJECT", "RADIO_ACCESS_FAILURE", "RADIO_LINK_FAILURE", "RADIO_LINK_LOST",
            "RADIO_UPLINK_FAILURE", "RADIO_SETUP_FAILURE", "RADIO_RELEASE_NORMAL",
            "RADIO_RELEASE_ABNORMAL", "ACCESS_CLASS_BLOCKED", "NETWORK_DETACH",
            "EMERGENCY_TEMP_FAILURE", "EMERGENCY_PERM_FAILURE", "CDMA_LOCKED_UNTIL_POWER_CYCLE",
            "CDMA_DROP", "CDMA_INTERCEPT", "CDMA_REORDER", "CDMA_SO_REJECT", "CDMA_RETRY_ORDER",
            "CDMA_ACCESS_FAILURE", "CDMA_PREEMPTED", "CDMA_NOT_EMERGENCY", "CDMA_ACCESS_BLOCKED",
            "EMERGENCY_REDIAL_ON_IMS", "EMERGENCY_REDIAL_ON_VOWIFI", "OEM_CAUSE_1", "OEM_CAUSE_2",
            "OEM_CAUSE_3", "OEM_CAUSE_4", "OEM_CAUSE_5", "OEM_CAUSE_6", "OEM_CAUSE_7",
            "OEM_CAUSE_8", "OEM_CAUSE_9", "OEM_CAUSE_10", "OEM_CAUSE_11", "OEM_CAUSE_12",
            "OEM_CAUSE_13", "OEM_CAUSE_14", "OEM_CAUSE_15", "ERROR_UNSPECIFIED" },
            value = {
                    NOT_VALID,
                    ...
                    CDMA_NOT_EMERGENCY,
                    CDMA_ACCESS_BLOCKED,
                    EMERGENCY_REDIAL_ON_IMS,
                    EMERGENCY_REDIAL_ON_VOWIFI,
                    ERROR_UNSPECIFIED,
            })
