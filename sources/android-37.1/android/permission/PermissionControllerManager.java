...
public final class PermissionControllerManager {
    ...
    public void getRuntimePermissionBackup(@NonNull UserHandle user,
        ...
        Log.i(TAG, "Requesting runtime permission backup for user " + user.getIdentifier());
        ...
        mRemoteService.postAsync(service -> RemoteStream.receiveBytes(remotePipe -> {
            ...
            if (err != null) {
                ...
                Log.i(TAG, "Successfully retrieved permission backup: "
    ...
    public void stageAndApplyRuntimePermissionsBackup(@NonNull byte[] backup,
        ...
        Log.i(TAG, "Staging and applying permission backup for user " + user.getIdentifier()
            ...
            service.stageAndApplyRuntimePermissionsBackup(user, remotePipe);
                ...
                .whenComplete((nullResult, err) -> {
                    if (err != null) {
                        ...
                        Log.i(TAG, "Successfully sent permission backup to service");
                    }
                });
    }
    ...
    public void applyStagedRuntimePermissionBackup(@NonNull String packageName,
        ...
        Log.i(TAG, "Applying staged permission backup for " + packageName
        ...
        mRemoteService.postAsync(service -> {
            ...
            try {
                if (err != null) {
                    ...
                    Log.i(TAG, "Staged permission restore completed for " + packageName
                            + ". More pending: " + applyStagedRuntimePermissionBackupResult);
