...
public class AudioMix implements android.os.Parcelable
{
  ...
  /** Indicates if the caller use batch capture */
  public boolean isBatchCapture = false;
  ...
  @Override public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag)
  {
    ...
    _aidl_parcel.writeBoolean(mIsPersistent);
    _aidl_parcel.writeBoolean(isBatchCapture);
  ...
  public final void readFromParcel(android.os.Parcel _aidl_parcel)
  {
    ...
    try {
      ...
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      mIsPersistent = _aidl_parcel.readBoolean();
      if (_aidl_parcel.dataPosition() - _aidl_start_pos >= _aidl_parcelable_size) return;
      isBatchCapture = _aidl_parcel.readBoolean();
    } finally {
