...
public final class EventConstants {
    ...
    public static final String KEY_SERVICE_INFO_ID = Channels._ID;
    // A list of service list ids.
    public static final String KEY_SERVICE_LIST_IDS = Channels.COLUMN_CHANNEL_LIST_ID;
