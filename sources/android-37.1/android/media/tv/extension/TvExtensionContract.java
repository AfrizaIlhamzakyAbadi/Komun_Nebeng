...
public class TvExtensionContract {
    ...
    public static final class GlobalSettings implements KeyValueColumns {
        ...
        /**
         * Cam Type. CAM_TYPE_PCMCIA should have slot type PCMCIA, CAM_TYPE_USB should have slot
         * type USB, and CAM_TYPE_PCMCIA_USB should have slot type either PCMCIA or USB.
         * Value is a {@link CamType}.
         *
         */
    ...
    public static final class InteractiveSettings {
       ...
       /**
        *  Json string represent opapp launch parameters
        *
        */
        public static final String COLUMN_OPAPP_LAUNCH_PARAMS = "opapp_launch_params";

        /**
         * The value is a {@link AeasFilterAudience}.
         */
        @Hide
        public static final String COLUMN_AEAS_FILTER_AUDIENCE = "aeas_filter_audience";
        ...
        @Hide
        @IntDef({
            AEAS_FILTER_AUDIENCE_NONE,
            AEAS_FILTER_AUDIENCE_PUBLIC,
            AEAS_FILTER_AUDIENCE_RESTRICTED,
            AEAS_FILTER_AUDIENCE_PRIVATE
        })
        @Retention(RetentionPolicy.SOURCE)
        public @interface AeasFilterAudience {}

        /**
         * The value is a {@link AeasFilterPriority}.
         */
        @Hide
        public static final String COLUMN_AEAS_FILTER_PRIORITY = "aeas_filter_priority";
        ...
        @Hide
        @IntDef({
            AEAS_FILTER_PRIORITY_NONE,
            AEAS_FILTER_PRIORITY_MINOR,
            AEAS_FILTER_PRIORITY_LOW,
            AEAS_FILTER_PRIORITY_MODERATE,
            AEAS_FILTER_PRIORITY_HIGH,
            AEAS_FILTER_PRIORITY_MAXIMUM
        })
        @Retention(RetentionPolicy.SOURCE)
        public @interface AeasFilterPriority {}

        /**
         * Whether ATSC 3.0 is supported by hardware. Value is 0 (not supported) or 1 (supported).
         */
        @Hide
        public static final String COLUMN_IS_ATSC_3_0_SUPPORTED = "is_atsc_3_0_supported";

        /**
         * Whether AEAS is enabled. Value is 0 (disabled) or 1 (enabled).
         */
        @Hide
        public static final String COLUMN_IS_AEAS_ENABLED = "is_aeas_enabled";

        /**
         * Whether AEAS audio setting is enabled. Value is 0 (disabled, text only) or 1 (enabled).
         */
        @Hide
        public static final String COLUMN_IS_AEAS_AUDIO_ENABLED = "is_aeas_audio_enabled";

        /**
         * Whether signed signal check is enabled. Value is 0 (disabled) or 1 (enabled).
         */
        @Hide
        public static final String COLUMN_SIGNED_SIGNAL_CHECK_ENABLED =
                "signed_signal_check_enabled";
    }
