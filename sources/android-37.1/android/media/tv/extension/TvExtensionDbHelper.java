...
public class TvExtensionDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TvExtensionContract.INTERACTIVE_SETTING_TABLE + " ("
                ...
                + " TEXT,"
                + InteractiveSettings.COLUMN_AEAS_FILTER_AUDIENCE
                + " INTEGER DEFAULT 0, "
                + InteractiveSettings.COLUMN_AEAS_FILTER_PRIORITY
                + " INTEGER DEFAULT 0, "
                + InteractiveSettings.COLUMN_IS_ATSC_3_0_SUPPORTED
                + " INTEGER DEFAULT 0, "
                + InteractiveSettings.COLUMN_IS_AEAS_ENABLED
                + " INTEGER DEFAULT 1, "
                + InteractiveSettings.COLUMN_IS_AEAS_AUDIO_ENABLED
                + " INTEGER DEFAULT 0, "
                + InteractiveSettings.COLUMN_SIGNED_SIGNAL_CHECK_ENABLED
                + " INTEGER DEFAULT 0, "
                ...
                + "CHECK (" + InteractiveSettings.COLUMN_IS_ATSC_3_0_SUPPORTED
                + " BETWEEN 0 AND 1),"
                + "CHECK (" + InteractiveSettings.COLUMN_IS_AEAS_ENABLED
                + " BETWEEN 0 AND 1),"
                + "CHECK (" + InteractiveSettings.COLUMN_IS_AEAS_AUDIO_ENABLED
                + " BETWEEN 0 AND 1),"
                + "CHECK (" + InteractiveSettings.COLUMN_SIGNED_SIGNAL_CHECK_ENABLED
                + " BETWEEN 0 AND 1)"
                + ");");
