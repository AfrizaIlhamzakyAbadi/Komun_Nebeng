...
public final class TvInteractiveAppServiceInfo implements Parcelable {
    ...
    /**
     * TODO: include subtype in parseServiceMetadata
     */
    @Hide
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(prefix = { "INTERACTIVE_APP_SUBTYPE_" }, value = {
            INTERACTIVE_APP_SUBTYPE_NONE,
            INTERACTIVE_APP_SUBTYPE_HBBTV_COMMON,
            INTERACTIVE_APP_SUBTYPE_HBBTV_OPAPP,
            INTERACTIVE_APP_SUBTYPE_HBBTV_BI_ONLY
    })
    public @interface InteractiveAppSubtype {}

    /**
     * No interactive app subtype specified.
     */
    @Hide
    public static final int INTERACTIVE_APP_SUBTYPE_NONE = 0;

    /**
     * HbbTV interactive app subtype: common
     */
    @Hide
    public static final int INTERACTIVE_APP_SUBTYPE_HBBTV_COMMON = 1;

    /**
     * HbbTV interactive app subtype: Operator Application (OpApp)
     */
    @Hide
    public static final int INTERACTIVE_APP_SUBTYPE_HBBTV_OPAPP = 2;

    /**
     * HbbTV interactive app subtype: broadcast-independent (BI) only
     */
    @Hide
