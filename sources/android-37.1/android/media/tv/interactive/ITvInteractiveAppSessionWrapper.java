...
public class ITvInteractiveAppSessionWrapper
    ...
    public void executeMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case DO_STOP_INTERACTIVE_APP_WITH_HANDLE: {
                mSessionImpl.stopInteractiveApp((Integer) msg.obj);
                break;
            }
            ...
            case DO_NOTIFY_INTERACTIVE_APP_FOCUS_CHANGED: {
                mSessionImpl.notifyInteractiveAppFocusChanged((Boolean) msg.obj);
                break;
            }
            ...
            case DO_SEND_PARENTAL_CONTROL_APPROVAL_RESULT: {
                SomeArgs args = (SomeArgs) msg.obj;
                mSessionImpl.sendParentalControlApprovalResult((Integer) args.arg1,
                        (Boolean) args.arg2);
                args.recycle();
                break;
            }
            case DO_SEND_VERIFY_PARENTAL_CONTROL_PIN_RESULT: {
                SomeArgs args = (SomeArgs) msg.obj;
                mSessionImpl.sendVerifyParentalControlPinResult((Integer) args.arg1,
                        (Integer) args.arg2);
                args.recycle();
                break;
            }
            case DO_SEND_PARENTAL_CONTROL_PIN_LENGTH: {
                mSessionImpl.sendParentalControlPinLength((Integer) msg.obj);
                break;
            }
            case DO_SEND_SET_PARENTAL_CONTROL_PIN_RESULT: {
                mSessionImpl.sendSetParentalControlPinResult((Integer) msg.obj);
                break;
            }
            ...
            case DO_SELECT_INTERACTIVE_APP_STREAMING_TRACK: {
                SomeArgs args = (SomeArgs) msg.obj;
                mSessionImpl.selectInteractiveAppStreamingTrack((Integer) args.arg1,
                        (String) args.arg2);
                args.recycle();
                break;
            }
            case DO_REQUEST_OPERATOR_APP_SUPPORTED_STATUS: {
                mSessionImpl.requestOperatorAppSupportedStatus();
                break;
            }
            case DO_START_OPERATOR_APP: {
                SomeArgs args = (SomeArgs) msg.obj;
                mSessionImpl.startOperatorApp((OperatorAppServiceInfo) args.arg1,
                        (String) args.arg2, (String) args.arg3, (Bundle) args.arg4);
                args.recycle();
                break;
            }
            case DO_STOP_OPERATOR_APP: {
                mSessionImpl.stopOperatorApp((OperatorAppServiceInfo) msg.obj);
                break;
            }
            case DO_SWITCH_OPERATOR_APP_STATE: {
                SomeArgs args = (SomeArgs) msg.obj;
                mSessionImpl.switchOperatorAppState((OperatorAppServiceInfo) args.arg1,
                                (Integer) args.arg2);
                args.recycle();
                break;
            }
    ...
    @Override
    public void stopInteractiveAppWithHandle(int handle) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageO(DO_STOP_INTERACTIVE_APP_WITH_HANDLE, handle));
    }
    ...
    public void notifyInteractiveAppFocusChanged(boolean focusLost) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageO(DO_NOTIFY_INTERACTIVE_APP_FOCUS_CHANGED, focusLost));
    }
    ...
    public void sendParentalControlApprovalResult(int requestId, boolean granted) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageOO(DO_SEND_PARENTAL_CONTROL_APPROVAL_RESULT, requestId,
                        granted));
    }

    @Override
    public void sendVerifyParentalControlPinResult(int requestId, int result) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageOO(DO_SEND_VERIFY_PARENTAL_CONTROL_PIN_RESULT, requestId,
                        result));
    }
    ...
    public void sendParentalControlPinLength(int length) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageO(DO_SEND_PARENTAL_CONTROL_PIN_LENGTH, length));
    }

    @Override
    public void sendSetParentalControlPinResult(int result) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageO(DO_SEND_SET_PARENTAL_CONTROL_PIN_RESULT, result));
    }
    ...
    @Override
    public void selectInteractiveAppStreamingTrack(int type, String trackId) {
        mCaller.executeOrSendMessage(mCaller.obtainMessageOO(
                DO_SELECT_INTERACTIVE_APP_STREAMING_TRACK, type, trackId));
    }
    ...
    public void requestOperatorAppSupportedStatus() {
        mCaller.executeOrSendMessage(mCaller.obtainMessage(
                DO_REQUEST_OPERATOR_APP_SUPPORTED_STATUS));
    }

    @Override
    public void startOperatorApp(OperatorAppServiceInfo opAppInfo, String startupLocation,
                    String launchLocation, Bundle extra) {
        mCaller.executeOrSendMessage(mCaller.obtainMessageOOOO(DO_START_OPERATOR_APP, opAppInfo,
                startupLocation, launchLocation, extra));
    }

    @Override
    public void stopOperatorApp(OperatorAppServiceInfo opAppInfo) {
        mCaller.executeOrSendMessage(mCaller.obtainMessageO(DO_STOP_OPERATOR_APP, opAppInfo));
    }

    @Override
    public void switchOperatorAppState(OperatorAppServiceInfo opAppInfo, int state) {
        mCaller.executeOrSendMessage(
                mCaller.obtainMessageOO(DO_SWITCH_OPERATOR_APP_STATE, opAppInfo, state));
    }
