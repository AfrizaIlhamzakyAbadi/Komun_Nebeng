...
public class TvInteractiveAppView extends ViewGroup {
     ...
     * @param type The type of the TV interactive app.
     *
    ...
    public void prepareInteractiveApp(
        ...
        prepareInteractiveApp(iAppServiceId, type,
                TvInteractiveAppServiceInfo.INTERACTIVE_APP_SUBTYPE_NONE);
    }

    /**
     * Prepares the interactive application runtime environment of corresponding
     * {@link TvInteractiveAppService} with a designated subtype.
     *
     * @param iAppServiceId the interactive app service ID, which can be found in
     *                      {@link TvInteractiveAppServiceInfo#getId()}.
     * @param type The type of the TV interactive app.
     * @param subtype The subtype of the TV interactive app.
     * @see android.media.tv.interactive.TvInteractiveAppManager#getTvInteractiveAppServiceList()
     */
    @Hide
    public void prepareInteractiveApp(
        ...
        mSessionCallback = new MySessionCallback(iAppServiceId, type, subtype);
        if (mTvInteractiveAppManager != null) {
            mTvInteractiveAppManager.createSession(
                    iAppServiceId, type, subtype, mSessionCallback, mHandler);
        }
    }

    /**
     * Starts the interactive application.
     * <p>This set of API is meant for the interactive app host environment.
     */
     ...
     * <p>This is meant for interactive applications that are broadcasted and alive only within
     * the host environment. While having multiple apps within one host environment is possible,
     * only one app can be running at one time. {@link #stopInteractiveApp(int handle)} must be
     * called before calling this API if there is an app currently running.
     *
    ...
    /**
     * Stops an interactive application using the unique identifier to this session.
     * <p>This is meant for interactive applications that are broadcasted and alive only within
     ...
     */
    @Hide
    public void stopInteractiveApp(int handle) {
        if (DEBUG) {
            Log.d(TAG, "stopInteractiveApp");
        }
        if (mSession != null) {
            mSession.stopInteractiveApp(handle);
        }
    }
    ...
    public List<TvTrackInfo> getInteractiveAppStreamingTracks(int type) {
        if (mSession != null) {
            return mSession.getInteractiveAppStreamingTracks(type);
        }
        return null;
    }
    ...
    public String getSelectedInteractiveAppStreamingTrack(int type) {
        if (mSession != null) {
            return mSession.getSelectedInteractiveAppStreamingTrack(type);
        }
        return null;
    }
     ...
     * @see #getSelectedInteractiveAppStreamingTrack(int)
     */
    @Hide
    public void selectInteractiveAppStreamingTrack(int type, @Nullable String trackId) {
        if (DEBUG) {
            Log.d(TAG, "selectInteractiveAppStreamingTrack type=" + type + ", trackId=" + trackId);
        }
        if (mSession != null) {
            mSession.selectInteractiveAppStreamingTrack(type, trackId);
        }
    }
    ...
    public void notifyInteractiveAppFocusChanged(boolean focusLost) {
        ...
        if (mSession != null) {
            mSession.notifyInteractiveAppFocusChanged(focusLost);
        }
    }

    /**
     * Sends the parental control approval result.
     *
     * @param requestId The ID to identify the request.
     * @param granted {@code true} if the parental control approval is granted.
     */
    @Hide
    public void sendParentalControlApprovalResult(int requestId, boolean granted) {
        if (DEBUG) {
            Log.d(TAG, "sendParentalControlApprovalResult (requestId=" + requestId
                    + ", granted=" + granted + ")");
        }
        if (mSession != null) {
            mSession.sendParentalControlApprovalResult(requestId, granted);
        }
    }

    /**
     * Sends the parental control PIN verification result.
     *
     * @param requestId The ID to identify the request.
     * @param result the PIN verification result.
     */
    @Hide
    public void sendVerifyParentalControlPinResult(int requestId,
        ...
        if (mSession != null) {
            mSession.sendVerifyParentalControlPinResult(requestId, result);
        }
    }

    /**
     * Sends the parental control PIN length.
     *
     * @param length the PIN length.
     */
    @Hide
    public void sendParentalControlPinLength(int length) {
        if (DEBUG) {
            Log.d(TAG, "sendParentalControlPinLength (length=" + length + ")");
        }
        if (mSession != null) {
            mSession.sendParentalControlPinLength(length);
        }
    }

    /**
     * Sends the parental control PIN set result.
     *
     * @param result the PIN verification result.
     */
    @Hide
    public void sendSetParentalControlPinResult(
            @TvInteractiveAppManager.PinVerificationResult int result) {
        if (DEBUG) {
            Log.d(TAG, "sendSetParentalControlPinResult (result=" + result + ")");
        }
        if (mSession != null) {
            mSession.sendSetParentalControlPinResult(result);
        }
    }
    ...
    public void requestOperatorAppSupportedStatus() {
        if (DEBUG) {
            Log.d(TAG, "requestOperatorAppSupportedStatus");
        }
        if (mSession != null) {
            mSession.requestOperatorAppSupportedStatus();
        }
    }
    ...
    public void startOperatorApp(@NonNull OperatorAppServiceInfo opAppInfo,
        ...
        if (DEBUG) {
            Log.d(TAG, "startOperatorApp");
        }
        if (mSession != null) {
            mSession.startOperatorApp(opAppInfo, startupLocation, launchLocation, extra);
        }
    }
    ...
    public void stopOperatorApp(@NonNull OperatorAppServiceInfo opAppInfo) {
        if (DEBUG) {
            Log.d(TAG, "stopOperatorApp");
        }
        if (mSession != null) {
            mSession.stopOperatorApp(opAppInfo);
        }
    }
    ...
    public void switchOperatorAppState(@NonNull OperatorAppServiceInfo opAppInfo,
        ...
        if (DEBUG) {
            Log.d(TAG, "switchOperatorAppState");
        }
        if (mSession != null) {
            mSession.switchOperatorAppState(opAppInfo, state);
        }
    }
    ...
    public abstract static class TvInteractiveAppCallback {
        ...
        /**
         * This is called when the parental control approval is requested.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param requestId The ID to identify the request.
        ...
        public void onRequestParentalControlApproval(
                @NonNull String iAppServiceId,
                int requestId,
                boolean challengeUser,
                @NonNull Bundle keyValues) {
        }

        /**
         * This is called when the parental control approval is canceled.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         */
        @Hide
        public void onCancelParentalControlApproval(@NonNull String iAppServiceId) {
        }

        /**
         * This is called when the parental control PIN is requested to be verified.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param requestId The ID to identify the request.
         ...
         */
        @Hide
        public void onVerifyParentalControlPinRequest(@NonNull String iAppServiceId, int requestId,
                @NonNull String pcPin) {
        }

        /**
         * This is called when the parental control PIN length is requested.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         */
        @Hide
        public void onParentalControlPinLengthRequest(@NonNull String iAppServiceId) {
        }

        /**
         * This is called when the parental control PIN is requested to be set.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         ...
         */
        @Hide
        public void onSetParentalControlPin(@NonNull String iAppServiceId, @NonNull String oldPcPin,
         ...
         */
        @Hide
        public void onInteractiveAppStreamingTracksChanged(@NonNull String iAppServiceId,
         ...
         */
        @Hide
        public void onInteractiveAppStreamingTrackSelected(@NonNull String iAppServiceId,
                int type, @Nullable String trackId) {
        }
         ...
         */
        @Hide
        public void onStreamingPlaybackStatusChanged(@NonNull String iAppServiceId,
                @TvInteractiveAppManager.StreamingPlaybackStatus int status) {
        }
    }

    /**
     * Callback for Operator App events.
     */
    @Hide
    public abstract static class OperatorAppCallback extends TvInteractiveAppCallback {
        /**
         * This is called when Operator App supported status is received.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param supported {@code true} if Operator App is supported.
         */
        public void onOperatorAppSupportedStatus(@NonNull String iAppServiceId, boolean supported) {
        }

        /**
         * This is called when Operator App update request is received.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param opAppInfo The information of the Operator App service.
         * @param immediate {@code true} if the update is immediate.
         */
        public void onOperatorAppUpdateRequest(@NonNull String iAppServiceId,
                @NonNull OperatorAppServiceInfo opAppInfo, boolean immediate) {
        }

        /**
         * This is called when key set is changed.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param value The key set value.
         * @param otherKeys The other keys.
         */
        public void onKeySetChanged(@NonNull String iAppServiceId, int value,
                @NonNull int[] otherKeys) {
        }

        /**
         * This is called when UI elements are replaced.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param elements The UI elements to be replaced.
         */
        public void onReplaceUiElements(@NonNull String iAppServiceId, @NonNull int[] elements) {
        }

        /**
         * This is called when Operator App status is changed.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param opAppInfo The information of the Operator App service.
         ...
         * @param extra The extra information.
         */
        public void onOperatorAppStatusChanged(@NonNull String iAppServiceId,
        ...
        /**
         * This is called when Operator App state is changed.
         *
         * @param iAppServiceId The ID of the TV interactive app service bound to this view.
         * @param opAppInfo The information of the Operator App service.
         * @param state The app state.
         */
        public void onOperatorAppStateChanged(@NonNull String iAppServiceId,
                @NonNull OperatorAppServiceInfo opAppInfo,
                @OperatorAppServiceInfo.OperatorAppState int state) {
        }
    }
    ...
    private class MySessionCallback extends SessionCallback {
        ...
        MySessionCallback(String iAppServiceId, int type, int subtype) {
        ...
        public void onRequestParentalControlApproval(
            ...
            if (DEBUG) {
                Log.d(TAG, "onRequestParentalControlApproval (requestId=" + requestId
                        + ", challengeUser=" + challengeUser + ")");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onRequestParentalControlApproval - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onRequestParentalControlApproval(
                                        mIAppServiceId, requestId, challengeUser, keyValues);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onCancelParentalControlApproval(Session session) {
            if (DEBUG) {
                Log.d(TAG, "onCancelParentalControlApproval");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onCancelParentalControlApproval - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onCancelParentalControlApproval(mIAppServiceId);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onVerifyParentalControlPinRequest(Session session, int requestId,
                String pcPin) {
            if (DEBUG) {
                Log.d(TAG, "onVerifyParentalControlPinRequest (requestId=" + requestId + ")");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onVerifyParentalControlPinRequest - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onVerifyParentalControlPinRequest(
                                        mIAppServiceId, requestId, pcPin);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onParentalControlPinLengthRequest(Session session) {
            if (DEBUG) {
                Log.d(TAG, "onParentalControlPinLengthRequest");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onParentalControlPinLengthRequest - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onParentalControlPinLengthRequest(mIAppServiceId);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onSetParentalControlPin(Session session, String oldPcPin, String newPcPin) {
            if (DEBUG) {
                Log.d(TAG, "onSetParentalControlPin");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onSetParentalControlPin - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onSetParentalControlPin(
                                        mIAppServiceId, oldPcPin, newPcPin);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onInteractiveAppStreamingTracksChanged(Session session,
                @NonNull List<TvTrackInfo> tracks) {
            if (DEBUG) {
                Log.d(TAG, "onInteractiveAppStreamingTracksChanged");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onInteractiveAppStreamingTracksChanged - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onInteractiveAppStreamingTracksChanged(
                                        mIAppServiceId, tracks);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onInteractiveAppStreamingTrackSelected(Session session,
                int type, String trackId) {
            if (DEBUG) {
                Log.d(TAG, "onInteractiveAppStreamingTrackSelected");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onInteractiveAppStreamingTrackSelected - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onInteractiveAppStreamingTrackSelected(
                                        mIAppServiceId, type, trackId);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onStreamingPlaybackStatusChanged(Session session,
                @TvInteractiveAppManager.StreamingPlaybackStatus int status) {
            if (DEBUG) {
                Log.d(TAG, "onStreamingPlaybackStatusChanged");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onStreamingPlaybackStatusChanged - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                mCallback.onStreamingPlaybackStatusChanged(mIAppServiceId, status);
                            }
                        }
                    });
                }
        ...
        @Override
        public void onKeySetChanged(Session session, int value, int[] otherKeys) {
            if (DEBUG) {
                Log.d(TAG, "onKeySetChanged");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onKeySetChanged - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                        ...
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onKeySetChanged(
                                            mIAppServiceId, value, otherKeys);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
                        }
                    });
        ...
        @Override
        public void onReplaceUiElements(Session session, int[] elements) {
            if (DEBUG) {
                Log.d(TAG, "onReplaceUiElements");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onReplaceUiElements - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onReplaceUiElements(
                                            mIAppServiceId, elements);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
        ...
        @Override
        public void onOperatorAppSupportedStatus(Session session, boolean supported) {
            if (DEBUG) {
                Log.d(TAG, "onOperatorAppSupportedStatus");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onOperatorAppSupportedStatus - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onOperatorAppSupportedStatus(
                                            mIAppServiceId, supported);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
        ...
        @Override
        public void onOperatorAppUpdateRequest(Session session, OperatorAppServiceInfo opAppInfo,
                boolean immediate) {
            if (DEBUG) {
                Log.d(TAG, "onOperatorAppUpdateRequest");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onOperatorAppUpdateRequest - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onOperatorAppUpdateRequest(
                                            mIAppServiceId, opAppInfo, immediate);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
        ...
        @Override
        public void onOperatorAppStatusChanged(Session session, OperatorAppServiceInfo opAppInfo,
                int status, Bundle extra) {
            if (DEBUG) {
                Log.d(TAG, "onOperatorAppStatusChanged");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onOperatorAppStatusChanged - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onOperatorAppStatusChanged(
                                            mIAppServiceId, opAppInfo, status, extra);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
        ...
        @Override
        public void onOperatorAppStateChanged(Session session, OperatorAppServiceInfo opAppInfo,
                int state) {
            if (DEBUG) {
                Log.d(TAG, "onOperatorAppStateChanged");
            }
            if (this != mSessionCallback) {
                Log.w(TAG, "onOperatorAppStateChanged - session not created");
                return;
            }
            synchronized (mCallbackLock) {
                if (mCallbackExecutor != null) {
                    mCallbackExecutor.execute(() -> {
                        synchronized (mCallbackLock) {
                            if (mCallback != null) {
                                if (mCallback instanceof OperatorAppCallback) {
                                    ((OperatorAppCallback) mCallback).onOperatorAppStateChanged(
                                            mIAppServiceId, opAppInfo, state);
                                } else {
                                    Log.e(TAG, "mCallback is not OperatorAppCallback");
                                }
                            }
