...
public final class MediaSession {
    ...
    public void setMetadata(@Nullable MediaMetadata metadata) {
        ...
        if (metadata != null) {
            // build a new metadata with bitmaps scaled to mMaxBitmapSize only when
            // the metadata has a bitmap dimension limit larger than mMaxBitmapSize
            if (metadata.getBitmapDimensionLimit() > mMaxBitmapSize) {
