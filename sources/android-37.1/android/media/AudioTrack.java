                                 ...
                                 , VolumeAutomation
{
    ...
    public void setOffloadEndOfStream() {
        ...
        synchronized (mPlayStateLock) {
            native_set_offload_end_of_stream();
    ...
    */
     ...
     * @return the actual flushed position.
     * @throws IllegalArgumentException if {@code accuracy} is not valid, or
     *     {@code positionInFrames} is negative.
     * @throws IllegalStateException if the AudioTrack is not initialized.
     * @throws IllegalStateException when accuracy is specified as
     *     {@link FLUSH_FROM_ACCURACY_EXACT} but the requested position is not between
     *     the rendered position and the written position. Call {@link #getTimestamp} to
     *     query the rendered position and {@link #getWrittenFramesCount} for the written
     *     position.
    ...
    */
    ...
    private native void native_set_offload_end_of_stream();
