 ...
 * Using: aidl --lang=java --structured --version 5 --hash 65ce17da33245aaa09abd506174f551debd63a03 --stability vintf --min_sdk_version 29 --ninja -d out/soong/.intermediates/system/hardware/interfaces/media/android.media.audio.common.types-V5-java-source/gen/android/media/audio/common/AudioChannelLayout.java.d -o out/soong/.intermediates/system/hardware/interfaces/media/android.media.audio.common.types-V5-java-source/gen -Nsystem/hardware/interfaces/media/aidl_api/android.media.audio.common.types/5 system/hardware/interfaces/media/aidl_api/android.media.audio.common.types/5/android/media/audio/common/AudioChannelLayout.aidl
 *
...
public final class AudioChannelLayout implements android.os.Parcelable {
  ...
  public final static int acnMask = 5;  // int acnMask;
  ...
  public static AudioChannelLayout acnMask(int _value) {
    return new AudioChannelLayout(acnMask, _value);
  }
  ...
  public void setAcnMask(int _value) {
    _set(acnMask, _value);
  }
  ...
  public final void writeToParcel(android.os.Parcel _aidl_parcel, int _aidl_flag) {
    ...
    case voiceMask:
      ...
      break;
    case acnMask:
      _aidl_parcel.writeInt(getAcnMask());
      break;
    }
  }
  ...
  public static final int ACN_CHANNEL_COUNT_BIT_MASK = 255;
  public static final int ACN_SOURCE_LAYOUT_BIT_SHIFT = 8;
  public static final int ACN_SOURCE_LAYOUT_BIT_MASK = 3840;
  ...
  public String toString() {
    ...
    case acnMask: return "AudioChannelLayout.acnMask(" + (getAcnMask()) + ")";
    }
  ...
  public static class Ambisonics implements android.os.Parcelable
  {
    ...
    public static final android.os.Parcelable.Creator<Ambisonics> CREATOR = new android.os.Parcelable.Creator<Ambisonics>() {
      @Override
      public Ambisonics createFromParcel(android.os.Parcel _aidl_source) {
        Ambisonics _aidl_out = new Ambisonics();
        _aidl_out.readFromParcel(_aidl_source);
        return _aidl_out;
      }
      @Override
      public Ambisonics[] newArray(int _aidl_size) {
        return new Ambisonics[_aidl_size];
      }
    };
    ...
    public static final byte MIN_ORDER = 0;
    public static final byte MAX_ORDER = 14;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_0 = 1;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_1 = 4;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_2 = 9;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_3 = 16;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_4 = 25;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_5 = 36;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_6 = 49;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_7 = 64;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_8 = 81;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_9 = 100;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_10 = 121;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_11 = 144;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_12 = 169;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_13 = 196;
    public static final int FULL_SPHERE_CHANNEL_COUNT_ORDER_14 = 225;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_0 = 1;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_1 = 3;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_2 = 5;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_3 = 7;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_4 = 9;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_5 = 11;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_6 = 13;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_7 = 15;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_8 = 17;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_9 = 19;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_10 = 21;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_11 = 23;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_12 = 25;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_13 = 27;
    public static final int HORIZONTAL_CHANNEL_COUNT_ORDER_14 = 29;
    public static final int MIN_CHANNEL_COUNT = 1;
    public static final int MAX_CHANNEL_COUNT = 225;
    @Override
    public int describeContents() {
      int _mask = 0;
      return _mask;
    }
    public static @interface SourceLayout {
