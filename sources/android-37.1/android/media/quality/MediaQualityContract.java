...
public class MediaQualityContract {
    ...
    public static final class SoundQuality {
        ...
        @Hide
        @Retention(RetentionPolicy.SOURCE)
        @IntDef(prefix = "DOLBY_SOUND_MODE_", value = {
                DOLBY_SOUND_MODE_GAME,
                DOLBY_SOUND_MODE_MOVIE,
                DOLBY_SOUND_MODE_MUSIC,
                DOLBY_SOUND_MODE_NEWS,
        ...
        public @interface DolbySoundMode {}

        /**
         * Dolby Sound Mode: Optimized for gaming content.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_GAME = 0;

        /**
         * Dolby Sound Mode: Optimized for movies.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_MOVIE = 1;

        /**
         * Dolby Sound Mode: Optimized for music.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_MUSIC = 2;

        /**
         * Dolby Sound Mode: Optimized for news and dialogue.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_NEWS = 3;

        /**
         * Dolby Sound Mode: Simulates a stadium environment.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_STADIUM = 4;

        /**
         * Dolby Sound Mode: Standard/Neutral profile.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        ...
        /**
         * Dolby Sound Mode: User-customized settings.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_MEDIA_QUALITY_FW_D)
        public static final int DOLBY_SOUND_MODE_USER = 6;
