...
public interface IMediaQualityManager extends android.os.IInterface
{
  ...
  public static class Default implements android.media.quality.IMediaQualityManager
  {
    ...
    @Override public void updatePictureProfileVariant(java.lang.String profileId, java.lang.String streamStatus, android.os.PersistableBundle params, int userId) throws android.os.RemoteException
    {
    }
    ...
    @Override public android.media.quality.DolbyAudioProcessingCapabilities getDolbyAudioProcessingCapabilities(int userId) throws android.os.RemoteException
    {
      return null;
    }
    @Override public android.media.quality.DolbyAudioProcessingSettings getDolbyAudioProcessingSettings(int userId) throws android.os.RemoteException
    {
      return null;
    }
    @Override public void setDolbyAudioProcessingSettings(android.media.quality.DolbyAudioProcessingSettings settings, int userId) throws android.os.RemoteException
    {
    }
    @Override public boolean setPanelMute(boolean enabled, int userId) throws android.os.RemoteException
    {
      return false;
    }
    @Override public boolean isPanelMuted(int userId) throws android.os.RemoteException
    {
      return false;
    }
    @Override public android.media.quality.DtsVirtualXCapabilities getDtsVirtualXCapabilities(int userId) throws android.os.RemoteException
    {
      return null;
    }
    @Override public android.media.quality.DtsVirtualXSettings getDtsVirtualXSettings(int userId) throws android.os.RemoteException
    {
      return null;
    }
    @Override public void setDtsVirtualXSettings(android.media.quality.DtsVirtualXSettings settings, int userId) throws android.os.RemoteException
    {
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.quality.IMediaQualityManager
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_updatePictureProfileVariant:
        {
          java.lang.String _arg0;
          _arg0 = data.readString();
          ...
          _arg3 = data.readInt();
          data.enforceNoDataAvail();
          this.updatePictureProfileVariant(_arg0, _arg1, _arg2, _arg3);
          reply.writeNoException();
          break;
        }
        ...
        case TRANSACTION_getDolbyAudioProcessingCapabilities:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.quality.DolbyAudioProcessingCapabilities _result = this.getDolbyAudioProcessingCapabilities(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_getDolbyAudioProcessingSettings:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.quality.DolbyAudioProcessingSettings _result = this.getDolbyAudioProcessingSettings(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_setDolbyAudioProcessingSettings:
        {
          android.media.quality.DolbyAudioProcessingSettings _arg0;
          _arg0 = data.readTypedObject(android.media.quality.DolbyAudioProcessingSettings.CREATOR);
          int _arg1;
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.setDolbyAudioProcessingSettings(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_setPanelMute:
        {
          boolean _arg0;
          _arg0 = data.readBoolean();
          int _arg1;
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          boolean _result = this.setPanelMute(_arg0, _arg1);
          reply.writeNoException();
          reply.writeBoolean(_result);
          break;
        }
        case TRANSACTION_isPanelMuted:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          boolean _result = this.isPanelMuted(_arg0);
          reply.writeNoException();
          reply.writeBoolean(_result);
          break;
        }
        case TRANSACTION_getDtsVirtualXCapabilities:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.quality.DtsVirtualXCapabilities _result = this.getDtsVirtualXCapabilities(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_getDtsVirtualXSettings:
        {
          int _arg0;
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          android.media.quality.DtsVirtualXSettings _result = this.getDtsVirtualXSettings(_arg0);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        case TRANSACTION_setDtsVirtualXSettings:
        {
          android.media.quality.DtsVirtualXSettings _arg0;
          _arg0 = data.readTypedObject(android.media.quality.DtsVirtualXSettings.CREATOR);
          int _arg1;
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.setDtsVirtualXSettings(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
        default:
    ...
    private static final class Proxy implements android.media.quality.IMediaQualityManager
    {
      ...
      @Override public void updatePictureProfileVariant(java.lang.String profileId, java.lang.String streamStatus, android.os.PersistableBundle params, int userId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(streamStatus);
          _data.writeTypedObject(params, 0);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_updatePictureProfileVariant, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public android.media.quality.DolbyAudioProcessingCapabilities getDolbyAudioProcessingCapabilities(int userId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.quality.DolbyAudioProcessingCapabilities _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDolbyAudioProcessingCapabilities, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.quality.DolbyAudioProcessingCapabilities.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public android.media.quality.DolbyAudioProcessingSettings getDolbyAudioProcessingSettings(int userId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.quality.DolbyAudioProcessingSettings _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDolbyAudioProcessingSettings, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.quality.DolbyAudioProcessingSettings.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public void setDolbyAudioProcessingSettings(android.media.quality.DolbyAudioProcessingSettings settings, int userId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeTypedObject(settings, 0);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setDolbyAudioProcessingSettings, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public boolean setPanelMute(boolean enabled, int userId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeBoolean(enabled);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setPanelMute, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readBoolean();
        }
        finally {
      ...
      @Override public boolean isPanelMuted(int userId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_isPanelMuted, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readBoolean();
        }
        finally {
      ...
      @Override public android.media.quality.DtsVirtualXCapabilities getDtsVirtualXCapabilities(int userId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.quality.DtsVirtualXCapabilities _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDtsVirtualXCapabilities, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.quality.DtsVirtualXCapabilities.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public android.media.quality.DtsVirtualXSettings getDtsVirtualXSettings(int userId) throws android.os.RemoteException
      {
        android.os.Parcel _data = android.os.Parcel.obtain(asBinder());
        android.os.Parcel _reply = android.os.Parcel.obtain();
        android.media.quality.DtsVirtualXSettings _result;
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDtsVirtualXSettings, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readTypedObject(android.media.quality.DtsVirtualXSettings.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public void setDtsVirtualXSettings(android.media.quality.DtsVirtualXSettings settings, int userId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeTypedObject(settings, 0);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setDtsVirtualXSettings, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
    ...
    static final int TRANSACTION_updatePictureProfileVariant = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
    static final int TRANSACTION_removePictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_getDefaultPictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_getDefaultSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
    static final int TRANSACTION_setDefaultPictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
    static final int TRANSACTION_setMutedColor = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
    static final int TRANSACTION_setColorMuteEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
    static final int TRANSACTION_getPictureProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
    static final int TRANSACTION_getPictureProfilesByPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
    static final int TRANSACTION_getAvailablePictureProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
    static final int TRANSACTION_getPictureProfilePackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
    static final int TRANSACTION_getPictureProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
    static final int TRANSACTION_setPictureProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
    static final int TRANSACTION_getPictureProfileHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
    static final int TRANSACTION_getPictureProfileHandles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
    static final int TRANSACTION_changeStreamStatus = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
    static final int TRANSACTION_getPictureProfileHandleValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
    static final int TRANSACTION_getDefaultPictureProfileHandleValue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
    static final int TRANSACTION_notifyPictureProfileHandleSelection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
    static final int TRANSACTION_getPictureProfileForTvInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
    static final int TRANSACTION_getCurrentPictureProfileHandleForTvInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
    static final int TRANSACTION_getCurrentPictureProfileForTvInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
    static final int TRANSACTION_getAllPictureProfilesForTvInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
    static final int TRANSACTION_createSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
    static final int TRANSACTION_updateSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_removeSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_setDefaultSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_getSoundProfile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_getSoundProfilesByPackage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_getAvailableSoundProfiles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    static final int TRANSACTION_getSoundProfilePackageNames = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
    static final int TRANSACTION_getSoundProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
    static final int TRANSACTION_setSoundProfileAllowList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
    static final int TRANSACTION_getSoundProfileHandle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
    static final int TRANSACTION_getSoundProfileHandles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
    static final int TRANSACTION_registerPictureProfileCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
    static final int TRANSACTION_registerSoundProfileCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
    static final int TRANSACTION_registerAmbientBacklightCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
    static final int TRANSACTION_registerActiveProcessingPictureListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
    static final int TRANSACTION_getParameterCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
    static final int TRANSACTION_isSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
    static final int TRANSACTION_setAutoPictureQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
    static final int TRANSACTION_isAutoPictureQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
    static final int TRANSACTION_setSuperResolutionEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
    static final int TRANSACTION_isSuperResolutionEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
    static final int TRANSACTION_setAutoSoundQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
    static final int TRANSACTION_isAutoSoundQualityEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
    static final int TRANSACTION_usesDisplayTechnology = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
    static final int TRANSACTION_setAmbientBacklightSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
    static final int TRANSACTION_setAmbientBacklightEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
    static final int TRANSACTION_isAmbientBacklightEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
    static final int TRANSACTION_getEqualizerCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
    static final int TRANSACTION_getEqualizerSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
    static final int TRANSACTION_setEqualizerSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
    static final int TRANSACTION_getDolbyAudioProcessingCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
    static final int TRANSACTION_getDolbyAudioProcessingSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
    static final int TRANSACTION_setDolbyAudioProcessingSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
    static final int TRANSACTION_setPanelMute = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
    static final int TRANSACTION_isPanelMuted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
    static final int TRANSACTION_getDtsVirtualXCapabilities = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
    static final int TRANSACTION_getDtsVirtualXSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
    static final int TRANSACTION_setDtsVirtualXSettings = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
  }
  @android.annotation.Hide
  ...
  public void updatePictureProfileVariant(java.lang.String profileId, java.lang.String streamStatus, android.os.PersistableBundle params, int userId) throws android.os.RemoteException;
  ...
  public android.media.quality.DolbyAudioProcessingCapabilities getDolbyAudioProcessingCapabilities(int userId) throws android.os.RemoteException;
  public android.media.quality.DolbyAudioProcessingSettings getDolbyAudioProcessingSettings(int userId) throws android.os.RemoteException;
  public void setDolbyAudioProcessingSettings(android.media.quality.DolbyAudioProcessingSettings settings, int userId) throws android.os.RemoteException;
  public boolean setPanelMute(boolean enabled, int userId) throws android.os.RemoteException;
  public boolean isPanelMuted(int userId) throws android.os.RemoteException;
  public android.media.quality.DtsVirtualXCapabilities getDtsVirtualXCapabilities(int userId) throws android.os.RemoteException;
  public android.media.quality.DtsVirtualXSettings getDtsVirtualXSettings(int userId) throws android.os.RemoteException;
  public void setDtsVirtualXSettings(android.media.quality.DtsVirtualXSettings settings, int userId) throws android.os.RemoteException;
}
