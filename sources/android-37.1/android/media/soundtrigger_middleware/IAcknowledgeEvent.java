 ...
 * Using: aidl --lang=java -Weverything -Wno-missing-permission-annotation --min_sdk_version current -pout/soong/.intermediates/system/hardware/interfaces/media/android.media.soundtrigger.types_interface/4/preprocessed.aidl -pout/soong/.intermediates/system/hardware/interfaces/media/android.media.audio.common.types_interface/5/preprocessed.aidl -pout/soong/.intermediates/frameworks/base/media/media_permission-aidl_interface/preprocessed.aidl --ninja -d out/soong/.intermediates/frameworks/base/media/soundtrigger_middleware-aidl-java-source/gen/android/media/soundtrigger_middleware/IAcknowledgeEvent.java.d -o out/soong/.intermediates/frameworks/base/media/soundtrigger_middleware-aidl-java-source/gen -Nframeworks/base/media/aidl frameworks/base/media/aidl/android/media/soundtrigger_middleware/IAcknowledgeEvent.aidl
 *
...
public interface IAcknowledgeEvent extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.soundtrigger_middleware.IAcknowledgeEvent
  {
    ...
    private static final class Proxy implements android.media.soundtrigger_middleware.IAcknowledgeEvent
    {
