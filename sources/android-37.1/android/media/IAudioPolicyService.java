...
public interface IAudioPolicyService extends android.os.IInterface
{
  ...
  public static class Default implements android.media.IAudioPolicyService
  {
     ...
     */
    @Override public void setVolumeIndexForGroup(int groupId, int uid, android.media.audio.common.AudioDeviceDescription device, int index, boolean muted) throws android.os.RemoteException
    {
    }
    /**
    ...
    /** product_strategy_t */
    @Override public int getStrategyForStream(int stream, int uid) throws android.os.RemoteException
    {
      return 0;
    }
    /**
     ...
     * UID / User ID)
     */
    @Override public android.media.audio.common.AudioDevice[] getDevicesForAttributes(android.media.audio.common.AudioAttributes attr, int uid, boolean forVolume) throws android.os.RemoteException
    {
      return null;
    }
    /** audio_io_handle_t */
     ...
     * number of elements without actually retrieving them.
     */
    @Override public int listAudioPorts(int role, int type, android.media.AudioPortFw[] ports) throws android.os.RemoteException
    {
      return 0;
    }
    /**
     ...
     * number of elements without actually retrieving them.
     */
    @Override public int listAudioPatches(android.media.AudioPatchFw[] patches) throws android.os.RemoteException
    {
      return 0;
    }
    ...
    @Override public void setProductStrategiesZoneIdForUserId(int userId, int zoneId) throws android.os.RemoteException
    {
    }
    @Override public void resetProductStrategiesZoneIdForUserId(int userId) throws android.os.RemoteException
    {
    }
    /** product_strategy_t */
     ...
     */
    @Override public int getDirectPlaybackSupport(android.media.audio.common.AudioAttributes attr, int uid, android.media.audio.common.AudioConfig config) throws android.os.RemoteException
    {
      return 0;
    }
    /**
     ...
     * UID / User ID).
     */
    @Override public android.media.audio.common.AudioProfile[] getDirectProfilesForAttributes(android.media.audio.common.AudioAttributes attr, int uid) throws android.os.RemoteException
    {
      return null;
    }
    /**
     ...
     * @param portId the port id of the device to be routed.
     */
    @Override public android.media.AudioMixerAttributesInternal getPreferredMixerAttributes(android.media.audio.common.AudioAttributes attr, int portId, int uid) throws android.os.RemoteException
    {
      return null;
    }
    /**
    ...
    @Override public void setHardeningOverride(byte hardeningOverride) throws android.os.RemoteException
    {
    }
    /**
     ...
     */
    @Override public int getFlushFromFrameSupport(android.media.audio.common.AudioConfigBase config, android.media.audio.common.AudioAttributes attributes, int uid, int flags) throws android.os.RemoteException
    {
      return 0;
    }
    /** Returns if mmap path is preferred for pcm offload playback. */
    @Override public boolean useMmapForPcmOffload() throws android.os.RemoteException
    {
      return false;
    }
    @Override
  ...
  public static abstract class Stub extends android.os.Binder implements android.media.IAudioPolicyService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_setVolumeIndexForGroup:
        {
          ...
          data.enforceNoDataAvail();
          this.setVolumeIndexForGroup(_arg0, _arg1, _arg2, _arg3, _arg4);
          reply.writeNoException();
          break;
        }
        ...
        case TRANSACTION_getStrategyForStream:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          int _result = this.getStrategyForStream(_arg0, _arg1);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_getDevicesForAttributes:
        {
          ...
          data.enforceNoDataAvail();
          android.media.audio.common.AudioDevice[] _result = this.getDevicesForAttributes(_arg0, _arg1, _arg2);
          reply.writeNoException();
        ...
        case TRANSACTION_listAudioPorts:
        {
          ...
          int _arg1;
          _arg1 = data.readInt();
          android.media.AudioPortFw[] _arg2;
          ...
          if (_arg2_length > 1000000) {
            ...
            _arg2 = new android.media.AudioPortFw[_arg2_length];
          }
          data.enforceNoDataAvail();
          int _result = this.listAudioPorts(_arg0, _arg1, _arg2);
          reply.writeNoException();
          reply.writeInt(_result);
        ...
        case TRANSACTION_listAudioPatches:
        {
          ...
          if (_arg0_length > 1000000) {
            ...
            _arg0 = new android.media.AudioPatchFw[_arg0_length];
          }
          data.enforceNoDataAvail();
          int _result = this.listAudioPatches(_arg0);
          reply.writeNoException();
          reply.writeInt(_result);
          reply.writeTypedArray(_arg0, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        ...
        case TRANSACTION_setProductStrategiesZoneIdForUserId:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          this.setProductStrategiesZoneIdForUserId(_arg0, _arg1);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_resetProductStrategiesZoneIdForUserId:
        {
          ...
          _arg0 = data.readInt();
          data.enforceNoDataAvail();
          this.resetProductStrategiesZoneIdForUserId(_arg0);
          reply.writeNoException();
          break;
        }
        ...
        case TRANSACTION_getDirectPlaybackSupport:
        {
          ...
          int _arg1;
          _arg1 = data.readInt();
          android.media.audio.common.AudioConfig _arg2;
          _arg2 = data.readTypedObject(android.media.audio.common.AudioConfig.CREATOR);
          data.enforceNoDataAvail();
          int _result = this.getDirectPlaybackSupport(_arg0, _arg1, _arg2);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_getDirectProfilesForAttributes:
        {
          ...
          _arg1 = data.readInt();
          data.enforceNoDataAvail();
          android.media.audio.common.AudioProfile[] _result = this.getDirectProfilesForAttributes(_arg0, _arg1);
          reply.writeNoException();
          reply.writeTypedArray(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        ...
        case TRANSACTION_getPreferredMixerAttributes:
        {
          ...
          _arg2 = data.readInt();
          data.enforceNoDataAvail();
          android.media.AudioMixerAttributesInternal _result = this.getPreferredMixerAttributes(_arg0, _arg1, _arg2);
          reply.writeNoException();
          reply.writeTypedObject(_result, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
          break;
        }
        ...
        case TRANSACTION_setHardeningOverride:
        {
          byte _arg0;
          _arg0 = data.readByte();
          data.enforceNoDataAvail();
          this.setHardeningOverride(_arg0);
          reply.writeNoException();
          break;
        }
        case TRANSACTION_getFlushFromFrameSupport:
        {
          android.media.audio.common.AudioConfigBase _arg0;
          _arg0 = data.readTypedObject(android.media.audio.common.AudioConfigBase.CREATOR);
          android.media.audio.common.AudioAttributes _arg1;
          ...
          _arg3 = data.readInt();
          data.enforceNoDataAvail();
          int _result = this.getFlushFromFrameSupport(_arg0, _arg1, _arg2, _arg3);
          reply.writeNoException();
          reply.writeInt(_result);
          break;
        }
        case TRANSACTION_useMmapForPcmOffload:
        {
          boolean _result = this.useMmapForPcmOffload();
          reply.writeNoException();
          reply.writeBoolean(_result);
          break;
        }
    ...
    private static final class Proxy implements android.media.IAudioPolicyService
    {
      ...
      @Override public void setProductStrategiesZoneIdForUserId(int userId, int zoneId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setProductStrategiesZoneIdForUserId, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void resetProductStrategiesZoneIdForUserId(int userId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(userId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_resetProductStrategiesZoneIdForUserId, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void setHardeningOverride(byte hardeningOverride) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeByte(hardeningOverride);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setHardeningOverride, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public int getFlushFromFrameSupport(android.media.audio.common.AudioConfigBase config, android.media.audio.common.AudioAttributes attributes, int uid, int flags) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeInt(uid);
          _data.writeInt(flags);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getFlushFromFrameSupport, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readInt();
        }
        finally {
      ...
      @Override public boolean useMmapForPcmOffload() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_useMmapForPcmOffload, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readBoolean();
        }
        finally {
    ...
    static final int TRANSACTION_getMaxVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
    static final int TRANSACTION_getMinVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_setMaxVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_setMinVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_setVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_getVolumeIndexForGroup = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    ...
    static final int TRANSACTION_setProductStrategiesZoneIdForUserId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
    static final int TRANSACTION_resetProductStrategiesZoneIdForUserId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
    static final int TRANSACTION_getProductStrategyFromAudioAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 91);
    static final int TRANSACTION_listAudioVolumeGroups = (android.os.IBinder.FIRST_CALL_TRANSACTION + 92);
    static final int TRANSACTION_getVolumeGroupFromAudioAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 93);
    static final int TRANSACTION_setRttEnabled = (android.os.IBinder.FIRST_CALL_TRANSACTION + 94);
    static final int TRANSACTION_isCallScreenModeSupported = (android.os.IBinder.FIRST_CALL_TRANSACTION + 95);
    static final int TRANSACTION_setDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 96);
    static final int TRANSACTION_removeDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 97);
    static final int TRANSACTION_clearDevicesRoleForStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 98);
    static final int TRANSACTION_getDevicesForRoleAndStrategy = (android.os.IBinder.FIRST_CALL_TRANSACTION + 99);
    static final int TRANSACTION_setDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 100);
    static final int TRANSACTION_addDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 101);
    static final int TRANSACTION_removeDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 102);
    static final int TRANSACTION_clearDevicesRoleForCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 103);
    static final int TRANSACTION_getDevicesForRoleAndCapturePreset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 104);
    static final int TRANSACTION_registerSoundTriggerCaptureStateListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 105);
    static final int TRANSACTION_getSpatializer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 106);
    static final int TRANSACTION_canBeSpatialized = (android.os.IBinder.FIRST_CALL_TRANSACTION + 107);
    static final int TRANSACTION_getDirectPlaybackSupport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 108);
    static final int TRANSACTION_getDirectProfilesForAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 109);
    static final int TRANSACTION_getSupportedMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 110);
    static final int TRANSACTION_setPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 111);
    static final int TRANSACTION_getPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 112);
    static final int TRANSACTION_clearPreferredMixerAttributes = (android.os.IBinder.FIRST_CALL_TRANSACTION + 113);
    static final int TRANSACTION_getPermissionController = (android.os.IBinder.FIRST_CALL_TRANSACTION + 114);
    static final int TRANSACTION_getMmapPolicyInfos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 115);
    static final int TRANSACTION_getMmapPolicyForDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 116);
    static final int TRANSACTION_setHardeningOverride = (android.os.IBinder.FIRST_CALL_TRANSACTION + 117);
    static final int TRANSACTION_getFlushFromFrameSupport = (android.os.IBinder.FIRST_CALL_TRANSACTION + 118);
    static final int TRANSACTION_useMmapForPcmOffload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 119);
  }
  @android.annotation.Hide
   ...
   * TODO (b/434866735) merge per attribute/per stream API into this API
   */
  public void setVolumeIndexForGroup(int groupId, int uid, android.media.audio.common.AudioDeviceDescription device, int index, boolean muted) throws android.os.RemoteException;
  /**
   * TODO (b/434866735) merge per attribute/per stream API into this API and add the Min / Max
   * getter API.
   */
  ...
  /** product_strategy_t */
  public int getStrategyForStream(int stream, int uid) throws android.os.RemoteException;
  /**
   * Requests the devices that would be used for routing (if forVolume is false) or for volume
   * operations for the given attributes and UID (as routing rules may be registered on
   * UID / User ID)
   */
  public android.media.audio.common.AudioDevice[] getDevicesForAttributes(android.media.audio.common.AudioAttributes attr, int uid, boolean forVolume) throws android.os.RemoteException;
  /** audio_io_handle_t */
   ...
   * number of elements without actually retrieving them.
   */
  public int listAudioPorts(int role, int type, android.media.AudioPortFw[] ports) throws android.os.RemoteException;
  /**
   * List all device ports declared in the configuration (including currently detached ones)
   * 'role' can be 'NONE' to get both input and output devices,
   * 'SINK' for output devices, and 'SOURCE' for input devices.
   ...
   * number of elements without actually retrieving them.
   */
  public int listAudioPatches(android.media.AudioPatchFw[] patches) throws android.os.RemoteException;
  /** Set audio port configuration. */
  ...
  public void setProductStrategiesZoneIdForUserId(int userId, int zoneId) throws android.os.RemoteException;
  public void resetProductStrategiesZoneIdForUserId(int userId) throws android.os.RemoteException;
  /** product_strategy_t */
   ...
   * attributes and UID (as routing rules may be registered on UID / User ID)
   */
  public int getDirectPlaybackSupport(android.media.audio.common.AudioAttributes attr, int uid, android.media.audio.common.AudioConfig config) throws android.os.RemoteException;
  /**
   * Query audio profiles available for direct playback on the current output device(s)
   * for the specified audio attributes and UID (as routing rules may be registered on
   * UID / User ID).
   */
  public android.media.audio.common.AudioProfile[] getDirectProfilesForAttributes(android.media.audio.common.AudioAttributes attr, int uid) throws android.os.RemoteException;
  /**
   * Return a list of AudioMixerAttributes that can be used to set preferred mixer attributes
   * for the given device.
   */
   ...
   * @param portId the port id of the device to be routed.
   */
  public android.media.AudioMixerAttributesInternal getPreferredMixerAttributes(android.media.audio.common.AudioAttributes attr, int portId, int uid) throws android.os.RemoteException;
  /**
   * Clear preferred mixer attributes for a given device on a given audio attributes that
   * is previously set via setPreferredMixerAttributes.
   * 
  ...
  /** Enable hardening independent of flag or exemption state */
  public void setHardeningOverride(byte hardeningOverride) throws android.os.RemoteException;
  /**
   * Returns how flushFromFrame is supported when the playback is created with given
   * audio config and audio attributes.
   */
  public int getFlushFromFrameSupport(android.media.audio.common.AudioConfigBase config, android.media.audio.common.AudioAttributes attributes, int uid, int flags) throws android.os.RemoteException;
  /** Returns if mmap path is preferred for pcm offload playback. */
