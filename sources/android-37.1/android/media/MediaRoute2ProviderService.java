...
public abstract class MediaRoute2ProviderService extends Service {
    ...
    public static final class SessionCreationParams {
        ...
        private final @Nullable Bundle mSessionHints;
        ...
        /**
         * Returns an optional bundle of opaque arguments.
         *
         * <p>Populated by {@link MediaRouter2.OnGetControllerHintsListener}.
         *
         * <p>A null bundle means that either:
         *
         * <ul>
         *   <li>The application does not implement {@link
         *       MediaRouter2.OnGetControllerHintsListener}.
         *   <li>The application passed a null bundle to {@link
         *       MediaRouter2.OnGetControllerHintsListener}.
         *   <li>The session to create doesn't involve session hints. For example, in the case of
         *       privileged routing sessions. See {@link
         ...
         */
        @Nullable
        @SuppressLint("NullableCollection") // Null for consistency with older overload hints param.
        public Bundle getSessionHints() {
            return mSessionHints;
        }

        /** Builder for {@link SessionCreationParams}. */
        @FlaggedApi(Flags.FLAG_ENABLE_MIRRORING_IN_MEDIA_ROUTER_2)
        public static final class Builder {
            private final long mRequestId;
            private final String mTargetPackageName;
            private final String mInitialRouteId;
            private @Nullable Bundle mSessionHints;

            /**
             * Constructor for {@link Builder}.
             *
             * @param requestId The ID of the request. See {@link #getRequestId()}.
             * @param targetPackageName The package name of the application that the session is
             *     intended for. See {@link #getTargetPackageName()}.
             * @param initiallySelectedRouteId The ID of the route to make initially selected. See
             *     {@link #getInitiallySelectedRouteId()}.
             */
            public Builder(
                    long requestId,
                    @NonNull String targetPackageName,
                    @NonNull String initiallySelectedRouteId) {
                mRequestId = requestId;
                mTargetPackageName = requireNonNull(targetPackageName);
                mInitialRouteId = requireNonNull(initiallySelectedRouteId);
                mSessionHints = null;
            }
             ...
             * Sets session hints.
             *
             * @param sessionHints A bundle of opaque arguments. See {@link #getSessionHints()}.
             */
            @NonNull
            public Builder setSessionHints(@Nullable Bundle sessionHints) {
                mSessionHints = sessionHints != null ? sessionHints.deepCopy() : null;
                return this;
            }

            /** Builds the {@link SessionCreationParams}. */
            @NonNull
            public SessionCreationParams build() {
                return new SessionCreationParams(
                        mRequestId, mTargetPackageName, mInitialRouteId, mSessionHints);
            }
        }
    }
     ...
     *
     * <p>Note: The system will always call this overload instead of {@link #onCreateSession(long,
     * String, String, Bundle)} on API levels where this method is available.
     *
     ...
     *     #notifyRequestFailed}.
     */
    // TODO: b/479156700 - Document exact SDK_INT guarantee on overload invocation once
    // FLAG_ENABLE_MIRRORING_IN_MEDIA_ROUTER_2 lands on nextfood. Once we know the SDK_INT we can
    // replace "on API levels where this method is available" with "API level x". See b/498526362.
    @FlaggedApi(Flags.FLAG_ENABLE_MIRRORING_IN_MEDIA_ROUTER_2)
    ...
    final class MediaRoute2ProviderServiceStub extends IMediaRoute2ProviderService.Stub {
        ...
        public void requestCreateSession(
            ...
            if (Flags.enableMirroringInMediaRouter2()) {
                // We use the constructor instead of the builder to avoid the sessionControlHints
                // deep copy, which we know is not necessary because we are yielding all ownership
                // over the sessionControlHints bundle.
