...
public interface IAudioManagerNative extends android.os.IInterface
{
  ...
  public static class Default implements android.media.IAudioManagerNative
  {
     ...
     */
    @Override public void playbackHardeningEvent(int uid, byte type, boolean bypassed, byte reason, int usage) throws android.os.RemoteException
    {
    }
    /** Block until AudioService synchronizes pending permission state with audioserver. */
    @Override public void permissionUpdateBarrier(boolean forRecord) throws android.os.RemoteException
    {
    }
    /**
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        case TRANSACTION_playbackHardeningEvent:
        {
          ...
          this.playbackHardeningEvent(_arg0, _arg1, _arg2, _arg3, _arg4);
          break;
        }
        case TRANSACTION_permissionUpdateBarrier:
        {
          ...
          data.enforceNoDataAvail();
          this.permissionUpdateBarrier(_arg0);
   ...
   * @param usage - the audio usage of the playback
   */
  public void playbackHardeningEvent(int uid, byte type, boolean bypassed, byte reason, int usage) throws android.os.RemoteException;
  /** Block until AudioService synchronizes pending permission state with audioserver. */
  public void permissionUpdateBarrier(boolean forRecord) throws android.os.RemoteException;
  /**
   * Update mute state event for port
   * @param portId Port id to update
   * @param event the mute event containing info about the mute
