 ...
 * <p>
 * These APIs are not for use by apps linking against the Android SDK.
 * </p><p>
 * Items annotated with this will be automatically hidden from the public API surface. That means
 * it is no longer necessary, or even allowed, for this to appear on an item that is already
 * marked <pre>@hide</pre> or is annotated with {@link Hide}.
 * </p>
 */
@Hide
