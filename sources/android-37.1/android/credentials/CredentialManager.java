...
public final class CredentialManager {
    ...
    private String getOpPackageName() {
        ...
        return context != null ? context.getOpPackageName() : null;
    }
    ...
    public boolean isEnabledCredentialProviderService(@NonNull ComponentName componentName) {
        ...
        try {
            return mService.isEnabledCredentialProviderService(
                    componentName, getOpPackageName());
        } catch (RemoteException e) {
    ...
    public void registerCredentialDescription(
        ...
        try {
            mService.registerCredentialDescription(request, getOpPackageName());
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
    ...
    public void unregisterCredentialDescription(
        ...
        try {
            mService.unregisterCredentialDescription(request, getOpPackageName());
        } catch (RemoteException e) {
            e.rethrowFromSystemServer();
        }
    }
    ...
    private static class GetCandidateCredentialsTransport
        ...
        private final Executor mExecutor;
        private OutcomeReceiver<GetCandidateCredentialsResponse,
    ...
    private static class GetCredentialTransport extends IGetCredentialCallback.Stub {
        ...
        public void onPendingIntent(PendingIntent pendingIntent) {
            Context context = mContext.get();
            if (context == null) {
                Log.w(TAG, "Context is null, cannot start pending intent");
                return;
            }
            try {
    ...
    private static class ClearCredentialStateTransport extends IClearCredentialStateCallback.Stub {
        ...
        private final Executor mExecutor;
        private OutcomeReceiver<Void, ClearCredentialStateException> mCallback;
    ...
    private static class SetEnabledProvidersTransport extends ISetEnabledProvidersCallback.Stub {
        ...
        private final Executor mExecutor;
        private OutcomeReceiver<Void, SetEnabledProvidersException> mCallback;
