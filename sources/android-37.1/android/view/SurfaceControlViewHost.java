...
public class SurfaceControlViewHost {
    ...
    public void relayout(WindowManager.LayoutParams attrs,
        ...
        if (com.android.window.flags.Flags.perfectEdge()) {
            mViewRoot.incrementSeqId();
        }
        mWm.setCompletionCallback(mViewRoot, callback);
    }
    ...
    public static class LayoutParams {
         ...
         */
        @Hide
        public WindowManager.LayoutParams toWindowManagerLayoutParams() {
