...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    private int mChecked = CHECKED_STATE_FALSE;
    ...
    public void setTextSelection(int start, int end) {
        enforceNotSealed();
        if (Flags.a11ySelectionApi()) {
            // If text selection is invalid, then set the selection to null.
            Selection selection = (start == UNDEFINED_SELECTION_INDEX
                    || end == UNDEFINED_SELECTION_INDEX)
                            ? null :
                    new Selection(
                ...
                mSelection =
                        new Selection(
                                new SelectionPosition(
                                        sps.mSourceNodeId, sps.getOffset(), sps.getOffsetType()),
                                new SelectionPosition(
                                        spe.mSourceNodeId, spe.getOffset(), spe.getOffsetType()));
            } else {
                mSelection = null;
            }
        }
    ...
    public static final class SelectionPosition implements Parcelable {
         ...
         */
        @FlaggedApi(Flags.FLAG_A11Y_SELECTION_POSITION_OFFSET_TYPES)
         ...
         * {@link AccessibilityNodeInfo#getChild(int)}. The offset bounds are from 0 to
         * {@link AccessibilityNodeInfo#getChildCount()}, inclusive. An offset of 0 represents
        ...
        private final @OffsetType int mOffsetType;
         ...
         * <p>
         * {@link #getOffsetType} will default to {@link #OFFSET_TYPE_TEXT}.
         *
        ...
        public SelectionPosition(@NonNull AccessibilityNodeInfo node, int offset) {
            this(node.mSourceNodeId, offset, OFFSET_TYPE_TEXT);
        }
        ...
        public SelectionPosition(@NonNull View view, int virtualDescendantId, int offset) {
            this(makeNodeId(view.getAccessibilityViewId(), virtualDescendantId),
                    offset, OFFSET_TYPE_TEXT);
        }

        private SelectionPosition(long sourceNodeId, int offset, @OffsetType int offsetType) {
            mOffset = offset;
        ...
        private SelectionPosition(Parcel in) {
            ...
            if (Flags.a11ySelectionPositionOffsetTypes()) {
                mOffsetType = in.readInt();
            } else {
                mOffsetType = OFFSET_TYPE_TEXT;
            }
        }
        ...
        /**
         * Builder for creating {@link SelectionPosition} objects.
         */
        @FlaggedApi(Flags.FLAG_A11Y_SELECTION_POSITION_OFFSET_TYPES)
        public static final class Builder {
             ...
             * <p>
             * By default, the offset type is initialized to {@link #OFFSET_TYPE_TEXT}.
             *
             * @param node The {@link AccessibilityNodeInfo} for the node of this position.
             * @param offset The offset for the position.
             */
            public Builder(@NonNull AccessibilityNodeInfo node, int offset) {
                mSourceNodeId = node.mSourceNodeId;
                mOffset = offset;
            }
            ...
            public Builder(@NonNull View view, int virtualDescendantId, int offset) {
                mSourceNodeId = makeNodeId(view.getAccessibilityViewId(), virtualDescendantId);
                mOffset = offset;
            }
            ...
            /**
             * Creates a new {@link SelectionPosition} instance.
             */
            @NonNull
            public SelectionPosition build() {
                return new SelectionPosition(mSourceNodeId, mOffset, mOffsetType);
            }
        }
