...
import static android.permission.flags.Flags.systemSelectionToolbarSessionEnabled;
...
public final class SelectionToolbarManager {
    ...
    /**
     * Returns {@code true} if remote render selection toolbar session design is enabled, otherwise
     * returns {@code false}. This is a direct channel to the remote render service instead of
     * interfacing with the system server.
     */
    public static boolean isRemoteSelectionToolbarSessionEnabled() {
        return systemSelectionToolbarSessionEnabled();
    }
}
