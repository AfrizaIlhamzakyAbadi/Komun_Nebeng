...
public final class Display {
    ...
    /**
     * Display flag: Indicates that the display can mirror another display.
     *
     * @see DisplayManager#VIRTUAL_DISPLAY_FLAG_AUTO_MIRROR
     */
    @Hide
    public static final int FLAG_AUTO_MIRROR = 1 << 16;
    ...
    public static boolean hasAccess(int uid, int flags, int ownerUid, int displayId) {
        return (flags & Display.FLAG_PRIVATE) == 0
                ...
                || (Flags.showLockScreenOnPrivateMirrorDisplays()
                && DisplayManagerGlobal.getInstance().canAccessPrivateDisplays(uid));
    }
