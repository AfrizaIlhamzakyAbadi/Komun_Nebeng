...
public class DragEvent implements Parcelable {
    ...
    private void init(int action, float x, float y, float offsetX, float offsetY, int displayId,
            int flags, @InputDevice.Source int inputSource, @KeyEvent.MetaState int metaState,
    ...
    static DragEvent obtain() {
        return DragEvent.obtain(0, 0f, 0f, 0f, 0f, 0, 0, 0, 0, null, null, null, null, null, false);
    }

    @Hide
    public static DragEvent obtain(int action, float x, float y, float offsetX, float offsetY,
            int displayId, int flags, int inputSource, int metaState, Object localState,
            ClipDescription description, ClipData data, SurfaceControl dragSurface,
        ...
        synchronized (gRecyclerLock) {
            if (gRecyclerTop == null) {
                ev = new DragEvent();
                ev.init(action, x, y, offsetX, offsetY, displayId, flags, inputSource, metaState,
                        description, data, dragSurface, dragAndDropPermissions, localState, result);
                return ev;
            }
            ev = gRecyclerTop;
    ...
    public static DragEvent obtain(DragEvent source) {
        return obtain(source.mAction, source.mX, source.mY, source.mOffsetX, source.mOffsetY,
                source.mDisplayId, source.mFlags, source.mInputSource, source.mMetaState,
    ...
    /**
     * Gets the source of the drag event.
     *
     * @return The input source or {@link InputDevice#SOURCE_UNKNOWN} if unknown.
    ...
    /**
     * Gets the state of the modifier keys (e.g., Shift, Ctrl, Alt) as of the
     * most recent drag location update. The state is derived from the
     * underlying motion events that drive the drag.
     *
     * @return The meta key state, as a combination of {@code KeyEvent#META_} flags.
    ...
    public String toString() {
        return "DragEvent{" + Integer.toHexString(System.identityHashCode(this))
                ...
                + " inputSource=" + mInputSource + " metaState=" + mMetaState + "}";
    }
    ...
    public static final @android.annotation.NonNull Parcelable.Creator<DragEvent> CREATOR =
        ...
        public DragEvent createFromParcel(Parcel in) {
            ...
            event.mInputSource = in.readInt();
            event.mMetaState = in.readInt();
