...
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.ALPHA;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.APPEARANCE;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.BEHAVIOR;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.BUTTON_BRIGHTNESS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.COLOR_MODE;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FIT_IGNORE_VISIBILITY;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FIT_INSETS_SIDES;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FIT_INSETS_TYPES;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FLAGS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FORCIBLY_SHOWN_TYPES;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.FORMAT;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.GRAVITY;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.HAS_SYSTEM_UI_LISTENERS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.HEIGHT;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.HORIZONTAL_MARGIN;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.INPUT_FEATURE_FLAGS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.PARAMS_FOR_ROTATION;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.PREFERRED_REFRESH_RATE;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.PRIVATE_FLAGS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.PROVIDED_INSETS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.RENDERING_HINTS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.ROTATION_ANIMATION;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.SCREEN_BRIGHTNESS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.SCREEN_BRIGHTNESS_UNIT;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.SOFT_INPUT_MODE;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.SUBTREE_SYSTEM_UI_VISIBILITY_FLAGS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.SYSTEM_UI_VISIBILITY_FLAGS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.TYPE;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.USER_ACTIVITY_TIMEOUT;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.VERTICAL_MARGIN;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.WIDTH;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.WINDOW_ANIMATIONS;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.X;
import static com.android.internal.tracing.winscope.protos.Windowlayoutparams.WindowLayoutParamsProto.Y;
import static com.android.server.display.feature.flags.Flags.FLAG_ENABLE_DISPLAY_CONTENT_MODE_MANAGEMENT;
import static com.android.server.display.feature.flags.Flags.FLAG_LAYOUT_PARAMS_BRIGHTNESS_UNIT;
...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
        ...
        /**
         * Flag to indicate that this window is not important for rendering resource (low priority).
         */
        @Hide
        public static final int RENDERING_HINT_LOW_PRIORITY = 1 << 4;

        /**
         * Flag to indicate that this window should not use IPC rendering (OOPR).
         */
        @Hide
        public static final int RENDERING_HINT_DISABLE_IPC_RENDERING = 1 << 5;

        @Hide
        @IntDef(flag = true, prefix = {"RENDERING_HINT_"},
                value =
                        {
                                ...
                                RENDERING_HINT_LOW_PRIORITY,
                                RENDERING_HINT_DISABLE_IPC_RENDERING,
                        })
        @Retention(RetentionPolicy.SOURCE)
        ...
        @ViewDebug.ExportedProperty(flagMapping =
                {
                    @ViewDebug.FlagToString(mask = RENDERING_HINT_DISABLE_PERFORMANCE_HINT,
                    ...
                    ,
                            ...
                            @ViewDebug.FlagToString(mask = RENDERING_HINT_LOW_PRIORITY,
                                    equals = RENDERING_HINT_LOW_PRIORITY, name = "LOW_PRIORITY"),
                            @ViewDebug.FlagToString(mask = RENDERING_HINT_DISABLE_IPC_RENDERING,
                                    equals = RENDERING_HINT_DISABLE_IPC_RENDERING,
                                    name = "DISABLE_IPC_RENDERING")
                })
        @RenderingHints
        public int renderingHints;

        /**
         * Returns whether this window disables IPC rendering (OOPR).
         */
        @Hide
        public boolean isIpcRenderingDisabled() {
            return (renderingHints & RENDERING_HINT_DISABLE_IPC_RENDERING) != 0;
        }
        ...
        /**
         * The unit of {@link #screenBrightness}.
         * If not set, the default is {@link DisplayManager#BRIGHTNESS_UNIT_RAW}.
         */
        @FlaggedApi(FLAG_LAYOUT_PARAMS_BRIGHTNESS_UNIT)
        @DisplayManager.BrightnessUnit
        public int screenBrightnessUnit = DisplayManager.BRIGHTNESS_UNIT_RAW;
         ...
         * <p>
         * The display resolution and refresh rate part of the mode requested by apps is treated as
         * a preference and may be ignored by the system based on device capabilities.
         *
        ...
        /**
         * Flag to indicate that this window should NOT receive focus when touched.
         * By default, windows receive focus on touch.
         */
        @Hide
        public static final int INPUT_FEATURE_SKIP_FOCUS_ON_TOUCH = 1 << 6;

        /**
         * Flag to indicate that this window should be skipped when searching for a focused window
         * during system focus resolution (e.g., when the current focused window is removed or
         * focus is reset). By default, windows are considered during search.
         */
        @Hide
        public static final int INPUT_FEATURE_SKIP_FOCUS_DURING_SEARCH = 1 << 7;
        ...
        @IntDef(flag = true, prefix = {"INPUT_FEATURE_"}, value = {
                ...
                INPUT_FEATURE_SKIP_FOCUS_ON_TOUCH,
                INPUT_FEATURE_SKIP_FOCUS_DURING_SEARCH
        })
        ...
        /**
         * Specifies whether the window can set the global TouchMode state.
         * If set to {@code true}: Allow Touchmode to be modified by user interactions
         * (touch/mouse/keyboard/etc). This is the default system behavior.
         *
         * If set to {@code false}: Prevent any user interaction from modifying the Touchmode state.
         *
         * Note: This field is only relevant for windows of type
         * {@link WindowManager.LayoutParams#TYPE_INPUT_METHOD}. For other window types, this
         * value is ignored. Use {@link #canChangeGlobalTouchMode()} to get the effective value, as
         * it includes the window type check.
         *
         * @see #setChangeGlobalTouchMode(boolean)
         * @see #canChangeGlobalTouchMode()
         */
        private boolean mCanChangeGlobalTouchMode = true;
        ...
        /**
         * Sets the TouchMode state of the window. This is specifically for IMEs that want to change
         * the global Touchmode state at runtime, will otherwise do a no-op for all other apps.
         *
         * <p>Note: This property is currently only supported for windows
         * of type {@link WindowManager.LayoutParams#TYPE_INPUT_METHOD}. Setting this
         * on other window types is a no-op.</p>
         *
         * <p>By default, this is set to {@code true} in which the window can set the TouchMode
         * state through interactions (touch/mouse/touchpad). This is only necessary if this window
         * was previously called with {@code false}.</p>
         *
         * <p>If set to {@code false}, user interactions within this window will not
         * modify the global TouchMode state. This is particularly useful for accessibility
         * on-screen keyboards that wish to avoid clearing the focus of the application they are
         * interacting with.</p>
         *
         * <p>Recommended use case: IMEs with {@link WindowManager.LayoutParams#FLAG_NOT_FOCUSABLE}
         * that do not receive any focus may want to set this to {@code false} to ensure that the
         * application bound to the IME does not destroy its focus when interacting with the IME via
         * touch/mouse/touchpad.</p>
         *
         * <p>Important: TouchMode is a global system synchronized state that applies to all
         * windows. If this is set to {@code false}, TouchMode will no longer be a global
         * synchronized state as this window no longer subscribes to TouchMode state changes until
         * either the window is closed or this is set to {@code true}.</p>
         *
         * @see #canChangeGlobalTouchMode() for more information on states.
         *
         * @param canChangeGlobalTouchMode whether the window should control the TouchMode state.
         */
        @FlaggedApi(com.android.window.flags.Flags.FLAG_CAN_CONTROL_TOUCH_MODE_API)
        public void setCanChangeGlobalTouchMode(boolean canChangeGlobalTouchMode) {
            mCanChangeGlobalTouchMode = canChangeGlobalTouchMode;
        }

        /**
         * Returns whether this window is allowed to change the global touch mode state.
         *
         * If the window is not {@link WindowManager.LayoutParams#TYPE_INPUT_METHOD}, this will
         * always return {@code true} (default value).
         *
         * @return {@code true} if the window can control the touch mode, {@code false}
         *         otherwise.
         * @see #setCanChangeGlobalTouchMode(boolean)
         */
        @FlaggedApi(com.android.window.flags.Flags.FLAG_CAN_CONTROL_TOUCH_MODE_API)
        public boolean canChangeGlobalTouchMode() {
            if (type == TYPE_INPUT_METHOD) {
                return mCanChangeGlobalTouchMode;
            }
            return true;
        }
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeInt(screenBrightnessUnit);
            ...
            out.writeBoolean(canChangeGlobalTouchMode());
        ...
        public LayoutParams(Parcel in) {
            ...
            screenBrightnessUnit = in.readInt();
            ...
            mCanChangeGlobalTouchMode = in.readBoolean();
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            if (screenBrightnessUnit != o.screenBrightnessUnit) {
                screenBrightnessUnit = o.screenBrightnessUnit;
                changes |= SCREEN_BRIGHTNESS_CHANGED;
            }
            ...
            if (mCanChangeGlobalTouchMode != o.canChangeGlobalTouchMode()) {
                mCanChangeGlobalTouchMode = o.canChangeGlobalTouchMode();
                changes |= LAYOUT_CHANGED;
            }
        ...
        public String toString(String prefix) {
            ...
            if (screenBrightness != BRIGHTNESS_OVERRIDE_NONE) {
                ...
                sb.append(" sbrtUnit=");
                sb.append(DisplayManager.brightnessUnitToString(screenBrightnessUnit));
            }
            ...
            if (renderingHints != 0) {
                ...
                sb.append(prefix).append("  rh=").append(ViewDebug.flagsToString(
                        LayoutParams.class, "renderingHints", renderingHints));
            }
        ...
        public void dumpDebug(ProtoOutputStream proto, long fieldId) {
            ...
            proto.write(SCREEN_BRIGHTNESS_UNIT, screenBrightnessUnit);
        ...
        private static String inputFeaturesToString(int inputFeatures) {
            ...
            if ((inputFeatures & INPUT_FEATURE_SKIP_FOCUS_ON_TOUCH) != 0) {
                inputFeatures &= ~INPUT_FEATURE_SKIP_FOCUS_ON_TOUCH;
                features.add("INPUT_FEATURE_SKIP_FOCUS_ON_TOUCH");
            }
            if ((inputFeatures & INPUT_FEATURE_SKIP_FOCUS_DURING_SEARCH) != 0) {
                inputFeatures &= ~INPUT_FEATURE_SKIP_FOCUS_DURING_SEARCH;
                features.add("INPUT_FEATURE_SKIP_FOCUS_DURING_SEARCH");
            }
            if (inputFeatures != 0) {
    ...
    final class DisplayEngagementModeState {
        ...
        /**
         * Returns the engagement mode flags.
         */
        @EngagementModeFlags
