...
public class WindowInfo implements Parcelable {
    ...
    // The attached window that is directly associated with this one, which may provide controls
    // that affect this window (ie. a caption bar window may control this task)
    public IBinder attachedToWindowToken;
    public IBinder activityToken;
    public boolean focused;
    public Region regionInScreen = new Region();
    public List<IBinder> childTokens;
    // The list of windows that this window is associated with and may affect (ie. if this window
    // is a caption bar, the attachedByWindowTokens may be the task it controls)
    public List<IBinder> attachedByWindowTokens;
    ...
    public static WindowInfo obtain(WindowInfo other) {
        ...
        window.attachedToWindowToken = other.attachedToWindowToken;
        ...
        if (other.childTokens != null && !other.childTokens.isEmpty()) {
            if (window.childTokens == null) {
                ...
                window.childTokens.clear();
                window.childTokens.addAll(other.childTokens);
            }
        }
        if (other.attachedByWindowTokens != null && !other.attachedByWindowTokens.isEmpty()) {
            if (window.attachedByWindowTokens == null) {
                window.attachedByWindowTokens = new ArrayList<>(other.attachedByWindowTokens);
            } else {
                window.attachedByWindowTokens.clear();
                window.attachedByWindowTokens.addAll(other.attachedByWindowTokens);
            }
        }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        parcel.writeStrongBinder(attachedToWindowToken);
        ...
        if (attachedByWindowTokens != null && !attachedByWindowTokens.isEmpty()) {
            parcel.writeInt(1);
            parcel.writeBinderList(attachedByWindowTokens);
        } else {
            parcel.writeInt(0);
        }
    ...
    public String toString() {
        ...
        builder.append(", attachedTo=").append(attachedToWindowToken);
        builder.append(", focused=").append(focused);
        builder.append(", children=").append(childTokens);
        builder.append(", attachedBy=").append(attachedByWindowTokens);
    ...
    private void initFromParcel(Parcel parcel) {
        ...
        attachedToWindowToken = parcel.readStrongBinder();
        ...
        final boolean hasAttachedBy = (parcel.readInt() == 1);
        if (hasAttachedBy) {
            if (attachedByWindowTokens == null) {
                attachedByWindowTokens = new ArrayList<>();
            }
            parcel.readBinderList(attachedByWindowTokens);
        }
