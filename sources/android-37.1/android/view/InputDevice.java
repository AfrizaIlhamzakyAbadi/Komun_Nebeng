...
public final class InputDevice implements Parcelable {
    ...
    /**
     * Returns a bitmask of all buttons which can be potentially returned by
     * {@link MotionEvent#getButtonState} for events produced by this device.
     */
    @Hide
    public int getSupportedButtons() {
        return InputManagerGlobal.getInstance().getSupportedButtons(mId);
    }
