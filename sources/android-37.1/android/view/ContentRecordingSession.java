...
public final class ContentRecordingSession implements Parcelable {
    ...
    /**
     * Capturing a specific piece of app content (e.g. a browser tab).
     */
    ...
    /**
     * The token of the layer where the recording overlay should stop at.
     *
     * <p>This token is only used if {@link #getContentToRecord()} is
     * {@link RecordContent#RECORD_CONTENT_BELOW_OVERLAY}. Otherwise, it is ignored.
     */
    @Nullable
    private IBinder mRecordingOverlayToken = null;

    /**
     * When {@code true}, no mirroring should take place until the user has re-granted access to the
     * consent token. When {@code false}, recording can begin immediately.
     *
    ...
    /** Returns an instance initialized for app content sharing. */
    public static ContentRecordingSession createAppContentSession() {
        return new ContentRecordingSession()
                .setContentToRecord(RECORD_CONTENT_APP_CONTENT);
    }

    /** Returns an instance initialized for "below overlay" recording. */
    public static ContentRecordingSession createOverlaySession(
            int displayToMirror,
            int recordingOwnerUid,
            @Nullable IBinder recordingOverlayWindowToken) {
        return new ContentRecordingSession()
                .setDisplayToRecord(displayToMirror)
                .setContentToRecord(RECORD_CONTENT_BELOW_OVERLAY)
                .setRecordingOwnerUid(recordingOwnerUid)
                .setRecordingOverlayToken(recordingOverlayWindowToken);
    }
    ...
    public static boolean isValid(ContentRecordingSession session) {
        ...
        final boolean isValidAppContentSession =
                session.getContentToRecord() == RECORD_CONTENT_APP_CONTENT;
        return isValidTaskSession || isValidDisplaySession || isValidOverlaySession
                || isValidAppContentSession;
    }
    ...
    public static String recordContentToString(@RecordContent int value) {
        switch (value) {
            ...
            case RECORD_CONTENT_APP_CONTENT:
                    return "RECORD_CONTENT_APP_CONTENT";
    ...
    /* package-private */ ContentRecordingSession(
            ...
            @Nullable IBinder recordingOverlayToken,
        ...
        if (!(mContentToRecord == RECORD_CONTENT_DISPLAY)
                ...
                && !(mContentToRecord == RECORD_CONTENT_APP_CONTENT)) {
            throw new java.lang.IllegalArgumentException(
                    "contentToRecord was " + mContentToRecord + " but must be one of: "
                            ...
                            + "RECORD_CONTENT_APP_CONTENT(" + RECORD_CONTENT_APP_CONTENT + ")");
        }

        this.mDisplayToRecord = displayToRecord;
        this.mTokenToRecord = tokenToRecord;
        this.mRecordingOverlayToken = recordingOverlayToken;
     ...
     */
    @DataClass.Generated.Member
    public @Nullable IBinder getRecordingOverlayToken() {
        return mRecordingOverlayToken;
    }
     ...
     */
    @DataClass.Generated.Member
    public @NonNull ContentRecordingSession setRecordingOverlayToken(@NonNull IBinder value) {
        mRecordingOverlayToken = value;
        return this;
    }
    ...
    public String toString() {
        ...
        return "ContentRecordingSession { " +
                ...
                "recordingOverlayToken = " + mRecordingOverlayToken + ", " +
    ...
    public boolean equals(@Nullable Object o) {
        ...
        return true
                ...
                && java.util.Objects.equals(mRecordingOverlayToken, that.mRecordingOverlayToken)
    ...
    public int hashCode() {
        ...
        _hash = 31 * _hash + java.util.Objects.hashCode(mRecordingOverlayToken);
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        int flg = 0;
        if (mWaitingForConsent) flg |= 0x80;
        if (mTokenToRecord != null) flg |= 0x20;
        if (mRecordingOverlayToken != null) flg |= 0x40;
        dest.writeInt(flg);
        ...
        if (mRecordingOverlayToken != null) dest.writeStrongBinder(mRecordingOverlayToken);
    ...
    /* package-private */ ContentRecordingSession(@NonNull Parcel in) {
        ...
        int flg = in.readInt();
        boolean waitingForConsent = (flg & 0x80) != 0;
        ...
        IBinder recordingOverlayToken = (flg & 0x40) == 0 ? null : (IBinder) in.readStrongBinder();
    ...
    public static final class Builder {
        ...
        private @Nullable IBinder mRecordingOverlayToken;
         ...
         */
        @DataClass.Generated.Member
        public @NonNull Builder setRecordingOverlayToken(@NonNull IBinder value) {
            checkNotUsed();
