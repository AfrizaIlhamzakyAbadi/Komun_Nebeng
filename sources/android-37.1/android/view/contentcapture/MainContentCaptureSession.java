...
public final class MainContentCaptureSession extends ContentCaptureSession {
    ...
    public MainContentCaptureSession(
        ...
        if (getContentCaptureVersion() == VERSION_1) {
    ...
    private void flushIfNeeded(@FlushReason int reason) {
        ...
        if (mEventProcessQueue == null) return;
    ...
    public void flush(@FlushReason int reason) {
        ...
        //  public API.
        if (getContentCaptureVersion() != VERSION_1) return;
    ...
    public int getContentCaptureVersion() {
        if (mComponentName != null) {
            return mManager.mOptions.getContentCaptureVersion(mComponentName);
        } else {
            return mManager.mOptions.getContentCaptureVersion();
        }
    }
    ...
    @Override
    protected void updateContentCaptureContext(@Nullable ContentCaptureContext context) {
    ...
    public void notifyWindowBoundsChanged(int sessionId, @NonNull Rect bounds) {
        if (!isContentCaptureEnabled() || getContentCaptureVersion() != VERSION_1) return;
        final ContentCaptureEvent event =
    ...
    public void notifyContentCaptureEvents(
        ...
        // Although all call sites are guarded, adding one more guard here for safety.
        if (getContentCaptureVersion() != VERSION_1) return;
        runOnUiThread(() -> {
