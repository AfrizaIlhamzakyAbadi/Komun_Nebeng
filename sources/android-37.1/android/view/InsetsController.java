...
import static com.android.internal.tracing.winscope.protos.Insetscontroller.InsetsControllerProto.CONTROL;
import static com.android.internal.tracing.winscope.protos.Insetscontroller.InsetsControllerProto.STATE;
...
public class InsetsController implements WindowInsetsController, InsetsAnimationControlCallbacks,
    ...
    public static final class InternalAnimationControlListener
        ...
        private final boolean mUsesSyncedInsetsAnimationByDefault;
        @InsetsType
        ...
        public InternalAnimationControlListener(boolean show, boolean hasAnimationCallbacks,
                ...
                boolean usesSyncedInsetsAnimationByDefault) {
            mShow = show;
            mHasAnimationCallbacks = hasAnimationCallbacks;
            mUsesSyncedInsetsAnimationByDefault = usesSyncedInsetsAnimationByDefault;
        ...
        public Interpolator getInsetsInterpolator(boolean hasZeroInsetsIme) {
            if ((mRequestedTypes & ime()) != 0) {
                if ((mHasAnimationCallbacks || mUsesSyncedInsetsAnimationByDefault)
                        && !hasZeroInsetsIme) {
    ...
    private static final class PendingControlRequest {
        ...
        final boolean mHasAnimationCallbacks;
        ...
        PendingControlRequest(@InsetsType int types,
                ...
                @Nullable CancellationSignal cancellationSignal, boolean hasAnimationCallbacks) {
            mTypes = types;
            mListener = listener;
    ...
    public InsetsController(@NonNull Host host, @NonNull Handler handler) {
        ...
        mAnimCallback = () -> {
            ...
            for (int i = mRunningAnimations.size() - 1; i >= 0; i--) {
                ...
                hasUserAnimation |= isRealUserAnimation(runner);
    ...
    private void handlePendingControlRequest(@NonNull PendingControlRequest pendingRequest,
        ...
        controlAnimationUnchecked(pendingRequest.mTypes, pendingRequest.mCancellationSignal,
                ...
                statsToken, pendingRequest.mHasAnimationCallbacks, false /* fromPredictiveBack */);
    }
    ...
    public void controlWindowInsetsAnimation(@InsetsType int types,
        ...
        controlAnimationUnchecked(types, cancellationSignal, listener, mFrame, mBounds, spec,
                animationType, getLayoutInsetsDuringAnimationMode(types, fromPredictiveBack,
                        hasAnimationCallbacks), false /* useInsetsAnimationThread */, statsToken,
                hasAnimationCallbacks, fromPredictiveBack);
    }
    ...
    private void controlAnimationUnchecked(@InsetsType int types,
            ...
            boolean hasAnimationCallbacks, boolean fromPredictiveBack) {
        ...
        controlAnimationUncheckedInner(types, cancellationSignal, listener, frame, bounds,
                ...
                useInsetsAnimationThread, statsToken, hasAnimationCallbacks, fromPredictiveBack);
    ...
    private void controlAnimationUncheckedInner(@InsetsType int types,
        ...
        final InsetsAnimationControlRunner runner = useInsetsAnimationThread
                ...
                : new InsetsAnimationControlImpl(controls,
                        ...
                        insetsAnimationSpec, animationType, layoutInsetsDuringAnimation,
                        mHost.getTranslator(), statsToken, hasAnimationCallbacks,
                        fromPredictiveBack);
    ...
    private int getLayoutInsetsDuringAnimationMode(@InsetsType int types,
            boolean fromPredictiveBack, boolean hasAnimationCallbacks) {
        if (fromPredictiveBack && !hasAnimationCallbacks) {
    ...
    private void cancelAnimation(@NonNull InsetsAnimationControlRunner runner,
        ...
        for (int i = mRunningAnimations.size() - 1; i >= 0; i--) {
            ...
            if (runningAnimation.mRunner == runner) {
                ...
                if (invokeCallback && runner instanceof WindowInsetsAnimationController) {
    ...
    private static boolean isRealUserAnimation(InsetsAnimationControlRunner runner) {
        // In case of a user animation that comes from predictive back, we actually don't want to
        // treat it as such (if flag is enabled), as otherwise the synced animation would not
        // been played.
        return runner.getAnimationType() == ANIMATION_TYPE_USER && !(
                com.android.window.flags.Flags.predictiveBackSyncedImeAnimation()
                        && runner.isFromPredictiveBack());
    }
    ...
    public void applyAnimation(@InsetsType final int types, boolean show,
        ...
        final boolean hasAnimationCallbacks = mHost.hasAnimationCallbacks();
        final boolean usesSyncedInsetsAnimationByDefault =
                mHost.usesSyncedInsetsAnimationByDefault();
        final boolean useInsetsAnimationThread =
                (!hasAnimationCallbacks && !usesSyncedInsetsAnimationByDefault) || skipsCallbacks;
        ...
        final var listener = new InternalAnimationControlListener(
                ...
                mLoggingListener, mJankContext, usesSyncedInsetsAnimationByDefault);
        ...
        controlAnimationUnchecked(
                ...
                useInsetsAnimationThread, statsToken, hasAnimationCallbacks,
    ...
    void startAnimation(@NonNull T runner, @NonNull WindowInsetsAnimationControlListener listener,
        ...
        final boolean isUserAnimation = isRealUserAnimation(runner);
