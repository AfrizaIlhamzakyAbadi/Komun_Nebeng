...
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.CURRENT_ALPHA;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.IS_CANCELLED;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.IS_FINISHED;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.PENDING_ALPHA;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.PENDING_FRACTION;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.PENDING_INSETS;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.SHOWN_ON_FINISH;
import static com.android.internal.tracing.winscope.protos.Insetsanimationcontrolimpl.InsetsAnimationControlImplProto.TMP_MATRIX;
...
public class InsetsAnimationControlImpl implements InternalInsetsAnimationController,
    ...
    /**
     * Whether the animation was triggered by predictive back.
     */
    private final boolean mFromPredictiveBack;

    /**
     * Whether there was an animation callback registered when the animation was started.
     */
    private final boolean mHasAnimationCallback;
    ...
    public InsetsAnimationControlImpl(@NonNull SparseArray<InsetsSourceControl> controls,
            ...
            @Nullable ImeTracker.Token statsToken, boolean hasAnimationCallback,
        ...
        mHasAnimationCallback = hasAnimationCallback;
        mFromPredictiveBack = fromPredictiveBack;
    ...
    public boolean hasAnimationCallback() {
        if (com.android.window.flags.Flags.predictiveBackSyncedImeAnimation()) {
            return mHasAnimationCallback;
        } else {
    ...
    @Override
    public boolean isFromPredictiveBack() {
        return mFromPredictiveBack;
    }
