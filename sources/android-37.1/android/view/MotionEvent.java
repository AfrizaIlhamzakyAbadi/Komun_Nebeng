...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    /**
     * Button constant: Extra button is pressed.
     *
     * @see #getButtonState
     */
    @Hide
    public static final int BUTTON_EXTRA = 1 << 7;

    /**
     * Button constant: Side button is pressed.
     *
     * @see #getButtonState
     */
    @Hide
    public static final int BUTTON_SIDE = 1 << 8;

    /**
     * Button constant: Task button is pressed.
     *
     * @see #getButtonState
     */
    @Hide
    public static final int BUTTON_TASK = 1 << 9;
