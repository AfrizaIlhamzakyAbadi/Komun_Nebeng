...
public final class FrameMetrics {
    ...
    public @interface Index {
        ...
        int ANIMATION_COUNTER = 14;
        int SYNC_QUEUED = 15;
        int SYNC_START = 16;
        int ISSUE_DRAW_COMMANDS_START = 17;
        int SWAP_BUFFERS = 18;
        int FRAME_COMPLETED = 19;
        int DEQUEUE_BUFFER_DURATION = 20;
        int QUEUE_BUFFER_DURATION = 21;
        int GPU_COMPLETED = 22;
        int SWAP_BUFFERS_COMPLETED = 23;
        int DISPLAY_PRESENT_TIME = 24;
        int COMMAND_SUBMISSION_COMPLETED = 25;

        int FRAME_STATS_COUNT = 26; // must always be last and in sync with
