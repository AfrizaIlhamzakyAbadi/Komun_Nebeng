...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    /**
     * Key code constant: Contextual Query key.
     * <p>
     * Introduced by HUTRR119, triggers contextual suggestions on active or
     * hovered screen elements (e.g. an image or a paragraph) to discover
     * available actions.
     */
    @FlaggedApi(Flags.FLAG_ENABLE_NEW_26Q3_KEYCODES)
    public static final int KEYCODE_CONTEXTUAL_QUERY = 341;
    ...
    public static final int LAST_KEYCODE = KEYCODE_CONTEXTUAL_QUERY;
     ...
     *
     * @param action Action code: either {@link #ACTION_DOWN} or {@link #ACTION_UP}.
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_CONTEXTUAL_QUERY:
                return true;
        }
     ...
     *
     * @return the event action: either {@link #ACTION_DOWN},
    ...
    /**
     * Retrieve the repeat count of the event.  For {@link #ACTION_DOWN} events,
     * this is the number of times the key has repeated with the first
     * down starting at 0 and counting up from there.  For {@link #ACTION_UP} events,
     * this is always 0.
     *
     ...
     * an {@link #ACTION_MULTIPLE} event and it is not handled, then an attempt will
