...
public interface InputMethodSession {
    ...
    /**
     * Received by the IME before dispatching to {@link InputMethodService#onKeyDown(int, KeyEvent)}
     * to determine if the {@link KeyEvent} requires system-level verification of its authenticity.
     *
