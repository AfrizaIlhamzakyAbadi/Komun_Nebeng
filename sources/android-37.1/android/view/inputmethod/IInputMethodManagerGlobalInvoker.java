 ...
 *
 * <p>All public static methods are guaranteed to be thread-safe.
 *
 * <p>All public methods are guaranteed to do nothing when {@link IInputMethodManager} is
 * unavailable.
 *
 * <p>If you want to use any of this method outside of {@code android.view.inputmethod}, create a
 * wrapper method in {@link InputMethodManagerGlobal} instead of making this class public.
 */
final class IInputMethodManagerGlobalInvoker {
    ...
    @AnyThread
    @Nullable
    static ImeTrackerServiceWrapper getImeTrackerService() {
        final var service = getService();
        if (service == null) {
            return null;
        }

        IImeTracker trackerService;
        try {
        ...
        return new ImeTrackerServiceWrapper(trackerService);
    }
}
