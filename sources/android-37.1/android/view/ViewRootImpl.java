...
import static android.view.flags.Flags.cleanupInitialTouchBoostOnDetach;
import static android.view.flags.Flags.enableWindowlessWindowFocusNavigation;
import static android.view.flags.Flags.holdbackAtomicTraversalBarrier;
...
import static com.android.internal.tracing.winscope.protos.Inputmethodeditor.InputMethodClientsTraceProto.ClientSideProto.IME_FOCUS_CONTROLLER;
import static com.android.internal.tracing.winscope.protos.Inputmethodeditor.InputMethodClientsTraceProto.ClientSideProto.INSETS_CONTROLLER;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.ADDED;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.APP_VISIBLE;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.CUR_SCROLL_Y;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.DISPLAY_ID;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.HEIGHT;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.IS_ANIMATING;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.IS_DRAWING;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.LAST_WINDOW_INSETS;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.REMOVED;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.SCROLL_Y;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.SOFT_INPUT_MODE;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.VIEW;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.VISIBLE_RECT;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.WIDTH;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.WINDOW_ATTRIBUTES;
import static com.android.internal.tracing.winscope.protos.Viewrootimpl.ViewRootImplProto.WIN_FRAME;
...
import static com.android.window.flags.Flags.canControlTouchModeApi;
...
import android.window.sharedsurface.SharedAnimationController;
...
public final class ViewRootImpl implements ViewParent,
    ...
    private final SharedAnimationController mSharedAnimationController;
    ...
    private TakenSurfaceHolder mSurfaceHolder;
    ...
    private final ViewInvalidationTracer mInvalidationTracer = new ViewInvalidationTracer();
    ...
    private final boolean mAtomicTraversalBarrier =
            atomicTraversalBarrier() && !holdbackAtomicTraversalBarrier();
    ...
    private int mSyncedWindowInsetsAnimationCount = 0;
    ...
    /** The initial info from {@link #setView} to be applied on the first traversal. */
    @Nullable
    private ActivityWindowInfo mInitialActivityWindowInfo;
    ...
    static ITransactionHangCallback sTransactionHangCallback =
        new ITransactionHangCallback.Stub() {
            @Override
    ...
    private static final boolean sCleanupInitialTouchBoostOnDetachValue =
            cleanupInitialTouchBoostOnDetach();
    ...
    public ViewRootImpl(@UiContext Context context, Display display, IWindowSession session,
        ...
        mSharedAnimationController = new SharedAnimationController(Looper.myLooper());
        ...
        mDisableDrawWakeLock = CompatChanges.isChangeEnabled(DISABLE_DRAW_WAKE_LOCK);
        ...
        mIpcRenderingEnabled = android.graphics.HardwareRenderer.isOoprEnabled();
    }
    ...
    public void setActivityConfigCallback(@Nullable ActivityConfigCallback callback) {
        ...
        if (callback == null) {
            ...
            if (mInitialActivityWindowInfo != null) {
                mPendingActivityWindowInfo.set(mInitialActivityWindowInfo);
                mLastReportedActivityWindowInfo.set(mInitialActivityWindowInfo);
                mInitialActivityWindowInfo = null;
            }
        }
    }
    ...
    public void setView(View view, WindowManager.LayoutParams attrs, View panelParentView,
        ...
        synchronized (this) {
            if (mView == null) {
                ...
                //  in next API bump
                if (mWindowAttributes.type == TYPE_APPLICATION_OVERLAY
                ...
                try {
                    ...
                    if (com.android.window.flags.Flags.asyncRelayoutOnActivityLaunch()
                            && addResult.mergedConfiguration.getMergedConfiguration().seq > 0) {
                        final Configuration configFromAm = getConfiguration();
                        final Configuration configFromWm =
                                addResult.mergedConfiguration.getMergedConfiguration();
                        if (configFromWm.diff(configFromAm) == 0) {
                            mPendingMergedConfiguration.setTo(addResult.mergedConfiguration);
                            mLastReportedMergedConfiguration.setTo(addResult.mergedConfiguration);
                            if (addResult.activityWindowInfo != null) {
                                mInitialActivityWindowInfo =
                                        new ActivityWindowInfo(addResult.activityWindowInfo);
                            }
                        }
                    }
                ...
                if (!com.android.window.flags.Flags.addWindowReturnPermissionDenied()) {
                    ...
                    registerSharedAnimationControllerOnWindow();
    ...
    private void registerListeners() {
        ...
        long eventsToBeRegistered = DisplayManagerGlobal.INTERNAL_EVENT_FLAG_DISPLAY_ADDED
  ...
  private void updateRendererSurfaceControlAndBbq(SurfaceControl sc, BLASTBufferQueue bq) {
    ...
    private void enableHardwareAcceleration(WindowManager.LayoutParams attrs) {
        ...
        if (hardwareAccelerated) {
            ...
            if (ThreadedRenderer.sRendererEnabled || forceHwAccelerated) {
                ...
                if (attrs.isIpcRenderingDisabled()) {
    ...
    private void handleResized(ClientWindowFrames frames, boolean reportDraw,
        ...
        if (!reportDraw && !configChanged && !attachedFrameChanged && !displayChanged
                && !forceLayout && !compatScaleChanged && !dragResizingChanged) {
            if (!frameChanged) {
                return;
            }
            if (com.android.window.flags.Flags.simplifyWindowMovement()
                    && (mWinFrame.width() == frame.width()
                            && mWinFrame.height() == frame.height())) {
    ...
    @UnsupportedAppUsage
    void invalidate() {
        invalidate(null /* descendant */);
    }

    void invalidate(@Nullable View descendant) {
        mInvalidationTracer.recordInvalidation(descendant);
    ...
    void updateBlastSurfaceIfNeeded() {
        ...
        // Natively rendered apps do not have a threaded renderer but still benefit from
        // being signalled on a wait for buffer release callback in order to initiate
        // buffer stuffing recovery.
        if (mAttachInfo.mThreadedRenderer == null) {
            mBlastBufferQueue.setWaitForBufferReleaseCallback(
                    mChoreographer::onWaitForBufferRelease);
        }
    ...
    public void dispatchWindowInsetsAnimationPrepare(@NonNull WindowInsetsAnimation animation,
        ...
        mView.dispatchWindowInsetsAnimationPrepare(animation);
    }
    ...
    public WindowInsetsAnimation.Bounds dispatchWindowInsetsAnimationStart(
        ...
        final boolean isSyncedAnimation = com.android.window.flags.Flags.syncedInsetsAnimation()
                && !isUserAnimation && !isResizeAnimation && !hasAnimationCallback;
        if (isSyncedAnimation) {
            mSyncedWindowInsetsAnimationCount++;
            if (mSyncedWindowInsetsAnimationCount == 1) {
                final JankTracker jankTracker = mView.getJankTracker();
                if (jankTracker != null) {
                    jankTracker.updateUiState(AppJankStats.WIDGET_CATEGORY_KEYBOARD, mTag,
                            AppJankStats.WIDGET_STATE_NONE, AppJankStats.WIDGET_STATE_ANIMATING);
                }
            }
            return null;
        }
    ...
    public WindowInsets dispatchWindowInsetsAnimationProgress(@NonNull WindowInsets insets,
        ...
        return mWindowInsetsAnimationCount > 0 && !runningAnimations.isEmpty()
    ...
    public void dispatchWindowInsetsAnimationEnd(@NonNull WindowInsetsAnimation animation,
        ...
        if (isSyncedAnimation) {
            mSyncedWindowInsetsAnimationCount--;
            if (mSyncedWindowInsetsAnimationCount == 0) {
                mLastInsetsDuringAnimationProgress = null;
                final JankTracker jankTracker = mView.getJankTracker();
                if (jankTracker != null) {
                    jankTracker.updateUiState(AppJankStats.WIDGET_CATEGORY_KEYBOARD, mTag,
                            AppJankStats.WIDGET_STATE_ANIMATING, AppJankStats.WIDGET_STATE_NONE);
                }
            }
            return;
        }
    ...
    private void performTraversals(long frameTimeNanos) {
        ...
        mInvalidationTracer.traceTraversals(getTitle());
        ...
        final boolean syncDragResizing = com.android.window.flags.Flags.perfectEdge()
                && (mPendingDragResizing || mDragResizing);
        if (syncDragResizing) {
            mForceNextWindowRelayout = true;
            try {
                if (!mWindowSession.prepareFrame(mWindow, mSeqId)) {
                    mLastPerformTraversalsSkipDrawReason = "syncDragResizing";
                    scheduleTraversals();
                    return;
                }
            } catch (RemoteException e) {
        ...
        if (mFirst || windowShouldResize || viewVisibilityChanged || params != null
            ...
            if (mSurfaceHolder != null) {
                ...
                mSurfaceHolder.mDrawingAllowed = true;
            }
            ...
            try {
                ...
                if ((mRelayoutRequested && shouldPerformConfigurationUpdate)
                        // Always force config update on first traversal to guarantee double
                        // measure on startup to preserve legacy behavior.
                        // TODO(b/472424549): Remove the condition in the next milestone.
                        || (mFirst && com.android.window.flags.Flags.asyncRelayoutOnActivityLaunch()
            ...
            if (mSurfaceHolder != null) {
                ...
                if (surfaceCreated) {
                    ...
                    mSurfaceHolder.mIsCreating = true;
                ...
                if ((surfaceCreated || surfaceReplaced || surfaceSizeChanged
                    ...
                    mSurfaceHolder.mIsCreating = false;
                }
        ...
        // During synced drag-resizing, IWindowSession#prepareFrame will decide if the draw should
        // be cancelled or not at be beginning of this method. Once it decides to proceed, the draw
        // should not be cancelled. Or, the server won't receive the expected frame, and the frame
        // drawn by this window and the one drawn by the window decoration won't match.
        mCheckIfCanDraw = !syncDragResizing && (isSyncRequest || cancelDraw);
    ...
    /**
     * Checks (and caches) if content capture version 1 is enabled for this context.
     */
    @VisibleForTesting
    ...
    /**
     * Checks (without caching) if content version 1 is enabled for this context.
     */
    private boolean isContentCaptureReallyEnabled() {
        ...
        ContentCaptureOptions options = mContext.getContentCaptureOptions();
        if (options == null || options.contentCaptureVersion != ContentCaptureSession.VERSION_1) {
            return false;
        }

        final ContentCaptureManager ccm = mAttachInfo.getContentCaptureManager(mContext);
        // Then check if it's enabled in the context itself.
    ...
    boolean ensureTouchMode(boolean inTouchMode) {
        ...
        if (canControlTouchModeApi() && !mWindowAttributes.canChangeGlobalTouchMode()) {
            if (DBG) {
                Log.d("touchmode",
                        "TouchMode toggling is prevented due to canChangeGlobalTouchMode is false");
            }
            return false;
        }
    ...
    final class ViewPostImeInputStage extends InputStage {
        ...
        private int processPointerEvent(QueuedInputEvent q) {
            ...
            boolean handled = false;
            if (mWindowAttributes.type != TYPE_INPUT_METHOD) {
    ...
    public int getLastTouchMetaState() {
        return mLastTouchMetaState;
    }
    ...
    private boolean canRelayoutAsync(StringBuilder denialReason) {
        ...
        if (com.android.window.flags.Flags.asyncRelayoutOnActivityLaunch()
                && mFirst && mPendingMergedConfiguration.getMergedConfiguration().seq > 0) {
            // The local configuration matches the configuration from addToDisplayAsUser, so the
            // first frame can use async relayout.
            return true;
        }
        ...
        if (mSurfaceControl.isValid()) {
            if (mPendingDragResizing && !mSurfaceSize.equals(
                ...
                mTransaction.setWindowCrop(mSurfaceControl,
                        mWinFrameInScreen.width(), mWinFrameInScreen.height());
                if (com.android.window.flags.Flags.perfectEdge()) {
                    applyTransactionOnDraw(mTransaction);
                }
                mIsDragResizeCropSet = true;
            } else {
                if (!HardwareRenderer.isDrawingEnabled()) {
                    ...
                    mTransaction.setWindowCrop(mSurfaceControl, mSurfaceSize.x, mSurfaceSize.y)
                            .apply();
                } else if (!mPendingDragResizing && mIsDragResizeCropSet) {
    ...
    private void updateOpacity(WindowManager.LayoutParams params, boolean dragResizing,
        ...
        boolean wouldBeOpaqueWithoutCorners = false;

        if (com.android.window.flags.Flags.enableClientRoundedCornerGraphiteOpaqueHint()) {
            if (!PixelFormat.formatHasAlpha(params.format)
                    ...
                    && !dragResizing) {
                wouldBeOpaqueWithoutCorners = true;
                if (mCornerRadii.isEmpty()) {
                    opaque = true;
                }
            }

            boolean wouldBeOpaqueChanged =
                    mIsWouldBeOpaqueWithoutCorners != wouldBeOpaqueWithoutCorners;

            if (!forceUpdate && mIsSurfaceOpaque == opaque && !wouldBeOpaqueChanged) {
                return;
            }

            mTransaction.setWouldBeOpaqueIfNotForClientRoundedCorners(
                    mSurfaceControl, wouldBeOpaqueWithoutCorners && !mCornerRadii.isEmpty());
            mIsWouldBeOpaqueWithoutCorners = wouldBeOpaqueWithoutCorners;
        } else {
            if (!PixelFormat.formatHasAlpha(params.format)
                    // Don't make surface with surfaceInsets opaque as they display a
    ...
    public void dump(String prefix, PrintWriter writer) {
        ...
        if (mAtomicTraversalBarrier) {
            final long atomicBarrier = mTraversalBarrierAtomic.get();
            writer.println(innerPrefix + "mTraversalBarrierAtomic="
                    + (atomicBarrier == UNSET_TRAVERSAL_BARRIER ? "UNSET" : atomicBarrier));
        } else {
            writer.println(innerPrefix + "mTraversalBarrier=" + mTraversalBarrier);
        }
        writer.println(innerPrefix + "mIsInTraversal=" + mIsInTraversal);
        writer.println(innerPrefix + "mWillDrawSoon=" + mWillDrawSoon);
    ...
    void doDie() {
        ...
        synchronized (this) {
            ...
            mSharedAnimationController.detachFromWindow();
            removeVrrMessages();
            mImeFocusController.onWindowDismissed();
    ...
    final class WindowInputEventReceiver extends InputEventReceiver {
        ...
        @Override
        public void onDragEvent(boolean isExiting, float x, float y, int displayId, int inputSource,
                int metaState) {
            ...
            DragEvent event = DragEvent.obtain(
                    ...
                    inputSource, metaState, null/* localState */,
    ...
    final class ConsumeBatchedInputCallback implements Choreographer.VsyncCallback {
        ...
        public void onVsync(Choreographer.FrameData frameData) {
            ...
            try {
                mConsumeBatchedInputScheduled = false;
                long frameTime = android.view.flags.Flags.noMoreResync()
                        ? frameData.getFrameTimeNanosForInput() : frameData.getFrameTimeNanos();
                if (doConsumeBatchedInput(frameTime)) {
    ...
    private void registerSharedAnimationControllerOnWindow() {
        mSharedAnimationController.attachOnWindow(mWindowSession, mWindow);
    }
    ...
    private void setPreferredFrameRate(float preferredFrameRate) {
        ...
        // For MRR devices, we only allow setFrameRate votes to go through if there is no
        // explicit category preference. If there is a category preference, then we clear the
        // setFrameRate vote.
        if (sToolkitDisableCategoryOnMrrFlagValue && !mDisplay.hasArrSupport()
                && mPreferredFrameRateCategory != FRAME_RATE_CATEGORY_NO_PREFERENCE
                && mPreferredFrameRateCategory != FRAME_RATE_CATEGORY_DEFAULT) {
    ...
    private void removeVrrMessages() {
        if (sCleanupInitialTouchBoostOnDetachValue) {
            mHandler.removeMessages(MSG_INITIAL_TOUCH_BOOST_TIMEOUT);
        }
        mHandler.removeMessages(MSG_TOUCH_BOOST_TIMEOUT);
        mHandler.removeMessages(MSG_FRAME_RATE_SETTING);
    ...
    public boolean isIpcRenderingEnabled() {
        return mIpcRenderingEnabled;
    }
