...
public class DataSourceParams {
    ...
    private DataSourceParams(@PerfettoDsBufferExhausted int bufferExhaustedPolicy,
        ...
        this.protoVmProgram = protoVmProgram;
    }
    ...
    public final byte[] protoVmProgram;
    ...
    public static final class Builder {
        ...
        /**
         * Sets the ProtoVM program to be passed at data source registration time.
         */
        @Hide
        public Builder setProtoVmProgram(byte[] program) {
            this.mProtoVmProgram = program;
            return this;
        }
        ...
        public DataSourceParams build() {
            return new DataSourceParams(this.mBufferExhaustedPolicy, this.mWillNotifyOnStop,
                    this.mNoFlush, this.mPostponeStop, this.mProtoVmProgram);
        }
        ...
        private byte[] mProtoVmProgram = null;
    }
}
