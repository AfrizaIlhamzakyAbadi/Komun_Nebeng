...
public final class StatsEvent {
    ...
    public static final class Builder {
        ...
        private static final int POS_ATOM_ID = POS_TIMESTAMP_NS + TYPE_ID_SIZE + Long.BYTES;
        ...
        /**
         * Overwrites the timestamp for this StatsEvent.
         *
         * This API is only meant to be used for atoms logged while the CPU is asleep
         * (e.g. atoms from ambient domains). Most atoms should not override the timestamp.
         *
         * @param elapsedTimeNs the elapsed time in nanoseconds to overwrite the timestamp with.
         * @return this Builder.
         **/
        @NonNull
        @FlaggedApi(Flags.FLAG_STATS_EVENT_OVERWRITE_TIMESTAMP)
        public Builder setTimestampNanos(final long elapsedTimeNs) {
            if (elapsedTimeNs > SystemClock.elapsedRealtimeNanos()) {
                return this; // do not allow future timestamps
            }
            mTimestampNs = elapsedTimeNs;
            mBuffer.putLong(POS_TIMESTAMP_NS + TYPE_ID_SIZE, elapsedTimeNs);
            return this;
        }
