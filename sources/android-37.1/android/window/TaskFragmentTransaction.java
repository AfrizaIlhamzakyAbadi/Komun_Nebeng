...
public final class TaskFragmentTransaction implements Parcelable {
    ...
    /**
     * Change type: an Activity is removed from the embedded TaskFragment.
     * This is to notify the organizer to clear any pending appeared Activity.
     * Note: this will only be triggered for Activity belonging to the organizer process.
     */
    @Hide
    ...
    @IntDef(prefix = { "TYPE_" }, value = {
            ...
            TYPE_ACTIVITY_REMOVED_FROM_TASK_FRAGMENT
    })
    ...
    public static final class Change implements Parcelable {
        ...
        private Change(Parcel in) {
            ...
            mIsActivityInOrganizerProcess = in.readBoolean();
        }
        ...
        public void writeToParcel(@NonNull Parcel dest, int flags) {
            ...
            dest.writeBoolean(mIsActivityInOrganizerProcess);
        }
        ...
        @Hide
        @NonNull
        public Change setIsActivityInOrganizerProcess(boolean isActivityInOrganizerProcess) {
            mIsActivityInOrganizerProcess = isActivityInOrganizerProcess;
            return this;
        }
        ...
        /**
         * Whether the activity token in this change belongs to the organizer process.
         * Currently, this is only set for {@link #TYPE_ACTIVITY_REPARENTED_TO_TASK}.
         */
        @Hide
        public boolean isActivityInOrganizerProcess() {
            return mIsActivityInOrganizerProcess;
        }
