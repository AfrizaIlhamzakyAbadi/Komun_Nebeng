 ...
 */
@Hide
@DataClass(genToString = true, genSetters = true, genAidl = true, genCopyConstructor = true)
public final class TransitionRequestInfo implements Parcelable {
    ...
    public static final class DisplayChange implements Parcelable {
        ...
        public int getDisplayId() {
            if (!com.android.graphics.surfaceflinger.flags.Flags.modesetMultiDisplay()) {
                return mDisplayId;
            }
        ...
        /* package-private */ DisplayChange(
                int displayId,
                @Nullable Rect startAbsBounds,
                @Nullable Rect endAbsBounds,
                @Nullable DisplayAreaInfo endDisplayAreaInfo,
                int startRotation,
                int endRotation,
                boolean physicalDisplayChanged,
                int disconnectReparentDisplay,
                @Nullable InsetsState endInsetsState) {
         ...
         */
        @DataClass.Generated.Member
        public DisplayChange(@android.annotation.NonNull DisplayChange orig) {
            mDisplayId = orig.mDisplayId;
            mStartAbsBounds = orig.mStartAbsBounds;
            mEndAbsBounds = orig.mEndAbsBounds;
            mEndDisplayAreaInfo = orig.mEndDisplayAreaInfo;
            mStartRotation = orig.mStartRotation;
            mEndRotation = orig.mEndRotation;
            mPhysicalDisplayChanged = orig.mPhysicalDisplayChanged;
            mDisconnectReparentDisplay = orig.mDisconnectReparentDisplay;
            mEndInsetsState = orig.mEndInsetsState;
        }
     ...
     */
    @DataClass.Generated.Member
    public TransitionRequestInfo(@android.annotation.NonNull TransitionRequestInfo orig) {
        mType = orig.mType;
        mTriggerTask = orig.mTriggerTask;
        mPipChange = orig.mPipChange;
        mRemoteTransitionInfo = orig.mRemoteTransitionInfo;
        mDisplayChanges = orig.mDisplayChanges;
        mRequestedLocation = orig.mRequestedLocation;
        mUserChange = orig.mUserChange;
        mWindowingLayerChange = orig.mWindowingLayerChange;
        mFullscreenRequestChange = orig.mFullscreenRequestChange;
        mFlags = orig.mFlags;
        mDebugId = orig.mDebugId;
    }
