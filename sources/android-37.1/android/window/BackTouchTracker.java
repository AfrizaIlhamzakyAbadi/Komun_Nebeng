...
public class BackTouchTracker {
    ...
    // To track if the Shell allow client to drive progress animations from motion event.
    ...
    /**
     * Gets whether the app can generate progress from motion event.
     */
    public boolean isGenerateProgressAllowed() {
        return mGenerateProgressAllowed;
    }

    /**
     * Marks the app can generate progress from motion event.
     */
    public void setGenerateProgressAllowed(boolean generateProgressAllowed) {
        mGenerateProgressAllowed = generateProgressAllowed;
    }
    ...
    public void reset() {
        ...
        mGenerateProgressAllowed = false;
    }
