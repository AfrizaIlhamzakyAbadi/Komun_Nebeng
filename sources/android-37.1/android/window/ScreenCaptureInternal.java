...
public class ScreenCaptureInternal {
     ...
     * interpret the screenshot HardwareBuffer. The class adopts HardwareBuffer lifecycle and
     * must not be used after {@link ScreenshotHardwareBuffer#close()} is called.
     */
    @Hide
    public static class ScreenshotHardwareBuffer implements AutoCloseable {
        ...
        /**
         * Destroys HardwareBuffer and Gainmap immediately. This will free underlying native
         * resources. After calling this method, other methods using HardwareBuffer and Gainmap
         * must not be used.
         **/
        @Override
        public void close() {
