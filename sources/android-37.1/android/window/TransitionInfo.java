...
import android.window.sharedsurface.SharedSurfaceProviderInfo;
...
public final class TransitionInfo implements Parcelable {
    ...
    /** This change represents that the task has changed interactivity state. */
    public static final int FLAG_CHANGED_INTERACTIVE = 1 << 25;

    /** The container is not visible throughout this transition. */
    public static final int FLAG_INVISIBLE = 1 << 26;

    /** The first unused bit. This can be used by remotes to attach custom flags to this change. */
    public static final int FLAG_FIRST_CUSTOM = 1 << 27;
    ...
    public static String flagsToString(@ChangeFlags int flags) {
        ...
        if ((flags & FLAG_INVISIBLE) != 0) {
            sb.append(sb.length() == 0 ? "" : "|").append("FLAG_INVISIBLE");
        }
        return sb.toString();
    }
    ...
    public static final class Change implements Parcelable {
        ...
        /**
         * Whether this change contains at least one of the given change flags.
         *
         * @deprecated Use {@link #hasAnyFlag(int)} which is clearer about the check being done,
         * or {@link #hasAllFlags(int)}, which requires all of the flags.
         */
        @Deprecated
        ...
        /** Whether this change contains at least one of the given change flags. */
        public boolean hasAnyFlag(@ChangeFlags int flags) {
            return (mFlags & flags) != 0;
        }
    ...
    public static final class AnimationOptions implements Parcelable {
        ...
        private int mUserId;
        private SharedSurfaceProviderInfo mSharedSurfaceProviderInfo;
        ...
        private AnimationOptions(Parcel in) {
            ...
            mUserId = in.readInt();
            mSharedSurfaceProviderInfo = in.readTypedObject(SharedSurfaceProviderInfo.CREATOR);
        }
        ...
        public void setSharedAnimationProvider(@NonNull SharedSurfaceProviderInfo provider) {
            mSharedSurfaceProviderInfo = provider;
        }
        ...
        /** Return shared surface animation provider if existed. */
        @Nullable
        public SharedSurfaceProviderInfo getSharedSurfaceProviderInfo() {
            return mSharedSurfaceProviderInfo;
        }
        ...
        public void writeToParcel(@NonNull Parcel dest, int flags) {
            ...
            dest.writeTypedObject(mSharedSurfaceProviderInfo, flags);
        }
