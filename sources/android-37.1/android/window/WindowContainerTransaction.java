...
public final class WindowContainerTransaction implements Parcelable {
    ...
    /**
     * Send a SurfaceControl transaction to the server, which the server will apply in sync when
     * the main window is drawn with the same seqId. This is used during drag-resizing, so the
     * transaction of drawing the main window can be applied togerther with the transaction of
     * drawing the window decoration.
     */
    @Hide
    @NonNull
    public WindowContainerTransaction setWindowDecorationTransaction(
            @NonNull WindowContainerToken container, int seqId,
            @NonNull SurfaceControl.Transaction t) {
        final Change chg = getOrCreateChange(container.asBinder());
        chg.mSeqId = seqId;
        chg.mWindowDecorationTransaction = t;
        chg.mChangeMask |= Change.CHANGE_WINDOW_DECORATION_TRANSACTION;
        return this;
    }
     ...
     *
     * <p>The container must be a TaskDisplayArea for this setting to have effect.
     *
    ...
    public WindowContainerTransaction removeTask(@NonNull WindowContainerToken containerToken) {
        return removeTask(containerToken, /* removeFromRecents */ true);
    }
    ...
    public static class Change implements Parcelable {
        ...
        public static final int CHANGE_WINDOW_DECORATION_TRANSACTION = 1 << 19;
        ...
        @IntDef(flag = true, prefix = { "CHANGE_" }, value = {
                ...
                CHANGE_WINDOW_DECORATION_TRANSACTION
        })
        @Retention(RetentionPolicy.SOURCE)
        ...
        @Nullable
        private SurfaceControl.Transaction mWindowDecorationTransaction = null;
        ...
        private Change(@NonNull Parcel in) {
            ...
            mSeqId = in.readInt();
            if ((mChangeMask & Change.CHANGE_WINDOW_DECORATION_TRANSACTION) != 0) {
                mWindowDecorationTransaction =
                        SurfaceControl.Transaction.CREATOR.createFromParcel(in);
            }
        }
        ...
        public void merge(@NonNull Change other, boolean transfer) {
            ...
            if ((other.mChangeMask & CHANGE_WINDOW_DECORATION_TRANSACTION) != 0) {
                if (transfer) {
                    mSeqId = other.mSeqId;
                    mWindowDecorationTransaction = other.mWindowDecorationTransaction;
                    other.mSeqId = -1;
                    other.mWindowDecorationTransaction = null;
                }
            }
        ...
        /**
         * Returns the ID of the frame that the window decoration is drawn for.
         */
        public int getSeqId() {
            return mSeqId;
        }
        ...
        /**
         * Returns the {@link SurfaceControl.Transaction} which collects the operations done by the
         * WindowDecoration for a specific frame.
         */
        @Nullable
        public SurfaceControl.Transaction getWindowDecorationTransaction() {
            return mWindowDecorationTransaction;
        }
        ...
        public String toString() {
            ...
            if (mSeqId != -1) {
                sb.append("mSeqId:").append(mSeqId).append(",");
            }
            if (mWindowDecorationTransaction != null) {
                sb.append("hasWindowDecorationTransaction,");
            }
        ...
        public void writeToParcel(@NonNull Parcel dest, int flags) {
            ...
            dest.writeInt(mSeqId);
            if (mWindowDecorationTransaction != null) {
                mWindowDecorationTransaction.writeToParcel(dest, flags);
            }
        }
    ...
    public static final class HierarchyOp implements Parcelable {
        ...
        public boolean getRemoveFromRecents() {
        ...
        private static class Builder {
            ...
            Builder setRemoveFromRecents(boolean removeFromRecents) {
                mRemoveFromRecents = removeFromRecents;
                return this;
            }
