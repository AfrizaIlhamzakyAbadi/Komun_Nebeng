...
import android.uwb.timesync.TimesyncConfig;
...
public final class UwbManager {
    ...
    /**
     * Get the timesync configuration.
     *
     * @return {@link TimesyncConfig} object containing timesync configuration.
     */
    ...
    public TimesyncConfig getTimesyncConfig() {
        try {
            return mUwbAdapter.getTimesyncConfig();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
