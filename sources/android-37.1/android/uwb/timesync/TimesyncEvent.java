...
public final class TimesyncEvent implements Parcelable {
    ...
    @TimesyncStatus private int mEventStatus;
    ...
    private TimesyncEvent(Builder builder) {
        ...
        mEventStatus = builder.mEventStatus;
        mIsClockSkewMeasurementAvailable = builder.mIsClockSkewMeasurementAvailable;
    }
    ...
    @Hide
    @Retention(RetentionPolicy.SOURCE)
    @IntDef({STATUS_SUCCESS, STATUS_UWB_DISABLED, STATUS_INTERNAL_ERROR})
    public @interface TimesyncStatus {}

    @FlaggedApi(com.android.ranging.flags.Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    public static final int STATUS_SUCCESS = 0;
    @FlaggedApi(com.android.ranging.flags.Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    public static final int STATUS_UWB_DISABLED = 1;
    @FlaggedApi(com.android.ranging.flags.Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    ...
    /**
     * Returns the status of the timesync event.
     *
     * @return timesync status {@link TimesyncStatus}
     */
    @TimesyncStatus
    @FlaggedApi(com.android.ranging.flags.Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
    ...
    /**
     * Indicates whether the User Device's clock system supports dynamic UWB clock skew measurement.
     * <p>
     * Under the Aliro and CCC Digital Key specifications (Supplementary Service Attribute ID 3),
     * this flag informs the Reader or Vehicle whether it can dynamically estimate and correct for
     * relative UWB clock drift over time rather than relying on static worst-case bounds.
     * </p>
     */
    @FlaggedApi(com.android.ranging.flags.Flags.FLAG_RANGING_STACK_UPDATES_26_Q_4)
            ...
            new Creator<TimesyncEvent>() {
                ...
                public TimesyncEvent createFromParcel(Parcel in) {
                    Builder builder = new Builder(
                            ...
                            in.readInt(),
                            in.readInt());
                    builder.setEventStatus(in.readInt());
                    builder.setClockSkewMeasurementAvailable(in.readBoolean());
    ...
    public static final class Builder {
        ...
        private int mMaxClockSkewPpm;
        private int mEventCounter;
        @TimesyncStatus private int mEventStatus = STATUS_SUCCESS;
        private boolean mIsClockSkewMeasurementAvailable = false;
        ...
        /** Set event status */
        @NonNull
        public Builder setEventStatus(@TimesyncStatus int eventStatus) {
            mEventStatus = eventStatus;
            return this;
        }

        /** Set clock skew measurement availability */
        @NonNull
        public Builder setClockSkewMeasurementAvailable(boolean isAvailable) {
            mIsClockSkewMeasurementAvailable = isAvailable;
            return this;
        }
    ...
    public String toString() {
        return "TimesyncEvent{" +
                ...
                ", mUwbTimestamp=" + mUwbTimestamp +
                ", mDeviceTimeUncertainty=" + mDeviceTimeUncertainty +
                ", mMaxClockSkewPpm=" + mMaxClockSkewPpm +
                ", mEventCounter=" + mEventCounter +
                ", mEventStatus=" + mEventStatus +
                ", mIsClockSkewMeasurementAvailable=" + mIsClockSkewMeasurementAvailable +
                '}';
    }
}
