...
public class SecurityLogTags {
  ...
  /** 210041 security_package_installed (package_name|3),(version_code|2),(user_id|1) */
  public static final int SECURITY_PACKAGE_INSTALLED = 210041;

  /** 210042 security_package_updated (package_name|3),(version_code|2),(user_id|1) */
  public static final int SECURITY_PACKAGE_UPDATED = 210042;

  /** 210043 security_package_uninstalled (package_name|3),(version_code|2),(user_id|1) */
  ...
  public static void writeSecurityPackageInstalled(String packageName, long versionCode, int userId) {
    android.util.EventLog.writeEvent(SECURITY_PACKAGE_INSTALLED, packageName, versionCode, userId);
  }

  public static void writeSecurityPackageUpdated(String packageName, long versionCode, int userId) {
    android.util.EventLog.writeEvent(SECURITY_PACKAGE_UPDATED, packageName, versionCode, userId);
  }

  public static void writeSecurityPackageUninstalled(String packageName, long versionCode, int userId) {
