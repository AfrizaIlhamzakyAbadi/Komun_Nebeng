...
public abstract class DevicePolicyManagerInternal {
    ...
    /**
     * Returns the multiuser managed device provisioning state.
     */
    public abstract int getMultiuserManagedDeviceProvisioningState();

    /**
     * Returns whether the user has affiliation with the device.
     */
    public abstract boolean hasAffiliationWithDevice(int userId);
    ...
    /**
     * Enforces resolved network logging policy, should only be invoked from device policy engine.
     */
    public abstract void enforceNetworkLoggingPolicy(int userId, boolean enabled);
