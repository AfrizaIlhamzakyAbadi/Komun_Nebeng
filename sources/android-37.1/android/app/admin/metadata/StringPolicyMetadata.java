...
public class StringPolicyMetadata extends PolicyMetadata<String> {
    ...
    private final boolean mPureWhitespaceAllowed;
    private final boolean mUnstrippedStringAllowed;
    ...
    public StringPolicyMetadata(
            ...
            boolean pureWhitespaceAllowed,
            boolean unstrippedStringAllowed,
            int maxLength) {
        super(
                id,
                allowedScopes,
        ...
        mPureWhitespaceAllowed = pureWhitespaceAllowed;
        mUnstrippedStringAllowed = unstrippedStringAllowed;
    ...
    public boolean isPureWhitespaceAllowed() {
        return mPureWhitespaceAllowed;
    }

    public boolean isUnstrippedStringAllowed() {
        return mUnstrippedStringAllowed;
    }
