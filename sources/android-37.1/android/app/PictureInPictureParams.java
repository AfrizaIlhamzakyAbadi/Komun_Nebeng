...
public final class PictureInPictureParams implements Parcelable {
    ...
    public static class Builder {
        ...
        @Nullable
        private RemoteAction mPrimaryAction;
        ...
        public Builder(@NonNull PictureInPictureParams original) {
            ...
            mPrimaryAction = original.mPrimaryAction;
        ...
        public Builder setActions(List<RemoteAction> actions) {
            return setActions(actions, null);
        }

        /**
         * Sets the user actions and a primary action. If there are more than
         * {@link Activity#getMaxNumPictureInPictureActions()} actions, then the input list
         * will be truncated to that number.
         *
         * <p>If the primary action is valid, the system would use a modern UI for the PiP menu.</p>
         *
         * @param actions the new actions to show in the picture-in-picture menu.
         * @param primaryAction to be used as the primary action in the PiP menu. This action MUST
         *                      be one of the actions set via {@code actions}.
         *
         * @return this builder instance.
         *
         * @see RemoteAction
         */
        @FlaggedApi(Flags.FLAG_ENABLE_PIP_UMO_EXPERIENCE)
        public @NonNull Builder setActions(@Nullable List<RemoteAction> actions,
                @Nullable RemoteAction primaryAction) {
            ...
            if (primaryAction != null) {
                if (mUserActions == null || !mUserActions.contains(primaryAction)) {
                    throw new IllegalArgumentException(
                            "Primary action must be one of the actions set via setActions()");
                }
        ...
        public PictureInPictureParams build() {
            PictureInPictureParams params = new PictureInPictureParams(mAspectRatio,
                    mExpandedAspectRatio, mUserActions, mCloseAction, mPrimaryAction,
    ...
    /**
     * Action to be used as the primary action in the PiP menu.
     */
    @Nullable
    private RemoteAction mPrimaryAction;
    ...
    PictureInPictureParams(Parcel in) {
        ...
        mPrimaryAction = in.readTypedObject(RemoteAction.CREATOR);
        if (in.readInt() != 0) {
        ...
        sanitizePrimaryAction();
    }

    @Hide
    PictureInPictureParams(Rational aspectRatio, Rational expandedAspectRatio,
            List<RemoteAction> actions, RemoteAction closeAction, RemoteAction primaryAction,
            Rect sourceRectHint, Boolean autoEnterEnabled, Boolean seamlessResizeEnabled,
            CharSequence title, CharSequence subtitle, Boolean isLaunchIntoPip) {
        mAspectRatio = aspectRatio;
        mExpandedAspectRatio = expandedAspectRatio;
    ...
    public void copyOnlySet(PictureInPictureParams otherArgs) {
        ...
        if (otherArgs.hasSetPrimaryAction()) {
            mPrimaryAction = otherArgs.mPrimaryAction;
        }
     ...
     *
     * @return the primary action or {@code null} if not set.
     * @see PictureInPictureParams.Builder#setPrimaryAction(RemoteAction)
     */
    @FlaggedApi(Flags.FLAG_ENABLE_PIP_UMO_EXPERIENCE)
    @Nullable
    public RemoteAction getPrimaryAction() {
        return mPrimaryAction;
    }

    /**
     * @return whether the primary action was set.
     */
    @Hide
    public boolean hasSetPrimaryAction() {
        return mPrimaryAction != null;
    }
    ...
    public boolean empty() {
        return !hasSourceBoundsHint() && !hasSetActions() && !hasSetCloseAction()
                && !hasSetPrimaryAction() && !hasSetAspectRatio() && !hasSetExpandedAspectRatio()
                && mAutoEnterEnabled == null && mSeamlessResizeEnabled == null && !hasSetTitle()
    ...
    public int hashCode() {
        return Objects.hash(mAspectRatio, mExpandedAspectRatio, mUserActions, mCloseAction,
                mPrimaryAction, mSourceRectHint, mAutoEnterEnabled, mSeamlessResizeEnabled, mTitle,
                mSubtitle, mIsLaunchIntoPip);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        out.writeTypedObject(mPrimaryAction, 0);
    ...
    /**
     * Sanitizes {@link #mPrimaryAction} is in {@link #mUserActions} if it's set.
     * Otherwise, reset {@link #mPrimaryAction} to {@code null}.
     */
    private void sanitizePrimaryAction() {
        if (mUserActions == null || mUserActions.isEmpty()) {
            mPrimaryAction = null;
        } else if (mPrimaryAction != null && !mUserActions.contains(mPrimaryAction)) {
            mPrimaryAction = null;
        }
    }
    ...
    public String toString() {
        return "PictureInPictureParams("
                ...
                + " hasSetPrimaryAction=" + hasSetPrimaryAction()
