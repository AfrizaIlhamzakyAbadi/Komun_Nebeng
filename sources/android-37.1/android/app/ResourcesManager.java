...
public class ResourcesManager {
    ...
    @RavenwoodIgnore(reason = "Make ResourcesManager independent from DisplayManagerGlobal")
    private static DisplayManagerGlobal getDisplayManager() {
    ...
    public @NonNull DisplayMetrics getDisplayMetrics(int displayId, DisplayAdjustments da) {
        final DisplayManagerGlobal displayManagerGlobal = getDisplayManager();
     ...
     */
    @RavenwoodThrow(blockedBy = DisplayManagerGlobal.class)
