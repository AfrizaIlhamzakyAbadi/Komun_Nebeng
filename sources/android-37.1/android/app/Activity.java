...
public class Activity extends ContextThemeWrapper
    ...
    /**
     * Task is finished if the finishing activity is the root of the task. To preserve the
    ...
    /**
     * Task is finished along with the finishing activity, but it is not removed from
     * recents.
     */
    @Hide
    ...
    @TestApi public static final String DUMP_ARG_LIST_DUMPABLES = "--list-dumpables";
    @TestApi public static final String DUMP_ARG_DUMP_DUMPABLE = "--dump-dumpable";
    ...
    @Hide
    @Override
    public final int getNextAutofillId() {
 ...
 flag(com.android.window.flags.Flags.FLAG_ENABLE_APP_RESTART_AFTER_UPDATE)){ and updates}}.
    ...
    /**
     * Implement to provide correct calling token.
     */
    @Hide
    @Override
     ...
     */
    @Hide
    public final boolean isOverlayWithDecorCaptionEnabled() {
     ...
     */
    @Hide
    public final void setOverlayWithDecorCaptionEnabled(boolean enabled) {
    ...
    public final void setActivityRecordInputSinkEnabled(boolean enabled) {
