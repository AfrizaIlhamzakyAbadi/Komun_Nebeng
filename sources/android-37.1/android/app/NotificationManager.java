...
import static android.app.Flags.refactorModesCode;
...
public class NotificationManager {
    ...
    private final Object mModesServiceLock = new Object();
    @Nullable private volatile IContextualModeManager mModesService;
    ...
    private IContextualModeManager getModesService() {
        if (!refactorModesCode()) {
            throw new IllegalStateException("refactor_modes_code is not enabled");
        }
        if (mModesService != null) {
            return mModesService;
        }
        synchronized (mModesServiceLock) {
            if (mModesService == null) {
                IBinder service = ServiceManager.getService(Context.CONTEXTUAL_MODE_SERVICE);
                mModesService = IContextualModeManager.Stub.asInterface(service);
            }
            return mModesService;
        }
    }
    ...
    public boolean matchesCallFilter(Bundle extras) {
        try {
            return refactorModesCode()
                    ? getModesService().matchesCallFilter(extras)
                    : service().matchesCallFilter(extras);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void cleanUpCallersAfter(long timeThreshold) {
        try {
            if (refactorModesCode()) {
                getModesService().cleanUpCallersAfter(timeThreshold);
            } else {
    ...
    public void setZenMode(int mode, Uri conditionId, String reason, boolean fromUser) {
        try {
            if (refactorModesCode()) {
                getModesService().setZenMode(mode, conditionId, reason, fromUser);
            } else {
    ...
    public int getZenMode() {
        try {
            return refactorModesCode() ? getModesService().getZenMode() : service().getZenMode();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public ZenModeConfig getZenModeConfig() {
        try {
            return refactorModesCode()
                    ? getModesService().getZenModeConfig()
    ...
    public @NonNull NotificationManager.Policy getConsolidatedNotificationPolicy() {
        try {
            return refactorModesCode()
                    ? getModesService().getConsolidatedNotificationPolicy()
                    : service().getConsolidatedNotificationPolicy();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int getRuleInstanceCount(ComponentName owner) {
        try {
            return refactorModesCode()
                    ? getModesService().getRuleInstanceCount(owner)
                    : service().getRuleInstanceCount(owner);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public Map<String, AutomaticZenRule> getAutomaticZenRules() {
        try {
            ...
            ParceledListSlice<AutomaticZenRule.AzrWithId> parceledRules =
                    refactorModesCode()
                            ? getModesService().getAutomaticZenRules()
    ...
    public AutomaticZenRule getAutomaticZenRule(String id) {
        try {
            return refactorModesCode()
                    ? getModesService().getAutomaticZenRule(id)
                    : service().getAutomaticZenRule(id);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public String addAutomaticZenRule(@NonNull AutomaticZenRule automaticZenRule,
        ...
        try {
            return refactorModesCode()
                    ? getModesService().addAutomaticZenRule(automaticZenRule,
                        mContext.getPackageName(), fromUser)
                    : service().addAutomaticZenRule(automaticZenRule, mContext.getPackageName(),
                            fromUser);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public boolean updateAutomaticZenRule(@NonNull String id,
        ...
        try {
            return refactorModesCode()
                    ? getModesService().updateAutomaticZenRule(id, automaticZenRule, fromUser)
                    : service().updateAutomaticZenRule(id, automaticZenRule, fromUser);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int getAutomaticZenRuleState(@NonNull String id) {
        try {
            return refactorModesCode()
                    ? getModesService().getAutomaticZenRuleState(id)
                    : service().getAutomaticZenRuleState(id);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setAutomaticZenRuleState(@NonNull String id, @NonNull Condition condition) {
        try {
            if (refactorModesCode()) {
                getModesService().setAutomaticZenRuleState(id, condition);
            } else {
    ...
    public boolean removeAutomaticZenRule(@NonNull String id, boolean fromUser) {
        try {
            return refactorModesCode()
                    ? getModesService().removeAutomaticZenRule(id, fromUser)
                    : service().removeAutomaticZenRule(id, fromUser);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean removeAutomaticZenRules(String packageName, boolean fromUser) {
        try {
            return refactorModesCode()
                    ? getModesService().removeAutomaticZenRules(packageName, fromUser)
                    : service().removeAutomaticZenRule(packageName, fromUser);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isNotificationPolicyAccessGranted() {
        try {
            return refactorModesCode()
                    ? getModesService().isNotificationPolicyAccessGranted(
                            mContext.getOpPackageName())
    ...
    public boolean isNotificationPolicyAccessGrantedForPackage(@NonNull String pkg) {
        try {
            return refactorModesCode()
                    ? getModesService().isNotificationPolicyAccessGrantedForPackage(pkg)
                    : service().isNotificationPolicyAccessGrantedForPackage(pkg);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public List<String> getEnabledZenPackages() {
        try {
            return refactorModesCode()
                    ? getModesService().getEnabledZenPackages()
                    : service().getEnabledZenPackages();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public Policy getNotificationPolicy() {
        try {
            return refactorModesCode()
                    ? getModesService().getNotificationPolicy(mContext.getOpPackageName())
    ...
    public void setNotificationPolicy(@NonNull Policy policy, boolean fromUser) {
        ...
        try {
            if (refactorModesCode()) {
                getModesService().setNotificationPolicy(mContext.getOpPackageName(), policy,
                        fromUser);
            } else {
    ...
    public void setNotificationPolicyAccessGranted(@NonNull String pkg, boolean granted) {
        try {
            if (refactorModesCode()) {
                getModesService().setNotificationPolicyAccessGranted(pkg, granted);
            } else {
    ...
    public @NonNull ZenPolicy getDefaultZenPolicy() {
        try {
            return refactorModesCode()
                    ? getModesService().getDefaultZenPolicy()
                    : service().getDefaultZenPolicy();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setManualZenRuleDeviceEffects(@NonNull ZenDeviceEffects effects) {
        try {
            if (refactorModesCode()) {
                getModesService().setManualZenRuleDeviceEffects(effects);
            } else {
    ...
    public final @InterruptionFilter int getCurrentInterruptionFilter() {
        try {
            return zenModeToInterruptionFilter(refactorModesCode()
                    ? getModesService().getZenMode() : service().getZenMode());
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public final void setInterruptionFilter(@InterruptionFilter int interruptionFilter,
        ...
        try {
            if (refactorModesCode()) {
                getModesService().setInterruptionFilter(mContext.getOpPackageName(),
                        interruptionFilter, fromUser);
            } else {
                service().setInterruptionFilter(mContext.getOpPackageName(),
                        interruptionFilter, fromUser);
            }
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
