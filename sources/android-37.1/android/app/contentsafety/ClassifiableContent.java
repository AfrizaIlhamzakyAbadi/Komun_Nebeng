...
public final class ClassifiableContent implements Parcelable {
    ...
    /**
     * The package name of the app that requested the classification.
     */
    ...
    private ClassifiableContent(@NonNull Parcel in) {
        ...
        mOriginatingPackageName = in.readString8();
    }
     ...
     *
     * @return the originating package name, or {@code null} if the originating package is unknown
     *     or not provided
     */
    @Nullable
    ...
    /**
     * Sets the package name of the app that requested the classification.
     */
    @Hide
    public void setOriginatingPackageName(@Nullable String originatingPackageName) {
    ...
    public void writeToParcel(@NonNull Parcel parcel, @WriteFlags int flags) {
        ...
        parcel.writeString8(mOriginatingPackageName);
    }
