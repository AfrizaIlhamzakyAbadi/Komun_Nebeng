...
public class ActivityManager {
    ...
    /**
     * User operation call: given user id is not known.
     */
    @Hide
    public static final int USER_OP_UNKNOWN_USER = -1;

    /**
     * User operation call: given user id is the current user, can't be stopped.
     */
    @Hide
    public static final int USER_OP_IS_CURRENT = -2;

    /**
     * User operation call: system user can't be stopped.
     */
    @Hide
    public static final int USER_OP_ERROR_IS_SYSTEM = -3;

    /**
     * User operation call: one of related users cannot be stopped.
     */
    @Hide
    ...
    /**
     * Process does not have any capability
     */
    @SystemApi
    public static final int PROCESS_CAPABILITY_NONE = 0;

    /**
     * Process can access location while in foreground
     */
    @SystemApi
    public static final int PROCESS_CAPABILITY_FOREGROUND_LOCATION = 1 << 0;

    /**
     * Process can access camera while in foreground
     */
    @SystemApi
    public static final int PROCESS_CAPABILITY_FOREGROUND_CAMERA = 1 << 1;

    /**
     * Process can access microphone while in foreground
     */
    @SystemApi
    public static final int PROCESS_CAPABILITY_FOREGROUND_MICROPHONE = 1 << 2;

    /**
     * Process can access network despite any power saving restrictions
     */
    @TestApi
    ...
    @Hide
    @RavenwoodKeep
    public static final int processStateAmToProto(@ProcessState int amInt) {
        switch (amInt) {
    ...
    /**
     * Should this process state be considered in the cache?
     */
    @Hide
    @RavenwoodKeep
    ...
    /**
     * Is this a foreground service type?
     */
    @Hide
    @RavenwoodKeep
    ...
    /**
     * Should this process state be considered jank perceptible?
     */
    @Hide
    ...
    /**
     * requestType for assist context: generate AssistStructure, but skip screen content
     * & view hierarchy.
     */
    @Hide
    ...
    /**
     * Mode for {@link IActivityManager#isAppStartModeDisabled}: normal free-to-run operation.
     */
    @Hide
    public static final int APP_START_MODE_NORMAL = 0;

    /**
     * Mode for {@link IActivityManager#isAppStartModeDisabled}: delay running until later.
     */
    @Hide
    public static final int APP_START_MODE_DELAYED = 1;

    /**
     * Mode for {@link IActivityManager#isAppStartModeDisabled}: delay running until later, with
    ...
    /**
     * Mode for {@link IActivityManager#isAppStartModeDisabled}: disable/cancel pending
    ...
    public static class TaskDescription implements Parcelable {
        ...
        public static final class Builder {
            ...
            public TaskDescription build() {
                return new TaskDescription(mLabel, mIcon, mBadge, mPrimaryColor, mBackgroundColor,
                        0, mStatusBarColor, mNavigationBarColor, 0, 0, false, false,
        ...
        public TaskDescription(String label, @DrawableRes int iconRes) {
            this(label, Icon.createWithResource(ActivityThread.currentPackageName(), iconRes),
                    null, 0, 0, 0, 0, 0, 0, 0, false, false, RESIZE_MODE_RESIZEABLE, -1, -1, 0);
        }
        ...
        public TaskDescription(String label) {
            this(label, null, null, 0, 0, 0, 0, 0, 0, 0, false, false, RESIZE_MODE_RESIZEABLE,
                    -1, -1, 0);
        }
        ...
        public TaskDescription() {
            this(null, null, null, 0, 0,  0, 0, 0, 0, 0, false, false, RESIZE_MODE_RESIZEABLE,
                    -1, -1, 0);
        }
        ...
        public TaskDescription(@Nullable String label, @Nullable Icon icon,
                @Nullable Icon badge, int colorPrimary, @ColorInt int colorBackground,
                @ColorInt int topOpaqueColorBackground, int statusBarColor, int navigationBarColor,
            ...
            mTopOpaqueColorBackground = topOpaqueColorBackground;
        ...
        public void copyFrom(TaskDescription other) {
            ...
            mTopOpaqueColorBackground = other.mTopOpaqueColorBackground;
        ...
        public void copyFromPreserveHiddenFields(TaskDescription other) {
            ...
            if (other.mTopOpaqueColorBackground != 0) {
                mTopOpaqueColorBackground = other.mTopOpaqueColorBackground;
            }
        ...
        /**
         * @return the color override on the theme's background color from the top visible activity.
         */
        @Hide
        @ColorInt
        public int getTopOpaqueBackgroundColor() {
            return mTopOpaqueColorBackground;
        }
        ...
        @Hide
        public void setTopOpaqueBackgroundColor(@ColorInt int backgroundColor) {
            mTopOpaqueColorBackground = backgroundColor;
        }
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeInt(mTopOpaqueColorBackground);
        ...
        public void readFromParcel(Parcel source) {
            ...
            mTopOpaqueColorBackground = source.readInt();
        ...
        public String toString() {
            return "TaskDescription Label: " + mLabel + " Icon: " + mIcon
                    ...
                    + " topOpaqueColorBackground: " + mTopOpaqueColorBackground
                    ...
                    + " colorBackgroundFloating: " + mColorBackgroundFloating
        ...
        public int hashCode() {
            ...
            result = result * 31 + mTopOpaqueColorBackground;
     ...
     * <a href="https://developer.android.com/studio/test/other-testing-tools/monkey">monkey</a>.
     */
    @RavenwoodRedirect
