...
import static android.app.Flags.notificationsReduceImageSizesPutExtras;
...
import android.graphics.BitmapCache;
...
public class Notification implements Parcelable
{
    ...
    /**
     * If the requesting app is capable of setting agent tasks, this notification's icon will not
     * show in the status bar.
     *
     * @see StatusBarManager#canSetAgentTask
     */
    @Hide
    @FlaggedApi(Flags.FLAG_STATUS_BAR_AGENT_ICON)
    public static final int FLAG_AGENT_TASK_INTERACTION_HIDE_STATUS_BAR_ICON = 1 << 0;

    /**
     * If the requesting app is capable of setting agent tasks, this notification should be treated
     * as silent.
     *
     * @see StatusBarManager#canSetAgentTask
     */
    @Hide
    @FlaggedApi(Flags.FLAG_STATUS_BAR_AGENT_ICON)
    public static final int FLAG_AGENT_TASK_INTERACTION_SILENT = 1 << 1;

    @Hide
    @Retention(RetentionPolicy.SOURCE)
    @IntDef(flag = true, prefix = { "FLAG_AGENT_TASK_INTERACTION_" }, value = {
            FLAG_AGENT_TASK_INTERACTION_HIDE_STATUS_BAR_ICON,
            FLAG_AGENT_TASK_INTERACTION_SILENT,
    })
    public @interface AgentTaskInteractionFlag {}

    private int mAgentInteractionFlags = 0;

    /**
     * Gets the agent interaction flags for this notification.
     */
    @Hide
    @FlaggedApi(Flags.FLAG_STATUS_BAR_AGENT_ICON)
    @AgentTaskInteractionFlag
    public int getAgentInteractionFlags() {
        return mAgentInteractionFlags;
    }
    ...
    private static boolean isStandardLayout(int layoutId) {
        return switch (layoutId) {
            case R.layout.notification_template_collapsed_base,
                 R.layout.notification_template_expanded_base,
                 R.layout.notification_template_heads_up_base,
                 R.layout.notification_template_header,
                 R.layout.notification_template_collapsed_conversation,
                 R.layout.notification_template_expanded_conversation,
                 R.layout.notification_template_collapsed_call,
                 R.layout.notification_template_expanded_call,
                 R.layout.notification_template_collapsed_messaging,
                 R.layout.notification_template_expanded_messaging,
                 R.layout.notification_template_collapsed_media,
                 R.layout.notification_template_expanded_media,
                 R.layout.notification_template_expanded_big_picture,
                 R.layout.notification_template_expanded_big_text,
                 R.layout.notification_template_expanded_progress,
                 R.layout.notification_template_expanded_inbox -> true;
            case R.layout.notification_template_collapsed_metric
                    -> Flags.apiMetricStyle();
            case R.layout.notification_template_expanded_metric
                    -> Flags.apiMetricStyle();
            case R.layout.notification_template_expanded_single_metric
                    -> Flags.apiMetricStyle();
            default -> false;
        };
    }
    ...
    private void readFromParcelImpl(Parcel parcel)
    {
        ...
        mAgentInteractionFlags = parcel.readInt();
    }
    ...
    public void cloneInto(Notification that, boolean heavy) {
        ...
        that.mAgentInteractionFlags = this.mAgentInteractionFlags;
    ...
    /**
     * Offloads bitmaps in all RemoteViews associated with this notification.
     */
    @Hide
    public void offloadRemoteViewBitmaps(Function<Bitmap, Uri> offloader) {
        final IdentityHashMap<Bitmap, Uri> cache = new IdentityHashMap<>();
        Function<Bitmap, Uri> cachedOffloader = b ->
                cache.computeIfAbsent(b, offloader);

        if (contentView != null) contentView.offloadBitmaps(cachedOffloader);
        if (bigContentView != null) bigContentView.offloadBitmaps(cachedOffloader);
        if (headsUpContentView != null) headsUpContentView.offloadBitmaps(cachedOffloader);
        if (publicVersion != null) {
            publicVersion.offloadRemoteViewBitmaps(cachedOffloader);
        }
    }
    ...
    */
    ...
    private void writeToParcelImpl(Parcel parcel, int flags) {
        ...
        parcel.writeInt(mAgentInteractionFlags);
    ...
    public String toString() {
        ...
        sb.append(" template=");
        sb.append(extras.getString(Notification.EXTRA_TEMPLATE));
        sb.append(")");
        return sb.toString();
    }
    ...
    /**
     * Returns whether this is a bridged notification.
     */
    @Hide
    public boolean isBridged() {
        return Flags.bridgedNotifications() && mBridgedNotificationMetadata != null;
    }
    ...
    public static class Builder {
        ...
        /**
         * Sets the agent interaction flags for this notification.
         */
        @Hide
        @FlaggedApi(Flags.FLAG_STATUS_BAR_AGENT_ICON)
        @NonNull
        public Builder setAgentInteractionFlags(@AgentTaskInteractionFlag int flags) {
            mN.mAgentInteractionFlags = flags;
            return this;
        }
        ...
        private void adjustExpandButtonPadding(RemoteViews contentView, boolean rightIconVisible) {
            ...
            int normalPadding = res.getDimensionPixelSize(R.dimen.notification_margin);
            int iconSpacing = res.getDimensionPixelSize(
                    R.dimen.notification_expand_button_right_icon_spacing);
        ...
        int getLargeIconMarginEnd(@NonNull StandardTemplateParams p) {
            ...
            if (mN.isPromotedOngoing() && !p.mHeaderless) {
                ...
                return res.getDimensionPixelSize(R.dimen.notification_margin);
            }

            int rightIconMarginPx = res.getDimensionPixelSize(
                    R.dimen.notification_right_icon_margin_end);
            int extraSpaceForExpanderPx = res.getDimensionPixelSize(
                    R.dimen.notification_extra_space_for_expander);
        ...
        private void bindBridgedIcon(RemoteViews contentView) {
            if (mN.getBridgedNotificationMetadata() != null) {
                ...
                contentView.setInt(R.id.bridging_app_icon, "setIconTypeOverride",
                        NotificationRowIconView.ICON_TYPE_TRANSPARENT_LAUNCHER_ICON);
            }
        }
        ...
        private void updateMarginsForActions(RemoteViews contentView, boolean emphasizedMode) {
            if (emphasizedMode) {
                ...
                contentView.setViewLayoutMarginDimen(R.id.actions_container,
                        ...
                        R.dimen.notification_smart_reply_container_margin);
                contentView.setViewLayoutMarginDimen(R.id.actions_container,
                ...
                contentView.setViewLayoutMarginDimen(R.id.actions_container,
                        RemoteViews.MARGIN_BOTTOM,
                        R.dimen.notification_action_list_margin_bottom);
            }
        }
        ...
        public static int getContentMarginTop(Context context, @DimenRes int spacingRes) {
            ...
            int notifMargin = resources.getDimensionPixelSize(R.dimen.notification_margin);
        ...
        private int getCollapsedBaseLayoutResource() {
            return R.layout.notification_template_collapsed_base;
        }

        private int getHeadsUpBaseLayoutResource() {
            return R.layout.notification_template_heads_up_base;
        }

        private int getCompactHeadsUpBaseLayoutResource() {
            return R.layout.notification_template_compact_heads_up_base;
        }

        private int getMessagingCompactHeadsUpLayoutResource() {
            return R.layout.notification_template_compact_heads_up_messaging;
        }

        private int getExpandedBaseLayoutResource() {
            return R.layout.notification_template_expanded_base;
        }

        private int getBigPictureLayoutResource() {
            return R.layout.notification_template_expanded_big_picture;
        }

        private int getBigTextLayoutResource() {
            return R.layout.notification_template_expanded_big_text;
        }

        private int getInboxLayoutResource() {
            return R.layout.notification_template_expanded_inbox;
        }

        private int getCollapsedMessagingLayoutResource() {
            return R.layout.notification_template_collapsed_messaging;
        }

        private int getExpandedMessagingLayoutResource() {
            return R.layout.notification_template_expanded_messaging;
        }

        private int getCompactHeadsUpMetricLayoutResource() {
            return R.layout.notification_template_compact_heads_up_metric;
        }

        private int getCollapsedMetricLayoutResource() {
            return R.layout.notification_template_collapsed_metric;
        }

        private int getHeadsUpMetricLayoutResource() {
            return R.layout.notification_template_heads_up_metric;
        }

        private int getExpandedMetricLayoutResource() {
            return R.layout.notification_template_expanded_metric;
        }

        private int getExpandedSingleMetricLayoutResource() {
            return R.layout.notification_template_expanded_single_metric;
        }
        private int getPromotedSingleMetricLayoutResource() {
            return R.layout.notification_template_promoted_single_metric;
        }

        private int getCollapsedMediaLayoutResource() {
            return R.layout.notification_template_collapsed_media;
        }

        private int getExpandedMediaLayoutResource() {
            return R.layout.notification_template_expanded_media;
        }

        private int getCollapsedConversationLayoutResource() {
            return R.layout.notification_template_collapsed_conversation;
        }

        private int getExpandedConversationLayoutResource() {
            return R.layout.notification_template_expanded_conversation;
        }

        private int getCollapsedCallLayoutResource() {
            return R.layout.notification_template_collapsed_call;
        }

        private int getExpandedCallLayoutResource() {
            return R.layout.notification_template_expanded_call;
        }

        private int getProgressLayoutResource() {
            return R.layout.notification_template_expanded_progress;
        }

        private int getPromotedProgressLayoutResource() {
            return R.layout.notification_template_promoted_progress;
        }
    ...
    public void reduceImageSizes(Context context) {
        ...
        if (mSmallIcon != null) {
            ...
            if (mSmallIcon.scaleDownToAshmem(maxSize, maxSize)
                    && notificationsReduceImageSizesPutExtras()) {
        ...
        if (mBridgedNotificationMetadata != null) {
            int maxSize = resources.getDimensionPixelSize(R.dimen.notification_small_icon_size);
            mBridgedNotificationMetadata.getAppIcon().scaleDownToAshmem(maxSize, maxSize);
        }

        if (mLargeIcon != null || largeIcon != null) {
            int maxSize = resources.getDimensionPixelSize(R.dimen.notification_right_icon_size);
            if (mLargeIcon != null) {
                if (mLargeIcon.scaleDownToAshmem(maxSize, maxSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    extras.putParcelable(EXTRA_LARGE_ICON, mLargeIcon);
                }
            }
            if (largeIcon != null) {
                Bitmap scaled = BitmapCache.getShared(largeIcon, maxSize, maxSize);
                if (scaled != largeIcon) {
                    largeIcon = scaled;
                    if (notificationsReduceImageSizesPutExtras()) {
                        extras.putParcelable(EXTRA_LARGE_ICON, largeIcon);
                    }
                }
            }
        }
        ...
        if (mBubbleMetadata != null) {
            ...
            if (mBubbleMetadata.mIcon != null) {
                mBubbleMetadata.mIcon.scaleDownToAshmem(bubbleSize, bubbleSize);
            }
        }
        ...
        if (actions != null) {
            for (Action action : actions) {
                if (action.mIcon != null) {
                    action.mIcon.scaleDownToAshmem(smallIconSize, smallIconSize);
                }
            }
        }
        ...
        if (customContent != null) {
            ...
            if (p.mHeaderless) {
                ...
                result.mTitleMarginSet.applyToView(template, R.id.notification_main_column,
                        resources.getDimension(R.dimen.notification_margin)
    ...
    public static class BigPictureStyle extends Style {
        ...
        public void reduceImageSizes(Context context) {
            ...
            if (mPictureIcon != null) {
                ...
                if (mPictureIcon.scaleDownToAshmem(maxPictureWidth, maxPictureHeight)
                        && notificationsReduceImageSizesPutExtras()) {
                    if (mPictureIcon.getType() == Icon.TYPE_BITMAP) {
                        mBuilder.mN.extras.putParcelable(EXTRA_PICTURE, mPictureIcon.getBitmap());
                        mBuilder.mN.extras.putParcelable(EXTRA_PICTURE_ICON, null);
                    } else {
                        mBuilder.mN.extras.putParcelable(EXTRA_PICTURE_ICON, mPictureIcon);
                        mBuilder.mN.extras.putParcelable(EXTRA_PICTURE, null);
                    }
                }
            }
            if (mBigLargeIcon != null) {
                ...
                if (mBigLargeIcon.scaleDownToAshmem(rightIconSize, rightIconSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_LARGE_ICON_BIG, mBigLargeIcon);
                }
            }
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void reduceImageSizes(Context context) {
            ...
            if (mShortcutIcon != null) {
                ...
                if (mShortcutIcon.scaleDownToAshmem(maxSize, maxSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_CONVERSATION_ICON, mShortcutIcon);
                }
            }
            ...
            if (mUser != null && mUser.getIcon() != null) {
                if (mUser.getIcon().scaleDownToAshmem(maxAvatarSize, maxAvatarSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_MESSAGING_PERSON, mUser);
                }
            }

            if (reduceMessagesIconSizes(mMessages, maxAvatarSize)
                    && notificationsReduceImageSizesPutExtras()) {
                mBuilder.mN.extras.putParcelableArray(EXTRA_MESSAGES,
                        getBundleArrayForMessages(mMessages, false /* processSpans */));
            }
            if (reduceMessagesIconSizes(mHistoricMessages, maxAvatarSize)
                    && notificationsReduceImageSizesPutExtras()) {
                mBuilder.mN.extras.putParcelableArray(EXTRA_HISTORIC_MESSAGES,
                        getBundleArrayForMessages(mHistoricMessages, false /* processSpans */));
            }
        }
        ...
        @Hide
        private static boolean reduceMessagesIconSizes(@Nullable List<Message> messages, int maxSize) {
            if (messages == null) {
                return false;
            }
            ...
            for (Message message : messages) {
                ...
                if (sender != null) {
                    ...
                    if (icon != null) {
                        modified |= icon.scaleDownToAshmem(maxSize, maxSize);
                    }
                }
            }
            return modified;
        ...
        public void reduceImageSizes(Context context) {
            if (mVerificationIcon != null) {
                int rightIconSize = context.getResources().getDimensionPixelSize(
                        R.dimen.notification_right_icon_size);
                if (mVerificationIcon.scaleDownToAshmem(rightIconSize, rightIconSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_VERIFICATION_ICON, mVerificationIcon);
                }
            }
            if (mPerson.getIcon() != null) {
                int leftIconSize = context.getResources().getDimensionPixelSize(
                        R.dimen.notification_person_icon_max_size);
                if (mPerson.getIcon().scaleDownToAshmem(leftIconSize, leftIconSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_CALL_PERSON, mPerson);
                }
            }
        }
    ...
    public static final class MetricStyle extends Style {
        ...
        private CharSequence getMetricLabel(
            ...
            if (isExpandedView || isForSingleMetric) {
                if (!TextUtils.isEmpty(valueString.subtext())) {
                    metricLabel = formatBidiMetricLabel(
                            mBuilder.mContext,
                            metric.getLabel(),
                            valueString.subtext()
                    );
        ...
        // Individually wrap parameters to isolate their directionality from the template's
        // neutral punctuation (e.g. parentheses), then wrap the composite result to enforce
        // a consistent base direction within RTL parent layouts.
        private CharSequence formatBidiMetricLabel(
                @NonNull Context context,
                @NonNull CharSequence label,
                @NonNull CharSequence unit) {
            final BidiFormatter bidi = BidiFormatter.getInstance();
            return bidi.unicodeWrap(context.getString(
                            R.string.notification_metric_label_unit,
                            label,
                            bidi.unicodeWrap(unit, FIRSTSTRONG_LTR)),
                    FIRSTSTRONG_LTR);
        }
    ...
    public static final class Metric {
        ...
        public static final class FixedFloat extends MetricValue {
            ...
            @TestApi public static final int DEFAULT_MIN_FRACTION_DIGITS = 0;
            @TestApi public static final int DEFAULT_MAX_FRACTION_DIGITS = 2;
    ...
    public static class ProgressStyle extends Notification.Style {
        ...
        */
        ...
        public void reduceImageSizes(Context context) {
            ...
            if (mStartIcon != null) {
                if (mStartIcon.scaleDownToAshmem(progressIconSize, progressIconSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_PROGRESS_START_ICON, mStartIcon);
                }
            }
            if (mEndIcon != null) {
                if (mEndIcon.scaleDownToAshmem(progressIconSize, progressIconSize)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_PROGRESS_END_ICON, mEndIcon);
                }
            }
            if (mTrackerIcon != null) {
                ...
                if (mTrackerIcon.scaleDownToAshmem(progressTrackerWidth, progressTrackerHeight)
                        && notificationsReduceImageSizesPutExtras()) {
                    mBuilder.mN.extras.putParcelable(EXTRA_PROGRESS_TRACKER_ICON, mTrackerIcon);
                }
            }
        }
    ...
    public static final class ProjectedExtender implements Extender {
        @TestApi public static final String EXTRA_PROJECTED_EXTENDER =
                "android.projected.EXTENSIONS";
        @TestApi public static final String KEY_CONTENT_INTENT = "content_intent";
