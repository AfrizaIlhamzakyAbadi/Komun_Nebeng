...
/**
 * Utility class for writing BackupHelpers for shared backup agents.
 */
@Hide
public abstract class BackupHelperInternal implements BackupHelper {
    private BackupRestoreEventLogger mLogger;
    private boolean mIsLoggerSet = false;
    private int mSourceVersion = -1;
    ...
    /** {@return the source sdk version, or -1 if unset} */
