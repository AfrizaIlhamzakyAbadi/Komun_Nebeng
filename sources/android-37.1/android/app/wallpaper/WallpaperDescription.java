...
public final class WallpaperDescription implements Parcelable {
    ...
    @Nullable private final String mOptionsName;
    ...
    private WallpaperDescription(@Nullable ComponentName component,
            ...
            @Nullable String optionsName, float sampleSize) {
    ...
    /**
     * @return the options name of the PersistableBundle key for the user configurable options, or
     *     null for none
     */
    @Hide
    @Nullable
    ...
    public void saveToXml(TypedXmlSerializer out) throws IOException, XmlPullParserException {
        ...
        if (mOptionsName != null) out.attribute(null, "optionsName", mOptionsName);
    ...
    public static WallpaperDescription restoreFromXml(TypedXmlPullParser in) throws IOException,
        ...
        String optionsName = in.getAttributeValue(null, "optionsName");
        ...
        return new WallpaperDescription(componentName, id, thumbnail, title, description,
                contextUri, contextDescription, content, cropHints, optionsName, sampleSize);
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeString8(mOptionsName);
    }
    ...
    public static final class Builder {
        ...
        @Nullable private String mOptionsName;
        ...
        /**
         * Specifies the key of the PersistableBundle value containing the user configurable
         * options, or null for none.
         *
         * @param optionsName the options name, or {@code null} for none
         */
        @Hide
        @NonNull
        public Builder setOptionsName(@Nullable String optionsName) {
            mOptionsName = optionsName;
            return this;
        }
        ...
        public WallpaperDescription build() {
            return new WallpaperDescription(mComponent, mId, mThumbnail, mTitle, mDescription,
                    mContextUri, mContextDescription, mContent, mCropHints, mOptionsName,
                    mSampleSize);
        }
    }
