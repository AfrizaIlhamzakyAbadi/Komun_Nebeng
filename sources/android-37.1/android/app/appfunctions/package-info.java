 ...
 * called from an {@link android.app.Activity} context should prefer {@link
 * AppFunctionMetadata#SCOPE_ACTIVITY}. Only use {@link AppFunctionMetadata#SCOPE_GLOBAL} for such
 * functions if you are absolutely sure there can be only one instance of that activity.
 *
