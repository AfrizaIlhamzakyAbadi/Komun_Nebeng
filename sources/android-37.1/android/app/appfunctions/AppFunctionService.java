 ...
 * }</pre>
 *
 * <p>When the service is disabled, its functions are not returned by {@link
 * AppFunctionManager#searchAppFunctions} and cannot be executed.
 *
 * <p><b>Important:</b> On Android versions before {@link
 * android.os.Build.VERSION_CODES#CINNAMON_BUN} only one {@link AppFunctionService} implementation
 * can be enabled in an app at a time, and having multiple implementations results in undefined
 * behavior.
 */
