...
import android.app.IOnAppInteractionAccessChangeListener;
...
public final class AppFunctionManager {
    ...
    public @interface AppInteractionAccessState {}
    ...
    @Retention(RetentionPolicy.SOURCE)
    public @interface AppInteractionAccessFlags {}
     ...
     *   <li>Functions in other packages that it is allowed to query via {@link
     *       android.content.pm.PackageManager#canPackageQuery} when holding the {@link
     ...
     *       {@code android.permission.EXECUTE_APP_FUNCTIONS_SYSTEM} or {@code
     *       android.permission.DISCOVER_APP_FUNCTIONS} permission on API level 37 and above.
     * </ul>
     *
    ...
    public AppFunctionRegistration registerAppFunction(
        ...
        return ensureRegistry()
                .register(
                        List.of(
                                new RegisterAppFunctionRequest(
                                        functionIdentifier, executor, appFunction)));
    }
            ...
            mService.isAppFunctionEnabled(
                    ...
                    new IIsAppFunctionEnabledCallback.Stub() {
                        ...
                        public void onSuccess(boolean isEnabled) {
                            executor.execute(() -> callback.onResult(isEnabled));
                        }
    ...
    public void updateAccessFlags(
            ...
            @AppInteractionAccessFlags int flagMask,
            @AppInteractionAccessFlags int flags) {
        try {
    ...
    private static final class OnAppFunctionAccessChangeListenerDelegate
            extends IOnAppInteractionAccessChangeListener.Stub {
        ...
        @Override
        public void onAppInteractionAccessChanged(int agentUid) {
