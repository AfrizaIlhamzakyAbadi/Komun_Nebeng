...
public class AppFunctionManagerHelper {
    ...
    private static boolean hasPermissionsToQueryRuntimeMetadata(@NonNull Context context) {
        if (context.checkSelfPermission(Manifest.permission.DISCOVER_APP_FUNCTIONS)
                == PackageManager.PERMISSION_GRANTED) {
            return true;
        }
        if (context.checkSelfPermission(Manifest.permission.EXECUTE_APP_FUNCTIONS_SYSTEM)
                == PackageManager.PERMISSION_GRANTED) {
            return true;
        }
