...
public class DreamManager {
    ...
    /**
     * Notifies dream manager of device postured state and device angle, which may affect dream
     * enablement.
     */
    @Hide
    @RequiresPermission(android.Manifest.permission.WRITE_DREAM_STATE)
    public void setDevicePostured(boolean isPostured, int deviceAngle) {
        try {
            mService.setDevicePostured(isPostured, deviceAngle);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
