...
public abstract class JobScheduler {
     ...
     *
     * Starting from Android version {@link android.os.Build.VERSION_CODES#CINNAMON_BUN},
     * the system will provide more specific pending reasons such as
     * {@link #PENDING_JOB_REASON_CONSTRAINT_CONNECTIVITY_NETWORK_UNAVAILABLE}, and/or
     * {@link #PENDING_JOB_REASON_CONSTRAINT_CONNECTIVITY_METERED_RESTRICTED}
     */
    ...
    /**
     * The requested connectivity constraint is not satisfied because there is no active
    ...
    /**
     * The requested connectivity constraint is not satisfied because the app is
    ...
    @IntDef(prefix = {"PENDING_JOB_REASON_"}, value = {
            ...
            PENDING_JOB_REASON_CONSTRAINT_CONNECTIVITY_NETWORK_UNAVAILABLE,
            PENDING_JOB_REASON_CONSTRAINT_CONNECTIVITY_METERED_RESTRICTED,
    })
    @Retention(RetentionPolicy.SOURCE)
