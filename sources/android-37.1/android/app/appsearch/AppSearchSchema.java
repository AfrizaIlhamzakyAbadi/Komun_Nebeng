...
public final class AppSearchSchema extends AbstractSafeParcelable {
    ...
    public abstract static class PropertyConfig {
        ...
        @Hide public static final int DATA_TYPE_STRING = 1;

        /** Constant value for Long data type. */
        @Hide public static final int DATA_TYPE_LONG = 2;

        /** Constant value for Double data type. */
        @Hide public static final int DATA_TYPE_DOUBLE = 3;

        /** Constant value for Boolean data type. */
        @Hide public static final int DATA_TYPE_BOOLEAN = 4;

        /** Unstructured BLOB. */
        @Hide public static final int DATA_TYPE_BYTES = 5;
         ...
         */
        @Hide public static final int DATA_TYPE_DOCUMENT = 6;

        /** Indicates that the property is an {@link EmbeddingVector}. */
        @Hide public static final int DATA_TYPE_EMBEDDING = 7;

        /** Indicates that the property is an {@link AppSearchBlobHandle}. */
        @Hide public static final int DATA_TYPE_BLOB_HANDLE = 8;
    ...
    public static final class EmbeddingPropertyConfig extends PropertyConfig {
        ...
        /**
         * Embedding vectors in this property will be indexed for Approximate Nearest Neighbor (ANN)
         * search.
         *
         * <p>The index maintains clusters of embedding vectors to offer faster search latency than
         * a full linear scan, but does not guarantee 100% recall. This allows tuning the trade-off
         * between search latency and recall at search time by configuring the number of clusters to
         * search via {@link SearchSpec.Builder#setEmbeddingQueryProbeCount(int)}.
         */
