...
public final class SearchSpec extends AbstractSafeParcelable {
    ...
    @Hide public static final int DEFAULT_NUM_PER_PAGE = 10;

    /** Default number of clusters to search for Approximate Nearest Neighbor (ANN) search. */
    @Hide public static final int DEFAULT_EMBEDDING_QUERY_PROBE_COUNT = 10;
     ...
     *
     * <p>This is used globally across all semanticSearch calls in the query expression. If this
     * value is <= 0, embeddings in properties marked with {@link
     * AppSearchSchema.EmbeddingPropertyConfig#INDEXING_TYPE_APPROXIMATE_NEAREST_NEIGHBOR} will be
     * skipped. Embeddings in properties marked with {@link
     * AppSearchSchema.EmbeddingPropertyConfig#INDEXING_TYPE_SIMILARITY} will still be searched
     * regardless of this value.
     *
     * <p>A larger value increases recall at the expense of higher search latency. A smaller value
     * reduces latency but may negatively impact recall. A value of 10 is generally a good default
     * choice.
     */
    ...
    public static final class Builder {
         ...
         * <p>This is used globally across all semanticSearch calls in the query expression. If this
         * value is <= 0, embeddings in properties marked with {@link
         * AppSearchSchema.EmbeddingPropertyConfig#INDEXING_TYPE_APPROXIMATE_NEAREST_NEIGHBOR} will
         * be skipped. Embeddings in properties marked with {@link
         * AppSearchSchema.EmbeddingPropertyConfig#INDEXING_TYPE_SIMILARITY} will still be searched
         * regardless of this value.
         *
         * <p>A larger value increases recall at the expense of higher search latency. A smaller
         * value reduces latency but may negatively impact recall. A value of 10 is generally a good
         * default choice.
         *
