...
public final class AppSearchAccount extends GenericDocument {
    ...
    @Hide public static final String PROPERTY_ACCOUNT_TYPE = "accountType";

    /** The property name of the name of an account. */
    @Hide public static final String PROPERTY_ACCOUNT_NAME = "accountName";

    /** The property name of the id of an account. */
    @Hide public static final String PROPERTY_ACCOUNT_ID = "accountId";
