...
public class GetNextPageAidlRequest extends AbstractSafeParcelable {
    ...
    @Field(id = 8, getter = "getMaxResultsToRetrieveFromPage")
    private final int mMaxResultsToRetrieveFromPage;
     ...
     * @param maxResultsToRetrieveFromPage The maximum number of results to retrieve in this call.
     */
    @Constructor
    public GetNextPageAidlRequest(
            ...
            @Param(id = 8) int maxResultsToRetrieveFromPage) {
        ...
        mMaxResultsToRetrieveFromPage = maxResultsToRetrieveFromPage;
    }
    ...
    public int getMaxResultsToRetrieveFromPage() {
        return mMaxResultsToRetrieveFromPage;
    }
