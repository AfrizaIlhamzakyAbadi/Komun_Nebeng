...
public class AppOpsManager {
    ...
    /**
     * Query all apps on device, regardless of declarations in the calling app manifest
     */
    @Hide
    ...
    /**
     * Communicate cross-profile within the same profile group.
     */
    @Hide
    ...
    /**
     * Controls whether or not read logs are available for incremental installations.
     */
    @Hide
    ...
    /**
     * Auto-revoke app permissions if app is unused for an extended period
     */
    @Hide
    ...
    /**
     * Access to read skin temperature.
     */
    @Hide
    ...
    /**
     * Access to audio playback and control APIs.
     */
    @Hide
    public static final int OP_CONTROL_AUDIO = AppOpEnums.APP_OP_CONTROL_AUDIO;

    /**
     * Similar to {@link OP_CONTROL_AUDIO}, but doesn't require capabilities.
     */
    @Hide
...
     */
    ...
    public static final int OP_MANAGE_PERIPHERAL_CUSTOMIZATION =
            AppOpEnums.APP_OP_MANAGE_PERIPHERAL_CUSTOMIZATION;

    /**
     * Allows an application to manage the user's contacts data.
     */
    @Hide
    @FlaggedApi(android.permission.flags.Flags.FLAG_MANAGE_CONTACTS_PERMISSION_ENABLED)
    public static final int OP_MANAGE_CONTACTS = AppOpEnums.APP_OP_MANAGE_CONTACTS;
    ...
    @StringDef(prefix = { "OPSTR_" }, value = {
            ...
            OPSTR_ACCESS_HID,
            OPSTR_MANAGE_PERIPHERAL_CUSTOMIZATION,
            OPSTR_MANAGE_CONTACTS,
    })
    ...
    /**
     * Allows an application to manage peripheral customizations.
     */
    @Hide
    @FlaggedApi(FLAG_ENABLE_POEM_INPUT_CUSTOMIZATION)
    public static final String OPSTR_MANAGE_PERIPHERAL_CUSTOMIZATION =
            "android:manage_peripheral_customization";
    ...
    /**
     * Access to system preferences write services
     */
    @Hide
    ...
    /**
     * Access to a audio playback and control APIs without capability requirements
     */
    @Hide
    ...
    /**
     * Required to draw system application overlays.
     */
    @Hide
    ...
    /** Allows an application to manage the user's contacts data. */
    @FlaggedApi(android.permission.flags.Flags.FLAG_MANAGE_CONTACTS_PERMISSION_ENABLED)
    public static final String OPSTR_MANAGE_CONTACTS = "android:manage_contacts";
    ...
    private static final int[] APP_OP_PERMISSION_UID_OPS = {
            ...
            OP_SYSTEM_APPLICATION_OVERLAY,
            com.android.hardware.input.Flags.hidApi() ? OP_ACCESS_HID : OP_NONE,
            com.android.hardware.input.Flags.enablePoemInputCustomization()
                    ? OP_MANAGE_PERIPHERAL_CUSTOMIZATION : OP_NONE,
            android.permission.flags.Flags.manageContactsPermissionEnabled() ? OP_MANAGE_CONTACTS
                    : OP_NONE,
    };
    ...
    static final AppOpInfo[] sAppOpInfos = new AppOpInfo[]{
        ...
        new AppOpInfo.Builder(OP_SYSTEM_APPLICATION_OVERLAY, OPSTR_SYSTEM_APPLICATION_OVERLAY,
                ...
                .setPermission(Manifest.permission.SYSTEM_APPLICATION_OVERLAY)
                .build(),
        ...
        new AppOpInfo.Builder(OP_MANAGE_PERIPHERAL_CUSTOMIZATION,
                OPSTR_MANAGE_PERIPHERAL_CUSTOMIZATION,
                "MANAGE_PERIPHERAL_CUSTOMIZATION", AppOpsManager.MODE_ERRORED)
                .setPermission(
                        com.android.hardware.input.Flags.enablePoemInputCustomization()
                                ? Manifest.permission.MANAGE_PERIPHERAL_CUSTOMIZATION : null)
                .build(),
        //TODO(b/519577153): Align on Private Compute Core (PCC) mode for OP_MANAGE_CONTACTS
        new AppOpInfo.Builder(OP_MANAGE_CONTACTS, OPSTR_MANAGE_CONTACTS, "MANAGE_CONTACTS",
                AppOpInfo.PCC_MODE_INHERIT)
                .setPermission(android.permission.flags.Flags.manageContactsPermissionEnabled()
                        ? android.Manifest.permission.MANAGE_CONTACTS : null).build(),
    };
