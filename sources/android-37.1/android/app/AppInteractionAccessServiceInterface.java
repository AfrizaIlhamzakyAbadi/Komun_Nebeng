...
public interface AppInteractionAccessServiceInterface {
    ...
    @AppFunctionManager.AppInteractionAccessState
    ...
    @AppFunctionManager.AppInteractionAccessFlags
    ...
    boolean updateAccessFlags(@NonNull String agentPackageName, int agentUserId,
            @NonNull String targetPackageName, int targetUserId,
            @AppFunctionManager.AppInteractionAccessFlags int flagMask,
            @AppFunctionManager.AppInteractionAccessFlags int flags)
    ...
    void addOnAccessChangedListener(@NonNull IOnAppInteractionAccessChangeListener listener,
            int userId);

    /** Remove a change listener */
    void removeOnAccessChangedListener(@NonNull IOnAppInteractionAccessChangeListener listener,
            int userId);
}
