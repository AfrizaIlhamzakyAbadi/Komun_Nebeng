...
public final class AppCompatCallbacks implements Compatibility.BehaviorChangeDelegate {
    ...
    public static final long[] CHANGES_DISABLED_FOR_SYSTEM_UID = new long[]{
            // Disable sandboxing landscape camera sensors when called from the system.
            CameraManager.OVERRIDE_CAMERA_LANDSCAPE_TO_PORTRAIT,
            CameraManager.OVERRIDE_CAMERA_ALLOW_LANDSCAPE_TO_PORTRAIT_OPT_IN_ONLY
    };
