...
public class SupervisionManager {
     ...
     *
     * <p>The intent must be invoked via {@link android.app.Activity#startActivityForResult} to
     * receive the result of whether or not the user approved the action. If approved, the result
     * will be {@link android.app.Activity#RESULT_OK}.
     *
    ...
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    @SystemApi
    @FlaggedApi(Flags.FLAG_ENABLE_CONFIRM_SUPERVISION_APPROVAL_API)
     ...
     * @deprecated Multiple applications can now hold the {@link
     * android.app.role.RoleManager#ROLE_SUPERVISION} role. To find all apps with this role,
     * please use {@link android.app.role.RoleManager#getRoleHolders(String)}.
     */
    @Hide
    @UserHandleAware
    @Nullable
     ...
     * @see Policy
     * @throws IllegalStateException if the policy is invalid, or if supervision is disabled for the
     *     calling user
     * @throws SecurityException if the caller does not hold the required permissions
     */
    @SystemApi
