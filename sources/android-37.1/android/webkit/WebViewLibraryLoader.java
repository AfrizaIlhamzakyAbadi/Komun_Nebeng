...
public class WebViewLibraryLoader {
    ...
    private static class RelroFileCreator {
        ...
        public static void main(String[] args) {
            ...
            try {
                ...
                result = nativeCreateRelroFile(libraryFileName, getRelroPath(),
                                               apk.getClassLoader());
    ...
    public static long getReservedAddress() {
        return nativeGetReservedAddress();
    }

    public static long getReservedSize() {
        return nativeGetReservedSize();
    }

    public static String getRelroPath() {
        return VMRuntime.getRuntime().is64Bit() ? CHROMIUM_WEBVIEW_NATIVE_RELRO_64 :
    ...
    private static native long nativeGetReservedAddress();
    private static native long nativeGetReservedSize();
}
