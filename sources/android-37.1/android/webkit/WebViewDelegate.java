...
public final class WebViewDelegate {
    ...
    /**
     * Returns {@code true} if the Native WebView Zygote is enabled for the
     * current platform.
     * When enabled, a native reimplementation of the WebView Zygote is
     * spawned, which forks native (Java-less) WebView renderers.
     */
    @FlaggedApi(Flags.FLAG_NATIVE_WEBVIEW_ZYGOTE_API)
    public boolean isNativeWebViewZygoteEnabled() {
        PackageInfo pkg = WebView.getCurrentWebViewPackage();
        return WebViewZygote.isNativeWebViewZygoteEnabledForPackage(pkg);
    }
