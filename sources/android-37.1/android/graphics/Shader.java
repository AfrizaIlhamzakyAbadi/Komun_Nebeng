...
public class Shader {
    ...
    /**
     * Only to be used by subclasses in android.graphics.
     */
    @Hide
    ...
    /**
     * Only to be used by subclasses in the graphics package.
     */
    @Hide
    ...
    /**
     * so it can be called by android.graphics.drawable but must not be called from outside
     * the module.
     */
    @Hide
    ...
    /**
     * Only to be called by subclasses in the android.graphics package.
     */
    @Hide
