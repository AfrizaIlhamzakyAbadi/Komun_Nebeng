...
public final class PdfStatsLog {
     ...
     * Usage: StatsLog.write(StatsLog.UI_EVENT_REPORTED, int event_id, int uid, java.lang.String package_name, int instance_id, java.lang.String event_name);<br>
     */
     ...
     * Usage: StatsLog.write(StatsLog.PHOTOPICKER_API_INFO_REPORTED, int session_id, int picker_intent_action, int screen_size, int media_filter, int max_picked_item_count, int selected_tab, int selected_album, boolean is_ordered_selection_set, boolean is_accent_color_set, boolean is_default_tab_set, boolean is_search_enabled, boolean is_cloud_search_enabled, boolean is_local_search_enabled, boolean is_transcoding_requested, int query_highlight_type, int thumbnail_aspect_ratio, boolean is_collapsed_mode_scrolling_enabled, boolean is_selection_bar_visible_in_expanded_mode, boolean is_location_metadata_requested);<br>
     */
    ...
    /**
     * SignaturePickerLaunched signature_picker_launched<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_PICKER_LAUNCHED, int uid);<br>
     */
    public static final int SIGNATURE_PICKER_LAUNCHED = 1328;

    /**
     * SignatureSelected signature_selected<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_SELECTED, int uid, int signature_type);<br>
     */
    public static final int SIGNATURE_SELECTED = 1329;

    /**
     * SignatureCreateLaunched signature_create_launched<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_CREATE_LAUNCHED, int uid);<br>
     */
    public static final int SIGNATURE_CREATE_LAUNCHED = 1330;

    /**
     * SignatureCreated signature_created<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_CREATED, int uid, int signature_type, int data_size_bytes);<br>
     */
    public static final int SIGNATURE_CREATED = 1331;

    /**
     * SignaturesLoadDuration signatures_load_duration<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURES_LOAD_DURATION, int uid, long duration_millis, int signature_count, int screen);<br>
     */
    public static final int SIGNATURES_LOAD_DURATION = 1332;

    /**
     * SignatureSaveDuration signature_save_duration<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_SAVE_DURATION, int uid, long duration_millis, int signature_type);<br>
     */
    public static final int SIGNATURE_SAVE_DURATION = 1333;

    /**
     * SignatureProviderOpenDuration signature_provider_open_duration<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_PROVIDER_OPEN_DURATION, int uid, long duration_millis);<br>
     */
    public static final int SIGNATURE_PROVIDER_OPEN_DURATION = 1334;

    /**
     * SignatureAppError signature_app_error<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_APP_ERROR, int uid, int error_type, int signature_type);<br>
     */
    public static final int SIGNATURE_APP_ERROR = 1335;

    /**
     * SignatureSettingsLaunched signature_settings_launched<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_SETTINGS_LAUNCHED, int uid);<br>
     */
    public static final int SIGNATURE_SETTINGS_LAUNCHED = 1336;

    /**
     * SignatureDeleted signature_deleted<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_DELETED, int uid, int signature_type, int screen);<br>
     */
    public static final int SIGNATURE_DELETED = 1337;

    /**
     * SignatureDeleteDuration signature_delete_duration<br>
     * Usage: StatsLog.write(StatsLog.SIGNATURE_DELETE_DURATION, int uid, long duration_millis, int screen);<br>
     */
    public static final int SIGNATURE_DELETE_DURATION = 1338;

    /**
     * PhotopickerSelectionParamsReported photopicker_selection_params_reported<br>
     * Usage: StatsLog.write(StatsLog.PHOTOPICKER_SELECTION_PARAMS_REPORTED, int session_id, long max_media_item_size_bytes, long max_video_duration_nanos, long min_video_duration_nanos, long max_media_item_resolution_pixels, long min_media_item_resolution_pixels, int mime_types, long max_selection_batch_size_bytes);<br>
     */
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED = 1364;
    ...
    // Values for PhotopickerApiInfoReported.thumbnail_aspect_ratio
    public static final int PHOTOPICKER_API_INFO_REPORTED__THUMBNAIL_ASPECT_RATIO__THUMBNAIL_ASPECT_RATIO_UNKNOWN = 0;
    public static final int PHOTOPICKER_API_INFO_REPORTED__THUMBNAIL_ASPECT_RATIO__THUMBNAIL_ASPECT_RATIO_UNSET = 1;
    public static final int PHOTOPICKER_API_INFO_REPORTED__THUMBNAIL_ASPECT_RATIO__THUMBNAIL_ASPECT_RATIO_SQUARE_1_1 = 2;
    public static final int PHOTOPICKER_API_INFO_REPORTED__THUMBNAIL_ASPECT_RATIO__THUMBNAIL_ASPECT_RATIO_PORTRAIT_9_16 = 3;
    ...
    public static final int PHOTOPICKER_BANNER_INTERACTION_LOGGED__BANNER_TYPE__PRIVACY_EXPLAINER = 5;
    public static final int PHOTOPICKER_BANNER_INTERACTION_LOGGED__BANNER_TYPE__PRIVACY_EXPLAINER_LIMITED_ACCESS = 6;
    public static final int PHOTOPICKER_BANNER_INTERACTION_LOGGED__BANNER_TYPE__SWITCH_PROFILE = 7;
    ...
    public static final int PHOTOPICKER_BANNER_INTERACTION_LOGGED__USER_BANNER_INTERACTION__BANNER_SHOWN = 4;
    ...
    // Values for SignatureSelected.signature_type
    public static final int SIGNATURE_SELECTED__SIGNATURE_TYPE__SIGNATURE_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_SELECTED__SIGNATURE_TYPE__SIGNATURE_TYPE_DRAW = 1;
    public static final int SIGNATURE_SELECTED__SIGNATURE_TYPE__SIGNATURE_TYPE_TYPE = 2;
    public static final int SIGNATURE_SELECTED__SIGNATURE_TYPE__SIGNATURE_TYPE_UPLOAD = 3;

    // Values for SignatureCreated.signature_type
    public static final int SIGNATURE_CREATED__SIGNATURE_TYPE__SIGNATURE_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_CREATED__SIGNATURE_TYPE__SIGNATURE_TYPE_DRAW = 1;
    public static final int SIGNATURE_CREATED__SIGNATURE_TYPE__SIGNATURE_TYPE_TYPE = 2;
    public static final int SIGNATURE_CREATED__SIGNATURE_TYPE__SIGNATURE_TYPE_UPLOAD = 3;

    // Values for SignaturesLoadDuration.screen
    public static final int SIGNATURES_LOAD_DURATION__SCREEN__SIGNATURE_SCREEN_UNKNOWN = 0;
    public static final int SIGNATURES_LOAD_DURATION__SCREEN__SIGNATURE_SCREEN_PICKER = 1;
    public static final int SIGNATURES_LOAD_DURATION__SCREEN__SIGNATURE_SCREEN_SETTINGS = 2;

    // Values for SignatureSaveDuration.signature_type
    public static final int SIGNATURE_SAVE_DURATION__SIGNATURE_TYPE__SIGNATURE_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_SAVE_DURATION__SIGNATURE_TYPE__SIGNATURE_TYPE_DRAW = 1;
    public static final int SIGNATURE_SAVE_DURATION__SIGNATURE_TYPE__SIGNATURE_TYPE_TYPE = 2;
    public static final int SIGNATURE_SAVE_DURATION__SIGNATURE_TYPE__SIGNATURE_TYPE_UPLOAD = 3;

    // Values for SignatureAppError.error_type
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_DB_READ_FAILED = 1;
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_DB_WRITE_FAILED = 2;
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_PROVIDER_UUID_NOT_FOUND = 3;
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_DB_DELETE_FAILED = 4;
    public static final int SIGNATURE_APP_ERROR__ERROR_TYPE__SIGNATURE_APP_ERROR_TYPE_UPLOAD_FAILED = 5;

    // Values for SignatureAppError.signature_type
    public static final int SIGNATURE_APP_ERROR__SIGNATURE_TYPE__SIGNATURE_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_APP_ERROR__SIGNATURE_TYPE__SIGNATURE_TYPE_DRAW = 1;
    public static final int SIGNATURE_APP_ERROR__SIGNATURE_TYPE__SIGNATURE_TYPE_TYPE = 2;
    public static final int SIGNATURE_APP_ERROR__SIGNATURE_TYPE__SIGNATURE_TYPE_UPLOAD = 3;

    // Values for SignatureDeleted.signature_type
    public static final int SIGNATURE_DELETED__SIGNATURE_TYPE__SIGNATURE_TYPE_UNKNOWN = 0;
    public static final int SIGNATURE_DELETED__SIGNATURE_TYPE__SIGNATURE_TYPE_DRAW = 1;
    public static final int SIGNATURE_DELETED__SIGNATURE_TYPE__SIGNATURE_TYPE_TYPE = 2;
    public static final int SIGNATURE_DELETED__SIGNATURE_TYPE__SIGNATURE_TYPE_UPLOAD = 3;

    // Values for SignatureDeleted.screen
    public static final int SIGNATURE_DELETED__SCREEN__SIGNATURE_SCREEN_UNKNOWN = 0;
    public static final int SIGNATURE_DELETED__SCREEN__SIGNATURE_SCREEN_PICKER = 1;
    public static final int SIGNATURE_DELETED__SCREEN__SIGNATURE_SCREEN_SETTINGS = 2;

    // Values for SignatureDeleteDuration.screen
    public static final int SIGNATURE_DELETE_DURATION__SCREEN__SIGNATURE_SCREEN_UNKNOWN = 0;
    public static final int SIGNATURE_DELETE_DURATION__SCREEN__SIGNATURE_SCREEN_PICKER = 1;
    public static final int SIGNATURE_DELETE_DURATION__SCREEN__SIGNATURE_SCREEN_SETTINGS = 2;

    // Values for PhotopickerSelectionParamsReported.mime_types
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__PHOTO = 0;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__VIDEO = 1;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__PHOTO_VIDEO = 2;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__GIF = 3;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__LIVE_PHOTO = 4;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__OTHER = 5;
    public static final int PHOTOPICKER_SELECTION_PARAMS_REPORTED__MIME_TYPES__UNSET_MEDIA_TYPE = 6;
    ...
    public static void write(int code, int arg1) {
        ...
        if (SIGNATURE_PICKER_LAUNCHED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (SIGNATURE_CREATE_LAUNCHED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (SIGNATURE_SETTINGS_LAUNCHED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static void write(int code, int arg1, int arg2, int arg3) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (SIGNATURE_CREATED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (SIGNATURE_APP_ERROR == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (SIGNATURE_DELETED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, boolean arg8, boolean arg9, boolean arg10, boolean arg11, boolean arg12, boolean arg13, boolean arg14, int arg15, int arg16, boolean arg17, boolean arg18, boolean arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, java.lang.String arg3, int arg4, java.lang.String arg5) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, long arg2) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (SIGNATURE_PROVIDER_OPEN_DURATION == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static void write(int code, int arg1, long arg2, int arg3) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (SIGNATURE_SAVE_DURATION == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        if (SIGNATURE_DELETE_DURATION == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeLong(arg2);
        builder.writeInt(arg3);
    ...
    public static void write(int code, int arg1, long arg2, int arg3, int arg4) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (SIGNATURES_LOAD_DURATION == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeLong(arg2);
        builder.writeInt(arg3);
    ...
    public static void write(int code, int arg1, long arg2, long arg3, long arg4, long arg5, long arg6, int arg7, long arg8) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeLong(arg2);
