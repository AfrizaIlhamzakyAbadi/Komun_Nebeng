...
public final class FormWidgetInfo implements Parcelable {
    ...
    public FormWidgetInfo(
        ...
        this.mWidgetName = Flags.enableFormWidgetName() ? widgetName : null;
    }
    ...
    /**
     * Returns the field's widget name, if present, or else {@code null}.
     *
     * <p><strong>Note:</strong> Comes from the "T" value in the annotation dictionary, if present,
     * else {@code null}.
     * See <a
     * href="https://opensource.adobe.com/dc-acrobat-sdk-docs/pdfstandards/pdfreference1.7old.pdf">
     * PDF Spec 1.7 Table 8.69</a>
     */
    @Nullable
    @FlaggedApi(Flags.FLAG_ENABLE_FORM_WIDGET_NAME)
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FormWidgetInfo other) {
            return mWidgetType == other.mWidgetType
                    ...
                    && Objects.equals(mWidgetName, other.mWidgetName);
        }
        return false;
    }
    ...
    public static final class Builder {
        ...
        /**
         * Sets the internal name of this widget.
         *
         * <p>This API is intended exclusively for debugging and testing purposes.
         * It is restricted to test environments because the widget name is a metadata value defined
         * within the PDF document that should not be mutated by external developers.
         */
        @TestApi
        @NonNull
        @FlaggedApi(Flags.FLAG_ENABLE_FORM_WIDGET_NAME)
