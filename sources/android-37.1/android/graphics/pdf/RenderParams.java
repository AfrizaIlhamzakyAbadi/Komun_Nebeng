...
public final class RenderParams {
    ...
    /** Flag to exclude {@link PdfPagePathObject} in the rendered page bitmaps */
    @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
    public static final int RENDER_PAGE_OBJECT_EXCLUDE_PATH = 1 << 1;

    /** Flag to exclude {@link PdfPageImageObject} in the rendered page bitmaps */
    @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
    public static final int RENDER_PAGE_OBJECT_EXCLUDE_IMAGE = 1 << 2;

    /** Flag to exclude {@link PdfPageTextObject} in the rendered page bitmaps */
    @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
    public static final int RENDER_PAGE_OBJECT_EXCLUDE_TEXT = 1 << 3;

    /** Flag to include all the page objects in the rendered page bitmaps */
    @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
    public static final int RENDER_PAGE_OBJECT_EXCLUDE_NONE = 0;

    private final int mRenderMode;
    private final int mRenderFlags;

    private final int mRenderFormContentMode;
    private final int mRenderPageObjectFlags;

    private RenderParams(int renderMode, int renderFlags,
            @RenderFormContentMode int renderFormContentMode,
            @RenderPageObjectFlags int renderPageObjectFlags) {
        this.mRenderMode = renderMode;
        this.mRenderFlags = renderFlags;
        this.mRenderFormContentMode = renderFormContentMode;
        this.mRenderPageObjectFlags = renderPageObjectFlags;
    }
     ...
     *
     * @see RenderPageObjectFlags
     */
    @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
    public int getRenderPageObjectFlags() {
        return mRenderPageObjectFlags;
    }
    ...
    @Hide
    @IntDef(flag = true, prefix = {"RENDER_PAGE_OBJECT_"}, value = {
            RENDER_PAGE_OBJECT_EXCLUDE_PATH,
            RENDER_PAGE_OBJECT_EXCLUDE_IMAGE,
            RENDER_PAGE_OBJECT_EXCLUDE_TEXT,
            RENDER_PAGE_OBJECT_EXCLUDE_NONE
    })
    @Retention(RetentionPolicy.SOURCE)
    public @interface RenderPageObjectFlags {
    ...
    public static final class Builder {
        ...
        @RenderPageObjectFlags
        private int mRenderPageObjectFlags = RENDER_PAGE_OBJECT_EXCLUDE_NONE;
        ...
        /**
         * Sets the state of the render flag for page objects.
         * Can be one of or Bitwise OR of
         * {@link #RENDER_PAGE_OBJECT_EXCLUDE_PATH} ,
         * {@link #RENDER_PAGE_OBJECT_EXCLUDE_IMAGE},
         * {@link #RENDER_PAGE_OBJECT_EXCLUDE_TEXT}
         *
         * @param flags The bitmask of the flags which
         *              denote which type of page objects to exclude from the
         *              page bitmap or {@link #RENDER_PAGE_OBJECT_EXCLUDE_NONE} to include all types
         *              of page objects.
         */
        @NonNull
        @FlaggedApi(Flags.FLAG_ENABLE_RENDER_PAGE_OBJECT_FLAGS)
        public Builder setRenderPageObjectFlags(@RenderPageObjectFlags int flags) {
            this.mRenderPageObjectFlags = flags;
            return this;
        }
