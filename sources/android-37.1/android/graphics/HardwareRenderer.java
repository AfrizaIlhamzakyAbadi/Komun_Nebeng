...
public class HardwareRenderer {
    ...
    @Hide
    @IntDef(flag = true, prefix = {"FLAG_DUMP_"},
            value = {FLAG_DUMP_FRAMESTATS, FLAG_DUMP_RESET, FLAG_DUMP_ALL})
    @Retention(RetentionPolicy.SOURCE)
    public @interface DumpFlags {}

    /**
     * Enables Out of Process Rendering for the application.
     */
    @Hide
    ...
    /**
     * Checks if Out of Process Rendering is enabled for the application.
     */
    @Hide
    public static boolean isOoprEnabled() {
        return nIsOoprEnabled();
    }
