...
public class Paint {
    ...
    // Use a holder to defer enum init that might be sensitive to static init ordering and dex
    ...
    /**
     * bit mask for the flag enabling subpixel glyph rendering for text
     */
    @Hide
    ...
    /**
     * bit mask for the flag forcing freetype's autohinter on for text
     */
    @Hide
   ...
   /**
    ...
    public Style getStyle() {
        return ClassAttributesHolder.sStyleArray[nGetStyle(mNativePaint)];
    }
    ...
    public Cap getStrokeCap() {
        return ClassAttributesHolder.sCapArray[nGetStrokeCap(mNativePaint)];
    }
    ...
    public Join getStrokeJoin() {
        return ClassAttributesHolder.sJoinArray[nGetStrokeJoin(mNativePaint)];
    }
    ...
    public Align getTextAlign() {
        return ClassAttributesHolder.sAlignArray[nGetTextAlign(mNativePaint)];
    }
