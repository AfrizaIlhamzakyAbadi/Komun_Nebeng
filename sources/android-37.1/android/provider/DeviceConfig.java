...
public final class DeviceConfig {
    ...
    private static final List<String> PUBLIC_NAMESPACES =
            Arrays.asList(NAMESPACE_TEXTCLASSIFIER, NAMESPACE_RUNTIME, NAMESPACE_STATSD_JAVA,
                    ...
                    NAMESPACE_LATENCY_TRACKER, "system_performance");
    ...
    private static void applyOverrides(@NonNull Properties properties) {
        ...
        try {
            overrides = getPropertiesWithoutOverrides(DEVICE_CONFIG_OVERRIDES_NAMESPACE);
        } catch (SecurityException e) {
            Log.w(TAG, "Cannot read overrides namespace due to lack of permission: "
                    + e.getMessage());
            return;
        }
