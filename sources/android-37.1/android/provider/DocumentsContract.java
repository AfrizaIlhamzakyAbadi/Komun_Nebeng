...
public final class DocumentsContract {
    ...
    public final static class Document {
        ...
        /**
         * Flag indicating this document supports subtree searching.
         *
         * <p>When set, this directory acts as a valid starting point for searches restricted to its
         * descendants. This flag is only valid when {@link #COLUMN_MIME_TYPE} is {@link
         * #MIME_TYPE_DIR}.
         *
         * <p>When set, the system will call {@link DocumentsProvider#querySearchDocuments(String,
         * String[], Bundle, CancellationSignal)} when a user initiates a search within this
         * document.
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsContract#buildSearchDocumentsUri(Uri, String)
         * @see DocumentsProvider#querySearchDocuments(String, String[], Bundle, CancellationSignal)
         */
        @FlaggedApi(Flags.FLAG_ENABLE_DOCUMENTSPROVIDER_SEARCH_BY_DOCUMENT_API)
        public static final int FLAG_SUPPORTS_SUBTREE_SEARCH = 1 << 18;
    }
    ...
    public final static class Root {
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsContract#buildSearchDocumentsUri(String, String, String)
         * @see DocumentsProvider#querySearchDocuments(String, String, String[])
         * @see DocumentsProvider#querySearchDocuments(String, String[], Bundle)
         */
         ...
         * <ul>
         *    <li>the device does not have internet connection
         *    <li>{@link Document#COLUMN_CONTENT_SYNC_STATE_FLAGS} is non-null and
         *          {@link Document#SYNC_STATE_FLAG_AVAILABLE_LOCALLY} is not set
         *    <li>{@link #FLAG_LIMITED_FUNCTIONALITY_WHEN_OFFLINE} is set
         *    <li>{@link Document#FLAG_VIRTUAL_DOCUMENT} is not set
         *    <li>{@link Document#COLUMN_MIME_TYPE} does not equal {@link Document#MIME_TYPE_DIR}
         * </ul>
         *
         ...
         *    <li>the device does not have internet connection
         *    <li>{@link #FLAG_LIMITED_FUNCTIONALITY_WHEN_OFFLINE} is set
         *    <li>{@link Document#COLUMN_MIME_TYPE} equals {@link Document#MIME_TYPE_DIR}
         * </ul>
         *
    ...
    /**
     * Build URI representing a search for matching documents under a specific directory in a
     * document provider. When queried, a provider will return zero or more rows with columns
     * defined by {@link Document}.
     *
     * @param parentDocumentUri the document that search results should be restricted to, which must
     *     be a directory with mime type of {@link Document#MIME_TYPE_DIR} and have {@link
     *     Document#FLAG_SUPPORTS_SUBTREE_SEARCH} set.
     ...
     */
    @FlaggedApi(Flags.FLAG_ENABLE_DOCUMENTSPROVIDER_SEARCH_BY_DOCUMENT_API)
    public static @NonNull Uri buildSearchDocumentsUri(
            @NonNull Uri parentDocumentUri, @Nullable String query) {
