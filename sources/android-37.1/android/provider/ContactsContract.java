...
public final class ContactsContract {
    ...
    protected interface ContactOptionsColumns {
         ...
         * <P>Type: TEXT (one of the values defined in {@link ContactColor})</P>
         * <P>There is no default color assigned to a contact, the value corresponding to this
         * column will be null, until a particular color is written</P>
         */
        @Hide
        String COLOR = "color";
    }
    ...
    /**
     * List of available colors to associate with a contact.
     */
    @Hide
    @StringDef(prefix = "COLOR_", value = {
        COLOR_NONE,
        COLOR_WHITE,
        COLOR_RED,
        COLOR_BLUE,
