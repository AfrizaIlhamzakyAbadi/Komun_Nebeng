...
public final class Settings {
    ...
    /**
     * Activity Action: Show settings to allow configuration of home time zone.
     * <p>
     * In some cases, a matching Activity may not exist, so ensure you
     * safeguard against this.
     * <p>
    ...
    public static final String ACTION_HOME_TIME_ZONE_SETTINGS =
            "android.settings.HOME_TIME_ZONE_SETTINGS";
    ...
    /**
     * Activity Action: Show App Lock settings.
     * <p>
     * In some cases, a matching Activity may not exist, so ensure you safeguard against this.
     * <p>
     * Input: Nothing.
    ...
    @SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    public static final String ACTION_APP_LOCK_SETTINGS = "android.settings.APP_LOCK_SETTINGS";
    ...
    /**
     * Intent extra: supervision restriction that we are trying to bypass.
     *
    ...
    /**
     * Intent extra: preference key of the restricted preference.
     *
     * <p>This should be used when launching {@link #ACTION_BYPASS_SUPERVISION_RESTRICTION} .
     */
    @Hide
    public static final String EXTRA_SUPERVISION_PREFERENCE_KEY =
            "android.settings.EXTRA_SUPERVISION_PREFERENCE_KEY";
    ...
    /**
     * - Private call() method on SettingsProvider to read from 'system' table.
     */
    @Hide
    public static final String CALL_METHOD_GET_SYSTEM = "GET_system";

    /**
     * - Private call() method on SettingsProvider to read from 'secure' table.
     */
    @Hide
    public static final String CALL_METHOD_GET_SECURE = "GET_secure";

    /**
     * - Private call() method on SettingsProvider to read from 'global' table.
     */
    @Hide
    public static final String CALL_METHOD_GET_GLOBAL = "GET_global";

    /**
     * - Private call() method on SettingsProvider to read from 'config' table.
     */
    @Hide
    ...
    /**
     * - User handle argument extra to the fast-path call()-based requests
     */
    @Hide
    public static final String CALL_METHOD_USER_KEY = "_user";

    /**
     * - Boolean argument extra to the fast-path call()-based requests
     */
    @Hide
    ...
    /**
     * - String argument extra to the fast-path call()-based requests
     */
    @Hide
    ...
    /**
     * - RemoteCallback monitor callback argument extra to the fast-path call()-based requests
     */
    @Hide
    ...
    /**
     * - Private call() method to write to 'system' table
     */
    @Hide
    public static final String CALL_METHOD_PUT_SYSTEM = "PUT_system";

    /**
     * - Private call() method to write to 'secure' table
     */
    @Hide
    public static final String CALL_METHOD_PUT_SECURE = "PUT_secure";

    /**
     * - Private call() method to write to 'global' table
     */
    @Hide
    public static final String CALL_METHOD_PUT_GLOBAL= "PUT_global";

    /**
     * - Private call() method to write to 'configuration' table
     */
    @Hide
    public static final String CALL_METHOD_PUT_CONFIG = "PUT_config";

    /**
     * - Private call() method to write to and delete from the 'configuration' table
     */
    @Hide
    public static final String CALL_METHOD_SET_ALL_CONFIG = "SET_ALL_config";

    /**
     * - Private call() method to delete from the 'system' table
     */
    @Hide
    public static final String CALL_METHOD_DELETE_SYSTEM = "DELETE_system";

    /**
     * - Private call() method to delete from the 'secure' table
     */
    @Hide
    public static final String CALL_METHOD_DELETE_SECURE = "DELETE_secure";

    /**
     * - Private call() method to delete from the 'global' table
     */
    @Hide
    public static final String CALL_METHOD_DELETE_GLOBAL = "DELETE_global";

    /**
     * - Private call() method to reset to defaults the 'configuration' table
     */
    @Hide
    public static final String CALL_METHOD_DELETE_CONFIG = "DELETE_config";

    /**
     * - Private call() method to reset to defaults the 'system' table
     */
    @Hide
    public static final String CALL_METHOD_RESET_SYSTEM = "RESET_system";

    /**
     * - Private call() method to reset to defaults the 'secure' table
     */
    @Hide
    public static final String CALL_METHOD_RESET_SECURE = "RESET_secure";

    /**
     * - Private call() method to reset to defaults the 'global' table
     */
    @Hide
    ...
    /**
     * - Private call() method to return the current mode of sync disabling for the
     * 'configuration' table
     */
    @Hide
    ...
    /**
     * - Private call() method to register monitor callback for 'configuration' table
     */
    @Hide
    ...
    /**
     * - Private call() method to unregister monitor callback for 'configuration' table
     */
    @Hide
    ...
    /**
     * - String argument extra to the config monitor callback
     */
    @Hide
    ...
    public static final class System extends NameValueTable {
        ...
        /**
         * Erase the fields in the Configuration that should be applied
         * by the settings.
         */
        @Hide
    ...
    public static final class Secure extends NameValueTable {
       ...
       @Hide
        ...
        /**
         * Whether or not lskf recovery has been enabled.
         */
        @Hide
        public static final String LSKF_RECOVERY_ENABLED = "lskf_recovery_enabled";
        ...
        /**
         * Whether QS tiles should restrict clicks and toggles when locked.
         *
         * If true (1), clicking on a tile requires unlocking device, if false (0) or non-existent
         * (legacy), it doesn't require unlock.
         */
        @Hide
        public static final String QS_TILES_DISALLOW_LOCKED = "sysui_qs_tiles_disallow_locked";
        ...
        /**
         * Whether the agent task feature (both state and events) is enabled to show in the
         * status bar. (default true)
         *
         * Type: int (0 for false, 1 for true)
         * @see android.app.StatusBarManager#canSetAgentTask
         */
        @FlaggedApi(android.app.Flags.FLAG_STATUS_BAR_AGENT_ICON)
        @Hide
        public static final String STATUS_BAR_AGENT_ICON_ENABLED = "status_bar_agent_icon_enabled";

        /**
         * Whether to show the mute icon in the Status Bar.
         * Default is 1 (show setting).
         */
        @Hide
        public static final String STATUS_BAR_SHOW_MUTE_ICON = "status_bar_show_mute_icon";
        /**
        ...
        /**
         * Whether the user can enable the contextual cursor via mouse entrypoint.
         */
        @Hide
        @Readable
        public static final String CONTEXTUAL_CURSOR_MOUSE_ENTRYPOINT =
                "contextual_cursor_mouse_entrypoint";

        /**
         * The speed of the contextual cursor.
         */
        @Hide
        @Readable
        public static final String CONTEXTUAL_CURSOR_SPEED =
                "contextual_cursor_speed";

        /**
         * Whether the user can enable the contextual cursor.
         */
        @Hide
        @Readable
        public static final String USE_CONTEXTUAL_CURSOR =
                "use_contextual_cursor";

        /**
         * Whether the user is ineligible to use the contextual cursor.
         */
        @Hide
        @Readable
        public static final String INELIGIBLE_TO_USE_CONTEXTUAL_CURSOR =
                "ineligible_to_use_contexual_cursor";
       ...
       @Hide
        ...
        /**
         * Tracks if the user has observed App Lock Settings or the number of apps enabled via the
         * Launcher to trigger discovery.
         *
         * Values:
         * <ul>
         *   <li>{@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_DISCOVERED}: The user has observed the
         *        App Lock Settings page (via direct visit, dismissing a Safety Center card, or
         *        viewing the Launcher promotion). Once the value is set to
         *        {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_DISCOVERED}, it will remain at
         *        {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_DISCOVERED}, since there is no need to
         *        track this anymore.</li>
         *   <li>{@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_INITIAL}: Initial state; no apps ever
         *        had App Lock enabled.</li>
         *   <li>Between {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_INITIAL} and
         *        {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_THRESHOLD}: The number of apps the user
         *        has enabled via the Launcher long-press menu. Once the count reaches
         *        {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_THRESHOLD}, a promotion is shown and
         *        the state is set to {@link #APP_LOCK_SETTINGS_DISCOVERED_STATE_DISCOVERED}.
         *   </li>
         * </ul>
         */
        @Hide
        public static final String APP_LOCK_SETTINGS_DISCOVERED = "app_lock_settings_discovered";

        /**
         * {@link #APP_LOCK_SETTINGS_DISCOVERED} state where the user has already discovered the App
         * Lock settings page.
         */
        @Hide
        ...
        /**
         * The initial {@link #APP_LOCK_SETTINGS_DISCOVERED} state where no apps have had App Lock
         * enabled.
         */
        @Hide
        ...
        /**
         * Threshold for the number of apps enabled through the Launcher required to trigger the App
         * Lock settings discovery promotion, see {@link #APP_LOCK_SETTINGS_DISCOVERED}.
         */
        @Hide
    ...
    public static final class Global extends NameValueTable {
        ...
        */
        ...
        public static final class Wearable extends NameValueTable {
            ...
            /**
             * Gesture primary action customization for watchface.
             */
            @Hide
            public static final String GESTURE_CUSTOMIZE_WATCHFACE_PRIMARY_ACTION =
                    "gesture_customize_watchface_primary_action";

            /**
             * Indicates that the primary gesture for watchface should open the ongoing
             * notification.
             */
            @Hide
            public static final int GESTURE_CUSTOMIZE_WATCHFACE_PRIMARY_ACTION_OPEN_ONGOING = 0;

            /**
             * Indicates that the primary gesture for watchface should always scroll the
             * notification tray.
             */
            @Hide
            public static final int GESTURE_CUSTOMIZE_WATCHFACE_PRIMARY_ACTION_ALWAYS_SCROLL = 1;

            /**
             * Indicates that the primary gesture for watchface should send the gesture to the
             * external device.
             */
            @Hide
            public static final int GESTURE_CUSTOMIZE_WATCHFACE_PRIMARY_ACTION_EXTERNAL_DEVICE = 2;
            ...
            /**
             * Whether Gemini is enabled and ready to support Raise-to-Talk
             */
            @Hide
            @Readable
            public static final String RAISE_TO_TALK_GEMINI_ENABLED =
                    "raise_to_talk_gemini_enabled";
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_GESTURE_SENSITIVITY_LOW = 1;

            /**
             * Indicates that the gesture sensitivity for Raise-to-Talk is set to medium.
             */
            @Hide
            public static final int RAISE_TO_TALK_GESTURE_SENSITIVITY_MEDIUM = 2;
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_GESTURE_SENSITIVITY_HIGH = 3;
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_VOICE_SENSITIVITY_VERY_LOW = 1;
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_VOICE_SENSITIVITY_LOW = 2;

            /**
             * Indicates that the voice sensitivity for Raise-to-Talk is set to medium.
             */
            @Hide
            public static final int RAISE_TO_TALK_VOICE_SENSITIVITY_MEDIUM = 3;
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_VOICE_SENSITIVITY_HIGH = 4;
             ...
             */
            @Hide
            public static final int RAISE_TO_TALK_VOICE_SENSITIVITY_VERY_HIGH = 5;
