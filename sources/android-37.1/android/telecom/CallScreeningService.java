...
public abstract class CallScreeningService extends Service {
    ...
    public static class CallResponse {
        ...
        private CallResponse(
            ...
            if (shouldRejectAsMissed && !shouldRejectCall) {
                throw new IllegalStateException("Must reject call if rejecting as missed.");
            }
         ...
         */
        @FlaggedApi(Flags.FLAG_REJECT_AS_MISSED_API)
        public boolean isRejectedAsMissed() {
        ...
        public boolean equals(Object o) {
            ...
            return mShouldDisallowCall == that.mShouldDisallowCall &&
                    ...
                    mCallComposerAttachmentsToShow == that.mCallComposerAttachmentsToShow
                            && mShouldRejectAsMissed == that.mShouldRejectAsMissed;
        }
        ...
        public static class Builder {
            ...
            private boolean mShouldRejectAsMissed;
            ...
            /**
             * Sets whether the incoming call should be rejected and marked as if it is a
             * missed call.
             * This property should only be set to true if the call is disallowed.
             */
            @NonNull
            @FlaggedApi(Flags.FLAG_REJECT_AS_MISSED_API)
            public Builder setRejectedAsMissed(boolean shouldRejectedAsMissed) {
                mShouldRejectAsMissed = shouldRejectedAsMissed;
                return this;
            }
            ...
            /**
             * Builds the {@link CallResponse} object.
             *
             * @throws IllegalStateException If {@code shouldDisallowCall} is {@code false} and
             * {@code shouldRejectAsMissed} is {@code true}, or if {@code shouldRejectAsMissed} is
             * {@code true} and {@code shouldRejectCall} is {@code false}.
             */
