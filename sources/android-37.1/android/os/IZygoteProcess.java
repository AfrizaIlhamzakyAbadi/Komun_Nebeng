...
public interface IZygoteProcess {
     ...
     * @param appInfo The ApplicationInfo used to derive the linker namespace parameters and the
     *                target SDK version.
     * @param nativePreloadLibrary The name of the native library to preload in the child zygote.
     *                             Only used for native-only services.
     * @param nativePreloadInit The name of the function to call in the preloaded native library.
     *                          Only used for native-only services.
     */
    default ChildZygoteProcess startChildZygote(String processClass,
                                        String niceName,
                                        ...
                                        String nativePreloadLibrary,
                                        String nativePreloadInit) {
        return startChildZygote(processClass, niceName, uid, gid, gids, runtimeFlags, seInfo,
                abi, acceptedAbiList, instructionSet, uidRangeStart, uidRangeEnd, appInfo,
                nativePreloadLibrary, nativePreloadInit,
                /*nativeReservedAddress=*/ 0, /*nativeReservedSize=*/ 0,
                /*nativeLibraryRelroPath=*/ null);
    }

    /**
     * Starts a new zygote process as a child of this zygote.
     *
     * @see #startChildZygote(String, String, int, int, int[], int, String, String, String, String,
     *                        int, int, ApplicationInfo, String, String)
     *
     * @param nativeReservedAddress The memory address reserved for the native library. Only used
     *                              for native-only services.
     * @param nativeReservedSize The size of the memory region reserved for the native library.
     *                           Only used for native-only services.
     * @param nativeLibraryRelroPath The path to the RELRO file to use for the preloaded native
     *                               library. Only used for native-only services.
     */
    ChildZygoteProcess startChildZygote(String processClass,
                                        ...
                                        String nativePreloadLibrary,
                                        String nativePreloadInit,
                                        long nativeReservedAddress,
                                        long nativeReservedSize,
                                        String nativeLibraryRelroPath);
