...
public final class AllowlistManager {
     ...
     * CTS tests.
     * @deprecated Use {@link #setTestAllowlistProvider(String)} instead
     */
    @TestApi
    @Deprecated
    @FlaggedApi(android.permission.flags.Flags.FLAG_ALLOWLIST_TEST_PROVIDER_ENABLED)
    @RequiresPermission(QUERY_ALLOWLIST)
    ...
    /**
     * Set the test package name of the allowlist provider service.
     * This is only used for testing.
     */
    @TestApi
    @FlaggedApi(android.permission.flags.Flags.FLAG_ALLOWLIST_TEST_PROVIDER_ENABLED)
    @RequiresPermission(android.Manifest.permission.QUERY_ALLOWLIST)
    public void setTestAllowlistProvider(@Nullable String packageName) {
        try {
            mService.setTestAllowlistProvider(packageName);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
