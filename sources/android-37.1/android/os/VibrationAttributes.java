...
import static android.os.vibrator.Flags.FLAG_COMPOSITION_API;
...
public final class VibrationAttributes implements Parcelable {
    ...
    @IntDef(prefix = { "FLAG_" }, flag = true, value = {
            ...
            FLAG_NO_FALLBACK_FOR_TIMELINED_COMPOSITION,
    })
    @Retention(RetentionPolicy.SOURCE)
    ...
    /**
     * Flag requesting that no fallback should be played if the vibration effect is a
     * timelined composition (e.g. created via {@link VibrationEffect.Builder}) and
     * is not supported by the HAL.
     *
     * <p>For more details about the background of haptics implementation and how
     * OEMs support these effects, see the
     * <a href="https://source.android.com/docs/core/interaction/haptics/haptics-implement">
     * Android Haptics Implementation Guidelines</a>.
     */
    @Hide
    @FlaggedApi(FLAG_COMPOSITION_API)
    public static final int FLAG_NO_FALLBACK_FOR_TIMELINED_COMPOSITION = 1 << 4;
