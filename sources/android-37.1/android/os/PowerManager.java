...
public final class PowerManager {
    ...
    /**
     * Wake lock level: Keeps the device asleep for the user, but ensures that the CPU
     * remains awake.
     * This level supersedes all other wake locks, suppressing all standard wake triggers
     * (e.g., power button, notifications).
     */
    @Hide
    ...
    /**
     * Go to sleep reason code: Going to sleep due to a dream failure.
     */
    @Hide
    public static final int GO_TO_SLEEP_REASON_DREAM_FAILED = 15;

    @Hide
    public static final int GO_TO_SLEEP_REASON_MAX = GO_TO_SLEEP_REASON_DREAM_FAILED;
    ...
    public static String sleepReasonToString(@GoToSleepReason int sleepReason) {
        switch (sleepReason) {
            ...
            case GO_TO_SLEEP_REASON_DREAM_FAILED: return "dream_failed";
    ...
    @IntDef(prefix = { "GO_TO_SLEEP_REASON_" }, value = {
            ...
            GO_TO_SLEEP_REASON_DREAM_FAILED,
   ...
   /**
    ...
    /**
     * Intent that is broadcast when the set of power save allowlist apps has changed.
     * This broadcast is only sent to registered receivers.
     */
    @Hide
    @SdkConstant(SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
