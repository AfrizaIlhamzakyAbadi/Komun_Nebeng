...
public abstract class VibrationEffectSegment implements Parcelable {
    ...
    static final int PARCEL_TOKEN_PRESET = 6;
    static final int PARCEL_TOKEN_BEATING = 7;
     ...
     */
    @TestApi
    @FlaggedApi(android.os.vibrator.Flags.FLAG_COMPOSITION_API)
                ...
                public VibrationEffectSegment createFromParcel(Parcel in) {
                    switch (in.readInt()) {
                        ...
                        case PARCEL_TOKEN_BASIC_PWLE:
                            ...
                            // Fall through to default if the flag is not enabled.
                        case PARCEL_TOKEN_PRESET:
                            if (Flags.compositionApi()) {
                                return new PresetSegment(in);
                            }
                            // Fall through to default if the flag is not enabled.
                        case PARCEL_TOKEN_BEATING:
                            if (Flags.beatingEffectApi()) {
