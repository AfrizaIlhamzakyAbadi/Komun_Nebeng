    ...
    public static final class Builder {
        ...
        public Builder addDischargePercentage(int dischargePercentage) {
            if (dischargePercentage < 0) {
                Slog.wtfStack(TAG,
                        "Negative dischargePercentage: " + dischargePercentage + " skipped");
                return this;
            }
        ...
        public Builder addDischargedPowerRange(double dischargedPowerLowerBoundMah,
            ...
            if (dischargedPowerLowerBoundMah < 0 || dischargedPowerUpperBoundMah < 0) {
                Slog.wtfStack(TAG, "Negative value in discharged power range: ["
                        + dischargedPowerLowerBoundMah + ", " + dischargedPowerUpperBoundMah
                        + "] skipped");
                return this;
            }
        ...
        public Builder addDischargeDurationMs(long durationMs) {
            if (durationMs < 0) {
                Slog.wtfStack(TAG, "Negative durationMs: " + durationMs + " skipped");
                return this;
            }
