...
public final class CompanionResources {
    ...
    public static final Set<String> ALLOWED_EXTRA_PERMISSIONS = Set.of(
            PERMISSION_GROUP_NEARBY
    );

    // Constants used by TrustPairingProcessor and CompanionTrustPairingActivity
    public static final String EXTRA_PIN_CODE = "pin_code";
    public static final String EXTRA_ASSOCIATION_ID = "association_id";
    public static final String EXTRA_REMOTE_DEVICE_NAME = "remote_device_name";
    public static final String EXTRA_TRUST_TYPES = "trust_types";
    public static final int RESULT_CODE_TRUST_PAIRING_APPROVED = 100;
    public static final int RESULT_CODE_TRUST_PAIRING_CANCELLED = 101;
}
