...
public sealed interface LifecycleState {
    ...
    /**
     * A convenience method to check whether this is the Suspended state: the special Blocked state
     * indicating that the session is suspended by the session owner.
     */
    default boolean isSuspended() {
        return this instanceof Blocked blocked
                && blocked.reason == ComputerControlSession.BLOCK_REASON_SUSPENDED;
    }
}
