...
public final class ComputerControlSessionParams implements Parcelable {
    ...
    public String toString() {
        return "ComputerControlSessionParams{"
                + "name='" + mName + '\''
                + ", targetComputerControlVersion=" + mTargetComputerControlVersion
                + ", targetPackageNames=" + mTargetPackageNames
                + ", appInteractionAttribution=" + mAppInteractionAttribution
                + ", hasPreviewIntent=" + (mPreviewIntent != null)
                + ", hasNotificationParams=" + (mNotificationParams != null)
                + '}';
    }
        ...
        public ComputerControlSessionParams build() {
            ...
            if (mTargetComputerControlVersion >= MIN_COMPUTER_CONTROL_VERSION_FOR_ANDROID_17) {
                ...
                if (mPreviewIntent == null) {
                    throw new IllegalArgumentException("Preview intent must be set");
                }
            }
