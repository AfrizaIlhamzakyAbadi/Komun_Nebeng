...
public final class VirtualCameraConfig implements Parcelable {
    ...
    public static final class Builder {
         ...
         * is called and an {@link ObjLongConsumer} instance is received in
         * {@link VirtualCameraCallback#onConfigureSession(VirtualCameraSessionConfig,
         * ObjLongConsumer)}.
         * The {@link ObjLongConsumer} instance allows the passing of a {@link CaptureResult}
         * and the timestamp (as {@code long}) associated with the image written to the
         * {@link Surface} for a successful frame capture.
         *
         ...
         * @see VirtualCameraCallback#onStreamConfigured(int, Surface, int, int, int)
         */
        @NonNull
