...
import static android.companion.CompanionResources.ALLOWED_EXTRA_PERMISSIONS;
...
public final class AssociationInfo implements Parcelable {
    ...
    private AssociationInfo(Builder builder) {
        ...
        mTrustTypes = builder.mTrustTypes;
    }
     ...
     *
     * @see CompanionDeviceManager#requestDeviceTrustPairing(int)
     */
    ...
    /**
     * @return An array of enabled trust types for this association.
     */
    @FlaggedApi(Flags.FLAG_TRUST_PAIRING)
    @Nullable
    public int[] getTrustTypes() {
        return mTrustTypes;
    }
    ...
    public String toString() {
        return "Association{"
                ...
                + ", mTrustTypes=" + java.util.Arrays.toString(mTrustTypes)
                + '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        return mId == that.mId
                ...
                && java.util.Arrays.equals(mTrustTypes, that.mTrustTypes);
    }
    ...
    public int hashCode() {
        return Objects.hash(mId, mUserId, mPackageName, mDeviceMacAddress, mDisplayName,
                ...
                mExtraPermissions, mRemoteAiAgentSupported, java.util.Arrays.hashCode(mTrustTypes));
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeIntArray(mTrustTypes);
    }
    ...
    public static final class Builder {
        ...
        @SuppressLint("MissingGetterMatchingBuilder")
        @FlaggedApi(Flags.FLAG_TRUST_PAIRING)
        public Builder setTrustTypes(@Nullable int[] trustTypes) {
            mTrustTypes = trustTypes;
            return this;
        }
        ...
        public AssociationInfo build() {
            ...
            if (!CollectionUtils.isEmpty(mExtraPermissions)
                    && !ALLOWED_EXTRA_PERMISSIONS.containsAll(mExtraPermissions)) {
                throw new IllegalArgumentException(
                        "Provided extra permissions contain unsupported permission."
                );
            }
