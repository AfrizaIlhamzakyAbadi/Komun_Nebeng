...
public final class NetworkStackConstants {
    ...
    // These are all ints to ensure they are all positive (as a short, TCPHDR_FLAGS_MASK would be
    // negative) and because kotlin bitwise operators only work on int.
    public static final int TCPHDR_FIN = (1 << 0);
    public static final int TCPHDR_SYN = (1 << 1);
    public static final int TCPHDR_RST = (1 << 2);
    public static final int TCPHDR_PSH = (1 << 3);
    public static final int TCPHDR_ACK = (1 << 4);
    public static final int TCPHDR_URG = (1 << 5);
    public static final int TCPHDR_ECE = (1 << 6);
    public static final int TCPHDR_CWR = (1 << 7);
    public static final int TCPHDR_AE = (1 << 8);
    public static final int TCPHDR_SYNACK = TCPHDR_SYN | TCPHDR_ACK;
    public static final int TCPHDR_FLAGS_MASK = 0xfff;
    public static final int TCPHDR_DOFF_MASK = 0xf000;
