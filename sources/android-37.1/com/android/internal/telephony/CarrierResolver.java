...
public class CarrierResolver extends Handler {
    ...
    /**
     * Internal signal to indicate a SIM refresh reset has occurred.
     * This is used to trigger an identity flush to prevent stale carrier identity
     * from leaking during the refresh window.
     */
    public static final String SIM_STATE_REFRESH_RESET = "SIM_REFRESH_RESET";
    ...
    public void resolveSubscriptionCarrierId(String simState) {
        ...
        switch (simState) {
            ...
            case IccCardConstants.INTENT_VALUE_ICC_LOADED:
                ...
                break;
            case SIM_STATE_REFRESH_RESET:
                if (mFeatureFlags.resetCarrierIdOnSimRefresh()) {
                    logd("resolveSubscriptionCarrierId: reset carrier id due to sim refresh");
                    resetCarrierInfo();
                }
                break;
        }
