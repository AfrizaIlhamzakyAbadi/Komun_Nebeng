        ...
        if (consent) {
            ...
            try {
                ...
                Set<Integer> existingSubscriptions  =
                        euiccController.getCurrentEmbeddedSubscriptionIds(cardId);
                boolean callerIsAdmin =
                        euiccController.callerCanManageDevicePolicyManagedSubscriptions(
                                mCallingPackage, mCallingToken);


                euiccController.downloadSubscriptionPrivileged(
                        cardId,
                        TelephonyManager.DEFAULT_PORT_INDEX,
                        token,
                        mDownloadableSubscription,
