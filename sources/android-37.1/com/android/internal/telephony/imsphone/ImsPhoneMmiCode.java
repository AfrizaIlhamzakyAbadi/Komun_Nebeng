...
public final class ImsPhoneMmiCode extends Handler implements MmiCode {
    ...
    /**
     * The no reply timer is not specified in the MMI code and not supported by the carrier.
     */
    static final int NO_REPLY_TIMER_NOT_SPECIFIED = 0;
...
*/
    ...
    private int getCfnryTime() {
        ...
        if (carrierConfig == null
            ...
            return mFeatureFlags.fixGetCfnryTimeWhenTimerNotSupported()
                    ? NO_REPLY_TIMER_NOT_SPECIFIED : DEFAULT_NO_REPLY_TIMER_FOR_CFNRY;
        }
    ...
    public CharSequence getScString() {
        if (mSc != null) {
            if (isServiceCodeCallBarring(mSc)) {
                ...
                if (mSc.equals(SC_CFB)) {
                    return mContext.getResources().getText(
                            com.android.internal.R.string.CfMmiBusy);
                } else if (mSc.equals(SC_CFNRy)) {
                    return mContext.getResources().getText(
                            com.android.internal.R.string.CfMmiNoReply);
                } else if (mSc.equals(SC_CFNR)) {
                    return mContext.getResources().getText(
                            com.android.internal.R.string.CfMmiNotReachable);
                } else if (mSc.equals(SC_CF_All_Conditional)) {
                    return mContext.getResources().getText(
                            com.android.internal.R.string.CfMmiConditional);
                } else if (mSc.equals(SC_CFU)) {
                    return mContext.getResources().getText(
                            com.android.internal.R.string.CfMmiAlwaysForward);
                } else {
