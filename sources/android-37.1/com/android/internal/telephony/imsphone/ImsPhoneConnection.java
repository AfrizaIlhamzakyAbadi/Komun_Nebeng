    ...
    */
    ...
    private boolean canTransfer(ImsPhoneConnection connection) {
        return (connection != null
                && mOwner == connection.mOwner
                && mImsCall != null
                && mParent != null
                && mParent.getState() == ImsPhoneCall.State.ACTIVE
                && connection.getImsCall() != null
    ...
    public void consultativeTransfer(Connection other) throws CallStateException {
        if (!(other instanceof ImsPhoneConnection)) {
            throw new CallStateException("other connection is not an ImsPhoneConnection");
        }
        ImsPhoneConnection bgConnection = (ImsPhoneConnection) other;
        ImsCall bgImsCall = bgConnection.getImsCall();
