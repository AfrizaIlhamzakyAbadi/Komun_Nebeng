...
public class SmsController extends ISmsImplBase {
    ...
    public void injectSmsPduForSubscriber(
        ...
        if (android.os.Process.isPrivateComputeCoreUid(getCallingUidForTesting())) {
            throw new SecurityException("PCC may not inject SMS");
        }
...
//        }
    ...
    @VisibleForTesting
    public int getCallingUidForTesting() {
