...
public final class TelephonyStatsLog {
    ...
    /**
     * CarrierPrivilegesReported carrier_privileges_reported<br>
     * Usage: StatsLog.write(StatsLog.CARRIER_PRIVILEGES_REPORTED, int sim_carrier_id, int sim_privileged_package_count, int config_privileged_package_count);<br>
     */
    public static final int CARRIER_PRIVILEGES_REPORTED = 1252;

    /**
     * CarrierServiceConfigOverridesReported carrier_service_config_overrides_reported<br>
     * Usage: StatsLog.write(StatsLog.CARRIER_SERVICE_CONFIG_OVERRIDES_REPORTED, int carrier_id, int carrier_service_package_uid, int[] package_uids);<br>
     */
    public static final int CARRIER_SERVICE_CONFIG_OVERRIDES_REPORTED = 1270;

    /**
     * MessageUpgradeResolved message_upgrade_resolved<br>
     * Usage: StatsLog.write(StatsLog.MESSAGE_UPGRADE_RESOLVED, int source_type, int original_message_type, int status, int upgrade_latency_ms, int default_sms_app_uid);<br>
     */
    public static final int MESSAGE_UPGRADE_RESOLVED = 1345;

    /**
     * MessageUpgradeIntentCached message_upgrade_intent_cached<br>
     * Usage: StatsLog.write(StatsLog.MESSAGE_UPGRADE_INTENT_CACHED, int source_type, int upgrade_type, int cache_event, int intent_type, int time_in_cache_ms);<br>
     */
    public static final int MESSAGE_UPGRADE_INTENT_CACHED = 1346;

    /**
     * StoredMessageSendRequested stored_message_send_requested<br>
     * Usage: StatsLog.write(StatsLog.STORED_MESSAGE_SEND_REQUESTED, int calling_uid, int message_type);<br>
     */
    public static final int STORED_MESSAGE_SEND_REQUESTED = 1350;

    /**
     * MessagingDbOperationStats messaging_db_operation_stats<br>
     * Usage: StatsLog.write(StatsLog.MESSAGING_DB_OPERATION_STATS, int operation, int target_uri, int min_latency_micros, int max_latency_micros, int avg_latency_micros, int total_operations, java.lang.String calling_package_name);<br>
     */
    public static final int MESSAGING_DB_OPERATION_STATS = 1351;

    /**
     * MessagingDbLockContentionStats messaging_db_lock_contention_stats<br>
     * Usage: StatsLog.write(StatsLog.MESSAGING_DB_LOCK_CONTENTION_STATS, int operation, int target_uri, java.lang.String victim_package_name, java.lang.String blocking_package_name, int running_telephony_process_count, int count);<br>
     */
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS = 1352;
     ...
     * Usage: StatsLog.write(StatsLog.DEVICE_TELEPHONY_PROPERTIES, boolean using_t_data_stack, boolean auto_data_switch_enabled, int auto_data_switch_toggle_count, boolean has_managed_profile_dedicated_sub, int mep_supported_slot_count, int ro_vendor_api_level, int ro_board_api_level, long telephony_features);<br>
     */
     ...
     * Usage: StatsLog.write(StatsLog.SATELLITE_ENTITLEMENT, int carrier_id, int result, int entitlement_status, boolean is_retry, int count, boolean is_allowed_service_entitlement, int[] entitlement_service_type, int entitlement_data_policy, int supported_connection_mode, int http_status_code, int trigger_event);<br>
     */
     ...
     * Usage: StatsLog.write(StatsLog.SATELLITE_ACCESS_CONTROLLER, int access_control_type, long location_query_time_millis, long on_device_lookup_time_millis, long total_checking_time_millis, boolean is_allowed, boolean is_emergency, int result_code, java.lang.String[] country_codes, int config_data_source, int carrier_id, int triggering_event, boolean is_ntn_only_carrier, int supported_connection_mode, int session_connection_mode);<br>
     */
    public static final int SATELLITE_ACCESS_CONTROLLER = 10219;

    /**
     * MessagingReadRestrictionInfo messaging_read_restriction_info<br>
     * Usage: StatsLog.write(StatsLog.MESSAGING_READ_RESTRICTION_INFO, int caller_uid, int content_provider, int read_restricted_messages_app_op_mode, int event_type, int count);<br>
     */
    public static final int MESSAGING_READ_RESTRICTION_INFO = 10273;
    ...
    // Values for MessageUpgradeResolved.source_type
    public static final int MESSAGE_UPGRADE_RESOLVED__SOURCE_TYPE__SOURCE_TYPE_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_RESOLVED__SOURCE_TYPE__SOURCE_TYPE_BLUETOOTH = 1;
    public static final int MESSAGE_UPGRADE_RESOLVED__SOURCE_TYPE__SOURCE_TYPE_THIRD_PARTY_APP = 2;
    public static final int MESSAGE_UPGRADE_RESOLVED__SOURCE_TYPE__SOURCE_TYPE_DEFAULT_APP = 3;

    // Values for MessageUpgradeResolved.original_message_type
    public static final int MESSAGE_UPGRADE_RESOLVED__ORIGINAL_MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_RESOLVED__ORIGINAL_MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS = 1;
    public static final int MESSAGE_UPGRADE_RESOLVED__ORIGINAL_MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS_MULTIPART = 2;
    public static final int MESSAGE_UPGRADE_RESOLVED__ORIGINAL_MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_MMS = 3;

    // Values for MessageUpgradeResolved.status
    public static final int MESSAGE_UPGRADE_RESOLVED__STATUS__STATUS_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_RESOLVED__STATUS__STATUS_NOT_SUPPORTED = 1;
    public static final int MESSAGE_UPGRADE_RESOLVED__STATUS__STATUS_SUCCEEDED = 2;
    public static final int MESSAGE_UPGRADE_RESOLVED__STATUS__STATUS_FAILED = 3;

    // Values for MessageUpgradeIntentCached.source_type
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__SOURCE_TYPE__SOURCE_TYPE_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__SOURCE_TYPE__SOURCE_TYPE_BLUETOOTH = 1;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__SOURCE_TYPE__SOURCE_TYPE_THIRD_PARTY_APP = 2;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__SOURCE_TYPE__SOURCE_TYPE_DEFAULT_APP = 3;

    // Values for MessageUpgradeIntentCached.upgrade_type
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__UPGRADE_TYPE__ORIGINAL_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__UPGRADE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS = 1;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__UPGRADE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS_MULTIPART = 2;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__UPGRADE_TYPE__ORIGINAL_MESSAGE_TYPE_MMS = 3;

    // Values for MessageUpgradeIntentCached.cache_event
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__CACHE_EVENT__CACHE_EVENT_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__CACHE_EVENT__CACHE_EVENT_ADDED = 1;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__CACHE_EVENT__CACHE_EVENT_REMOVED_DISPATCHED = 2;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__CACHE_EVENT__CACHE_EVENT_REMOVED_REJECTED = 3;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__CACHE_EVENT__CACHE_EVENT_REMOVED_EVICTED = 4;

    // Values for MessageUpgradeIntentCached.intent_type
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__INTENT_TYPE__UPGRADE_INTENT_UNKNOWN = 0;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__INTENT_TYPE__UPGRADE_INTENT_SENT = 1;
    public static final int MESSAGE_UPGRADE_INTENT_CACHED__INTENT_TYPE__UPGRADE_INTENT_DELIVERY = 2;

    // Values for StoredMessageSendRequested.message_type
    public static final int STORED_MESSAGE_SEND_REQUESTED__MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_UNKNOWN = 0;
    public static final int STORED_MESSAGE_SEND_REQUESTED__MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS = 1;
    public static final int STORED_MESSAGE_SEND_REQUESTED__MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_SMS_MULTIPART = 2;
    public static final int STORED_MESSAGE_SEND_REQUESTED__MESSAGE_TYPE__ORIGINAL_MESSAGE_TYPE_MMS = 3;

    // Values for MessagingDbOperationStats.operation
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__UNKNOWN_OP = 0;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__QUERY = 1;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__INSERT = 2;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__UPDATE = 3;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__DELETE = 4;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__BULK_INSERT = 5;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__BACKUP = 6;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__RESTORE = 7;
    public static final int MESSAGING_DB_OPERATION_STATS__OPERATION__OPEN_FILE = 8;

    // Values for MessagingDbOperationStats.target_uri
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__UNKNOWN_URI = 0;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__CONVERSATIONS = 1;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__SMS = 2;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__MMS = 3;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__THREADS = 4;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__THREAD_ID_RESOLUTION = 5;
    public static final int MESSAGING_DB_OPERATION_STATS__TARGET_URI__PART = 6;

    // Values for MessagingDbLockContentionStats.operation
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__UNKNOWN_OP = 0;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__QUERY = 1;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__INSERT = 2;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__UPDATE = 3;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__DELETE = 4;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__BULK_INSERT = 5;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__BACKUP = 6;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__RESTORE = 7;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__OPERATION__OPEN_FILE = 8;

    // Values for MessagingDbLockContentionStats.target_uri
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__UNKNOWN_URI = 0;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__CONVERSATIONS = 1;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__SMS = 2;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__MMS = 3;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__THREADS = 4;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__THREAD_ID_RESOLUTION = 5;
    public static final int MESSAGING_DB_LOCK_CONTENTION_STATS__TARGET_URI__PART = 6;
    ...
    // Values for OutgoingSms.satellite_message_trigger
    public static final int OUTGOING_SMS__SATELLITE_MESSAGE_TRIGGER__SATELLITE_MESSAGE_TRIGGER_UNKNOWN = 0;
    public static final int OUTGOING_SMS__SATELLITE_MESSAGE_TRIGGER__SATELLITE_MESSAGE_TRIGGER_DIRECT_MESSAGES_UI = 1;
    public static final int OUTGOING_SMS__SATELLITE_MESSAGE_TRIGGER__SATELLITE_MESSAGE_TRIGGER_NON_EMERGENCY_DIALER_DIALOG = 2;
    public static final int OUTGOING_SMS__SATELLITE_MESSAGE_TRIGGER__SATELLITE_MESSAGE_TRIGGER_EMERGENCY_DIALER_BUTTON = 3;
    public static final int OUTGOING_SMS__SATELLITE_MESSAGE_TRIGGER__SATELLITE_MESSAGE_TRIGGER_SYSTEM_NOTIFICATION = 4;
    ...
    public static final int DATA_CALL_SESSION__DEACTIVATE_REASON__DEACTIVATE_REASON_UNSUPPORTED_NETWORK_CAPABILITIES = 38;
    ...
    public static final int TELEPHONY_NETWORK_REQUESTS_V2__CAPABILITY__PRIORITIZE_UNIFIFED_COMMUNICATIONS = 11;
    ...
    // Values for SatelliteController.supported_connection_mode
    public static final int SATELLITE_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;
    ...
    // Values for SatelliteSession.supported_connection_mode
    public static final int SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteSession.session_connection_mode
    public static final int SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;
    ...
    // Values for SatelliteIncomingDatagram.supported_connection_mode
    public static final int SATELLITE_INCOMING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_INCOMING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_INCOMING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_INCOMING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteIncomingDatagram.session_connection_mode
    public static final int SATELLITE_INCOMING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_INCOMING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_INCOMING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;
    ...
    // Values for SatelliteOutgoingDatagram.supported_connection_mode
    public static final int SATELLITE_OUTGOING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_OUTGOING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_OUTGOING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_OUTGOING_DATAGRAM__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteOutgoingDatagram.session_connection_mode
    public static final int SATELLITE_OUTGOING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_OUTGOING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_OUTGOING_DATAGRAM__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;
    ...
    // Values for SatelliteProvision.supported_connection_mode
    public static final int SATELLITE_PROVISION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_PROVISION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_PROVISION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_PROVISION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;
    ...
    // Values for SatelliteSosMessageRecommender.supported_connection_mode
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteSosMessageRecommender.session_connection_mode
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;

    // Values for SatelliteSosMessageRecommender.emergency_number_source_used_in_handover_intent
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__EMERGENCY_NUMBER_SOURCE_USED_IN_HANDOVER_INTENT__EMERGENCY_NUMBER_SOURCE_UNKNOWN = 0;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__EMERGENCY_NUMBER_SOURCE_USED_IN_HANDOVER_INTENT__EMERGENCY_NUMBER_SOURCE_USER_DIALED = 1;
    public static final int SATELLITE_SOS_MESSAGE_RECOMMENDER__EMERGENCY_NUMBER_SOURCE_USED_IN_HANDOVER_INTENT__EMERGENCY_NUMBER_SOURCE_CARRIER_REDIRECTION = 2;
    ...
    // Values for CarrierRoamingSatelliteSession.supported_connection_mode
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for CarrierRoamingSatelliteSession.session_connection_mode
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;

    // Values for CarrierRoamingSatelliteSession.eligibility_source
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_ENTITLEMENT = 1;
    public static final int CARRIER_ROAMING_SATELLITE_SESSION__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_CARRIER_CONFIG = 2;
    ...
    // Values for CarrierRoamingSatelliteControllerStats.supported_connection_mode
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for CarrierRoamingSatelliteControllerStats.service_data_policy
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SERVICE_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SERVICE_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_RESTRICTED = 1;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SERVICE_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_CONSTRAINED = 2;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__SERVICE_DATA_POLICY__SATELLITE_ENTITLEMENT_SERVICE_POLICY_SUPPORT_ALL = 3;

    // Values for CarrierRoamingSatelliteControllerStats.eligibility_source
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_UNKNOWN = 0;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_ENTITLEMENT = 1;
    public static final int CARRIER_ROAMING_SATELLITE_CONTROLLER_STATS__ELIGIBILITY_SOURCE__SATELLITE_ELIGIBILITY_SOURCE_CARRIER_CONFIG = 2;
    ...
    // Values for SatelliteEntitlement.supported_connection_mode
    public static final int SATELLITE_ENTITLEMENT__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_ENTITLEMENT__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_ENTITLEMENT__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_ENTITLEMENT__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteEntitlement.trigger_event
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_UNKNOWN = 0;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_BOOTUP = 1;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_REFRESH_TIMER = 2;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_INTERNET_CONNECTED = 3;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_CARRIER_CONFIG_CHANGED = 4;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_FCM_TICKLE = 5;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_SIM_REFRESH = 6;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_AIRPLANE_MODE_TOGGLE = 7;
    public static final int SATELLITE_ENTITLEMENT__TRIGGER_EVENT__SATELLITE_ENTITLEMENT_QUERY_TRIGGER_RETRY = 8;
    ...
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_INVALID_SATELLITE_ACCESS_CONFIG_FILE = 12;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_MAX_ALLOWED_DATA_MODE = 13;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_TYPE_PER_PLMN = 14;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_TYPE = 15;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_DATA_SUPPORT_MODE = 16;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_ENTITLEMENT_URL = 17;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_HANDOVER_TYPE = 18;
    public static final int SATELLITE_CONFIG_UPDATER__OEM_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_HYSTERESIS = 19;
    ...
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_INVALID_SATELLITE_ACCESS_CONFIG_FILE = 12;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_MAX_ALLOWED_DATA_MODE = 13;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_TYPE_PER_PLMN = 14;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_TYPE = 15;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_DATA_SUPPORT_MODE = 16;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_ENTITLEMENT_URL = 17;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_HANDOVER_TYPE = 18;
    public static final int SATELLITE_CONFIG_UPDATER__CARRIER_CONFIG_RESULT__CONFIG_UPDATE_RESULT_CARRIER_DATA_INVALID_CONNECT_HYSTERESIS = 19;
    ...
    // Values for SatelliteAccessController.supported_connection_mode
    public static final int SATELLITE_ACCESS_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_ACCESS_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_ACCESS_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_MANUAL = 2;
    public static final int SATELLITE_ACCESS_CONTROLLER__SUPPORTED_CONNECTION_MODE__SATELLITE_GLOBAL_CONNECT_TYPE_HYBRID = 3;

    // Values for SatelliteAccessController.session_connection_mode
    public static final int SATELLITE_ACCESS_CONTROLLER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_UNKNOWN = 0;
    public static final int SATELLITE_ACCESS_CONTROLLER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_AUTOMATIC = 1;
    public static final int SATELLITE_ACCESS_CONTROLLER__SESSION_CONNECTION_MODE__SATELLITE_SESSION_CONNECT_TYPE_MANUAL = 2;

    // Values for MessagingReadRestrictionInfo.content_provider
    public static final int MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_SMS_PROVIDER = 1;
    public static final int MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_MMS_PROVIDER = 2;

    // Values for MessagingReadRestrictionInfo.read_restricted_messages_app_op_mode
    public static final int MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_ALLOWED = 1;
    public static final int MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_IGNORED = 2;

    // Values for MessagingReadRestrictionInfo.event_type
    public static final int MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__MESSAGING_READ_RESTRICTION_EVENT_TYPE_UNKNOWN = 0;
    public static final int MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__RESTRICTED_MESSAGE_INSERTED = 1;
    public static final int MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UNRESTRICTED_MESSAGE_INSERTED = 2;
    public static final int MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UPDATED_MESSAGE_TO_UNRESTRICTED = 3;
    public static final int MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__QUERY_RESTRICTED_MESSAGES = 4;
    ...
    public static void write(int code, int arg1, int arg2) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (STORED_MESSAGE_SEND_REQUESTED == code) {
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (MESSAGE_UPGRADE_RESOLVED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static void write(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, java.lang.String arg7) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static void write(int code, int arg1, int arg2, int[] arg3) {
        ...
        builder.writeInt(arg1);
        builder.writeInt(arg2);
        if (CARRIER_SERVICE_CONFIG_OVERRIDES_REPORTED == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
    ...
    public static StatsEvent buildStatsEvent(int code, boolean arg1, boolean arg2, int arg3, boolean arg4, int arg5, int arg6, int arg7, long arg8) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeBoolean(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, boolean arg1, int arg2, boolean arg3, int arg4, int arg5, boolean arg6, int arg7, boolean arg8, boolean arg9, int arg10, boolean arg11, int arg12, int arg13, java.lang.String arg14, boolean arg15, int arg16, int arg17) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeBoolean(arg1);
        builder.writeInt(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, boolean arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9, int arg10, int arg11, int arg12, int arg13, int arg14, int arg15, int arg16, int[] arg17, int arg18, long arg19, boolean arg20, boolean arg21, int arg22, int[] arg23, int arg24, int arg25, int arg26, int arg27, int arg28, int arg29, int arg30, int arg31, java.lang.String[] arg32, int[] arg33, long[] arg34, int arg35, int arg36, java.lang.String arg37, boolean arg38, boolean arg39, boolean arg40, int arg41, int arg42, boolean arg43, int arg44, long arg45, int arg46, boolean arg47, int arg48, int arg49, int arg50, long arg51, long arg52, long[] arg53, long[] arg54) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeBoolean(arg2);
        ...
        builder.writeLong(arg51);
        builder.writeLong(arg52);
        builder.writeLongArray(null == arg53 ? new long[0] : arg53);
        builder.writeLongArray(null == arg54 ? new long[0] : arg54);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, boolean arg3, boolean arg4, int arg5, boolean arg6, int arg7) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, boolean arg4, int arg5, boolean arg6, int[] arg7, int arg8, int arg9, int arg10, int arg11) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6, boolean arg7, int arg8, int arg9, boolean arg10, boolean arg11, int arg12, boolean arg13, boolean arg14, boolean arg15, boolean arg16, boolean arg17, boolean arg18, java.lang.String arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        builder.setAtomId(code);
        builder.writeInt(arg1);
        if (MESSAGING_READ_RESTRICTION_INFO == code) {
        builder.addBooleanAnnotation(ANNOTATION_ID_IS_UID, true);
        }
        builder.writeInt(arg2);
        builder.writeInt(arg3);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7, int arg8, boolean arg9, int arg10, boolean arg11, boolean arg12, int arg13, long arg14, int arg15, boolean arg16, boolean arg17, boolean arg18, boolean arg19, int arg20, java.lang.String arg21) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, boolean arg9, boolean arg10, int arg11, boolean arg12, int arg13, int arg14, int arg15, int arg16, int arg17, boolean arg18, int arg19) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, int arg4, long arg5, long arg6, int arg7, int arg8, int arg9, int arg10, int arg11, boolean arg12, int arg13, int arg14, int arg15, int arg16, int arg17, boolean arg18, boolean arg19, int arg20, int arg21, int arg22, java.lang.String arg23, int arg24, int arg25, boolean arg26, int arg27, long arg28) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, int arg3, long arg4, boolean arg5, int arg6, boolean arg7, int arg8, int arg9, java.lang.String arg10) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    public static StatsEvent buildStatsEvent(int code, int arg1, int arg2, long arg3, boolean arg4, int arg5, boolean arg6, int arg7, int arg8, java.lang.String arg9) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeInt(arg2);
    ...
    @android.annotation.SuppressLint("ObsoleteSdkInt")
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    public static StatsEvent buildStatsEvent(int code, int arg1, long arg2, long arg3, long arg4, boolean arg5, boolean arg6, int arg7, java.lang.String[] arg8, int arg9, int arg10, int arg11, boolean arg12, int arg13, int arg14) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
        builder.writeInt(arg1);
        builder.writeLong(arg2);
