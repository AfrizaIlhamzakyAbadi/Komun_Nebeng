...
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO;
...
public class MetricsCollector implements StatsManager.StatsPullAtomCallback {
    ...
    public MetricsCollector(Context context, PersistAtomsStorage storage,
        ...
        if (mStatsManager != null) {
            ...
            registerAtom(MESSAGING_READ_RESTRICTION_INFO);
    ...
    public int onPullAtom(int atomTag, List<StatsEvent> data) {
        switch (atomTag) {
            ...
            case MESSAGING_READ_RESTRICTION_INFO:
                return pullMessagingReadRestrictionInfo(data);
            default:
    ...
    private int pullMessagingReadRestrictionInfo(List<StatsEvent> data) {
        ...
        if (messagingReadRestrictionEvents != null) {
            ...
            Rlog.w(TAG, "MESSAGING_READ_RESTRICTION_INFO pull too frequent, skipping");
            return StatsManager.PULL_SKIP;
        }
        return StatsManager.PULL_SUCCESS;
    }
    ...
    private static StatsEvent buildStatsEvent(MessagingReadRestrictionEvent event) {
        return TelephonyStatsLog.buildStatsEvent(
                MESSAGING_READ_RESTRICTION_INFO,
                event.callerUid,
