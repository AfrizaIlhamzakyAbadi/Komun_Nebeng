...
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_ALLOWED;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_IGNORED;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_SMS_PROVIDER;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_MMS_PROVIDER;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__RESTRICTED_MESSAGE_INSERTED;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UNRESTRICTED_MESSAGE_INSERTED;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UPDATED_MESSAGE_TO_UNRESTRICTED;
import static com.android.internal.telephony.TelephonyStatsLog.MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__QUERY_RESTRICTED_MESSAGES;
...
public class ReadRestrictionStatsLogger {
    ...
    public void onMessageInserted(ContentProvider contentProvider, int callerUid,
        ...
        if (isMessageReadRestricted) {
            event.eventType =
                    MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__RESTRICTED_MESSAGE_INSERTED;
        } else {
            event.eventType =
                    MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UNRESTRICTED_MESSAGE_INSERTED;
        }
    ...
    public void onMessageUnrestricted(ContentProvider contentProvider, int callerUid) {
        ...
        event.contentProvider = getContentProviderId(contentProvider);
        event.eventType =
                MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__UPDATED_MESSAGE_TO_UNRESTRICTED;
        atomsStorage.addMessagingReadRestrictionEvent(event);
    }
    ...
    public void onRestrictedMessagesQueried(ContentProvider contentProvider,
        ...
        event.contentProvider = getContentProviderId(contentProvider);
        event.eventType
            = MESSAGING_READ_RESTRICTION_INFO__EVENT_TYPE__QUERY_RESTRICTED_MESSAGES;
        event.readRestrictedMessagesAppOpMode = canReadRestrictedMessages
                ? MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_ALLOWED
                : MESSAGING_READ_RESTRICTION_INFO__READ_RESTRICTED_MESSAGES_APP_OP_MODE__APP_OP_MODE_IGNORED;
        atomsStorage.addMessagingReadRestrictionEvent(event);
    }
    ...
    private int getContentProviderId(ContentProvider contentProvider) {
        return switch (contentProvider) {
            case SMS ->
               MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_SMS_PROVIDER;
            case MMS ->
               MESSAGING_READ_RESTRICTION_INFO__CONTENT_PROVIDER__CONTENT_PROVIDER_MMS_PROVIDER;
        };
    }
