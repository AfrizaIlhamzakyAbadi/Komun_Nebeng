...
public class PhoneSwitcher extends Handler {
    ...
    public PhoneSwitcher(int maxActivePhones, Context context, Looper looper,
        ...
        mContext = context;
        mFlags = featureFlags;
        // TODO(b/510863698): Update the default initialization after flag cleanup.
        if (mFlags.getPreferredDataSubIsOpportunisticSetDataSub()) {
            mOpportunisticSetDataSubId = SubscriptionManager.DEFAULT_SUBSCRIPTION_ID;
        }
    ...
    private void validate(int subId, boolean needValidation, int switchReason,
        ...
        mPendingSwitchSubId = INVALID_SUBSCRIPTION_ID;
        if (switchReason == DataSwitch.Reason.DATA_SWITCH_REASON_CBRS) {
     ...
     */
    public int getOpportunisticSetDataSubId() { return mOpportunisticSetDataSubId; }
