...
public interface PhoneInternalInterface {
     ...
     */
    void holdActiveCall() throws CallStateException;

    /**
     * Unhold the currently held call, possibly holding a currently active call.
     */
     ...
     */
    void hold(Connection c) throws CallStateException;
     ...
     */
    void unhold(Connection c) throws CallStateException;
