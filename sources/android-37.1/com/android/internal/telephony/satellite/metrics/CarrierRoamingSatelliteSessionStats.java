...
public class CarrierRoamingSatelliteSessionStats {
        ...
        if (networkStatsManager != null) {
            ...
            if (!TextUtils.isEmpty(subscriberId)) {
                try {
                    ...
                    loge("Failed to force update network stats: " + e);
                }
    ...
    private void reportMetrics(int subId) {
        ...
        if (mSatelliteAppsPackageNameArray == null) {
            mSatelliteAppsPackageNameArray = new String[0];
        }
        if (mSatelliteAppsUidArray == null) {
            mSatelliteAppsUidArray = new int[0];
        }
        if (mPerAppSatelliteDataConsumedBytesArray == null) {
            mPerAppSatelliteDataConsumedBytesArray = new long[0];
        }
        if (mPerAppRxDataConsumedBytesArray == null) {
            mPerAppRxDataConsumedBytesArray = new long[0];
        }
        if (mPerAppTxDataConsumedBytesArray == null) {
            mPerAppTxDataConsumedBytesArray = new long[0];
        }
