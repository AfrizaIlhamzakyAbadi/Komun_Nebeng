...
public class SatelliteSessionController extends StateMachine {
    ...
    private volatile Boolean mIsConcurrentTnScanningSupportedForCtsTest = null;
    private volatile Boolean mIsTnScanningDuringSatelliteSessionAllowedForCtsTest = null;
    ...
    private boolean isConcurrentTnScanningSupported() {
        // Read to a local variable to prevent NullPointerException due to
        // concurrent resets from CTS tearDown threads.
        Boolean isSupported = mIsConcurrentTnScanningSupportedForCtsTest;
        if (isSupported != null) {
    ...
    private boolean isTnScanningAllowedDuringSatelliteSession() {
        // Read to a local variable to prevent NullPointerException due to
        // concurrent resets from CTS tearDown threads.
        Boolean isAllowed = mIsTnScanningDuringSatelliteSessionAllowedForCtsTest;
        if (isAllowed != null) {
