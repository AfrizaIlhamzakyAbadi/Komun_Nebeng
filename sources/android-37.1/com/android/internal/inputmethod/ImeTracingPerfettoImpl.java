...
import com.android.internal.tracing.winscope.protos.FrameworksBaseWinscope.FrameworksBaseWinscopeExtensions;
import com.android.internal.tracing.winscope.protos.FrameworksNativeWinscope.FrameworksNativeWinscopeTracePacket;
import com.android.internal.tracing.winscope.protos.Inputmethodeditor.InputMethodClientsTraceProto;
import com.android.internal.tracing.winscope.protos.Inputmethodeditor.InputMethodManagerServiceTraceProto;
        ...
        try {
            ...
            mDataSource.trace((ctx) -> {
                ...
                final long tokenWinscopeExtensions =
                        os.start(FrameworksNativeWinscopeTracePacket.WINSCOPE_EXTENSIONS);
                final long tokenExtensionsField =
                        os.start(FrameworksBaseWinscopeExtensions.INPUTMETHOD_CLIENTS);
        ...
        try {
            ...
            mDataSource.trace((ctx) -> {
                ...
                final long tokenWinscopeExtensions =
                        os.start(FrameworksNativeWinscopeTracePacket.WINSCOPE_EXTENSIONS);
                final long tokenExtensionsField =
                        os.start(FrameworksBaseWinscopeExtensions.INPUTMETHOD_SERVICE);
        ...
        try {
            ...
            mDataSource.trace((ctx) -> {
                ...
                final long tokenWinscopeExtensions =
                        os.start(FrameworksNativeWinscopeTracePacket.WINSCOPE_EXTENSIONS);
                final long tokenExtensionsField =
                        os.start(FrameworksBaseWinscopeExtensions.INPUTMETHOD_MANAGER_SERVICE);
