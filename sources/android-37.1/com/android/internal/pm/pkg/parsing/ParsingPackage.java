...
public interface ParsingPackage {
    ...
    @NonNull
    ArrayMap<String, SparseArray<ArraySet<ParsedMainComponent>>> getProcessToComponentMapping();
    ...
    /**
     * Adds a memory budget for the application.
     */
    ParsingPackage addMemoryBudget(@NonNull MemoryBudget memoryBudget);

    /**
     * Returns the memory budgets for the application.
     */
    @NonNull
    List<MemoryBudget> getMemoryBudgets();

    /**
     * Returns whether this application has processes with their own memory budget.
     * @hide
     */
    boolean hasProcessMemoryBudget();
}
