...
public class ParsedProcessImpl implements ParsedProcess, Parcelable {
    ...
    @NonNull
    private List<MemoryBudget> memoryBudgets = new ArrayList<>();
    ...
    public ParsedProcessImpl(@NonNull ParsedProcess other) {
        ...
        memoryBudgets = new ArrayList<>(other.getMemoryBudgets());
        singleUser = other.isSingleUser();
    }
    ...
    public void addStateFrom(@NonNull ParsedProcess other) {
        ...
        memoryBudgets.addAll(other.getMemoryBudgets());
    }
    ...
    /**
     * Adds a process-specific memory budget.
     */
    public void addMemoryBudget(@NonNull MemoryBudget memoryBudget) {
        MemoryBudget.addBudget(memoryBudgets, memoryBudget);
    }
    ...
    public ParsedProcessImpl(
            ...
            @NonNull List<MemoryBudget> memoryBudgets,
            boolean singleUser) {
        this.name = name;
        ...
        this.memoryBudgets = memoryBudgets;
        com.android.internal.util.AnnotationValidations.validate(
                NonNull.class, null, memoryBudgets);
    ...
    @DataClass.Generated.Member
    public @NonNull List<MemoryBudget> getMemoryBudgets() {
    ...
    @DataClass.Generated.Member
    public @NonNull ParsedProcessImpl setMemoryBudgets(@NonNull List<MemoryBudget> value) {
        memoryBudgets = value;
        com.android.internal.util.AnnotationValidations.validate(
                NonNull.class, null, memoryBudgets);
        return this;
    ...
    @DataClass.Generated.Member
    public @NonNull ParsedProcessImpl setSingleUser( boolean value) {
        singleUser = value;
        return this;
    }
    ...
    public void writeToParcel(@NonNull Parcel dest, int flags) {
        ...
        dest.writeParcelableList(memoryBudgets, flags);
    }
    ...
    protected ParsedProcessImpl(@NonNull Parcel in) {
        ...
        boolean _singleUser = (flg & 0x100) != 0;
        String _name = in.readString();
        ArrayMap<String,String> _appClassNamesByPackage = new ArrayMap();
        in.readMap(_appClassNamesByPackage, String.class.getClassLoader(), String.class, String.class);
        ...
        List<MemoryBudget> _memoryBudgets = new ArrayList<>();
        in.readParcelableList(_memoryBudgets, MemoryBudget.class.getClassLoader(), MemoryBudget.class);
        ...
        this.memoryBudgets = _memoryBudgets;
        com.android.internal.util.AnnotationValidations.validate(
                NonNull.class, null, memoryBudgets);
        this.singleUser = _singleUser;
