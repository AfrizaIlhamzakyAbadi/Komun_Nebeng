...
public final class DumpUtils {
    ...
    static {
        ...
        // LINT.ThenChange(:perfetto_track_names)
    ...
    // Keep this in sync with STATE_NAMES[]
    // LINT.IfChange(perfetto_track_names)
    private static final String TRACK_PERSISTENT = "proc_state: Persist";
    private static final String TRACK_TOP = "proc_state: Top";
    private static final String TRACK_BOUND_TOP = "proc_state: BTop";
    private static final String TRACK_FGS = "proc_state: Fgs";
    private static final String TRACK_BOUND_FGS = "proc_state: BFgs";
    private static final String TRACK_IMPORTANT_FOREGROUND = "proc_state: ImpFg";
    private static final String TRACK_IMPORTANT_BACKGROUND = "proc_state: ImpBg";
    private static final String TRACK_BACKUP = "proc_state: Backup";
    private static final String TRACK_SERVICE = "proc_state: Service";
    private static final String TRACK_SERVICE_RESTARTING = "proc_state: ServRst";
    private static final String TRACK_RECEIVER = "proc_state: Receivr";
    private static final String TRACK_HEAVY_WEIGHT = "proc_state: HeavyWt";
    private static final String TRACK_HOME = "proc_state: Home";
    private static final String TRACK_LAST_ACTIVITY = "proc_state: LastAct";
    private static final String TRACK_CACHED = "proc_state: Cached";
    private static final String TRACK_FROZEN = "proc_state: Frozen";
    private static final String TRACK_UNKNOWN = "proc_state: Unknown";

    /**
     * Applies the Perfetto track name for a given process state to the provided builder.
     * This uses compile-time constant strings to satisfy Error Prone requirements.
     */
    public static PerfettoTrackEventBuilder setTrackForProcessState(
            PerfettoTrackEventBuilder builder, int state) {
        switch (state) {
            case STATE_PERSISTENT -> builder.usingProcessCounterTrack(TRACK_PERSISTENT);
            case STATE_TOP -> builder.usingProcessCounterTrack(TRACK_TOP);
            case STATE_BOUND_TOP -> builder.usingProcessCounterTrack(TRACK_BOUND_TOP);
            case STATE_FGS -> builder.usingProcessCounterTrack(TRACK_FGS);
            case STATE_BOUND_FGS -> builder.usingProcessCounterTrack(TRACK_BOUND_FGS);
            case STATE_IMPORTANT_FOREGROUND ->
                builder.usingProcessCounterTrack(TRACK_IMPORTANT_FOREGROUND);
            case STATE_IMPORTANT_BACKGROUND ->
                builder.usingProcessCounterTrack(TRACK_IMPORTANT_BACKGROUND);
            case STATE_BACKUP -> builder.usingProcessCounterTrack(TRACK_BACKUP);
            case STATE_SERVICE -> builder.usingProcessCounterTrack(TRACK_SERVICE);
            case STATE_SERVICE_RESTARTING ->
                builder.usingProcessCounterTrack(TRACK_SERVICE_RESTARTING);
            case STATE_RECEIVER -> builder.usingProcessCounterTrack(TRACK_RECEIVER);
            case STATE_HEAVY_WEIGHT -> builder.usingProcessCounterTrack(TRACK_HEAVY_WEIGHT);
            case STATE_HOME -> builder.usingProcessCounterTrack(TRACK_HOME);
            case STATE_LAST_ACTIVITY -> builder.usingProcessCounterTrack(TRACK_LAST_ACTIVITY);
            case STATE_CACHED -> builder.usingProcessCounterTrack(TRACK_CACHED);
            case STATE_FROZEN -> builder.usingProcessCounterTrack(TRACK_FROZEN);
            default -> builder.usingProcessCounterTrack(TRACK_UNKNOWN);
        }
        return builder;
    }
    // LINT.ThenChange()
