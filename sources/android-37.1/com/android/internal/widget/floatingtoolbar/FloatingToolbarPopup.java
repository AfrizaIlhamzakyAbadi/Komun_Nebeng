...
public interface FloatingToolbarPopup {
    ...
    static FloatingToolbarPopup createInstance(Context context, View parent) {
        if (SelectionToolbarManager.isRemoteSelectionToolbarSessionEnabled()) {
            return new RemoteFloatingToolbarPopup2(context, parent);
        } else if (SelectionToolbarManager.isRemoteSelectionToolbarEnabled(context)) {
