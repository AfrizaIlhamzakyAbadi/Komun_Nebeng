...
public class LockPatternUtils {
    ...
    public LockPatternUtils(Context context, @Nullable Looper looper) {
        this(context, /* lockSettings= */ null, LockPatternUtils::systemTimeSinceBoot, looper);
    }
    ...
    /**
     * Primary constructor for internal and test usage.
     */
    @VisibleForTesting
    public LockPatternUtils(
            Context context,
            ILockSettings lockSettings,
            Supplier<Duration> timeSinceBootSupplier,
            @Nullable Looper looper) {
        mContext = context;
        mContentResolver = context.getContentResolver();
        final Looper resolvedLooper = (looper != null) ? looper : Looper.myLooper();
        mHandler = (resolvedLooper != null) ? new Handler(resolvedLooper) : null;
