...
public class NotificationExpandButton extends FrameLayout {
    ...
    private void updateExpandedState() {
        ...
        if (mExpanded) {
            drawableId = R.drawable.ic_notification_collapse;
            contentDescriptionId = R.string.expand_button_content_description_expanded;
        } else {
            drawableId = R.drawable.ic_notification_expand;
    ...
    private void updatePadding() {
        ...
        int reducedPadding = getResources().getDimensionPixelSize(
                R.dimen.notification_expand_button_reduced_end_padding);
        int normalPadding = getResources().getDimensionPixelSize(
                R.dimen.notification_expand_button_horizontal_icon_padding);
