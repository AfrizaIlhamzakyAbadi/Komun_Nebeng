...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    @DrawableRes private int mDefaultNavigationIconResId;
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style,
        ...
        mDefaultNavigationIconResId = a.getResourceId(R.styleable.ActionBar_homeAsUpIndicator, 0);
        if (style) {
            ...
            mLogoResId = a.getResourceId(R.styleable.ActionBar_logo, 0);
            mIconResId = a.getResourceId(R.styleable.ActionBar_icon, 0);
            if (mLogoResId != 0 || mIconResId != 0) {
                updateToolbarLogo();
            }
    ...
    public boolean hasIcon() {
        return mIcon != null || mIconResId != 0;
    }

    @Override
    public boolean hasLogo() {
        return mLogo != null || mLogoResId != 0;
    }
    ...
    private Drawable getLogo() {
        if (mLogo == null && mLogoResId != 0) {
            mLogo = getContext().getDrawable(mLogoResId);
        }
        return mLogo;
    }
    ...
    private void updateToolbarLogo() {
        ...
        if ((mDisplayOpts & ActionBar.DISPLAY_SHOW_HOME) != 0) {
            if ((mDisplayOpts & ActionBar.DISPLAY_USE_LOGO) != 0) {
                final Drawable l = getLogo();
                logo = l != null ? l : getIcon();
            } else {
                logo = getIcon();
            }
        }
    ...
    public void setDefaultNavigationIcon(Drawable defaultNavigationIcon) {
        if (mDefaultNavigationIcon != defaultNavigationIcon || mDefaultNavigationIconResId != 0) {
            mDefaultNavigationIcon = defaultNavigationIcon;
            mDefaultNavigationIconResId = 0;
            updateNavigationIcon();
        }
    }

    @Nullable
    private Drawable getDefaultNavigationIcon() {
        if (mDefaultNavigationIcon == null && mDefaultNavigationIconResId != 0) {
            mDefaultNavigationIcon = mToolbar.getContext().getDrawable(mDefaultNavigationIconResId);
        }
        return mDefaultNavigationIcon;
    }

    private void updateNavigationIcon() {
        if ((mDisplayOpts & ActionBar.DISPLAY_HOME_AS_UP) != 0) {
            mToolbar.setNavigationIcon(mNavIcon != null ? mNavIcon : getDefaultNavigationIcon());
        } else {
