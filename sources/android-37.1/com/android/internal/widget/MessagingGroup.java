...
public class MessagingGroup extends NotificationOptimizedLinearLayout implements
    ...
    protected void onFinishInflate() {
        ...
        if (mShowingAvatar) {
            setMinimumHeight(res.getDimensionPixelSize(
    ...
    public void setShowingAvatar(boolean showingAvatar) {
        ...
        setMinimumHeight(showingAvatar ? mContext.getResources().getDimensionPixelSize(
                R.dimen.notification_icon_circle_size) : 0);
    }
    ...
    private static int getMessagingGroupLayoutResource() {
        return R.layout.notification_messaging_group;
    }
    ...
    public int getMeasuredType() {
        if (mShowingAvatar && getMeasuredHeight() < getMinimumHeight()) {
