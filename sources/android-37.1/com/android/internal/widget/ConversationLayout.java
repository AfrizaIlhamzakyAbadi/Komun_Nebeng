...
public class ConversationLayout extends NotificationFrameLayout
    ...
    protected void onFinishInflate() {
        ...
        if (leftIcon != null) {
            leftIcon.setBackgroundResource(
                    R.drawable.notification_conversation_icon_background);
        }
        ...
        mSummarizationStartMargin = getResources().getDimensionPixelSize(
                R.dimen.notification_content_margin_start_summarization);
    }
    ...
    public void setIsImportantConversation(boolean isImportantConversation, boolean animate) {
        ...
        if (animate && isImportantConversation) {
            ...
            int bgSize = getResources()
                    .getDimensionPixelSize(R.dimen.notification_conversation_icon_badge_size);
