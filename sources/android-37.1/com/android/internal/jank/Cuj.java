...
public class Cuj {
    ...
    /**
     * Tracks the Desktop Mode home screen peek animation.
     */
    public static final int CUJ_DESKTOP_MODE_HOME_SCREEN_PEEK = 167;

    /**
     * Tracks the Desktop Mode home screen unpeek animation.
     */
    public static final int CUJ_DESKTOP_MODE_HOME_SCREEN_UNPEEK = 168;

    /**
     * Tracks the Wear Origin Transition Open animation.
     *
     * <p>This includes transitions such as opening a complication (on a Koru Watchface) or tapping
     * on a tile component from wear 6.1+
     */
    public static final int CUJ_WEAR_ORIGIN_TRANSITION_OPEN = 169;

    /**
     * Tracks the Jank in transitions handled by WearAppLaunchMixinTransition.
     *
     * <p>This includes opening the launcher or recents in sysui.
     */
    public static final int CUJ_WEAR_APP_LAUNCH_TRANSITION = 170;

    /** Track drag window release animation in desktop mode. */
    public static final int CUJ_DESKTOP_MODE_DRAG_WINDOW_RELEASE = 171;

    /**
     * Tracks jank in desk-to-fullscreen slide-in transitions.
     *
     * <p> A desk is the space where Desktop tasks are shown. This CUJ is triggered when moving from
     * a desk to a Fullscreen task. This happens for example when launching or refocusing a
     * Fullscreen task while in a desk (a container for Desktop tasks).
     */
    public static final int CUJ_DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE = 172;

    /** Tracks the Dream Switcher edge swipe animation. */
    public static final int CUJ_DREAM_SWITCHER_EDGE_SWIPE = 173;

    /** Track cross-display window drag interaction in desktop mode. */
    public static final int CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW = 174;

    /** Track cross-display drag window release animation in desktop mode. */
    public static final int CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE = 175;

    /** Tracks the jank when opening the Internet details tile. */
    public static final int CUJ_SHADE_INTERNET_DETAILS_OPEN = 176;

    /** Tracks the jank when opening the Bluetooth details tile. */
    public static final int CUJ_SHADE_BLUETOOTH_DETAILS_OPEN = 177;

    /** Tracks the jank when opening a general details tile in QS. */
    public static final int CUJ_SHADE_TILE_DETAILS_OPEN = 178;

    /**
     * Tracks the device entry authentication ripple animation.
     *
     * <p> Tracking starts when the auth ripple is triggered for device entry
     * from face auth, fingerprint auth, or the device entry icon and
     * finishes when the animation ends.
     */
    public static final int CUJ_UNLOCK_AUTH_RIPPLE = 179;

    /**
     * Tracks the jank in fullscreen-to-desk slide-in transitions.
     *
     * <p> A desk is the space where Desktop tasks are shown. This CUJ is triggered when moving from
     * a Fullscreen task to a desk. This happens for example when launching or refocusing a Desktop
     * task while in a Fullscreen task.
     */
    public static final int CUJ_DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE = 180;

    // When adding a CUJ, update this and make sure to also update CUJ_TO_STATSD_INTERACTION_TYPE.
    @VisibleForTesting static final int LAST_CUJ = CUJ_DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE;
    ...
    @IntDef({
            ...
            CUJ_DESKTOP_MODE_HOME_SCREEN_PEEK,
            CUJ_DESKTOP_MODE_HOME_SCREEN_UNPEEK,
            CUJ_WEAR_ORIGIN_TRANSITION_OPEN,
            CUJ_WEAR_APP_LAUNCH_TRANSITION,
            CUJ_DESKTOP_MODE_DRAG_WINDOW_RELEASE,
            CUJ_DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE,
            CUJ_DREAM_SWITCHER_EDGE_SWIPE,
            CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW,
            CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE,
            CUJ_SHADE_INTERNET_DETAILS_OPEN,
            CUJ_SHADE_BLUETOOTH_DETAILS_OPEN,
            CUJ_SHADE_TILE_DETAILS_OPEN,
            CUJ_UNLOCK_AUTH_RIPPLE,
            CUJ_DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE
    })
    ...
    static {
        ...
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_HOME_SCREEN_PEEK] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_HOME_SCREEN_PEEK;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_HOME_SCREEN_UNPEEK] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_HOME_SCREEN_UNPEEK;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_WEAR_ORIGIN_TRANSITION_OPEN] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_ORIGIN_TRANSITION_OPEN;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_WEAR_APP_LAUNCH_TRANSITION] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__WEAR_APP_LAUNCH_TRANSITION;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_DRAG_WINDOW_RELEASE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DRAG_WINDOW_RELEASE;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DREAM_SWITCHER_EDGE_SWIPE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DREAM_SWITCHER_EDGE_SWIPE;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_SHADE_INTERNET_DETAILS_OPEN] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_INTERNET_DETAILS_OPEN;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_SHADE_BLUETOOTH_DETAILS_OPEN] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_BLUETOOTH_DETAILS_OPEN;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_SHADE_TILE_DETAILS_OPEN] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__SHADE_TILE_DETAILS_OPEN;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_UNLOCK_AUTH_RIPPLE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__UNLOCK_AUTH_RIPPLE;
        CUJ_TO_STATSD_INTERACTION_TYPE[CUJ_DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE] = FrameworkStatsLog.UIINTERACTION_FRAME_INFO_REPORTED__INTERACTION_TYPE__DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE;
    }
    ...
    public static String getNameOfCuj(int cujType) {
        ...
        switch (cujType) {
           ...
           case CUJ_WEAR_ALERT_NOTIFICATION_DIALOG:
            ...
            case CUJ_DESKTOP_MODE_HOME_SCREEN_PEEK:
                return "DESKTOP_MODE_HOME_SCREEN_PEEK";
            case CUJ_DESKTOP_MODE_HOME_SCREEN_UNPEEK:
                return "DESKTOP_MODE_HOME_SCREEN_UNPEEK";
            case CUJ_WEAR_ORIGIN_TRANSITION_OPEN:
                return "WEAR_ORIGIN_TRANSITION_OPEN";
            case CUJ_WEAR_APP_LAUNCH_TRANSITION:
                return "WEAR_APP_LAUNCH_TRANSITION";
            case CUJ_DESKTOP_MODE_DRAG_WINDOW_RELEASE:
                return "DESKTOP_MODE_DRAG_WINDOW_RELEASE";
            case CUJ_DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE:
                return "DESKTOP_MODE_DESK_TO_FULLSCREEN_SLIDE";
            case CUJ_DREAM_SWITCHER_EDGE_SWIPE:
                return "DREAM_SWITCHER_EDGE_SWIPE";
            case CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW:
                return "DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW";
            case CUJ_DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE:
                return "DESKTOP_MODE_CROSS_DISPLAY_DRAG_WINDOW_RELEASE";
            case CUJ_SHADE_INTERNET_DETAILS_OPEN:
                return "SHADE_INTERNET_DETAILS_OPEN";
            case CUJ_SHADE_BLUETOOTH_DETAILS_OPEN:
                return "SHADE_BLUETOOTH_DETAILS_OPEN";
            case CUJ_SHADE_TILE_DETAILS_OPEN:
                return "SHADE_TILE_DETAILS_OPEN";
            case CUJ_UNLOCK_AUTH_RIPPLE:
                return "UNLOCK_AUTH_RIPPLE";
            case CUJ_DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE:
                return "DESKTOP_MODE_FULLSCREEN_TO_DESK_SLIDE";
        }
        return "UNKNOWN";
    }
