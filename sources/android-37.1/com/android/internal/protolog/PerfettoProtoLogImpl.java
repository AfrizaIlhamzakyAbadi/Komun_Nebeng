...
import static com.android.internal.tracing.winscope.protos.FrameworksNativeWinscope.FrameworksNativeWinscopeTracePacket.PROTOLOG_MESSAGE;
import static com.android.internal.tracing.winscope.protos.FrameworksNativeWinscope.FrameworksNativeWinscopeTracePacket.PROTOLOG_VIEWER_CONFIG;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.BOOLEAN_PARAMS;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.DOUBLE_PARAMS;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.MESSAGE_ID;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.SINT64_PARAMS;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.STACKTRACE_IID;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogMessage.STR_PARAM_IIDS;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.GROUPS;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.Group.ID;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.Group.NAME;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.Group.TAG;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.MESSAGES;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.MessageData.GROUP_ID;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.MessageData.LEVEL;
import static com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.MessageData.MESSAGE;
...
import com.android.internal.tracing.winscope.protos.Protolog.ProtoLogViewerConfig.MessageData;
...
public abstract class PerfettoProtoLogImpl extends IProtoLogClient.Stub implements IProtoLog,
        ...
        ProtoLogNative.NativeDataSourceListener {
    ...
    protected PerfettoProtoLogImpl(
        ...
        mSingleThreadedExecutor = executorService;
        mDataSource = dataSource;
        mCacheUpdater = cacheUpdater;
        mConfigurationService = null;
    ...
    public void enable(boolean async, @Nullable IProtoLogConfigurationService service) {
        ...
        if (android.tracing.Flags.javaNativeProtolog()) {
            ProtoLogNative.registerListener(this);
            ProtoLogNative.init();
        }
        ...
        if (!android.tracing.Flags.javaNativeProtolog()) {
            // Use native callbacks directly instead if this flag is enabled
    ...
    public void disable() {
        ...
        if (android.tracing.Flags.javaNativeProtolog()) {
            ProtoLogNative.unregisterListener(this);
        }
    ...
    @Override
    public void onTracingInstanceStart(String dsName, int instanceIdx, byte[] config) {
        if (!Objects.equals(dsName, mDataSource.name)) {
            Log.d(LOG_TAG, "Discarding start callback. Expected: "
                    + mDataSource.name + ", got: " + dsName);
            return;
        }

        try {
            final ProtoLogDataSource.ProtoLogConfig parsedConfig =
                    ProtoLogDataSource.ProtoLogConfig.parseFrom(config);
            onTracingInstanceStart(instanceIdx, parsedConfig);
        } catch (IOException e) {
            Log.wtf(LOG_TAG, "Failed to parse ProtoLogConfig from native", e);
        } catch (java.util.concurrent.RejectedExecutionException e) {
            Log.w(LOG_TAG,
                    "Failed to queue tracing instance start, executor might be shut down", e);
        }
    }
    ...
    public void onTracingInstanceStart(
        ...
        // NOTE: This method may be executed while holding native locks (g_callback_mutex).
        // Do NOT add blocking operations or acquire other locks that might invert lock order.
    ...
    @Override
    public void onTracingInstanceStop(String dsName, int instanceIdx, byte[] config) {
        if (!Objects.equals(dsName, mDataSource.name)) {
            Log.d(LOG_TAG,
                    "Discarding stop callback. Expected: " + mDataSource.name + ", got: " + dsName);
            return;
        }
        ...
        try {
            final ProtoLogDataSource.ProtoLogConfig parsedConfig =
                    ProtoLogDataSource.ProtoLogConfig.parseFrom(config);
            onTracingInstanceStop(instanceIdx, parsedConfig);
        } catch (IOException e) {
            Log.wtf(LOG_TAG, "Failed to parse ProtoLogConfig from native", e);
        } catch (java.util.concurrent.RejectedExecutionException e) {
            Log.w(LOG_TAG,
                    "Failed to queue tracing instance removal, executor might be shut down", e);
        }
    }

    @Override
    public void onTracingInstanceStop(
            int instanceIdx, @NonNull ProtoLogDataSource.ProtoLogConfig config) {
        // NOTE: This method may be executed while holding native locks (g_callback_mutex).
        // Do NOT add blocking operations or acquire other locks that might invert lock order.
