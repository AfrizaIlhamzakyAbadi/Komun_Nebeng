...
public final class ShortcutConstants {
    ...
    /**
     * A map of a11y feature to its SystemUI QS tile component.
     */
    ...
    public static final String TILE_SPEC_COLOR_INVERSION = "inversion";
    public static final String TILE_SPEC_COLOR_CORRECTION = "color_correction";
    public static final String TILE_SPEC_ONE_HANDED = "onehanded";
    public static final String TILE_SPEC_REDUCE_BRIGHTNESS = "reduce_brightness";
    public static final String TILE_SPEC_FONT_SCALING = "font_scaling";
    public static final String TILE_SPEC_HEARING_DEVICES = "hearing_devices";

    /**
     * A map of a11y feature to its SystemUI QS tile spec.
     */
    public static final Map<ComponentName, String> A11Y_FEATURE_TO_SYSTEMUI_TILE = Map.of(
            COLOR_INVERSION_COMPONENT_NAME, TILE_SPEC_COLOR_INVERSION,
            DALTONIZER_COMPONENT_NAME, TILE_SPEC_COLOR_CORRECTION,
            ONE_HANDED_COMPONENT_NAME, TILE_SPEC_ONE_HANDED,
            REDUCE_BRIGHT_COLORS_COMPONENT_NAME, TILE_SPEC_REDUCE_BRIGHTNESS,
            FONT_SIZE_COMPONENT_NAME, TILE_SPEC_FONT_SCALING,
            ACCESSIBILITY_HEARING_AIDS_COMPONENT_NAME, TILE_SPEC_HEARING_DEVICES
    );
}
