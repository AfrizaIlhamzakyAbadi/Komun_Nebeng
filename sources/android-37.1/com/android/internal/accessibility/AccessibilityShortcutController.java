...
public class AccessibilityShortcutController {
    ...
    public static final ComponentName BOUNCE_KEYS_COMPONENT_NAME =
            new ComponentName("com.android.server.accessibility", "BounceKeys");
    public static final ComponentName MOUSE_KEYS_COMPONENT_NAME =
            new ComponentName("com.android.server.accessibility", "MouseKeys");
    public static final ComponentName STICKY_KEYS_COMPONENT_NAME =
            new ComponentName("com.android.server.accessibility", "StickyKeys");
    public static final ComponentName SLOW_KEYS_COMPONENT_NAME =
            new ComponentName("com.android.server.accessibility", "SlowKeys");
    ...
    public static Map<ComponentName, FrameworkFeatureInfo>
        ...
        if (sFrameworkShortcutFeaturesMap == null) {
            ...
            if (enableKeyboardA11yConfirmationDialogs()) {
                final String bounceKeysThresholdMillis =
                        String.valueOf(InputSettings.DEFAULT_BOUNCE_KEYS_THRESHOLD_MILLIS);
                featuresMap.put(
                        BOUNCE_KEYS_COMPONENT_NAME,
                        new ToggleableFrameworkFeatureInfo(
                                Settings.Secure.ACCESSIBILITY_BOUNCE_KEYS,
                                bounceKeysThresholdMillis /* Value to enable */,
                                "0" /* Value to disable */,
                                R.string.bounce_keys_feature_name));
                featuresMap.put(STICKY_KEYS_COMPONENT_NAME,
                        new ToggleableFrameworkFeatureInfo(
                                Settings.Secure.ACCESSIBILITY_STICKY_KEYS,
                                 "1" /* Value to enable */, "0" /* Value to disable */,
                                R.string.sticky_keys_feature_name));
                final String slowKeysThresholdMillis =
                        String.valueOf(InputSettings.DEFAULT_SLOW_KEYS_THRESHOLD_MILLIS);
                featuresMap.put(
                        SLOW_KEYS_COMPONENT_NAME,
                        new ToggleableFrameworkFeatureInfo(
                                Settings.Secure.ACCESSIBILITY_SLOW_KEYS,
                                slowKeysThresholdMillis /* Value to enable */,
                                "0" /* Value to disable */,
                                R.string.slow_keys_feature_name));
            }
     ...
     */
    @VisibleForTesting
    public void playNotificationTone(int userId) {
        if (Flags.volumeShortcutSilentForMagnification()) {
            final List<String> shortcutTargets = mFrameworkObjectProvider
                    .getAccessibilityManagerInstance(mContext)
                    .getAccessibilityShortcutTargets(HARDWARE, userId);
            if (shortcutTargets.size() == 1
                    && MAGNIFICATION_CONTROLLER_NAME.equals(shortcutTargets.getFirst())) {
                return;
            }
        }
