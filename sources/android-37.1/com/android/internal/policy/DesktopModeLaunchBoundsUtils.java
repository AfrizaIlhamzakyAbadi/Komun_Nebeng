...
public final class DesktopModeLaunchBoundsUtils {
    /**
     * The scale factor applied to the display size to determine the initial bounds of a new
     * desktop mode window.
     */
    ...
    /**
     * The padding to be applied to landscape applications when launched in desktop mode.
     */
    ...
    public static void cascadeWindowStepped(@NonNull Rect frame, @NonNull Rect dest,
        ...
        if (direction != NONE) {
            ...
            dest.offsetTo(prevBoundsList.get(0).left, prevBoundsList.get(0).top);
