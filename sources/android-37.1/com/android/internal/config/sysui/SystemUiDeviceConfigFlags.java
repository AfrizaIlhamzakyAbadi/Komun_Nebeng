...
public final class SystemUiDeviceConfigFlags {
    ...
    // Flags related to ContextualCursor GestureDetection

    /**
     * (boolean) Whether to print the cursor positions to the system log when (and ONLY WHEN) a
     * trigger gesture is detected, so that they can be included in the user feedback.
     */
    public static final String
            CONTEXTUAL_CURSOR_GESTURE_LOGGING_FOR_FEEDBACK =
            "contextual_cursor_gesture_logging_for_feedback";

    /**
     * (boolean) Whether to use v3 over any earlier version of the detection, any flags that
     * activate a more recent version will override this flag (e.g. use_v4).
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_USE_V3 =
            "contextual_cursor_gesture_use_v3";

    /**
     * (long) The cooldown between the last trigger and the next detection cycle.
     * The value is a positive integer.
     * The unit is milliseconds.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_COOLDOWN_MS =
            "contextual_cursor_gesture_cooldown_ms";

    /**
     * (long) The threshold after which the first cursor movement window is ignored (i.e. how long
     * the cursor must be idle before the detection is paused).
     * The value is a positive integer.
     * The unit is milliseconds.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_IDLE_THRESHOLD_MS =
            "contextual_cursor_gesture_idle_threshold_ms";

    /**
     * (long) How long the detection is paused after a click-release action.
     * The value is a positive integer.
     * The unit is milliseconds.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_POST_CLICK_IGNORE_MS =
            "contextual_cursor_gesture_post_click_ignore_ms";

    // V2 gesture detection parameters

    /**
     * (int) The window size in milliseconds over which to detect the gesture.
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_WINDOW_SIZE_MS =
            "contextual_cursor_gesture_v2_level_0_window_size_ms";


    /**
     * (float) The maximum angle to be considered a sharp turn, measured in the cosine of the angle.
     * The range is [-1, 1].
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_MAX_TURN_COSINE =
            "contextual_cursor_gesture_v2_level_0_max_turn_cosine";

    /**
     * (int) The minimum number of sharp turns that must occur in a gesture.
     * The value is a non-negative integer.
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_MIN_TURN_COUNT =
            "contextual_cursor_gesture_v2_level_0_min_turn_count";

    /**
     * (int) The length of the cursor path over the window, normalized to the size of its bounding
     * box. The value is a positive integer. The unit is device independent pixels (DIP).
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_MIN_PATH_LENGTH_DIP =
            "contextual_cursor_gesture_v2_level_0_min_path_length_dip";

    /**
     * (float) The peak instantaneous velocity over the window.
     * The value is a positive floating point.
     * The unit is device independent pixels per milliseconds.
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_MIN_PEAK_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_0_min_peak_speed_dipms";

    /**
     * (float) The required instantaneous speed during a turn.
     * The value is a positive floating point.
     * The unit is device independent pixels per milliseconds.
     * This version is for the level_0 sensitivity setting.
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_0_MIN_TURN_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_0_min_turn_speed_dipms";

    // The following V2 flags have the same type and meaning as above but for different sensitivity
    // level settings.

    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_WINDOW_SIZE_MS =
            "contextual_cursor_gesture_v2_level_1_window_size_ms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_MAX_TURN_COSINE =
            "contextual_cursor_gesture_v2_level_1_max_turn_cosine";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_MIN_TURN_COUNT =
            "contextual_cursor_gesture_v2_level_1_min_turn_count";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_MIN_PATH_LENGTH_DIP =
            "contextual_cursor_gesture_v2_level_1_min_path_length_dip";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_MIN_PEAK_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_1_min_peak_speed_dipms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_1_MIN_TURN_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_1_min_turn_speed_dipms";

    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_WINDOW_SIZE_MS =
            "contextual_cursor_gesture_v2_level_2_window_size_ms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_MAX_TURN_COSINE =
            "contextual_cursor_gesture_v2_level_2_max_turn_cosine";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_MIN_TURN_COUNT =
            "contextual_cursor_gesture_v2_level_2_min_turn_count";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_MIN_PATH_LENGTH_DIP =
            "contextual_cursor_gesture_v2_level_2_min_path_length_dip";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_MIN_PEAK_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_2_min_peak_speed_dipms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_2_MIN_TURN_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_2_min_turn_speed_dipms";

    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_WINDOW_SIZE_MS =
            "contextual_cursor_gesture_v2_level_3_window_size_ms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_MAX_TURN_COSINE =
            "contextual_cursor_gesture_v2_level_3_max_turn_cosine";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_MIN_TURN_COUNT =
            "contextual_cursor_gesture_v2_level_3_min_turn_count";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_MIN_PATH_LENGTH_DIP =
            "contextual_cursor_gesture_v2_level_3_min_path_length_dip";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_MIN_PEAK_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_3_min_peak_speed_dipms";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V2_LEVEL_3_MIN_TURN_SPEED_DIPMS =
            "contextual_cursor_gesture_v2_level_3_min_turn_speed_dipms";

    // V3 gesture detection parameters

    /**
     * (float) The score threshold to trigger contextual cursor. This value represents the
     * detector's confidence level that a gesture occurred. The range is in [0, 1].
     */
    public static final String CONTEXTUAL_CURSOR_GESTURE_V3_LEVEL_0_TRIGGER_THRESHOLD =
            "contextual_cursor_gesture_v3_level_0_trigger_threshold";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V3_LEVEL_1_TRIGGER_THRESHOLD =
            "contextual_cursor_gesture_v3_level_1_trigger_threshold";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V3_LEVEL_2_TRIGGER_THRESHOLD =
            "contextual_cursor_gesture_v3_level_2_trigger_threshold";
    public static final String CONTEXTUAL_CURSOR_GESTURE_V3_LEVEL_3_TRIGGER_THRESHOLD =
            "contextual_cursor_gesture_v3_level_3_trigger_threshold";
