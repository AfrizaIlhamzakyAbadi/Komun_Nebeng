...
public class TransferPipe implements Runnable, Closeable {
    ...
    static final long DEFAULT_TIMEOUT = 5_000;  // 5 seconds
    ...
    protected TransferPipe(String bufferPrefix, String threadName) throws IOException {
        this(bufferPrefix, threadName, DEFAULT_BUFFER_SIZE, DEFAULT_TIMEOUT);
    }

    protected TransferPipe(String bufferPrefix, String threadName, int bufferSize, long timeout)
            throws IOException {
