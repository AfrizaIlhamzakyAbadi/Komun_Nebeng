...
public interface IDropBoxManagerService extends android.os.IInterface
{
  ...
  public static class Default implements com.android.internal.os.IDropBoxManagerService
  {
    ...
    /** @see DropBoxManager#getNextEntry */
    @Override public boolean isTagEnabledWithException(java.lang.String tag, java.lang.String exceptionClassName) throws android.os.RemoteException
    {
      return false;
    }
    /** @see DropBoxManager#getNextEntry */
  ...
  public static abstract class Stub extends android.os.Binder implements com.android.internal.os.IDropBoxManagerService
  {
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_isTagEnabledWithException:
        {
          java.lang.String _arg0;
          _arg0 = data.readString();
          ...
          data.enforceNoDataAvail();
          boolean _result = this.isTagEnabledWithException(_arg0, _arg1);
          reply.writeNoException();
          reply.writeBoolean(_result);
          break;
        }
    ...
    private static final class Proxy implements com.android.internal.os.IDropBoxManagerService
    {
      ...
      @Override public boolean isTagEnabledWithException(java.lang.String tag, java.lang.String exceptionClassName) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_isTagEnabledWithException, _data, _reply, 0);
          _reply.readException();
          _result = _reply.readBoolean();
        }
        finally {
    ...
    static final int TRANSACTION_isTagEnabledWithException = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
    static final int TRANSACTION_getNextEntry = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
    static final int TRANSACTION_getNextEntryWithAttribution = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
  }
  ...
  /** @see DropBoxManager#getNextEntry */
  public boolean isTagEnabledWithException(java.lang.String tag, java.lang.String exceptionClassName) throws android.os.RemoteException;
  /** @see DropBoxManager#getNextEntry */
  @android.compat.annotation.UnsupportedAppUsage(maxTargetSdk = 30, publicAlternatives = "Use {@link android.os.DropBoxManager#getNextEntry} instead", overrideSourcePosition="frameworks/base/core/java/com/android/internal/os/IDropBoxManagerService.aidl:39:1:40:93")
