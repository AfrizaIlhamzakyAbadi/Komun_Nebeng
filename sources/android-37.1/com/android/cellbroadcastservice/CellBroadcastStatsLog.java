...
public final class CellBroadcastStatsLog {
    ...
    /**
     * CellbroadcastUxReported cellbroadcast_ux_reported<br>
     * Usage: StatsLog.write(StatsLog.CELLBROADCAST_UX_REPORTED, int message_id, boolean translation_button_show, boolean translation_is_triggered, int error_type, boolean map_button_show, boolean map_is_triggered, int map_geo_data_type, int map_error_type);<br>
     */
    public static final int CELLBROADCAST_UX_REPORTED = 1187;

    /**
     * CellbroadcastDynamicConfigUpdated cellbroadcast_dynamic_config_updated<br>
     * Usage: StatsLog.write(StatsLog.CELLBROADCAST_DYNAMIC_CONFIG_UPDATED, int outcome, int payload_presence, int failure_reason);<br>
     */
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED = 1385;
    ...
    // Values for CellbroadcastUxReported.error_type
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_UNKNOWN = 0;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_NONE = 1;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_NETWORK_EXCEPTION = 2;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_HTTP_ERROR = 3;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_PARSING_FAILED = 4;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_PACKAGE_NOT_FOUND = 5;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_SIGNING_INFO_NULL = 6;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_NO_SUCH_ALGORITHM = 7;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_CANCELLED = 8;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_STALE_RESULT = 9;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_ACTIVITY_DESTROYED = 10;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_NOT_APPLICABLE = 11;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_LANGUAGE_MISSING = 12;
    public static final int CELLBROADCAST_UX_REPORTED__ERROR_TYPE__TRANSLATION_ERROR_EXCEPTION = 13;

    // Values for CellbroadcastUxReported.map_geo_data_type
    public static final int CELLBROADCAST_UX_REPORTED__MAP_GEO_DATA_TYPE__GEO_DATA_TYPE_UNKNOWN = 0;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_GEO_DATA_TYPE__GEO_DATA_TYPE_POLYGON = 1;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_GEO_DATA_TYPE__GEO_DATA_TYPE_CIRCLE = 2;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_GEO_DATA_TYPE__GEO_DATA_TYPE_MULTIPLE = 3;

    // Values for CellbroadcastUxReported.map_error_type
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_UNKNOWN = 0;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_NONE = 1;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_NO_MESSAGE = 2;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_NO_GEOMETRY_DATA = 3;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_INVALID_GEOMETRY_DATA = 4;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_URI_ENCODING_FAILED = 5;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_CORE_ACTIVITY_NOT_FOUND = 6;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_CORE_ACTIVITY_PERMISSION_DENIED = 7;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_MULTIPLE_CORE_ACTIVITIES_FOUND = 8;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_PERMISSION_CHECK_EXCEPTION = 9;
    public static final int CELLBROADCAST_UX_REPORTED__MAP_ERROR_TYPE__MAP_ERROR_CORE_ACTIVITY_START_FAILED = 10;

    // Values for CellbroadcastDynamicConfigUpdated.outcome
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__OUTCOME__CONFIG_UPDATE_PROCESS_OUTCOME_UNKNOWN = 0;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__OUTCOME__CONFIG_UPDATE_PROCESS_OUTCOME_SUCCESS = 1;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__OUTCOME__CONFIG_UPDATE_PROCESS_OUTCOME_FAILURE = 2;

    // Values for CellbroadcastDynamicConfigUpdated.payload_presence
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__PAYLOAD_PRESENCE__PAYLOAD_PRESENCE_STATE_UNKNOWN = 0;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__PAYLOAD_PRESENCE__PAYLOAD_PRESENCE_STATE_HAS_CONTENT = 1;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__PAYLOAD_PRESENCE__PAYLOAD_PRESENCE_STATE_NO_CONTENT_DEFAULT = 2;

    // Values for CellbroadcastDynamicConfigUpdated.failure_reason
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__FAILURE_REASON__CONFIG_UPDATE_FAILURE_REASON_UNKNOWN = 0;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__FAILURE_REASON__CONFIG_UPDATE_FAILURE_REASON_NONE = 1;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__FAILURE_REASON__CONFIG_UPDATE_FAILURE_REASON_CRC32_MISMATCH = 2;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__FAILURE_REASON__CONFIG_UPDATE_FAILURE_REASON_SIZE_DISCREPANCY = 3;
    public static final int CELLBROADCAST_DYNAMIC_CONFIG_UPDATED__FAILURE_REASON__CONFIG_UPDATE_FAILURE_REASON_VERSION_MISMATCH = 4;
    ...
    public static void write(int code, int arg1, boolean arg2, boolean arg3, int arg4, boolean arg5, boolean arg6, int arg7, int arg8) {
        final StatsEvent.Builder builder = StatsEvent.newBuilder();
        builder.setAtomId(code);
