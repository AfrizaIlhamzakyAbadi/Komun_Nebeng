...
public final class DdmServer {
    ...
    /**
     * Returns true if DDM support is disabled via the
     * `com.android.art.rw.flags.reject_ddm_packets_in_jdwp` aconfig flag.
     * This native method is needed because the flag is defined in the ART module and
     * there is a limitation that prevents us from using read-write flags directly
     * here (see b/391379705).
     */
    private native static boolean isDdmDisabled();
    ...
    {
        if (isDdmDisabled()) {
            System.err.println("DDM is deprecated; rejecting chunk " + ChunkHandler.name(type));
            return ChunkHandler.createFailChunk(1, "DDM is deprecated");
        }
